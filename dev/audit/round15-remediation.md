...
- **2026-06-27 D2 DONE (WIN)** — G3 xref-class breakout: scripture `v-`/`ch-` cross-references counted + failure-bucketed
  ...
  per-build gates PASS) + 2 unit tests. **▶▶ ROUND-15 ✅ ALL DIMENSIONS COMPLETE (D1–D9 both lanes).** Only follow-ups: the
  D1 retired-asset re-cut at the v1.0.0 tag (outward-facing, flagged); Mac cross-OS verify of the D5 build + D3 golden re-stamp.
