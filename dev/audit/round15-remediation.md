...
- **★ MAC ROUND-15 COMPLETE (all 5 owned dims D1/D3/D4-diagnosis/D6/D7 + breadth pass).** Remaining cross-lane: (a) WIN re-stamp G1
  golden for D3 (`vulgate` popup Ps 2:12/4:8); (b) WIN D5/D8/D9 + D2-G3-wiring; (c) D1 retired-asset re-cut at the v1.0.0 tag;
