...
- **2026-06-27 D5 DONE (WIN)** — flagship glossary byte-streamer proven: CHECK A real 255 MB monolith str==from-file byte-identical
  ...
  `round15-d5-glossary-byteproof.md`. **▶ ROUND-15 WIN dims COMPLETE (D2◐ G3-breakout = the lone remaining WIN sub-item;
  D1 retired-asset re-cut deferred to the v1.0.0 tag). ▶ Mac: cross-OS verify the D5 build (rebuild flagship eink on macOS → G5
