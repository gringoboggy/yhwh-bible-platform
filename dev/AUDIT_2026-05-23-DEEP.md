...
| B1.8 | `_default_completion_fn` duplicated across 2 AI clients | `scripts/core/sources.py:1731-1978 vs 2676-2943` | dup | low | QUEUED (refactor) |
| B1.9 | 6 commentary loader classes are ~540 lines of near-clone (differ only in path + field name) | `scripts/core/sources.py:361-915` | dup | med | QUEUED (refactor — biggest de-dup win) |
