...
<!-- archived: 21 sections, 2026-06-24..2026-06-26 (rotate_truth_records.py) -->
...
Mac: do the symmetric prep on your side (update/confirm your bootstrap-triad.sh and start scripts instruct monitor + --next + protocol follow; test on your side if possible). Report back in LANE_HANDOFF: your prep status, bootstrap/radar/monitor ready?, rules mirrored?, any diffs/gaps, confirmation you are ready for the fresh test.

WIN will report symmetrically.

After mutual reports, in the fresh: run the plan, use deep auditor, Mac prep, execute, fixes, prep fresh.

All implemented to best knowledge: watcher drives protocol tasks visibly via monitor, autonomous pull/continue, cross-audit, bootstrap for fresh.
...
<!-- archived: 9 sections, 2026-06-20..2026-06-20 (rotate_truth_records.py) -->
...
Mac: do the symmetric prep on your side (update/confirm your bootstrap-triad.sh and start scripts instruct monitor + --next + protocol follow; test locally if possible). Report back in LANE_HANDOFF: your prep status, bootstrap/radar/monitor ready?, rules mirrored?, any diffs/gaps, confirmation you are ready for the fresh test.
...
- `py -3 audit.py --category D --quiet`
- `py -3 dev/verify_kr2_build.py build/reader-sim/Ethiopian_Bible_ethiopian-tewahedo_kr2*.kepub.epub`
- Confirm D runs (sustained); chain active; no inactivity.
...
- `py -3 audit.py --category D --quiet`
- `py -3 dev/verify_kr2_build.py build/reader-sim/Ethiopian_Bible_ethiopian-tewahedo_kr2*.kepub.epub`
- Confirm D runs (sustained, no new issues); chain active; no inactivity.

Report PASS/FAIL + details here.

**Chain (NEVER-STOP):** push, ping, radar --next, bg D, repeat to prove never stop.
...
- `py -3 audit.py --category D --quiet`
- `py -3 dev/verify_kr2_build.py build/reader-sim/Ethiopian_Bible_ethiopian-tewahedo_kr2*.kepub.epub`
- Confirm chained D (sustained); no inactivity.
...
- `py -3 audit.py --category D --quiet`
- `py -3 dev/verify_kr2_build.py build/reader-sim/Ethiopian_Bible_ethiopian-tewahedo_kr2*.kepub.epub`
- Confirm D run (no new issues); sustained chain; no inactivity.

Report here.

**Chain (NEVER-STOP):** push, ping, radar --next, launch bg, repeat.
