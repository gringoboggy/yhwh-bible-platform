...
| τ.7.x.d-z Amharic remaining books | τ.7.x.d → τ.7.x.z | ⬜ next-phase under D1-a per-book cadence | τ.7.x.d (Amharic Numbers) is next-up. Re-uses τ.7.x.a+b+c pipeline; needs NUMBERS_VERSE_COUNTS floor (36 ch / 1288 v) + structural_map.numbers block (pdf_page_range starting at 214 per τ.7.x.c boundary inspection — Num 1:1 confirmed at p214). |
