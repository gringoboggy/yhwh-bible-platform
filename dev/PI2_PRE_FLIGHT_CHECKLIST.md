...
| τ.7.x.c-z Amharic remaining books | τ.7.x.c → τ.7.x.z | ⬜ next-phase under D1-a per-book cadence | τ.7.x.c (Amharic Leviticus) is next-up. Re-uses τ.7.x.a + τ.7.x.b pipeline; needs LEVITICUS_VERSE_COUNTS floor (27 ch / 859 v) + structural_map.leviticus block (pdf_page_range likely [161, ~210] per τ.7.x.b boundary inspection — Lev 1:1 confirmed at page 161). |
