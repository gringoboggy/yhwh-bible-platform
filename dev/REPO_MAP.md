...
| `website/` | 🆕 Mac lane | **Public website** — the free-download landing page for `yhwhyaway.com`: `index.html` + `style.css` + `covers/` (cover thumbnails). Static (plain HTML/CSS + a planned `build_site.py`); deploys to GitLab Pages. Plan: `docs/superpowers/plans/2026-06-03-website-plan.md`. |
