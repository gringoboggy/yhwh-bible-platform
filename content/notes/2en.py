"""
Notes for The Second Book of Enoch, or Slavonic Enoch, or The Book of the Secrets of Enoch (2en).

No notes yet — add tuples to the NOTES list below or use:
    python3 scripts/add_note.py --book 2en --ch <N> --v <V> --anchor "…" \
...
NOTES_2EN = NOTES  # backward-compat alias
