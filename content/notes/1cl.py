"""
Notes for The First Epistle of Clement to the Corinthians (1cl).

No notes yet — add tuples to the NOTES list below or use:
    python3 scripts/add_note.py --book 1cl --ch <N> --v <V> --anchor "…" \
...
NOTES_1CL = NOTES  # backward-compat alias
