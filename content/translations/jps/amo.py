...
VERSES = [
    ...
    (2, 13, "Behold, I will make it creak under you, as a cart creaketh that is full of sheaves."),
    (
        2,
        14,
    ...
    (5, 4, "For thus saith the LORD unto the house of Israel: Seek ye Me, and live;"),
    (
        5,
        5,
    ...
    (5, 17, "And in all vineyards shall be lamentation; for I will pass through the midst of thee, saith the LORD."),
    (
        5,
        18,
    ...
    (6, 5, "That thrum on the psaltery, that devise for themselves instruments of music, like David;"),
    (
        6,
        6,
    ...
    (7, 6, "The LORD repented concerning this; 'This also shall not be', saith the Lord GOD."),
    (
        7,
        7,
    ...
    (8, 1, "Thus the Lord GOD showed me; and behold a basket of summer fruit."),
    (
        8,
        2,
    ...
    (8, 4, "Hear this, O ye that would swallow the needy, and destroy the poor of the land,"),
    (
        8,
        5,
    ...
    (8, 6, "That we may buy the poor for silver, and the needy for a pair of shoes, and sell the refuse of the corn?'"),
    (8, 7, "The LORD hath sworn by the pride of Jacob: Surely I will never forget any of their works."),
    (
        8,
        8,
