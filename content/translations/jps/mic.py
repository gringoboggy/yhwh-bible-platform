...
VERSES = [
    ...
    (5, 9, "(5-8) Let Thy hand be lifted up above Thine adversaries, and let all Thine enemies be cut off."),
    (
        5,
        10,
    ...
    (5, 11, "(5-10) And I will cut off the cities of thy land, and will throw down all thy strongholds;"),
    (5, 12, "(5-11) And I will cut off witchcrafts out of thy hand; and thou shalt have no more soothsayers;"),
    (
        5,
        13,
    ...
    (5, 14, "(5-13) And I will pluck up thy Asherim out of the midst of thee; and I will destroy thine enemies."),
    (5, 15, "(5-14) And I will execute vengeance in anger and fury upon the nations, because they hearkened not."),
    (
        6,
        1,
