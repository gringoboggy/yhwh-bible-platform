...
VERSES = [
    ...
    (5, 5, "(5-4) Better is it that thou shouldest not vow, than that thou shouldest vow and not pay."),
    (
        5,
        6,
    ...
    (5, 7, "(5-6) For through the multitude of dreams and vanities there are also many words; but fear thou God."),
    (
        5,
        8,
    ...
    (5, 9, "(5-8) But the profit of a land every way is a king that maketh himself servant to the field."),
    (
        5,
        10,
    ...
    (5, 17, "(5-16) All his days also he eateth in darkness, and he hath much vexation and sickness and wrath."),
    (
        5,
        18,
