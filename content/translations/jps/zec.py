...
VERSES = [
    ...
    (1, 13, "And the LORD answered the angel that spoke with me with good words, even comforting words —"),
    (
        1,
        14,
    ...
    (1, 18, "(2-1) And I lifted up mine eyes, and saw, and behold four horns."),
    (
        1,
        19,
    ...
    (1, 20, "(2-3) And the LORD showed me four craftsmen."),
    (
        1,
        21,
    ...
    (2, 1, "(2-5) And I lifted up mine eyes, and saw, and behold a man with a measuring line in his hand."),
    (
        2,
        2,
        "(2-6) Then said I: 'Whither goest thou?' And he said unto me: 'To measure Jerusalem, to see what is the breadth thereof, and what is the length thereof.'",
    ),
    (2, 3, "(2-7) And, behold, the angel that spoke with me went forth, and another angel went out to meet him,"),
    (
        2,
        4,
        "(2-8) and said unto him: 'Run, speak to this young man, saying: 'Jerusalem shall be inhabited without walls for the multitude of men and cattle therein.",
    ),
    (
        2,
        5,
        "(2-9) For I, saith the LORD, will be unto her a wall of fire round about, and I will be the glory in the midst of her.",
    ),
    (
        2,
        6,
    ...
    (2, 7, "(2-11) Ho, Zion, escape, thou that dwellest with the daughter of Babylon.'"),
    (
        2,
        8,
    ...
    (
        2,
        9,
        "(2-13) For, behold, I will shake My hand over them, and they shall be a spoil to those that served them'; and ye shall know that the LORD of hosts hath sent me.",
    ),
    (
        2,
        10,
    ...
    (
        2,
        11,
        "(2-15) And many nations shall join themselves to the LORD in that day, and shall be My people, and I will dwell in the midst of thee'; and thou shalt know that the LORD of hosts hath sent me unto thee.",
    ),
    (
        2,
        12,
    ...
    (2, 13, "(2-17) Be silent, all flesh, before the LORD; for He is aroused out of His holy habitation."),
    (
        3,
        1,
    ...
    (3, 6, "And the angel of the LORD forewarned Joshua, saying:"),
    (
        3,
        7,
    ...
    (5, 10, "Then said I to the angel that spoke with me: 'Whither do these bear the measure?'"),
    (
        5,
        11,
    ...
    (7, 6, "And when ye eat, and when ye drink, are ye not they that eat, and they that drink?"),
    (
        7,
        7,
    ...
    (8, 15, "so again do I purpose in these days to do good unto Jerusalem and to the house of Judah; fear ye not."),
    (
        8,
        16,
    ...
    (9, 2, "And Hamath also shall border thereon; Tyre and Zidon, for she is very wise."),
    (
        9,
        3,
