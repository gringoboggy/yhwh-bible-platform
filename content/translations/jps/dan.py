...
VERSES = [
    ...
    (4, 4, "(4-1) I Nebuchadnezzar was at rest in my house, and flourishing in my palace."),
    (
        4,
        5,
    ...
    (4, 29, "(4-26) At the end of twelve months he was walking upon the royal palace of Babylon."),
    (
        4,
        30,
    ...
    (5, 31, "(6-1) And Darius the Mede received the kingdom, being about threescore and two years old."),
    (
        6,
        1,
    ...
    (6, 9, "(6-10) Wherefore king Darius signed the writing and the interdict."),
    (
        6,
        10,
    ...
    (6, 28, "(6-29) So this Daniel prospered in the reign of Darius, and in the reign of Cyrus the Persian."),
    (
        7,
        1,
