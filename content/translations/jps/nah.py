...
VERSES = [
    ...
    (1, 7, "The LORD is good, a stronghold in the day of trouble; and He knoweth them that take refuge in Him."),
    (
        1,
        8,
        "But with an overrunning flood He will make a full end of the place thereof, and darkness shall pursue His enemies.",
    ),
    (1, 9, "What do ye devise against the LORD? He will make a full end; trouble shall not rise up the second time."),
    (
        1,
        10,
    ...
    (1, 11, "Out of thee came he forth, that deviseth evil against the LORD, that counselleth wickedness."),
    (
        1,
        12,
    ...
    (2, 6, "(2-7) The gates of the rivers are opened, and the palace is dissolved."),
    (
        2,
        7,
    ...
    (
        2,
        11,
        "(2-12) Where is the den of the lions, which was the feeding-place of the young lions, where the lion and the lioness walked, and the lion's whelp, and none made them afraid?",
    ),
    (
        2,
        12,
    ...
    (
        2,
        13,
        "(2-14) Behold, I am against thee, saith the LORD of hosts, and I will burn her chariots in the smoke, and the sword shall devour thy young lions; and I will cut off thy prey from the earth, and the voice of thy messengers shall no more be heard.",
    ),
    ...
    (3, 11, "Thou also shalt be drunken, thou shalt swoon; thou also shalt seek a refuge because of the enemy."),
    (
        3,
        12,
