...
VERSES = [
    ...
    (2, 30, "(3-3) And I will shew wonders in the heavens and in the earth, blood, and fire, and pillars of smoke."),
    (
        2,
        31,
    ...
    (3, 15, "(4-15) The sun and the moon are become black, and the stars withdraw their shining."),
    (
        3,
        16,
    ...
    (3, 20, "(4-20) But Judah shall be inhabited for ever, and Jerusalem from generation to generation."),
    (
        3,
        21,
