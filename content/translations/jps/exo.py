...
VERSES = [
    ...
    (8, 2, "(7-27) And if thou refuse to let them go, behold, I will smite all thy borders with frogs."),
    (
        8,
        3,
    ...
    (8, 4, "(7-29) And the frogs shall come up both upon thee, and upon thy people, and upon all thy servants.'"),
    (
        8,
        5,
    ...
    (8, 14, "(8-10) And they gathered them together in heaps; and the land stank."),
    (
        8,
        15,
    ...
    (8, 23, "(8-19) And I will put a division between My people and thy people — by to-morrow shall this sign be.'"),
    (
        8,
        24,
    ...
    (8, 25, "(8-21) And Pharaoh called for Moses and for Aaron, and said: 'Go ye, sacrifice to your God in the land.'"),
    (
        8,
        26,
    ...
    (8, 30, "(8-26) And Moses went out from Pharaoh, and entreated the LORD."),
    (
        8,
        31,
    ...
    (8, 32, "(8-28) And Pharaoh hardened his heart this time also, and he did not let the people go."),
    (
        9,
        1,
    ...
    (20, 14, "(20-13) Thou shalt not commit adultery."),
    (20, 15, "(20-13) Thou shalt not steal."),
    (20, 16, "(20-13) Thou shalt not bear false witness against thy neighbour."),
    (
        20,
        17,
    ...
    (20, 21, "(20-18) And the people stood afar off; but Moses drew near unto the thick darkness where God was."),
    (
        20,
        22,
    ...
    (20, 23, "(20-20) Ye shall not make with Me — gods of silver, or gods of gold, ye shall not make unto you."),
    (
        20,
        24,
    ...
    (20, 26, "(20-23) Neither shalt thou go up by steps unto Mine altar, that thy nakedness be not uncovered thereon."),
    ...
    (22, 4, "(22-3) If the theft be found in his hand alive, whether it be ox, or ass, or sheep, he shall pay double."),
    (
        22,
        5,
    ...
    (22, 12, "(22-11) But if it be stolen from him, he shall make restitution unto the owner thereof."),
    (
        22,
        13,
    ...
    (22, 18, "(22-17) Thou shalt not suffer a sorceress to live."),
    (22, 19, "(22-18) Whosoever lieth with a beast shall surely be put to death."),
    (22, 20, "(22-19) He that sacrificeth unto the gods, save unto the LORD only, shall be utterly destroyed."),
    (
        22,
        21,
        "(22-20) And a stranger shalt thou not wrong, neither shalt thou oppress him; for ye were strangers in the land of Egypt.",
    ),
    (22, 22, "(22-21) Ye shall not afflict any widow, or fatherless child."),
    (
        22,
        23,
    ...
    (22, 28, "(22-27) Thou shalt not revile God, nor curse a ruler of thy people."),
    (
        22,
        29,
