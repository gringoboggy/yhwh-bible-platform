...
VERSES = [
    ...
    (2, 10, "Thou hast devised shame to thy house, by cutting off many peoples, and hast forfeited thy life."),
    ...
    (3, 4, "And a brightness appeareth as the light; rays hath He at His side; and there is the hiding of His power."),
    ...
    (3, 12, "Thou marchest through the earth in indignation, Thou threshest the nations in anger."),
    (
        3,
        13,
    ...
    (3, 15, "Thou hast trodden the sea with Thy horses, the foaming of mighty waters."),
    (
        3,
        16,
