...
VERSES = [
    ...
    (6, 17, "But let this that we have spoken be for a warning unto us. And now will we come to the declaring of the matter in a few words."),
    ...
    (7, 7, "So when the first was dead after this manner, they brought the second to make him a mocking stock: and when they had pulled off the skin of his head with the hair, they asked him, Wilt thou eat, before thou be punished throughout every member of thy body?"),
    ...
    (7, 39, "Then the king being in a rage, handed him worse than all the rest, and took it grievously that he was mocked."),
    ...
    (11, 1, "Not long after this, Lysias the king’s protector and cousin, who also managed the affairs, took sore displeasure for the things that were done."),
    ...
    (15, 36, "And they ordained all with a common decree in no case to let that day pass without solemnity, but to celebrate the thirteenth day of the twelfth month, which in the Syrian tongue is called Adar, the day before Mardocheus’ day."),
