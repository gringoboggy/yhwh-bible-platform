...
VERSES = [
    ...
    (
        6,
        17,
        "But let this that we have spoken be for a warning unto us. And now will we come to the declaring of the matter in a few words.",
    ),
    (
        6,
        18,
    ...
    (
        7,
        7,
        "So when the first was dead after this manner, they brought the second to make him a mocking stock: and when they had pulled off the skin of his head with the hair, they asked him, Wilt thou eat, before thou be punished throughout every member of thy body?",
    ),
    (
        7,
        8,
    ...
    (
        7,
        27,
        "But she bowing herself toward him, laughing the cruel tyrant to scorn, spake in her country language on this manner; O my son, have pity upon me that bare thee nine months in my womb, and gave thee suck three years, and nourished thee, and brought thee up unto this age, and endured the troubles of education.",
    ),
    (
        7,
        28,
    ...
    (
        11,
        1,
        "Not long after this, Lysias the king’s protector and cousin, who also managed the affairs, took sore displeasure for the things that were done.",
    ),
    (
        11,
        2,
