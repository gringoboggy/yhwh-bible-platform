...
VERSES = [
    ...
    (48, 36, "Therefore mine heart shall sound for Moab like pipes, and mine heart shall sound like pipes for the men of Kir-heres: because the riches [that] he hath gotten are perished."),
    ...
    (52, 12, "¶ Now in the fifth month, in the tenth [day] of the month, which [was] the nineteenth year of Nebuchadrezzar king of Babylon, came Nebuzar-adan, captain of the guard, [which] served the king of Babylon, into Jerusalem,"),
