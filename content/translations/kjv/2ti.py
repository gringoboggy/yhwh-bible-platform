...
VERSES = [
    ...
    (1, 11, "Where unto I am appointed a preacher, and an apostle, and a teacher of the Gentiles."),
    (
        1,
        12,
    ...
    (2, 9, "Where in I suffer trouble, as an evil doer, [even] unto bonds; but the word of God is not bound."),
    (
        2,
        10,
