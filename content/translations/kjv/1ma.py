...
VERSES = [
    ...
    (8, 1, "Now Judas had heard of the Romans, that they were mighty and valiant men, and such as would lovingly accept all that joined themselves unto them, and make a league of amity with all that came unto them;"),
    ...
    (9, 6, "Who seeing the multitude of the other army to be so great were sore afraid; whereupon many conveyed themselves out of the host, insomuch as abode of them no more but eight hundred men."),
    ...
    (9, 50, "Afterward returned Bacchides to Jerusalem and repaired the strong cites in Judea; the fort in Jericho, and Emmaus, and Bethhoron, and Beth-el, and Thamnatha, Pharathoni, and Taphon, these did he strengthen with high walls, with gates and with bars."),
