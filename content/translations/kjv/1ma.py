...
VERSES = [
    ...
    (
        1,
        63,
        "Wherefore they chose rather to die, that they might not be defiled with meats, and that they might not profane the holy covenant: so then they died.",
    ),
    ...
    (
        9,
        50,
        "Afterward returned Bacchides to Jerusalem and repaired the strong cites in Judea; the fort in Jericho, and Emmaus, and Bethhoron, and Beth-el, and Thamnatha, Pharathoni, and Taphon, these did he strengthen with high walls, with gates and with bars.",
    ),
    ...
    (
        10,
        63,
        "And he made him sit by himself, and said unto his princes, Go with him into the midst of the city, and make proclamation, that no man complain against him of any matter, and that no man trouble him for any manner of cause.",
    ),
    (
        10,
        64,
