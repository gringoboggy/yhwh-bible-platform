"""Translation: vulgate-clementine · Book: ezr
...
VERSES = [
    ...
    (2, 3, "filii Pharos duo millia centum septuaginta duo."),
    (2, 4, "Filii Sephatia, trecenti septuaginta duo."),
    (2, 5, "Filii Area, septingenti septuaginta quinque."),
    (2, 6, "Filii Phahath Moab, filiorum Josue: Joab, duo millia octingenti duodecim."),
    (2, 7, "Filii Ælam, mille ducenti quinquaginta quatuor."),
    (2, 8, "Filii Zethua, nongenti quadraginta quinque."),
    (2, 9, "Filii Zachai, septingenti sexaginta."),
    (2, 10, "Filii Bani, sexcenti quadraginta duo."),
    (2, 11, "Filii Bebai, sexcenti viginti tres."),
    (2, 12, "Filii Azgad, mille ducenti viginti duo."),
    (2, 13, "Filii Adonicam, sexcenti sexaginta sex."),
    (2, 14, "Filii Beguai, duo millia quinquaginta sex."),
    (2, 15, "Filii Adin, quadringenti quinquaginta quatuor."),
    (2, 16, "Filii Ather, qui erant ex Ezechia, nonaginta octo."),
    (2, 17, "Filii Besai, trecenti viginti tres."),
    (2, 18, "Filii Jora, centum duodecim."),
    (2, 19, "Filii Hasum, ducenti viginti tres."),
    (2, 20, "Filii Gebbar, nonaginta quinque."),
    (2, 21, "Filii Bethlehem, centum viginti tres."),
    (2, 22, "Viri Netupha, quinquaginta sex."),
    (2, 23, "Viri Anathoth, centum viginti octo."),
    (2, 24, "Filii Azmaveth, quadraginta duo."),
    (2, 25, "Filii Cariathiarim, Cephira et Beroth, septingenti quadraginta tres."),
    (2, 26, "Filii Rama et Gabaa, sexcenti viginti unus."),
    (2, 27, "Viri Machmas, centum viginti duo."),
    (2, 28, "Viri Bethel et Hai, ducenti viginti tres."),
    (2, 29, "Filii Nebo, quinquaginta duo."),
    (2, 30, "Filii Megbis, centum quinquaginta sex."),
    (2, 31, "Filii Ælam alterius, mille ducenti quinquaginta quatuor."),
    (2, 32, "Filii Harim, trecenti viginti."),
    (2, 33, "Filii Lod Hadid, et Ono, septingenti viginti quinque."),
    (2, 34, "Filii Jericho, trecenti quadraginta quinque."),
    (2, 35, "Filii Senaa, tria millia sexcenti triginta."),
    (2, 36, "Sacerdotes: filii Jadaia in domo Josue, nongenti septuaginta tres."),
    ...
    (2, 40, "Levitæ: filii Josue et Cedmihel filiorum Odoviæ, septuaginta quatuor."),
    ...
    (2, 56, "filii Jala, filii Dercon, filii Geddel,"),
    (2, 57, "filii Saphatia, filii Hatil, filii Phochereth, qui erant de Asebaim, filii Ami:"),
    (2, 58, "omnes Nathinæi, et filii servorum Salomonis, trecenti nonaginta duo."),
    (
        2,
        59,
    ...
    (2, 60, "Filii Dalaia, filii Tobia, filii Necoda, sexcenti quinquaginta duo."),
    (
        2,
        61,
        "Et de filiis sacerdotum: filii Hobia, filii Accos, filii Berzellai, qui accepit de filiabus Berzellai Galaaditis, uxorem, et vocatus est nomine eorum:",
    ),
    (2, 62, "hi quæsierunt scripturam genealogiæ suæ, et non invenerunt, et ejecti sunt de sacerdotio."),
    (
        2,
        63,
    ...
    (2, 67, "cameli eorum, quadringenti triginta quinque, asini eorum, sex millia septingenti viginti."),
    (
        2,
        68,
    ...
    (4, 1, "Audierunt autem hostes Judæ et Benjamin, quia filii captivitatis ædificarent templum Domino Deo Israël:"),
    (
        4,
        2,
    ...
    (4, 4, "Factum est igitur ut populus terræ impediret manus populi Judæ, et turbaret eos in ædificando."),
    (
        4,
        5,
    ...
    (6, 10, "Et offerant oblationes Deo cæli, orentque pro vita regis, et filiorum ejus."),
    (
        6,
        11,
    ...
    (6, 19, "Fecerunt autem filii Israël transmigrationis Pascha, quartadecima die mensis primi."),
    (
        6,
        20,
    ...
    (7, 8, "Et venerunt in Jerusalem mense quinto, ipse est annus septimus regis."),
    (
        7,
        9,
    ...
    (7, 19, "Vasa quoque, quæ dantur tibi in ministerium domus Dei tui, trade in conspectu Dei in Jerusalem."),
    (
        7,
        20,
    ...
    (8, 4, "De filiis Phahath Moab, Elioënai filius Zarehe, et cum eo ducenti viri."),
    (8, 5, "De filiis Secheniæ, filius Ezechiel, et cum eo trecenti viri."),
    (8, 6, "De filiis Adan, Abed filius Jonathan, et cum eo quinquaginta viri."),
    (8, 7, "De filiis Alam, Isaias filius Athaliæ, et cum eo septuaginta viri."),
    (8, 8, "De filiis Saphatiæ, Zebedia filius Michaël, et cum eo octoginta viri."),
    (8, 9, "De filiis Joab, Obedia filius Jahiel, et cum eo ducenti decem et octo viri."),
    (8, 10, "De filiis Selomith, filius Josphiæ, et cum eo centum sexaginta viri."),
    (8, 11, "De filiis Bebai, Zacharias filius Bebai, et cum eo viginti octo viri."),
    (8, 12, "De filiis Azgad, Johanan filius Eccetan, et cum eo centum et decem viri."),
    (
        8,
        13,
    ...
    (8, 19, "et Hasabiam, et cum eo Isaiam de filiis Merari, fratresque ejus, et filios ejus viginti:"),
    (
        8,
        20,
    ...
    (8, 23, "Jejunavimus autem, et rogavimus Deum nostrum per hoc: et evenit nobis prospere."),
    (
        8,
        24,
    ...
    (8, 32, "Et venimus Jerusalem, et mansimus ibi tribus diebus."),
    (
        8,
        33,
    ...
    (8, 34, "juxta numerum et pondus omnium: descriptumque est omne pondus in tempore illo."),
    (
        8,
        35,
    ...
    (10, 22, "Et de filiis Pheshur, Elioënai, Maasia, Ismaël, Nathanaël, Jozabed, et Elasa."),
    ...
    (10, 26, "Et de filiis Ælam, Mathania, Zacharias, et Jehiel, et Abdi, et Jerimoth, et Elia."),
    (10, 27, "Et de filiis Zethua, Elioënai, Eliasib, Mathania, et Jerimuth, et Zabad, et Aziza."),
    ...
    (10, 43, "De filiis Nebo, Jehiel, Mathathias, Zabad, Zabina, Jeddu, et Joël, et Banaia."),
