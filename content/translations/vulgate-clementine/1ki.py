"""Translation: vulgate-clementine · Book: 1ki
...
VERSES = [
    ...
    (1, 7, "Et sermo ei cum Joab filio Sarviæ, et cum Abiathar sacerdote, qui adjuvabant partes Adoniæ."),
    (
        1,
        8,
    ...
    (1, 26, "me servum tuum, et Sadoc sacerdotem, et Banaiam filium Jojadæ, et Salomonem famulum tuum non vocavit."),
    (
        1,
        27,
    ...
    (1, 36, "Et respondit Banaias filius Jojadæ regi, dicens: Amen: sic loquatur Dominus Deus domini mei regis."),
    (
        1,
        37,
    ...
    (1, 43, "Responditque Jonathas Adoniæ: Nequaquam: dominus enim noster rex David regem constituit Salomonem:"),
    (
        1,
        44,
    ...
    (2, 25, "Misitque rex Salomon per manum Banaiæ filii Jojadæ, qui interfecit eum, et mortuus est."),
    (
        2,
        26,
    ...
    (2, 35, "Et constituit rex Banaiam filium Jojadæ pro eo super exercitum, et Sadoc sacerdotem posuit pro Abiathar."),
    (
        2,
        36,
    ...
    (2, 43, "quare ergo non custodisti jusjurandum Domini, et præceptum quod præceperam tibi?"),
    (
        2,
        44,
    ...
    (2, 46, "Jussit itaque rex Banaiæ filio Jojadæ, qui egressus, percussit eum, et mortuus est."),
    (
        3,
        1,
    ...
    (3, 27, "Respondit rex, et ait: Date huic infantem vivum, et non occidatur: hæc est enim mater ejus."),
    (
        3,
        28,
    ...
    (5, 13, "Elegitque rex Salomon operarios de omni Israël, et erat indictio triginta millia virorum."),
    (
        5,
        14,
    ...
    (6, 13, "et habitabo in medio filiorum Israël, et non derelinquam populum meum Israël."),
    ...
    (7, 28, "Et ipsum opus basium, interrasile erat: et sculpturæ inter juncturas."),
    (
        7,
        29,
    ...
    (8, 3, "Veneruntque cuncti senes de Israël, et tulerunt arcam sacerdotes,"),
    (
        8,
        4,
    ...
    (8, 7, "Siquidem cherubim expandebant alas super locum arcæ, et protegebant arcam, et vectes ejus desuper."),
    (
        8,
        8,
    ...
    (8, 14, "Convertitque rex faciem suam, et benedixit omni ecclesiæ Israël: omnia enim ecclesia Israël stabat."),
    (
        8,
        15,
    ...
    (8, 17, "Voluitque David pater meus ædificare domum nomini Domini Dei Israël:"),
    (
        8,
        18,
    ...
    (8, 22, "Stetit autem Salomon ante altare Domini in conspectu ecclesiæ Israël, et expandit manus suas in cælum,"),
    (
        8,
        23,
    ...
    (8, 26, "Et nunc Domine Deus Israël, firmentur verba tua quæ locutus es servo tuo David patri meo."),
    (
        8,
        27,
    ...
    (8, 45, "et exaudies in cælo orationes eorum et preces eorum, et facies judicium eorum."),
    (
        8,
        46,
    ...
    (8, 49, "exaudies in cælo, in firmamento solii tui, orationes eorum et preces eorum, et facies judicium eorum:"),
    (
        8,
        50,
    ...
    (8, 51, "Populus enim tuus est, et hæreditas tua, quos eduxisti de terra Ægypti, de medio fornacis ferreæ."),
    (
        8,
        52,
    ...
    (8, 55, "Stetit ergo, et benedixit omni ecclesiæ Israël voce magna, dicens:"),
    (
        8,
        56,
    ...
    (8, 62, "Igitur rex, et omnis Israël cum eo, immolabant victimas coram Domino."),
    (
        8,
        63,
    ...
    (11, 3, "Fueruntque ei uxores quasi reginæ septingentæ, et concubinæ trecentæ: et averterunt mulieres cor ejus."),
    (
        11,
        4,
    ...
    (11, 16, "(sex enim mensibus ibi moratus est Joab, et omnis Israël, donec interimeret omne masculinum in Idumæa),"),
    (
        11,
        17,
    ...
    (11, 35, "Auferam autem regnum de manu filii ejus, et dabo tibi decem tribus:"),
    (
        11,
        36,
    ...
    (11, 37, "Te autem assumam, et regnabis super omnia quæ desiderat anima tua, erisque rex super Israël."),
    (
        11,
        38,
    ...
    (11, 42, "Dies autem quos regnavit Salomon in Jerusalem super omnem Israël, quadraginta anni sunt."),
    (
        11,
        43,
        "Dormivitque Salomon cum patribus suis, et sepultus est in civitate David patris sui: regnavitque Roboam filius ejus pro eo.",
    ),
    (12, 1, "Venit autem Roboam in Sichem: illuc enim congregatus erat omnis Israël ad constituendum eum regem."),
    (
        12,
        2,
    ...
    (12, 17, "Super filios autem Israël, quicumque habitabant in civitatibus Juda, regnavit Roboam."),
    (
        12,
        18,
    ...
    (12, 19, "recessitque Israël a domo David usque in præsentem diem."),
    (
        12,
        20,
    ...
    (12, 26, "Dixitque Jeroboam in corde suo: Nunc revertetur regnum ad domum David,"),
    (
        12,
        27,
    ...
    (13, 34, "Et propter hanc causam peccavit domus Jeroboam, et eversa est, et deleta de superficie terræ."),
    (14, 1, "In tempore illo ægrotavit Abia filius Jeroboam."),
    (
        14,
        2,
    ...
    (14, 16, "Et tradet Dominus Israël propter peccata Jeroboam, qui peccavit, et peccare fecit Israël."),
    (
        14,
        17,
    ...
    (14, 25, "In quinto autem anno regni Roboam, ascendit Sesac rex Ægypti in Jerusalem,"),
    (
        14,
        26,
    ...
    (15, 1, "Igitur in octavodecimo anno regni Jeroboam filii Nabat, regnavit Abiam super Judam."),
    (15, 2, "Tribus annis regnavit in Jerusalem: nomen matris ejus Maacha filia Abessalom."),
    (
        15,
        3,
    ...
    (15, 6, "Attamen bellum fuit inter Roboam et Jeroboam omni tempore vitæ ejus."),
    (
        15,
        7,
    ...
    (15, 9, "In anno ergo vigesimo Jeroboam regis Israël regnavit Asa rex Juda,"),
    (15, 10, "et quadraginta et uno anno regnavit in Jerusalem. Nomen matris ejus Maacha filia Abessalom."),
    (15, 11, "Et fecit Asa rectum ante conspectum Domini, sicut David pater ejus:"),
    (15, 12, "et abstulit effeminatos de terra, purgavitque universas sordes idolorum quæ fecerant patres ejus."),
    (
        15,
        13,
    ...
    (15, 16, "Bellum autem erat inter Asa, et Baasa regem Israël cunctis diebus eorum."),
    (
        15,
        17,
    ...
    (15, 28, "Interfecit ergo illum Baasa in anno tertio Asa regis Juda, et regnavit pro eo."),
    (
        15,
        29,
    ...
    (15, 32, "Fuitque bellum inter Asa, et Baasa regem Israël, cunctis diebus eorum."),
    (
        15,
        33,
    ...
    (16, 8, "Anno vigesimo sexto Asa regis Juda, regnavit Ela filius Baasa super Israël in Thersa, duobus annis."),
    (
        16,
        9,
    ...
    (16, 17, "Ascendit ergo Amri, et omnis Israël cum eo, de Gebbethon, et obsidebant Thersa."),
    (
        16,
        18,
    ...
    (17, 3, "Recede hinc, et vade contra orientem, et abscondere in torrente Carith, qui est contra Jordanem,"),
    ...
    (17, 15, "Quæ abiit, et fecit juxta verbum Eliæ: et comedit ipse, et illa, et domus ejus: et ex illa die"),
    (
        17,
        16,
    ...
    (18, 15, "Et dixit Elias: Vivit Dominus exercituum, ante cujus vultum sto, quia hodie apparebo ei."),
    (18, 16, "Abiit ergo Abdias in occursum Achab, et indicavit ei: venitque Achab in occursum Eliæ."),
    (18, 17, "Et cum vidisset eum, ait: Tune es ille, qui conturbas Israël?"),
    (
        18,
        18,
    ...
    (18, 20, "Misit Achab ad omnes filios Israël, et congregavit prophetas in monte Carmeli."),
    (
        18,
        21,
    ...
    (19, 1, "Nuntiavit autem Achab Jezabel omnia quæ fecerat Elias, et quomodo occidisset universos prophetas gladio."),
    (
        19,
        2,
    ...
    (20, 2, "Mittensque nuntios ad Achab regem Israël in civitatem,"),
    (
        20,
        3,
        "ait: Hæc dicit Benadad: Argentum tuum, et aurum tuum meum est: et uxores tuæ, et filii tui optimi, mei sunt.",
    ),
    (20, 4, "Responditque rex Israël: Juxta verbum tuum, domine mi rex, tuus sum ego, et omnia mea."),
    (
        20,
        5,
    ...
    (20, 11, "Et respondens rex Israël, ait: Dicite ei: Ne glorietur, accinctus æque ut discinctus."),
    (
        20,
        12,
    ...
    (20, 21, "Necnon egressus rex Israël percussit equos et currus, et percussit Syriam plaga magna."),
    (
        20,
        22,
    ...
    (20, 41, "At ille statim abstersit pulverem de facie sua, et cognovit eum rex Israël, quod esset de prophetis."),
    (
        20,
        42,
    ...
    (20, 43, "Reversus est igitur rex Israël in domum suam, audire contemnens, et furibundus venit in Samariam."),
    (
        21,
        1,
    ...
    (21, 3, "Cui respondit Naboth: Propitius sit mihi Dominus, ne dem hæreditatem patrum meorum tibi."),
    (
        21,
        4,
    ...
    (21, 9, "Litterarum autem hæc erat sententia: Prædicate jejunium, et sedere facite Naboth inter primos populi:"),
    (
        21,
        10,
    ...
    (21, 12, "prædicaverunt jejunium, et sedere fecerunt Naboth inter primos populi."),
    (
        21,
        13,
    ...
    (22, 1, "Transierunt igitur tres anni absque bello inter Syriam et Israël."),
    (22, 2, "In anno autem tertio, descendit Josaphat rex Juda ad regem Israël."),
    (
        22,
        3,
        "(Dixitque rex Israël ad servos suos: Ignoratis quod nostra sit Ramoth Galaad, et negligimus tollere eam de manu regis Syriæ?)",
    ),
    (22, 4, "Et ait ad Josaphat: Veniesne mecum ad præliandum in Ramoth Galaad?"),
    (
        22,
        5,
    ...
    (22, 7, "Dixit autem Josaphat: Non est hic propheta Domini quispiam, ut interrogemus per eum?"),
    (
        22,
        8,
    ...
    (22, 9, "Vocavit ergo rex Israël eunuchum quemdam, et dixit ei: Festina adducere Michæam filium Jemla."),
    (
        22,
        10,
    ...
    (22, 29, "Ascendit itaque rex Israël, et Josaphat rex Juda, in Ramoth Galaad."),
    (
        22,
        30,
    ...
    (22, 33, "Intellexeruntque principes curruum quod non esset rex Israël, et cessaverunt ab eo."),
    (
        22,
        34,
    ...
    (22, 40, "Dormivit ergo Achab cum patribus suis, et regnavit Ochozias filius ejus pro eo."),
    (22, 41, "Josaphat vero filius Asa regnare cœperat super Judam anno quarto Achab regis Israël."),
    (
        22,
        42,
    ...
    (22, 44, "Pacemque habuit Josaphat cum rege Israël."),
    (
        22,
        45,
    ...
    (22, 46, "Sed et reliquias effeminatorum qui remanserant in diebus Asa patris ejus, abstulit de terra."),
    (22, 47, "Nec erat tunc rex constitutus in Edom."),
    (
        22,
        48,
