"""Translation: vulgate-clementine · Book: sng
...
BOOK = "sng"
VERSES = [
    (1, 2, "[Sponsa Osculetur me osculo oris sui; quia meliora sunt ubera tua vino,"),
    (1, 3, "fragrantia unguentis optimis. Oleum effusum nomen tuum; ideo adolescentulæ dilexerunt te."),
    (
        1,
        4,
    ...
    (1, 5, "Sponsa Nigra sum, sed formosa, filiæ Jerusalem, sicut tabernacula Cedar, sicut pelles Salomonis."),
    (
        1,
        6,
    ...
    (1, 9, "Equitatui meo in curribus Pharaonis assimilavi te, amica mea."),
    (1, 10, "Pulchræ sunt genæ tuæ sicut turturis; collum tuum sicut monilia."),
    (1, 11, "Murenulas aureas faciemus tibi, vermiculatas argento."),
    (1, 12, "Sponsa Dum esset rex in accubitu suo, nardus mea dedit odorem suum."),
    (1, 13, "Fasciculus myrrhæ dilectus meus mihi; inter ubera mea commorabitur."),
    (1, 14, "Botrus cypri dilectus meus mihi in vineis Engaddi."),
    (1, 15, "Sponsus Ecce tu pulchra es, amica mea ! ecce tu pulchra es ! Oculi tui columbarum."),
    (1, 16, "Sponsa Ecce tu pulcher es, dilecte mi, et decorus ! Lectulus noster floridus."),
    (1, 17, "Tigna domorum nostrarum cedrina, laquearia nostra cypressina.]"),
    (2, 1, "[Ego flos campi, et lilium convallium."),
    (2, 2, "Sponsus Sicut lilium inter spinas, sic amica mea inter filias."),
    (
        2,
        3,
    ...
    (2, 8, "Sponsa Vox dilecti mei; ecce iste venit, saliens in montibus, transiliens colles."),
    (
        2,
        9,
    ...
    (2, 10, "En dilectus meus loquitur mihi. Sponsus Surge, propera, amica mea, columba mea, formosa mea, et veni:"),
    ...
    (2, 15, "Sponsa Capite nobis vulpes parvulas quæ demoliuntur vineas: nam vinea nostra floruit."),
    ...
    (4, 16, "Sponsa Surge, aquilo, et veni, auster: perfla hortum meum, et fluant aromata illius.]"),
    (
        5,
        1,
    ...
    (5, 5, "Surrexi ut aperirem dilecto meo; manus meæ stillaverunt myrrham, et digiti mei pleni myrrha probatissima."),
    (
        5,
        6,
    ...
    (5, 8, "Adjuro vos, filiæ Jerusalem, si inveneritis dilectum meum, ut nuntietis ei quia amore langueo."),
    (
        5,
        9,
    ...
    (5, 11, "Caput ejus aurum optimum; comæ ejus sicut elatæ palmarum, nigræ quasi corvus."),
    (
        5,
        12,
    ...
    (5, 14, "Manus illius tornatiles, aureæ, plenæ hyacinthis. Venter ejus eburneus, distinctus sapphiris."),
    (
        5,
        15,
    ...
    (6, 4, "Sponsus Pulchra es, amica mea; suavis, et decora sicut Jerusalem; terribilis ut castrorum acies ordinata."),
    (
        6,
        5,
    ...
    (6, 7, "Sicut cortex mali punici, sic genæ tuæ, absque occultis tuis."),
    (6, 8, "Sexaginta sunt reginæ, et octoginta concubinæ, et adolescentularum non est numerus."),
    (
        6,
        9,
    ...
    (6, 13, "Chorus Revertere, revertere, Sulamitis ! revertere, revertere ut intueamur te.]"),
    (
        7,
        1,
    ...
    (8, 4, "Sponsus Adjuro vos, filiæ Jerusalem, ne suscitetis, neque evigilare faciatis dilectam, donec ipsa velit."),
    (
        8,
        5,
    ...
    (8, 13, "Sponsus Quæ habitas in hortis, amici auscultant; fac me audire vocem tuam."),
    (8, 14, "Sponsa Fuge, dilecte mi, et assimilare capreæ, hinnuloque cervorum super montes aromatum.]"),
]
