"""Translation: vulgate-clementine · Book: zec
...
VERSES = [
    ...
    (2, 1, "Et levavi oculos meos, et vidi, et ecce vir, et in manu ejus funiculus mensorum."),
    (
        2,
        2,
    ...
    (4, 3, "Et duæ olivæ super illud: una a dextris lampadis, et una a sinistris ejus."),
    ...
    (4, 11, "Et respondi, et dixi ad eum: Quid sunt duæ olivæ istæ, ad dexteram candelabri, et ad sinistram ejus?"),
    (
        4,
        12,
    ...
    (5, 8, "Et dixit: Hæc est impietas. Et projecit eam in medio amphoræ, et misit massam plumbeam in os ejus."),
    (
        5,
        9,
    ...
    (6, 11, "Et sumes aurum et argentum, et facies coronas, et pones in capite Jesu filii Josedec, sacerdotis magni:"),
    (
        6,
        12,
    ...
    (8, 5, "Et plateæ civitatis complebuntur infantibus et puellis, ludentibus in plateis ejus."),
    (
        8,
        6,
    ...
    (8, 11, "Nunc autem non juxta dies priores ego faciam reliquiis populi hujus, dicit Dominus exercituum,"),
    (
        8,
        12,
    ...
    (9, 2, "Emath quoque in terminis ejus, et Tyrus, et Sidon: assumpserunt quippe sibi sapientiam valde."),
    (9, 3, "Et ædificavit Tyrus munitionem suam, et coacervavit argentum quasi humum, et aurum ut lutum platearum."),
    (9, 4, "Ecce Dominus possidebit eam: et percutiet in mari fortitudinem ejus, et hæc igni devorabitur."),
    (
        9,
        5,
    ...
    (9, 12, "Convertimini ad munitionem, vincti spei: hodie quoque annuntians duplicia reddam tibi."),
    (
        9,
        13,
    ...
    (9, 17, "Quid enim bonum ejus est, et quid pulchrum ejus, nisi frumentum electorum, et vinum germinans virgines?]"),
    (
        10,
        1,
    ...
    (12, 9, "[Et erit in die illa: quæram conterere omnes gentes quæ veniunt contra Jerusalem."),
    (
        12,
        10,
    ...
    (14, 9, "Et erit Dominus rex super omnem terram: in die illa erit Dominus unus, et erit nomen ejus unum."),
    (
        14,
        10,
    ...
    (14, 11, "Et habitabunt in ea, et anathema non erit amplius, sed sedebit Jerusalem secura."),
    (
        14,
        12,
