"""Translation: vulgate-clementine · Book: joe
...
BOOK = "joe"
VERSES = [
    (1, 1, "Verbum Domini, quod factum est ad Joël, filium Phatuel."),
    (
        1,
        2,
    ...
    (1, 16, "Numquid non coram oculis vestris alimenta perierunt de domo Dei nostri, lætitia et exsultatio?"),
    (
        1,
        17,
    ...
    (2, 6, "A facie ejus cruciabuntur populi; omnes vultus redigentur in ollam."),
    (
        2,
        7,
    ...
    (2, 15, "Canite tuba in Sion, sanctificate jejunium, vocate cœtum:"),
    (
        2,
        16,
    ...
    (2, 21, "Noli timere, terra: exsulta, et lætare, quoniam magnificavit Dominus ut faceret."),
    (
        2,
        22,
