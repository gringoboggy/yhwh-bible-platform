"""Translation: vulgate-clementine · Book: 2th
...
VERSES = [
    ...
    (1, 7, "et vobis, qui tribulamini, requiem nobiscum in revelatione Domini Jesu de cælo cum angelis virtutis ejus,"),
    (
        1,
        8,
        "in flamma ignis dantis vindictam iis qui non noverunt Deum, et qui non obediunt Evangelio Domini nostri Jesu Christi,",
    ),
    (1, 9, "qui pœnas dabunt in interitu æternas a facie Domini, et a gloria virtutis ejus:"),
    (
        1,
        10,
    ...
    (2, 1, "Rogamus autem vos, fratres, per adventum Domini nostri Jesu Christi, et nostræ congregationis in ipsum:"),
    (
        2,
        2,
    ...
    (2, 7, "Nam mysterium jam operatur iniquitatis: tantum ut qui tenet nunc, teneat, donec de medio fiat."),
    (
        2,
        8,
    ...
    (2, 9, "cujus est adventus secundum operationem Satanæ in omni virtute, et signis, et prodigiis mendacibus,"),
    (
        2,
        10,
    ...
    (2, 14, "in qua et vocavit vos per Evangelium nostrum in acquisitionem gloriæ Domini nostri Jesu Christi."),
    (
        2,
        15,
