"""Translation: vulgate-clementine · Book: gal
...
VERSES = [
    ...
    (1, 3, "Gratia vobis, et pax a Deo Patre, et Domino nostro Jesu Christo,"),
    (
        1,
        4,
    ...
    (1, 18, "deinde post annos tres veni Jerosolymam videre Petrum, et mansi apud eum diebus quindecim:"),
    (1, 19, "alium autem Apostolorum vidi neminem, nisi Jacobum fratrem Domini."),
    (1, 20, "Quæ autem scribo vobis, ecce coram Deo, quia non mentior."),
    (1, 21, "Deinde veni in partes Syriæ, et Ciliciæ."),
    (1, 22, "Eram autem ignotus facie ecclesiis Judææ, quæ erant in Christo:"),
    (
        1,
        23,
    ...
    (2, 1, "Deinde post annos quatuordecim, iterum ascendi Jerosolymam cum Barnaba, assumpto et Tito."),
    (
        2,
        2,
    ...
    (2, 7, "Sed e contra cum vidissent quod creditum est mihi Evangelium præputii, sicut et Petro circumcisionis"),
    ...
    (2, 15, "Nos natura Judæi, et non ex gentibus peccatores."),
    (
        2,
        16,
    ...
    (2, 21, "Non abjicio gratiam Dei. Si enim per legem justitia, ergo gratis Christus mortuus est."),
    (
        3,
        1,
    ...
    (3, 18, "Nam si ex lege hæreditas, jam non ex promissione. Abrahæ autem per repromissionem donavit Deus."),
    (
        3,
        19,
    ...
    (3, 24, "Itaque lex pædagogus noster fuit in Christo, ut ex fide justificemur."),
    (3, 25, "At ubi venit fides, jam non sumus sub pædagogo."),
    (3, 26, "Omnes enim filii Dei estis per fidem, quæ est in Christo Jesu."),
    ...
    (3, 29, "Si autem vos Christi, ergo semen Abrahæ estis, secundum promissionem hæredes."),
    (4, 1, "Dico autem: quanto tempore hæres parvulus est, nihil differt a servo, cum sit dominus omnium:"),
    ...
    (4, 7, "Itaque jam non est servus, sed filius: quod si filius, et hæres per Deum."),
    ...
    (4, 14, "non sprevistis, neque respuistis: sed sicut angelum Dei excepistis me, sicut Christum Jesum."),
    (
        4,
        15,
    ...
    (4, 25, "Sina enim mons est in Arabia, qui conjunctus est ei quæ nunc est Jerusalem, et servit cum filiis suis."),
    (4, 26, "Illa autem, quæ sursum est Jerusalem, libera est, quæ est mater nostra."),
    (
        4,
        27,
    ...
    (5, 1, "State, et nolite iterum jugo servitutis contineri."),
    ...
    (5, 5, "Nos enim spiritu ex fide, spem justitiæ exspectamus."),
    (
        5,
        6,
