"""Translation: vulgate-clementine · Book: 1jn
...
VERSES = [
    ...
    (2, 3, "Et in hoc scimus quoniam cognovimus eum, si mandata ejus observemus."),
    (2, 4, "Qui dicit se nosse eum, et mandata ejus non custodit, mendax est, et in hoc veritas non est."),
    (
        2,
        5,
    ...
    (2, 12, "Scribo vobis, filioli, quoniam remittuntur vobis peccata propter nomen ejus."),
    (
        2,
        13,
    ...
    (2, 17, "Et mundus transit, et concupiscentia ejus: qui autem facit voluntatem Dei manet in æternum."),
    (
        2,
        18,
    ...
    (2, 29, "Si scitis quoniam justus est, scitote quoniam et omnis, qui facit justitiam, ex ipso natus est."),
    (
        3,
        1,
    ...
    (3, 11, "quoniam hæc est annuntiatio, quam audistis ab initio, ut diligatis alterutrum."),
    (
        3,
        12,
    ...
    (5, 2, "In hoc cognoscimus quoniam diligamus natos Dei, cum Deum diligamus, et mandata ejus faciamus."),
    (5, 3, "Hæc est enim caritas Dei, ut mandata ejus custodiamus: et mandata ejus gravia non sunt."),
    (5, 4, "Quoniam omne quod natum est ex Deo, vincit mundum: et hæc est victoria, quæ vincit mundum, fides nostra."),
    (5, 5, "Quis est, qui vincit mundum, nisi qui credit quoniam Jesus est Filius Dei?"),
    (
        5,
        6,
    ...
    (5, 11, "Et hoc est testimonium, quoniam vitam æternam dedit nobis Deus: et hæc vita in Filio ejus est."),
