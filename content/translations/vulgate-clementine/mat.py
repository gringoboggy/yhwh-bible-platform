"""Translation: vulgate-clementine · Book: mat
...
VERSES = [
    ...
    (2, 3, "Audiens autem Herodes rex, turbatus est, et omnis Jerosolyma cum illo."),
    (
        2,
        4,
        "Et congregans omnes principes sacerdotum, et scribas populi, sciscitabatur ab eis ubi Christus nasceretur.",
    ),
    (2, 5, "At illi dixerunt: In Bethlehem Judæ: sic enim scriptum est per prophetam:"),
    (
        2,
        6,
    ...
    (2, 14, "Qui consurgens accepit puerum et matrem ejus nocte, et secessit in Ægyptum:"),
    (
        2,
        15,
    ...
    (2, 17, "Tunc adimpletum est quod dictum est per Jeremiam prophetam dicentem:"),
    (
        2,
        18,
        "[Vox in Rama audita est ploratus, et ululatus multus: Rachel plorans filios suos, et noluit consolari, quia non sunt.]",
    ),
    (2, 19, "Defuncto autem Herode, ecce angelus Domini apparuit in somnis Joseph in Ægypto,"),
    (
        2,
        20,
        "dicens: Surge, et accipe puerum, et matrem ejus, et vade in terram Israël: defuncti sunt enim qui quærebant animam pueri.",
    ),
    (2, 21, "Qui consurgens, accepit puerum, et matrem ejus, et venit in terram Israël."),
    (
        2,
        22,
    ...
    (3, 1, "In diebus autem illis venit Joannes Baptista prædicans in deserto Judææ,"),
    ...
    (3, 5, "Tunc exibat ad eum Jerosolyma, et omnis Judæa, et omnis regio circa Jordanem;"),
    (3, 6, "et baptizabantur ab eo in Jordane, confitentes peccata sua."),
    (
        3,
        7,
    ...
    (3, 13, "Tunc venit Jesus a Galilæa in Jordanem ad Joannem, ut baptizaretur ab eo."),
    (3, 14, "Joannes autem prohibebat eum, dicens: Ego a te debeo baptizari, et tu venis ad me?"),
    (
        3,
        15,
    ...
    (5, 4, "Beati qui lugent: quoniam ipsi consolabuntur."),
    ...
    (12, 24, "Pharisæi autem audientes, dixerunt: Hic non ejicit dæmones nisi in Beelzebub principe dæmoniorum."),
    (
        12,
        25,
    ...
    (12, 27, "Et si ego in Beelzebub ejicio dæmones, filii vestri in quo ejiciunt? ideo ipsi judices vestri erunt."),
    (12, 28, "Si autem ego in Spiritu Dei ejicio dæmones, igitur pervenit in vos regnum Dei."),
    (
        12,
        29,
    ...
    (12, 46, "Adhuc eo loquente ad turbas, ecce mater ejus et fratres stabant foris, quærentes loqui ei."),
    ...
    (13, 34, "Hæc omnia locutus est Jesus in parabolis ad turbas: et sine parabolis non loquebatur eis:"),
    (
        13,
        35,
    ...
    (13, 49, "Sic erit in consummatione sæculi: exibunt angeli, et separabunt malos de medio justorum,"),
    ...
    (16, 5, "Et cum venissent discipuli ejus trans fretum, obliti sunt panes accipere."),
    ...
    (16, 8, "Sciens autem Jesus, dixit: Quid cogitatis intra vos modicæ fidei, quia panes non habetis?"),
    (
        16,
        9,
        "Nondum intelligitis, neque recordamini quinque panum in quinque millia hominum, et quot cophinos sumpsistis?",
    ),
    (16, 10, "neque septem panum in quatuor millia hominum, et quot sportas sumpsistis?"),
    ...
    (16, 14, "At illi dixerunt: Alii Joannem Baptistam, alii autem Eliam, alii vero Jeremiam, aut unum ex prophetis."),
    (16, 15, "Dicit illis Jesus: Vos autem, quem me esse dicitis?"),
    ...
    (16, 20, "Tunc præcepit discipulis suis ut nemini dicerent quia ipse esset Jesus Christus."),
    (
        16,
        21,
    ...
    (17, 18, "Et increpavit illum Jesus, et exiit ab eo dæmonium, et curatus est puer ex illa hora."),
    (17, 19, "Tunc accesserunt discipuli ad Jesum secreto, et dixerunt: Quare nos non potuimus ejicere illum?"),
    (
        17,
        20,
    ...
    (17, 21, "Hoc autem genus non ejicitur nisi per orationem et jejunium."),
    (17, 22, "Conversantibus autem eis in Galilæa, dixit illis Jesus: Filius hominis tradendus est in manus hominum:"),
    (17, 23, "et occident eum, et tertia die resurget. Et contristati sunt vehementer."),
    (
        17,
        24,
    ...
    (17, 26, "Et ille dixit: Ab alienis. Dixit illi Jesus: Ergo liberi sunt filii."),
    (
        17,
        27,
    ...
    (18, 1, "In illa hora accesserunt discipuli ad Jesum, dicentes: Quis, putas, major est in regno cælorum?"),
    (18, 2, "Et advocans Jesus parvulum, statuit eum in medio eorum,"),
    (
        18,
        3,
        "et dixit: Amen dico vobis, nisi conversi fueritis, et efficiamini sicut parvuli, non intrabitis in regnum cælorum.",
    ),
    (18, 4, "Quicumque ergo humiliaverit se sicut parvulus iste, hic est major in regno cælorum."),
    ...
    (18, 29, "Et procidens conservus ejus, rogabat eum, dicens: Patientiam habe in me, et omnia reddam tibi."),
    ...
    (18, 34, "Et iratus dominus ejus tradidit eum tortoribus, quoadusque redderet universum debitum."),
    ...
    (19, 6, "Itaque jam non sunt duo, sed una caro. Quod ergo Deus conjunxit, homo non separet."),
    ...
    (19, 10, "Dicunt ei discipuli ejus: Si ita est causa hominis cum uxore, non expedit nubere."),
    ...
    (19, 20, "Dicit illi adolescens: Omnia hæc custodivi a juventute mea: quid adhuc mihi deest?"),
    (
        19,
        21,
    ...
    (19, 23, "Jesus autem dixit discipulis suis: Amen dico vobis, quia dives difficile intrabit in regnum cælorum."),
    (
        19,
        24,
    ...
    (21, 6, "Euntes autem discipuli fecerunt sicut præcepit illis Jesus."),
    (
        21,
        7,
    ...
    (21, 10, "Et cum intrasset Jerosolymam, commota est universa civitas, dicens: Quis est hic?"),
    (21, 11, "Populi autem dicebant: Hic est Jesus propheta a Nazareth Galilææ."),
    (
        21,
        12,
    ...
    (21, 25, "Baptismus Joannis unde erat? e cælo, an ex hominibus? At illi cogitabant inter se, dicentes:"),
    (
        21,
        26,
    ...
    (21, 34, "Cum autem tempus fructuum appropinquasset, misit servos suos ad agricolas, ut acciperent fructus ejus."),
    (21, 35, "Et agricolæ, apprehensis servis ejus, alium ceciderunt, alium occiderunt, alium vero lapidaverunt."),
    ...
    (21, 39, "Et apprehensum eum ejecerunt extra vineam, et occiderunt."),
    ...
    (21, 43, "Ideo dico vobis, quia auferetur a vobis regnum Dei, et dabitur genti facienti fructus ejus."),
    (21, 44, "Et qui ceciderit super lapidem istum, confringetur: super quem vero ceciderit, conteret eum."),
    (21, 45, "Et cum audissent principes sacerdotum et pharisæi parabolas ejus, cognoverunt quod de ipsis diceret."),
    ...
    (28, 10, "Tunc ait illis Jesus: Nolite timere: ite, nuntiare fratribus meis ut eant in Galilæam; ibi me videbunt."),
    (
        28,
        11,
