"""Translation: vulgate-clementine · Book: jud
...
VERSES = [
    ...
    (1, 17, "Vos autem carissimi, memores estote verborum, quæ prædicta sunt ab apostolis Domini nostri Jesu Christi,"),
    (
        1,
        18,
    ...
    (1, 20, "Vos autem carissimi superædificantes vosmetipsos sanctissimæ vestræ fidei, in Spiritu Sancto orantes,"),
    (
        1,
        21,
