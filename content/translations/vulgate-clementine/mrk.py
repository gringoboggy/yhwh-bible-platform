"""Translation: vulgate-clementine · Book: mrk
...
VERSES = [
    ...
    (7, 34, "et suscipiens in cælum, ingemuit, et ait illi: Ephphetha, quod est, Adaperire."),
    ...
    (9, 4, "Et apparuit illis Elias cum Moyse: et erant loquentes cum Jesu."),
    (
        9,
        5,
    ...
    (9, 8, "Et statim circumspicientes, neminem amplius viderunt, nisi Jesum tantum secum."),
    (
        9,
        9,
    ...
    (9, 11, "Et interrogabant eum, dicentes: Quid ergo dicunt pharisæi et scribæ, quia Eliam oportet venire primum?"),
    (
        9,
        12,
    ...
    (9, 13, "Sed dico vobis quia et Elias venit (et fecerunt illi quæcumque voluerunt) sicut scriptum est de eo."),
    (9, 14, "Et veniens ad discipulos suos, vidit turbam magnam circa eos, et scribas conquirentes cum illis."),
    (9, 15, "Et confestim omnis populus videns Jesum, stupefactus est, et expaverunt, et accurrentes salutabant eum."),
    (9, 16, "Et interrogavit eos: Quid inter vos conquiritis?"),
    (9, 17, "Et respondens unus de turba, dixit: Magister, attuli filium meum ad te habentem spiritum mutum:"),
    (
        9,
        18,
    ...
    (9, 21, "Et interrogavit patrem ejus: Quantum temporis est ex quo ei hoc accidit? At ille ait: Ab infantia:"),
    (
        9,
        22,
        "et frequenter eum in ignem, et in aquas misit ut eum perderet: sed si quid potes, adjuva nos, misertus nostri.",
    ),
    (9, 23, "Jesus autem ait illi: Si potes credere, omnia possibilia sunt credenti."),
    (9, 24, "Et continuo exclamans pater pueri, cum lacrimis aiebat: Credo, Domine; adjuva incredulitatem meam."),
    (
        9,
        25,
    ...
    (9, 27, "Jesus autem tenens manum ejus elevavit eum, et surrexit."),
    (
        9,
        28,
        "Et cum introisset in domum, discipuli ejus secreto interrogabant eum: Quare nos non potuimus ejicere eum?",
    ),
    (9, 29, "Et dixit illis: Hoc genus in nullo potest exire, nisi in oratione et jejunio."),
    (9, 30, "Et inde profecti prætergrediebantur Galilæam: nec volebat quemquam scire."),
    (
        9,
        31,
    ...
    (9, 32, "At illi ignorabant verbum: et timebant interrogare eum."),
    (9, 33, "Et venerunt Capharnaum. Qui cum domi essent, interrogabat eos: Quid in via tractabatis?"),
    (9, 34, "At illi tacebant: siquidem in via inter se disputaverunt: quis eorum major esset."),
    (
        9,
        35,
        "Et residens vocavit duodecim, et ait illis: Si quis vult primus esse, erit omnium novissimus, et omnium minister.",
    ),
    (9, 36, "Et accipiens puerum, statuit eum in medio eorum: quem cum complexus esset, ait illis:"),
    (
        9,
        37,
    ...
    (9, 49, "Omnis enim igne salietur, et omnis victima sale salietur."),
    (
        9,
        50,
    ...
    (11, 1, "Et cum appropinquarent Jerosolymæ et Bethaniæ ad montem Olivarum, mittit duos ex discipulis suis,"),
    (
        11,
        2,
    ...
    (11, 6, "Qui dixerunt eis sicut præceperat illis Jesus, et dimiserunt eis."),
    ...
    (11, 30, "Baptismus Joannis, de cælo erat, an ex hominibus? Respondete mihi."),
    ...
    (13, 5, "Et respondens Jesus cœpit dicere illis: Videte ne quid vos seducat:"),
