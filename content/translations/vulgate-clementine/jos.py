"""Translation: vulgate-clementine · Book: jos
...
VERSES = [
    ...
    (2, 15, "Demisit ergo eos per funem de fenestra: domus enim ejus hærebat muro."),
    (
        2,
        16,
    ...
    (2, 17, "Qui dixerunt ad eam: Innoxii erimus a juramento hoc, quo adjurasti nos:"),
    (
        2,
        18,
    ...
    (3, 9, "Dixitque Josue ad filios Israël: Accedite huc, et audite verbum Domini Dei vestri."),
    (
        3,
        10,
    ...
    (3, 11, "Ecce arca fœderis Domini omnis terræ antecedet vos per Jordanem."),
    (3, 12, "Parate duodecim viros de tribubus Israël, singulos per singulas tribus."),
    (
        3,
        13,
    ...
    (4, 4, "Vocavitque Josue duodecim viros, quos elegerat de filiis Israël, singulos de singulis tribubus,"),
    (
        4,
        5,
    ...
    (4, 16, "Præcipe sacerdotibus, qui portant arcam fœderis, ut ascendant de Jordane."),
    (4, 17, "Qui præcepit eis, dicens: Ascendite de Jordane."),
    (
        4,
        18,
    ...
    (4, 22, "docebitis eos, atque dicetis: Per arentem alveum transivit Israël Jordanem istum,"),
    (
        4,
        23,
    ...
    (5, 2, "Eo tempore ait Dominus ad Josue: Fac tibi cultros lapideos, et circumcide secundo filios Israël."),
    (5, 3, "Fecit quod jusserat Dominus, et circumcidit filios Israël in colle præputiorum."),
    (
        5,
        4,
    ...
    (5, 11, "et comederunt de frugibus terræ die altero, azymos panes, et polentam ejusdem anni."),
    (
        5,
        12,
    ...
    (
        5,
        14,
        "Qui respondit: Nequaquam: sed sum princeps exercitus Domini, et nunc venio. Cecidit Josue pronus in terram, et adorans ait: Quid dominus meus loquitur ad servum suum?",
    ),
    (
        5,
        15,
    ...
    (6, 1, "Jericho autem clausa erat atque munita, timore filiorum Israël, et nullus egredi audebat aut ingredi."),
    ...
    (6, 8, "Cumque Josue verba finisset, et septem sacerdotes septem buccinis clangerent ante arcam fœderis Domini,"),
    ...
    (7, 8, "Mi Domine Deus, quid dicam, videns Israëlem hostibus suis terga vertentem?"),
    (
        7,
        9,
    ...
    (7, 16, "Surgens itaque Josue mane, applicuit Israël per tribus suas, et inventa est tribus Juda."),
    (
        7,
        17,
    ...
    (7, 20, "Responditque Achan Josue, et dixit ei: Vere ego peccavi Domino Deo Israël, et sic et sic feci."),
    (
        7,
        21,
    ...
    (7, 23, "Auferentesque de tentorio, tulerunt ea ad Josue, et ad omnes filios Israël, projeceruntque ante Dominum."),
    (
        7,
        24,
    ...
    (8, 8, "Cumque ceperitis, succendite eam, et sic omnia facietis, ut jussi."),
    (
        8,
        9,
    ...
    (8, 15, "Josue vero et omnis Israël cesserunt loco, simulantes metum, et fugientes per solitudinis viam."),
    (
        8,
        16,
    ...
    (8, 18, "dixit Dominus ad Josue: Leva clypeum, qui in manu tua est, contra urbem Hai, quoniam tibi tradam eam."),
    (
        8,
        19,
    ...
    (8, 23, "regem quoque urbis Hai apprehenderunt viventem, et obtulerunt Josue."),
    (
        8,
        24,
    ...
    (8, 27, "Jumenta autem et prædam civitatis diviserunt sibi filii Israël, sicut præceperat Dominus Josue."),
    ...
    (8, 30, "Tunc ædificavit Josue altare Domino Deo Israël in monte Hebal,"),
    (
        8,
        31,
    ...
    (8, 32, "Et scripsit super lapides Deuteronomium legis Moysi, quod ille digesserat coram filiis Israël."),
    (
        8,
        33,
    ...
    (10, 14, "Non fuit antea nec postea tam longa dies, obediente Domino voci hominis, et pugnante pro Israël."),
    (10, 15, "Reversusque est Josue cum omni Israël in castra Galgalæ."),
    ...
    (10, 22, "Præcepitque Josue, dicens: Aperite os speluncæ, et producite ad me quinque reges, qui in ea latitant."),
    (
        10,
        23,
    ...
    (10, 29, "Transivit autem cum omni Israël de Maceda in Lebna, et pugnabat contra eam:"),
    (
        10,
        30,
    ...
    (10, 31, "De Lebna transivit in Lachis cum omni Israël: et exercitu per gyrum disposito, oppugnabat eam."),
    (
        10,
        32,
    ...
    (10, 36, "Ascendit quoque cum omni Israël de Eglon in Hebron, et pugnavit contra eam:"),
    (
        10,
        37,
    ...
    (10, 43, "Reversusque est cum omni Israël ad locum castrorum in Galgala."),
    (
        11,
        1,
    ...
    (11, 5, "Conveneruntque omnes reges isti in unum ad aquas Merom, ut pugnarent contra Israël."),
    (
        11,
        6,
    ...
    (11, 14, "Omnemque prædam istarum urbium ac jumenta diviserunt sibi filii Israël, cunctis hominibus interfectis."),
    (
        11,
        15,
    ...
    (12, 9, "Rex Jericho unus: rex Hai, quæ est ex latere Bethel, unus:"),
    ...
    (13, 22, "Et Balaam filium Beor ariolum occiderunt filii Israël gladio cum ceteris interfectis."),
    (
        13,
        23,
    ...
    (13, 24, "Deditque Moyses tribui Gad et filiis ejus per cognationes suas possessionem, cujus hæc divisio est."),
    (
        13,
        25,
    ...
    (13, 29, "Dedit et dimidiæ tribui Manasse, filiisque ejus juxta cognationes suas, possessionem,"),
    (
        13,
        30,
    ...
    (14, 5, "Sicut præceperat Dominus Moysi, ita fecerunt filii Israël, et diviserunt terram."),
    (
        14,
        6,
    ...
    (17, 8, "Etenim in sorte Manasse ceciderat terra Taphuæ, quæ est juxta terminos Manasse filiorum Ephraim."),
    (
        17,
        9,
    ...
    (18, 2, "Remanserant autem filiorum Israël septem tribus, quæ necdum acceperant possessiones suas."),
    (
        18,
        3,
    ...
    (18, 10, "Qui misit sortes coram Domino in Silo, divisitque terram filiis Israël in septem partes."),
    (
        18,
        11,
    ...
    (18, 21, "Fueruntque civitates ejus, Jericho et Beth Hagla et vallis Casis,"),
    ...
    (18, 27, "et Recem, Jarephel et Tharela,"),
    (
        18,
        28,
    ...
    (20, 1, "Et locutus est Dominus ad Josue, dicens: Loquere filiis Israël, et dic eis:"),
    ...
    (21, 41, "Itaque civitates universæ Levitarum in medio possessionis filiorum Israël fuerunt quadraginta octo"),
    (21, 42, "cum suburbanis suis, singulæ per familias distributæ."),
    (
        21,
        43,
    ...
    (22, 18, "Et vos hodie reliquistis Dominum, et cras in universum Israël ira ejus desæviet."),
    (
        22,
        19,
    ...
    (22, 21, "Responderuntque filii Ruben et Gad, et dimidia tribus Manasse, principibus legationis Israël:"),
    (
        22,
        22,
    ...
    (24, 10, "et ego nolui audire eum, sed e contrario per illum benedixi vobis, et liberavi vos de manu ejus."),
    (
        24,
        11,
    ...
    (24, 21, "Dixitque populus ad Josue: Nequaquam ita ut loqueris erit, sed Domino serviemus."),
    (
        24,
        22,
        "Et Josue ad populum: Testes, inquit, vos estis, quia ipsi elegeritis vobis Dominum ut serviatis ei. Responderuntque: Testes.",
    ),
    (24, 23, "Nunc ergo, ait, auferte deos alienos de medio vestri, et inclinate corda vestra ad Dominum Deum Israël."),
    (24, 24, "Dixitque populus ad Josue: Domino Deo nostro serviemus, et obedientes erimus præceptis ejus."),
    (24, 25, "Percussit ergo Josue in die illo fœdus, et proposuit populo præcepta atque judicia in Sichem."),
    (
        24,
        26,
    ...
    (24, 29, "Et post hæc mortuus est Josue filius Nun servus Domini, centum et decem annorum:"),
    (
        24,
        30,
