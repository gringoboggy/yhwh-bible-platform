"""Translation: vulgate-clementine · Book: exo
...
VERSES = [
    ...
    (2, 4, "stante procul sorore ejus, et considerante eventum rei."),
    (
        2,
        5,
    ...
    (2, 6, "aperiens, cernensque in ea parvulum vagientem, miserta ejus, ait: De infantibus Hebræorum est hic."),
    ...
    (2, 10, "Quem illa adoptavit in locum filii, vocavitque nomen ejus Moyses, dicens: Quia de aqua tuli eum."),
    (
        2,
        11,
    ...
    (2, 17, "Supervenere pastores, et ejecerunt eas: surrexitque Moyses, et defensis puellis, adaquavit oves earum."),
    ...
    (2, 21, "Juravit ergo Moyses quod habitaret cum eo. Accepitque Sephoram filiam ejus uxorem:"),
    (
        2,
        22,
    ...
    (2, 24, "Et audivit gemitum eorum, ac recordatus est fœderis quod pepigit cum Abraham, Isaac et Jacob."),
    (2, 25, "Et respexit Dominus filios Israël et cognovit eos."),
    (
        3,
        1,
    ...
    (3, 9, "Clamor ergo filiorum Israël venit ad me: vidique afflictionem eorum, qua ab Ægyptiis opprimuntur."),
    (3, 10, "Sed veni, et mittam te ad Pharaonem, ut educas populum meum, filios Israël, de Ægypto."),
    (3, 11, "Dixitque Moyses ad Deum: Quis sum ego ut vadam ad Pharaonem, et educam filios Israël de Ægypto?"),
    (
        3,
        12,
    ...
    (3, 14, "Dixit Deus ad Moysen: Ego sum qui sum. Ait: Sic dices filiis Israël: Qui est, misit me ad vos."),
    (
        3,
        15,
    ...
    (4, 22, "Dicesque ad eum: Hæc dicit Dominus: Filius meus primogenitus Israël."),
    (
        4,
        23,
    ...
    (4, 29, "Veneruntque simul, et congregaverunt cunctos seniores filiorum Israël."),
    ...
    (5, 4, "Ait ad eos rex Ægypti: Quare Moyses et Aaron sollicitatis populum ab operibus suis? ite ad onera vestra."),
    (
        5,
        5,
    ...
    (6, 5, "Ego audivi gemitum filiorum Israël, quo Ægyptii oppresserunt eos: et recordatus sum pacti mei."),
    (
        6,
        6,
    ...
    (6, 11, "Ingredere, et loquere ad Pharaonem regem Ægypti, ut dimittat filios Israël de terra sua."),
    (
        6,
        12,
    ...
    (6, 22, "Filii quoque Oziel: Misaël, et Elisaphan, et Sethri."),
    (
        6,
        23,
    ...
    (7, 3, "Sed ego indurabo cor ejus, et multiplicabo signa et ostenta mea in terra Ægypti,"),
    (
        7,
        4,
    ...
    (7, 12, "Projeceruntque singuli virgas suas, quæ versæ sunt in dracones: sed devoravit virga Aaron virgas eorum."),
    ...
    (8, 13, "Fecitque Dominus juxta verbum Moysi: et mortuæ sunt ranæ de domibus, et de villis, et de agris."),
    ...
    (9, 26, "Tantum in terra Gessen, ubi erant filii Israël, grando non cecidit."),
    (
        9,
        27,
    ...
    (9, 31, "Linum ergo et hordeum læsum est, eo quod hordeum esset virens, et linum jam folliculos germinaret:"),
    ...
    (10, 20, "Et induravit Dominus cor Pharaonis, nec dimisit filios Israël."),
    (
        10,
        21,
    ...
    (13, 6, "Septem diebus vesceris azymis: et in die septimo erit solemnitas Domini."),
    ...
    (13, 10, "Custodies hujuscemodi cultum statuto tempore a diebus in dies."),
    (
        13,
        11,
    ...
    (14, 3, "Dicturusque est Pharao super filiis Israël: Coarctati sunt in terra; conclusit eos desertum."),
    (
        14,
        4,
    ...
    (14, 15, "Dixitque Dominus ad Moysen: Quid clamas ad me? loquere filiis Israël ut proficiscantur."),
    (
        14,
        16,
    ...
    (14, 30, "liberavitque Dominus in die illa Israël de manu Ægyptiorum."),
    (
        14,
        31,
    ...
    (15, 4, "currus Pharaonis et exercitum ejus projecit in mare: electi principes ejus submersi sunt in mari Rubro."),
    ...
    (16, 2, "Et murmuravit omnis congregatio filiorum Israël contra Moysen et Aaron in solitudine."),
    (
        16,
        3,
    ...
    (16, 17, "Feceruntque ita filii Israël: et collegerunt, alius plus, alius minus."),
    (
        16,
        18,
    ...
    (17, 8, "Venit autem Amalec, et pugnabat contra Israël in Raphidim."),
    (
        17,
        9,
    ...
    (17, 11, "Cumque levaret Moyses manus, vincebat Israël: sin autem paululum remisisset, superabat Amalec."),
    (
        17,
        12,
    ...
    (17, 15, "Ædificavitque Moyses altare: et vocavit nomen ejus, Dominus exaltatio mea, dicens:"),
    ...
    (19, 1, "Mense tertio egressionis Israël de terra Ægypti, in die hac venerunt in solitudinem Sinai."),
    (
        19,
        2,
    ...
    (19, 6, "et vos eritis mihi in regnum sacerdotale, et gens sancta. Hæc sunt verba quæ loqueris ad filios Israël."),
    (19, 7, "Venit Moyses: et convocatis majoribus natu populi, exposuit omnes sermones quos mandaverat Dominus."),
    (
        19,
        8,
    ...
    (20, 22, "Dixit præterea Dominus ad Moysen: Hæc dices filiis Israël: Vos vidistis quod de cælo locutus sim vobis."),
    ...
    (24, 9, "Ascenderuntque Moyses et Aaron, Nadab et Abiu, et septuaginta de senioribus Israël:"),
    (
        24,
        10,
    ...
    (24, 17, "Erat autem species gloriæ Domini quasi ignis ardens super verticem montis in conspectu filiorum Israël."),
    (
        24,
        18,
    ...
    (26, 3, "Quinque cortinæ sibi jungentur mutuo, et aliæ quinque nexu simili cohærebunt."),
    ...
    (26, 8, "Longitudo sagi unius habebit triginta cubitos, et latitudo, quatuor: æqua erit mensura sagorum omnium."),
    (
        26,
        9,
    ...
    (26, 11, "Facies et quinquaginta fibulas æneas quibus jungantur ansæ, ut unum ex omnibus operimentum fiat."),
    (
        26,
        12,
    ...
    (28, 9, "Sumesque duos lapides onychinos, et sculpes in eis nomina filiorum Israël:"),
    ...
    (29, 35, "Omnia, quæ præcepi tibi, facies super Aaron et filiis ejus. Septem diebus consecrabis manus eorum:"),
    (
        29,
        36,
    ...
    (29, 43, "Ibique præcipiam filiis Israël, et sanctificabitur altare in gloria mea."),
    (
        29,
        44,
        "Sanctificabo et tabernaculum testimonii cum altari, et Aaron cum filiis suis, ut sacerdotio fungantur mihi.",
    ),
    (29, 45, "Et habitabo in medio filiorum Israël, eroque eis Deus,"),
    (
        29,
        46,
    ...
    (32, 3, "Fecitque populus quæ jusserat, deferens inaures ad Aaron."),
    (
        32,
        4,
    ...
    (32, 17, "Audiens autem Josue tumultum populi vociferantis, dixit ad Moysen: Ululatus pugnæ auditur in castris."),
    (
        32,
        18,
    ...
    (33, 6, "Deposuerunt ergo filii Israël ornatum suum a monte Horeb."),
    (
        33,
        7,
    ...
    (34, 12, "Cave ne umquam cum habitatoribus terræ illius jungas amicitias, quæ sint tibi in ruinam:"),
    (34, 13, "sed aras eorum destrue, confringe statuas, lucosque succide:"),
    (34, 14, "noli adorare deum alienum. Dominus zelotes nomen ejus; Deus est æmulator."),
    (
        34,
        15,
    ...
    (34, 23, "Tribus temporibus anni apparebit omne masculinum tuum in conspectu omnipotentis Domini Dei Israël."),
    (
        34,
        24,
    ...
    (34, 25, "Non immolabis super fermento sanguinem hostiæ meæ: neque residebit mane de victima solemnitatis Phase."),
    (34, 26, "Primitias frugum terræ tuæ offeres in domo Domini Dei tui. Non coques hædum in lacte matris suæ."),
    (34, 27, "Dixitque Dominus ad Moysen: Scribe tibi verba hæc, quibus et tecum et cum Israël pepigi fœdus."),
    (
        34,
        28,
    ...
    (34, 30, "Videntes autem Aaron et filii Israël cornutam Moysi faciem, timuerunt prope accedere."),
    (34, 31, "Vocatique ab eo, reversi sunt tam Aaron, quam principes synagogæ. Et postquam locutus est ad eos,"),
    (34, 32, "venerunt ad eum etiam omnes filii Israël: quibus præcepit cuncta quæ audierat a Domino in monte Sinai."),
    ...
    (35, 1, "Igitur congregata omni turba filiorum Israël, dixit ad eos: Hæc sunt quæ jussit Dominus fieri."),
    (
        35,
        2,
    ...
    (35, 4, "Et ait Moyses ad omnem catervam filiorum Israël: Iste est sermo quem præcepit Dominus, dicens:"),
    (
        35,
        5,
    ...
    (35, 16, "altare holocausti, et craticulam ejus æneam cum vectibus et vasis suis: labrum et basim ejus:"),
    ...
    (35, 20, "Egressaque omnis multitudo filiorum Israël de conspectu Moysi,"),
    (
        35,
        21,
    ...
    (38, 2, "cujus cornua de angulis procedebant, operuitque illum laminis æneis."),
    (
        38,
        3,
        "Et in usus ejus paravit ex ære vasa diversa, lebetes, forcipes, fuscinulas, uncinos, et ignium receptacula.",
    ),
    (38, 4, "Craticulamque ejus in modum retis fecit æneam, et subter eam in altaris medio arulam,"),
    ...
    (38, 19, "Columnæ autem in ingressu fuere quatuor cum basibus æneis, capitaque earum et cælaturæ argenteæ."),
    ...
    (38, 22, "quæ Beseleel filius Uri filii Hur de tribu Juda, Domino per Moysen jubente, compleverat,"),
    (
        38,
        23,
    ...
    (
        38,
        27,
        "Fuerunt præterea centum talenta argenti e quibus conflatæ sunt bases sanctuarii, et introitus, ubi velum pendet. Centum bases factæ sunt de talentis centum, singulis talentis per bases singulas supputatis.",
    ),
    (
        38,
        28,
    ...
    (39, 7, "posuitque eos in lateribus superhumeralis in monimentum filiorum Israël, sicut præceperat Dominus Moysi."),
    (
        39,
        8,
    ...
    (39, 10, "Et posuit in eo gemmarum ordines quatuor. In primo versu erat sardius, topazius, smaragdus."),
    (39, 11, "In secundo, carbunculus, sapphirus, et jaspis."),
    ...
    (39, 22, "Feceruntque quoque tunicam superhumeralis totam hyacinthinam,"),
    (39, 23, "et capitium in superiori parte contra medium, oramque per gyrum capitii textilem:"),
    (39, 24, "deorsum autem ad pedes mala punica ex hyacintho, purpura, vermiculo, ac bysso retorta:"),
    (39, 25, "et tintinnabula de auro purissimo, quæ posuerunt inter malogranata, in extrema parte tunicæ per gyrum:"),
    (
        39,
        26,
    ...
    (39, 27, "Fecerunt et tunicas byssinas opere textili Aaron et filiis ejus:"),
    (39, 28, "et mitras cum coronulis suis ex bysso: feminalia quoque linea, byssina:"),
    (
        39,
        29,
    ...
    (39, 31, "et strinxerunt eam cum mitra vitta hyacinthina, sicut præceperat Dominus Moysi."),
    (
        39,
        32,
    ...
    (39, 34, "opertorium de pellibus arietum rubricatis, et aliud operimentum de janthinis pellibus,"),
    (39, 35, "velum; arcam, vectes, propitiatorium,"),
    (39, 36, "mensam cum vasis suis et propositionis panibus;"),
    (39, 37, "candelabrum, lucernas, et utensilia earum cum oleo;"),
    (39, 38, "altare aureum, et unguentum, et thymiama ex aromatibus, et tentorium in introitu tabernaculi;"),
    (
        39,
        39,
    ...
    (39, 41, "Vestes quoque, quibus sacerdotes utuntur in sanctuario, Aaron scilicet et filii ejus,"),
    (39, 42, "obtulerunt filii Israël, sicut præceperat Dominus."),
    ...
    (40, 15, "indues sanctis vestibus, ut ministrent mihi, et unctio eorum in sacerdotium sempiternum proficiat."),
    (40, 16, "Fecitque Moyses omnia quæ præceperat Dominus."),
    (40, 17, "Igitur mense primo anni secundi, prima die mensis, collocatum est tabernaculum."),
    (40, 18, "Erexitque Moyses illud, et posuit tabulas ac bases et vectes, statuitque columnas,"),
    (40, 19, "et expandit tectum super tabernaculum, imposito desuper operimento, sicut Dominus imperaverat."),
    (40, 20, "Posuit et testimonium in arca, subditis infra vectibus, et oraculum desuper."),
    (40, 21, "Cumque intulisset arcam in tabernaculum, appendit ante eam velum ut expleret Domini jussionem."),
    (40, 22, "Posuit et mensam in tabernaculo testimonii ad plagam septentrionalem extra velum,"),
    (40, 23, "ordinatis coram propositionis panibus, sicut præceperat Dominus Moysi."),
    (40, 24, "Posuit et candelabrum in tabernaculo testimonii e regione mensæ in parte australi,"),
    (40, 25, "locatis per ordinem lucernis, juxta præceptum Domini."),
    (40, 26, "Posuit et altare aureum sub tecto testimonii contra velum,"),
    (40, 27, "et adolevit super eo incensum aromatum, sicut jusserat Dominus Moysi."),
    (40, 28, "Posuit et tentorium in introitu tabernaculi testimonii,"),
    (
        40,
        29,
    ...
    (40, 31, "Laveruntque Moyses et Aaron ac filii ejus manus suas et pedes,"),
    (40, 32, "cum ingrederentur tectum fœderis, et accederent ad altare, sicut præceperat Dominus Moysi."),
    (
        40,
        33,
    ...
    (40, 36, "Siquando nubes tabernaculum deserebat, proficiscebantur filii Israël per turmas suas:"),
