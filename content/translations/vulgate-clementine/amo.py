"""Translation: vulgate-clementine · Book: amo
...
VERSES = [
    ...
    (1, 4, "Et mittam ignem in domum Azaël, et devorabit domos Benadad."),
    (
        1,
        5,
    ...
    (1, 7, "Et mittam ignem in murum Gazæ, et devorabit ædes ejus."),
    (
        1,
        8,
    ...
    (2, 5, "Et mittam ignem in Juda, et devorabit ædes Jerusalem."),
    (
        2,
        6,
    ...
    (4, 3, "Et per aperturas exibitis altera contra alteram, et projiciemini in Armon, dicit Dominus.]"),
    (
        4,
        4,
    ...
    (6, 11, "Quia ecce Dominus mandabit, et percutiet domum majorem ruinis, et domum minorem scissionibus."),
    (
        6,
        12,
    ...
    (6, 13, "Qui lætamini in nihilo; qui dicitis: Numquid non in fortitudine nostra assumpsimus nobis cornua?"),
    (
        6,
        14,
    ...
    (7, 7, "Hæc ostendit mihi Dominus: et ecce Dominus stans super murum litum, et in manu ejus trulla cæmentarii."),
    (
        7,
        8,
    ...
    (7, 11, "Hæc enim dicit Amos: In gladio morietur Jeroboam, et Israël captivus migrabit de terra sua."),
    (
        7,
        12,
    ...
    (7, 15, "Et tulit me Dominus cum sequerer gregem, et dixit Dominus ad me: Vade, propheta ad populum meum Israël."),
    (7, 16, "Et nunc audi verbum Domini: [Tu dicis: Non prophetabis super Israël, et non stillabis super domum idoli."),
    (
        7,
        17,
