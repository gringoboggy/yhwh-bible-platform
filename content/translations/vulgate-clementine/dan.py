"""Translation: vulgate-clementine · Book: dan
...
BOOK = "dan"
VERSES = [
    (1, 1, "Anno tertio regni Joakim regis Juda, venit Nabuchodonosor, rex Babylonis, in Jerusalem, et obsedit eam:"),
    (
        1,
        2,
    ...
    (1, 6, "Fuerunt ergo inter eos de filiis Juda, Daniel, Ananias, Misaël, et Azarias."),
    (
        1,
        7,
    ...
    (1, 14, "Qui, audito sermone hujuscemodi, tentavit eos diebus decem."),
    (
        1,
        15,
    ...
    (2, 13, "Et egressa sententia, sapientes interficiebantur: quærebanturque Daniel et socii ejus, ut perirent."),
    (
        2,
        14,
    ...
    (2, 17, "Et ingressus est domum suam, Ananiæque et Misaëli et Azariæ, sociis suis, indicavit negotium,"),
    (
        2,
        18,
    ...
    (3, 8, "Statimque in ipso tempore accedentes viri Chaldæi accusaverunt Judæos:"),
    ...
    (3, 30, "Tunc rex promovit Sidrach, Misach, et Abdenago in provincia Babylonis."),
    (
        4,
        1,
        "Nabuchodonosor rex, omnibus populis, gentibus, et linguis, qui habitant in universa terra, pax vobis multiplicetur.",
    ),
    (4, 2, "Signa, et mirabilia fecit apud me Deus excelsus. Placuit ergo mihi prædicare"),
    (
        4,
        3,
    ...
    (4, 10, "Visio capitis mei in cubili meo: videbam, et ecce arbor in medio terræ, et altitudo ejus nimia."),
    (
        4,
        11,
    ...
    (4, 13, "Videbam in visione capitis mei super stratum meum, et ecce vigil, et sanctus, de cælo descendit."),
    (
        4,
        14,
    ...
    (4, 16, "Cor ejus ab humano commutetur, et cor feræ detur ei: et septem tempora mutentur super eum."),
    (
        4,
        17,
    ...
    (4, 24, "hæc est interpretatio sententiæ Altissimi, quæ pervenit super dominum meum regem,"),
    (
        4,
        25,
    ...
    (4, 28, "Omnia hæc venerunt super Nabuchodonosor regem."),
    (4, 29, "Post finem mensium duodecim, in aula Babylonis deambulabat."),
    (
        4,
        30,
    ...
    (5, 22, "Tu quoque, filius ejus Baltassar, non humiliasti cor tuum, cum scires hæc omnia:"),
    (
        5,
        23,
    ...
    (5, 31, "Et Darius Medus successit in regnum, annos natus sexaginta duos."),
    ...
    (7, 2, "Videbam in visione mea nocte: et ecce quatuor venti cæli pugnabant in mari magno."),
    ...
    (7, 17, "Hæ quatuor bestiæ magnæ, quatuor sunt regna, quæ consurgent de terra."),
    (
        7,
        18,
    ...
    (8, 14, "Et dixit ei: Usque ad vesperam et mane, dies duo millia trecenti: et mundabitur sanctuarium."),
    (
        8,
        15,
    ...
    (8, 16, "Et audivi vocem viri inter Ulai: et clamavit, et ait: Gabriel, fac intelligere istam visionem."),
    (
        8,
        17,
    ...
    (9, 3, "Et posui faciem meam ad Dominum Deum meum rogare et deprecari in jejuniis, sacco, et cinere."),
    (
        9,
        4,
    ...
    (10, 4, "Die autem vigesima et quarta mensis primi, eram juxta fluvium magnum, qui est Tigris."),
    (10, 5, "Et levavi oculos meos, et vidi: et ecce vir unus vestitus lineis, et renes ejus accincti auro obrizo:"),
    (
        10,
        6,
    ...
    (11, 12, "Et capiet multitudinem, et exaltabitur cor ejus, et dejiciet multa millia, sed non prævalebit."),
    (
        11,
        13,
    ...
    (11, 22, "Et brachia pugnantis expugnabuntur a facie ejus, et conterentur: insuper et dux fœderis."),
