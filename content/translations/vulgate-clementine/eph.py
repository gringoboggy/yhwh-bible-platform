"""Translation: vulgate-clementine · Book: eph
...
VERSES = [
    ...
    (1, 20, "quam operatus est in Christo, suscitans illum a mortuis, et constituens ad dexteram suam in cælestibus:"),
    (
        1,
        21,
    ...
    (2, 6, "et conresuscitavit, et consedere fecit in cælestibus in Christo Jesu:"),
    (
        2,
        7,
    ...
    (2, 19, "Ergo jam non estis hospites, et advenæ: sed estis cives sanctorum, et domestici Dei,"),
    (2, 20, "superædificati super fundamentum apostolorum, et prophetarum, ipso summo angulari lapide Christo Jesu:"),
    ...
    (3, 1, "Hujus rei gratia, ego Paulus vinctus Christi Jesu, pro vobis gentibus,"),
    (3, 2, "si tamen audistis dispensationem gratiæ Dei, quæ data est mihi in vobis:"),
    ...
    (3, 9, "et illuminare omnes, quæ sit dispensatio sacramenti absconditi a sæculis in Deo, qui omnia creavit:"),
    (3, 10, "ut innotescat principatibus et potestatibus in cælestibus per Ecclesiam, multiformis sapientia Dei,"),
    (3, 11, "secundum præfinitionem sæculorum, quam fecit in Christo Jesu Domino nostro:"),
    (3, 12, "in quo habemus fiduciam, et accessum in confidentia per fidem ejus."),
    (3, 13, "Propter quod peto ne deficiatis in tribulationibus meis pro vobis: quæ est gloria vestra."),
    (3, 14, "Hujus rei gratia flecto genua mea ad Patrem Domini nostri Jesu Christi,"),
    (3, 15, "ex quo omnis paternitas in cælis et in terra nominatur,"),
    (3, 16, "ut det vobis secundum divitias gloriæ suæ, virtute corroborari per Spiritum ejus in interiorem hominem,"),
    (3, 17, "Christum habitare per fidem in cordibus vestris: in caritate radicati, et fundati,"),
    (
        3,
        18,
        "ut possitis comprehendere cum omnibus sanctis, quæ sit latitudo, et longitudo, et sublimitas, et profundum:",
    ),
    (3, 19, "scire etiam supereminentem scientiæ caritatem Christi, ut impleamini in omnem plenitudinem Dei."),
    (
        3,
        20,
    ...
    (3, 21, "ipsi gloria in Ecclesia, et in Christo Jesu, in omnes generationes sæculi sæculorum. Amen."),
    (4, 1, "Obsecro itaque vos ego vinctus in Domino, ut digne ambuletis vocatione, qua vocati estis,"),
    (4, 2, "cum omni humilitate, et mansuetudine, cum patientia, supportantes invicem in caritate,"),
    (4, 3, "solliciti servare unitatem Spiritus in vinculo pacis."),
    (4, 4, "Unum corpus, et unus Spiritus, sicut vocati estis in una spe vocationis vestræ."),
    ...
    (4, 9, "Quod autem ascendit, quid est, nisi quia et descendit primum in inferiores partes terræ?"),
    (4, 10, "Qui descendit, ipse est et qui ascendit super omnes cælos, ut impleret omnia."),
    (
        4,
        11,
        "Et ipse dedit quosdam quidem apostolos, quosdam autem prophetas, alios vero evangelistas, alios autem pastores et doctores,",
    ),
    (4, 12, "ad consummationem sanctorum in opus ministerii, in ædificationem corporis Christi:"),
    (
        4,
        13,
    ...
    (4, 21, "si tamen illum audistis, et in ipso edocti estis, sicut est veritas in Jesu,"),
    (
        4,
        22,
        "deponere vos secundum pristinam conversationem veterem hominem, qui corrumpitur secundum desideria erroris.",
    ),
    (4, 23, "Renovamini autem spiritu mentis vestræ,"),
    (4, 24, "et induite novum hominem, qui secundum Deum creatus est in justitia, et sanctitate veritatis."),
    (
        4,
        25,
    ...
    (5, 4, "aut turpitudo, aut stultiloquium, aut scurrilitas, quæ ad rem non pertinet: sed magis gratiarum actio."),
    (
        5,
        5,
    ...
    (5, 6, "Nemo vos seducat inanibus verbis: propter hæc enim venit ira Dei in filios diffidentiæ."),
    (5, 7, "Nolite ergo effici participes eorum."),
    (5, 8, "Eratis enim aliquando tenebræ: nunc autem lux in Domino. Ut filii lucis ambulate:"),
    ...
    (5, 12, "Quæ enim in occulto fiunt ab ipsis, turpe est et dicere."),
    (5, 13, "Omnia autem, quæ arguuntur, a lumine manifestantur: omne enim, quod manifestatur, lumen est."),
    ...
    (5, 17, "Propterea nolite fieri imprudentes, sed intelligentes quæ sit voluntas Dei."),
    ...
    (5, 23, "quoniam vir caput est mulieris, sicut Christus caput est Ecclesiæ: ipse, salvator corporis ejus."),
    ...
    (5, 31, "Propter hoc relinquet homo patrem et matrem suam, et adhærebit uxori suæ, et erunt duo in carne una."),
    ...
    (6, 3, "ut bene sit tibi, et sis longævus super terram."),
    (
        6,
        4,
    ...
    (6, 14, "State ergo succincti lumbos vestros in veritate, et induti loricam justitiæ,"),
    (6, 15, "et calceati pedes in præparatione Evangelii pacis,"),
    ...
    (6, 22, "quem misi ad vos in hoc ipsum, ut cognoscatis quæ circa nos sunt, et consoletur corda vestra."),
