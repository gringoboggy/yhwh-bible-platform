"""Translation: vulgate-clementine · Book: jam
...
VERSES = [
    ...
    (2, 1, "Fratres mei, nolite in personarum acceptione habere fidem Domini nostri Jesu Christi gloriæ."),
    (
        2,
        2,
    ...
    (2, 4, "nonne judicatis apud vosmetipsos, et facti estis judices cogitationum iniquarum?"),
    (
        2,
        5,
    ...
    (2, 12, "Sic loquimini, et sic facite sicut per legem libertatis incipientes judicari."),
    (
        2,
        13,
    ...
    (2, 21, "Abraham pater noster nonne ex operibus justificatus est, offerens Isaac filium suum super altare?"),
    ...
    (2, 24, "Videtis quoniam ex operibus justificatur homo, et non ex fide tantum?"),
    (
        2,
        25,
    ...
    (3, 1, "Nolite plures magistri fieri fratres mei, scientes quoniam majus judicium sumitis."),
    (
        3,
        2,
    ...
    (3, 18, "Fructus autem justitiæ, in pace seminatur, facientibus pacem."),
    ...
    (4, 6, "majorem autem dat gratiam. Propter quod dicit: Deus superbis resistit, humilibus autem dat gratiam."),
    ...
    (4, 12, "Unus est legislator et judex, qui potest perdere et liberare."),
    (
        4,
        13,
    ...
    (4, 16, "Nunc autem exsultatis in superbiis vestris. Omnis exsultatio talis, maligna est."),
    ...
    (5, 6, "Addixistis, et occidistis justum, et non resistit vobis."),
    (
        5,
        7,
    ...
    (5, 9, "Nolite ingemiscere, fratres, in alterutrum, ut non judicemini. Ecce judex ante januam assistit."),
    (
        5,
        10,
