"""Translation: vulgate-clementine · Book: bel
...
BOOK = "bel"
VERSES = [
    (1, 1, "Et rex Astyages appositus est ad patres suos, et suscepit Cyrus Perses regnum ejus."),
    (1, 2, "Erat autem Daniel conviva regis, et honoratus super omnes amicos ejus."),
    (
        1,
        3,
    ...
    (1, 16, "Surrexit autem rex primo diluculo, et Daniel cum eo."),
    (1, 17, "Et ait rex: Salvane sunt signacula, Daniel? Qui respondit: Salva, rex."),
    (
        1,
        18,
    ...
    (1, 20, "Et dixit rex: Video vestigia virorum, et mulierum, et infantium. Et iratus est rex."),
    (
        1,
        21,
    ...
    (1, 22, "Occidit ergo illos rex, et tradidit Bel in potestatem Danielis: qui subvertit eum, et templum ejus."),
    (1, 23, "Et erat draco magnus in loco illo, et colebant eum Babylonii."),
    (1, 24, "Et dixit rex Danieli: Ecce nunc non potes dicere quia iste non sit deus vivens: adora ergo eum."),
    (1, 25, "Dixitque Daniel: Dominum Deum meum adoro, quia ipse est Deus vivens: iste autem non est deus vivens."),
    (1, 26, "Tu autem, rex, da mihi potestatem, et interficiam draconem absque gladio et fuste. Et ait rex: Do tibi."),
    (
        1,
        27,
    ...
    (1, 29, "Et dixerunt cum venissent ad regem: Trade nobis Danielem, alioquin interficiemus te, et domum tuam."),
    (1, 30, "Vidit ergo rex quod irruerent in eum vehementer: et necessitate compulsus, tradidit eis Danielem."),
    (1, 31, "Qui miserunt eum in lacum leonum, et erat ibi diebus sex."),
    (
        1,
        32,
    ...
    (1, 35, "Et dixit Habacuc: Domine, Babylonem non vidi, et lacum nescio."),
    (
        1,
        36,
    ...
    (1, 37, "Et clamavit Habacuc, dicens: Daniel serve Dei, tolle prandium quod misit tibi Deus."),
    (1, 38, "Et ait Daniel: Recordatus es mei, Deus, et non dereliquisti diligentes te."),
    (1, 39, "Surgensque Daniel comedit. Porro angelus Domini restituit Habacuc confestim in loco suo."),
    (
        1,
        40,
        "Venit ergo rex die septimo ut lugeret Danielem: et venit ad lacum, et introspexit, et ecce Daniel sedens in medio leonum.",
    ),
    (1, 41, "Et exclamavit voce magna rex, dicens: Magnus es, Domine Deus Danielis. Et extraxit eum de lacu leonum."),
    (
        1,
        42,
