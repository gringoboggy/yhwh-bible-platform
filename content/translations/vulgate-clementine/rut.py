"""Translation: vulgate-clementine · Book: rut
...
VERSES = [
    ...
    (1, 3, "Et mortuus est Elimelech maritus Noëmi: remansitque ipsa cum filiis."),
    (
        1,
        4,
    ...
    (1, 15, "cui dixit Noëmi: En reversa est cognata tua ad populum suum, et ad deos suos, vade cum ea."),
    (
        1,
        16,
    ...
    (2, 5, "Dixitque Booz juveni, qui messoribus præerat: Cujus est hæc puella?"),
    (2, 6, "Cui respondit: Hæc est Moabitis, quæ venit cum Noëmi, de regione Moabitide,"),
    (
        2,
        7,
    ...
    (3, 5, "Quæ respondit: Quidquid præceperis, faciam."),
    (3, 6, "Descenditque in aream, et fecit omnia quæ sibi imperaverat socrus."),
    (
        3,
        7,
    ...
    (3, 16, "et venit ad socrum suam. Quæ dixit ei: Quid egisti, filia? Narravitque ei omnia, quæ sibi fecisset homo."),
    ...
    (4, 16, "Susceptumque Noëmi puerum posuit in sinu suo, et nutricis ac gerulæ fungebatur officio."),
    (
        4,
        17,
    ...
    (4, 18, "Hæ sunt generationes Phares: Phares genuit Esron,"),
