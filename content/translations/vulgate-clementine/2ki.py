"""Translation: vulgate-clementine · Book: 2ki
...
BOOK = "2ki"
VERSES = [
    (1, 1, "Prævaricatus est autem Moab in Israël, postquam mortuus est Achab."),
    (
        1,
        2,
    ...
    (1, 7, "Qui dixit eis: Cujus figuræ et habitus est vir ille, qui occurrit vobis, et locutus est verba hæc?"),
    ...
    (2, 13, "Et levavit pallium Eliæ, quod ceciderat ei: reversusque stetit super ripam Jordanis,"),
    (
        2,
        14,
    ...
    (2, 22, "Sanatæ sunt ergo aquæ usque in diem hanc, juxta verbum Elisei quod locutus est."),
    (
        2,
        23,
    ...
    (3, 3, "Verumtamen in peccatis Jeroboam filii Nabat, qui peccare fecit Israël, adhæsit, nec recessit ab eis."),
    (
        3,
        4,
    ...
    (3, 5, "Cumque mortuus fuisset Achab, prævaricatus est fœdus quod habebat cum rege Israël."),
    (3, 6, "Egressus est igitur rex Joram in die illa de Samaria, et recensuit universum Israël."),
    (
        3,
        7,
    ...
    (3, 10, "Dixitque rex Israël: Heu ! heu ! heu ! congregavit nos Dominus tres reges ut traderet in manus Moab."),
    (
        3,
        11,
    ...
    (3, 16, "Hæc dicit Dominus: Facite alveum torrentis hujus fossas et fossas."),
    (
        3,
        17,
    ...
    (5, 24, "Cumque venisset jam vesperi, tulit de manu eorum, et reposuit in domo, dimisitque viros, et abierunt."),
    (
        5,
        25,
    ...
    (8, 17, "Triginta duorum annorum erat cum regnare cœpisset, et octo annis regnavit in Jerusalem."),
    (
        8,
        18,
    ...
    (8, 25, "Anno duodecimo Joram filii Achab regis Israël regnavit Ochozias filius Joram regis Judæ."),
    (
        8,
        26,
    ...
    (9, 23, "Convertit autem Joram manum suam, et fugiens ait ad Ochoziam: Insidiæ, Ochozia."),
    (
        9,
        24,
    ...
    (10, 28, "Delevit itaque Jehu Baal de Israël:"),
    (
        10,
        29,
    ...
    (10, 32, "In diebus illis cœpit Dominus tædere super Israël: percussitque eos Hazaël in universis finibus Israël,"),
    (
        10,
        33,
    ...
    (10, 36, "Dies autem quos regnavit Jehu super Israël, viginti et octo anni sunt in Samaria."),
    ...
    (11, 21, "Septemque annorum erat Joas, cum regnare cœpisset."),
    (
        12,
        1,
    ...
    (13, 22, "Igitur Hazaël rex Syriæ afflixit Israël cunctis diebus Joachaz:"),
    (
        13,
        23,
    ...
    (13, 24, "Mortuus est autem Hazaël rex Syriæ, et regnavit Benadad filius ejus pro eo."),
    (
        13,
        25,
    ...
    (14, 1, "In anno secundo Joas filii Joachaz regis Israël, regnavit Amasias filius Joas regis Juda."),
    (
        14,
        2,
    ...
    (14, 12, "Percussusque est Juda coram Israël, et fugerunt unusquisque in tabernacula sua."),
    (
        14,
        13,
    ...
    (14, 18, "Reliqua autem sermonum Amasiæ, nonne hæc scripta sunt in libro sermonum dierum regum Juda?"),
    (
        14,
        19,
    ...
    (14, 22, "Ipse ædificavit Ælath, et restituit eam Judæ, postquam dormivit rex cum patribus suis."),
    (
        14,
        23,
    ...
    (14, 29, "Dormivitque Jeroboam cum patribus suis regibus Israël, et regnavit Zacharias filius ejus pro eo."),
    (15, 1, "Anno vigesimo septimo Jeroboam regis Israël, regnavit Azarias filius Amasiæ regis Juda."),
    (
        15,
        2,
    ...
    (15, 3, "Fecitque quod erat placitum coram Domino, juxta omnia quæ fecit Amasias pater ejus."),
    ...
    (15, 11, "Reliqua autem verborum Zachariæ, nonne hæc scripta sunt in libro sermonum dierum regum Israël?"),
    (
        15,
        12,
    ...
    (15, 22, "Et dormivit Manahem cum patribus suis: regnavitque Phaceia filius ejus pro eo."),
    (15, 23, "Anno quinquagesimo Azariæ regis Juda, regnavit Phaceia filius Manahem super Israël in Samaria biennio."),
    (
        15,
        24,
    ...
    (15, 32, "Anno secundo Phacee filii Romeliæ regis Israël, regnavit Joatham filius Oziæ regis Juda."),
    (
        15,
        33,
    ...
    (15, 34, "Fecitque quod erat placitum coram Domino: juxta omnia quæ fecerat Ozias pater suus, operatus est."),
    (
        15,
        35,
    ...
    (15, 37, "In diebus illis cœpit Dominus mittere in Judam Rasin regem Syriæ, et Phacee filium Romeliæ."),
    (
        15,
        38,
    ...
    (16, 1, "Anno decimoseptimo Phacee filii Romeliæ, regnavit Achaz filius Joatham regis Juda."),
    (
        16,
        2,
    ...
    (16, 16, "Fecit igitur Urias sacerdos juxta omnia quæ præceperat rex Achaz."),
    (
        16,
        17,
    ...
    (16, 19, "Reliqua autem verborum Achaz quæ fecit, nonne hæc scripta sunt in libro sermonum dierum regum Juda?"),
    (
        16,
        20,
        "Dormivitque Achaz cum patribus suis, et sepultus est cum eis in civitate David: et regnavit Ezechias filius ejus pro eo.",
    ),
    (17, 1, "Anno duodecimo Achaz regis Juda, regnavit Osee filius Ela in Samaria super Israël novem annis."),
    (17, 2, "Fecitque malum coram Domino, sed non sicut reges Israël qui ante eum fuerant."),
    ...
    (17, 22, "Et ambulaverunt filii Israël in universis peccatis Jeroboam quæ fecerat: et non recesserunt ab eis,"),
    (
        17,
        23,
    ...
    (17, 40, "Illi vero non audierunt, sed juxta consuetudinem suam pristinam perpetrabant."),
    (
        17,
        41,
    ...
    (18, 1, "Anno tertio Osee filii Ela regis Israël, regnavit Ezechias filius Achaz regis Juda."),
    (
        18,
        2,
    ...
    (18, 3, "Fecitque quod erat bonum coram Domino, juxta omnia quæ fecerat David pater ejus."),
    (
        18,
        4,
    ...
    (20, 21, "Dormivitque Ezechias cum patribus suis, et regnavit Manasses filius ejus pro eo."),
    (
        21,
        1,
    ...
    (21, 2, "Fecitque malum in conspectu Domini, juxta idola gentium quas delevit Dominus a facie filiorum Israël."),
    (
        21,
        3,
    ...
    (21, 5, "Et exstruxit altaria universæ militiæ cæli in duobus atriis templi Domini."),
    (
        21,
        6,
    ...
    (21, 25, "Reliqua autem sermonum Amon quæ fecit, nonne hæc scripta sunt in libro sermonum dierum regum Juda?"),
    ...
    (22, 15, "Et illa respondit eis: Hæc dicit Dominus Deus Israël: Dicite viro qui misit vos ad me:"),
    (
        22,
        16,
    ...
    (23, 23, "sicut in octavodecimo anno regis Josiæ factum est Phase istud Domino in Jerusalem."),
    (
        23,
        24,
    ...
    (23, 32, "Et fecit malum coram Domino, juxta omnia quæ fecerant patres ejus."),
    (
        23,
        33,
    ...
    (23, 37, "Et fecit malum coram Domino juxta omnia quæ fecerant patres ejus."),
    (
        24,
        1,
    ...
    (24, 9, "Et fecit malum coram Domino, juxta omnia quæ fecerat pater ejus."),
    (
        24,
        10,
    ...
    (24, 19, "Et fecit malum coram Domino, juxta omnia quæ fecerat Joakim."),
    (
        24,
        20,
    ...
    (25, 10, "Et muros Jerusalem in circuitu destruxit omnis exercitus Chaldæorum, qui erat cum principe militum."),
    (
        25,
        11,
