"""Translation: vulgate-clementine · Book: mal
...
BOOK = "mal"
VERSES = [
    (1, 1, "Onus verbi Domini ad Israël in manu Malachiæ."),
    (
        1,
        2,
        "Dilexi vos, dicit Dominus, et dixistis: In quo dilexisti nos? Nonne frater erat Esau Jacob? dicit Dominus: et dilexi Jacob,",
    ),
    (1, 3, "Esau autem odio habui, et posui montes ejus in solitudinem, et hæreditatem ejus in dracones deserti."),
    (
        1,
        4,
    ...
    (1, 5, "Et oculi vestri videbunt, et vos dicetis: Magnificetur Dominus super terminum Israël."),
    (
        1,
        6,
    ...
    (3, 4, "Et placebit Domino sacrificium Juda et Jerusalem, sicut dies sæculi, et sicut anni antiqui."),
    (
        3,
        5,
