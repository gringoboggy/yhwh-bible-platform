"""Translation: vulgate-clementine · Book: isa
...
VERSES = [
    ...
    (1, 17, "discite benefacere; quærite judicium, subvenite oppresso, judicate pupillo, defendite viduam.]"),
    (
        1,
        18,
    ...
    (2, 1, "Verbum quod vidit Isaias, filius Amos, super Juda et Jerusalem."),
    (
        2,
        2,
    ...
    (8, 11, "Hæc enim ait Dominus ad me: Sicut in manu forti erudivit me, ne irem in via populi hujus, dicens:"),
    (
        8,
        12,
    ...
    (
        9,
        1,
        "et ad terram intuebitur; et ecce tribulatio et tenebræ, dissolutio et angustia, et caligo persequens, et non poterit avolare de angustia sua.] [Primo tempore alleviata est terra Zabulon et terra Nephthali: et novissimo aggravata est via maris trans Jordanem Galilææ gentium.",
    ),
    (
        9,
        2,
    ...
    (9, 8, "[Verbum misit Dominus in Jacob, et cecidit in Israël."),
    ...
    (9, 14, "Et disperdet Dominus ab Israël caput et caudam, incurvantem et refrenantem, die una."),
    ...
    (
        9,
        21,
        "Et declinabit ad dexteram, et esuriet; et comedet ad sinistram, et non saturabitur; unusquisque carnem brachii sui vorabit: Manasses Ephraim, et Ephraim Manassen; simul ipsi contra Judam. In omnibus his non est aversus furor ejus, sed adhuc manus ejus extenta.]",
    ),
    ...
    (10, 28, "[Veniet in Ajath, transibit in Magron, apud Machmas commendabit vasa sua."),
    ...
    (12, 6, "Exsulta et lauda, habitatio Sion, quia magnus in medio tui Sanctus Israël.]"),
    ...
    (13, 22, "et respondebunt ibi ululæ in ædibus ejus, et sirenes in delubris voluptatis.]"),
    (
        14,
        1,
    ...
    (17, 2, "Derelictæ civitates Aroër gregibus erunt, et requiescent ibi, et non erit qui exterreat."),
    (
        17,
        3,
    ...
    (17, 7, "In die illa inclinabitur homo ad factorem suum, et oculi ejus ad Sanctum Israël respicient;"),
    (
        17,
        8,
    ...
    (22, 23, "Et figam illum paxillum in loco fideli, et erit in solium gloriæ domui patris ejus."),
    (
        22,
        24,
    ...
    (24, 10, "Attrita est civitas vanitatis, clausa est omnis domus, nullo introëunte."),
    ...
    (24, 15, "Propter hoc in doctrinis glorificate Dominum; in insulis maris nomen Domini Dei Israël."),
    (
        24,
        16,
    ...
    (27, 6, "Qui ingrediuntur impetu ad Jacob, florebit et germinabit Israël, et implebunt faciem orbis semine."),
    ...
    (29, 19, "Et addent mites in Domino lætitiam, et pauperes homines in Sancto Israël exsultabunt;"),
    (
        29,
        20,
    ...
    (30, 11, "Auferte a me viam; declinate a me semitam; cesset a facie nostra Sanctus Israël."),
    (
        30,
        12,
    ...
    (31, 6, "Convertimini, sicut in profundum recesseratis, filii Israël."),
    (
        31,
        7,
    ...
    (37, 32, "quia de Jerusalem exibunt reliquiæ, et salvatio de monte Sion: zelus Domini exercituum faciet istud."),
    (
        37,
        33,
    ...
    (41, 8, "[Et tu, Israël, serve meus, Jacob quem elegi, semen Abraham amici mei:"),
    (
        41,
        9,
    ...
    (42, 2, "Non clamabit, neque accipiet personam, nec audietur vox ejus foris."),
    ...
    (44, 1, "[Et nunc audi, Jacob, serve meus, et Israël, quem elegi."),
    (
        44,
        2,
    ...
    (45, 15, "Vere tu es Deus absconditus, Deus Israël, salvator."),
    ...
    (45, 25, "In Domino justificabitur, et laudabitur omne semen Israël.]"),
    (
        46,
        1,
    ...
    (47, 4, "Redemptor noster, Dominus exercituum nomen illius, Sanctus Israël."),
    ...
    (48, 12, "Audi me, Jacob, et Israël, quem ego voco: ego ipse, ego primus, et ego novissimus."),
    ...
    (49, 3, "Et dixit mihi: Servus meus es tu Israël, quia in te gloriabor."),
    (
        49,
        4,
    ...
    (56, 8, "Ait Dominus Deus, qui congregat dispersos Israël: Adhuc congregabo ad eum congregatos ejus.]"),
    ...
    (
        63,
        19,
        "Facti sumus quasi in principio, cum non dominareris nostri, neque invocaretur nomen tuum super nos.] [Utinam dirumperes cælos, et descenderes; a facie tua montes defluerent;",
    ),
    (
        64,
        2,
