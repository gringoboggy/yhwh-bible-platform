"""Translation: vulgate-clementine · Book: 1pe
...
VERSES = [
    ...
    (1, 4, "in hæreditatem incorruptibilem, et incontaminatam, et immarcescibilem, conservatam in cælis in vobis,"),
    ...
    (1, 24, "quia omnis caro ut fœnum: et omnis gloria ejus tamquam flos fœni: exaruit fœnum, et flos ejus decidit."),
    ...
    (2, 13, "Subjecti igitur estote omni humanæ creaturæ propter Deum: sive regi quasi præcellenti:"),
    ...
    (2, 19, "Hæc est enim gratia, si propter Dei conscientiam sustinet quis tristitias, patiens injuste."),
    (
        2,
        20,
    ...
    (2, 22, "qui peccatum non fecit, nec inventus est dolus in ore ejus:"),
    (
        2,
        23,
    ...
    (3, 5, "Sic enim aliquando et sanctæ mulieres, sperantes in Deo, ornabant se, subjectæ propriis viris."),
    (
        3,
        6,
    ...
    (4, 13, "sed communicantes Christi passionibus gaudete, ut et in revelatione gloriæ ejus gaudeatis exsultantes."),
    (
        4,
        14,
    ...
    (5, 13, "Salutat vos ecclesia quæ est in Babylone coëlecta, et Marcus filius meus."),
