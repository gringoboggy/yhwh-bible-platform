"""Translation: vulgate-clementine · Book: hag
...
VERSES = [
    ...
    (1, 13, "Et dixit Aggæus, nuntius Domini de nuntiis Domini, populo dicens: Ego vobiscum sum, dicit Dominus."),
    (
        1,
        14,
    ...
    (1, 15, "In die vigesima et quarta mensis, in sexto mense, in anno secundo Darii regis."),
    (2, 1, "In septimo mense, vigesima et prima mensis, factum est verbum Domini in manu Aggæi prophetæ, dicens:"),
    (
        2,
        2,
    ...
    (2, 11, "Hæc dicit Dominus exercituum: Interroga sacerdotes legem, dicens:"),
    (
        2,
        12,
    ...
    (2, 20, "Et factum est verbum Domini secundo ad Aggæum in vigesima et quarta mensis, dicens:"),
    (2, 21, "Loquere ad Zorobabel ducem Juda, dicens: [Ego movebo cælum pariter et terram,"),
    (
        2,
        22,
