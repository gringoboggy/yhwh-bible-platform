"""Translation: vulgate-clementine · Book: luk
...
VERSES = [
    ...
    (1, 14, "et erit gaudium tibi, et exsultatio, et multi in nativitate ejus gaudebunt:"),
    (
        1,
        15,
        "erit enim magnus coram Domino: et vinum et siceram non bibet, et Spiritu Sancto replebitur adhuc ex utero matris suæ:",
    ),
    (1, 16, "et multos filiorum Israël convertet ad Dominum Deum ipsorum:"),
    (
        1,
        17,
    ...
    (1, 21, "Et erat plebs exspectans Zachariam: et mirabantur quod tardaret ipse in templo."),
    (
        1,
        22,
        "Egressus autem non poterat loqui ad illos, et cognoverunt quod visionem vidisset in templo. Et ipse erat innuens illis, et permansit mutus.",
    ),
    (1, 23, "Et factum est, ut impleti sunt dies officii ejus, abiit in domum suam:"),
    (1, 24, "post hos autem dies concepit Elisabeth uxor ejus, et occultabat se mensibus quinque, dicens:"),
    ...
    (1, 39, "Exsurgens autem Maria in diebus illis, abiit in montana cum festinatione, in civitatem Juda:"),
    ...
    (1, 44, "Ecce enim ut facta est vox salutationis tuæ in auribus meis, exsultavit in gaudio infans in utero meo."),
    ...
    (1, 50, "et misericordia ejus a progenie in progenies timentibus eum."),
    ...
    (1, 54, "Suscepit Israël puerum suum, recordatus misericordiæ suæ:"),
    (1, 55, "sicut locutus est ad patres nostros, Abraham et semini ejus in sæcula.]"),
    ...
    (1, 60, "Et respondens mater ejus, dixit: Nequaquam, sed vocabitur Joannes."),
    (1, 61, "Et dixerunt ad illam: Quia nemo est in cognatione tua, qui vocetur hoc nomine."),
    (1, 62, "Innuebant autem patri ejus, quem vellet vocari eum."),
    (1, 63, "Et postulans pugillarem scripsit, dicens: Joannes est nomen ejus. Et mirati sunt universi."),
    (1, 64, "Apertum est autem illico os ejus, et lingua ejus, et loquebatur benedicens Deum."),
    (
        1,
        65,
    ...
    (1, 67, "Et Zacharias pater ejus repletus est Spiritu Sancto: et prophetavit, dicens:"),
    (1, 68, "[Benedictus Dominus Deus Israël, quia visitavit, et fecit redemptionem plebis suæ:"),
    (1, 69, "et erexit cornu salutis nobis in domo David pueri sui,"),
    (1, 70, "sicut locutum est per os sanctorum, qui a sæculo sunt, prophetarum ejus:"),
    ...
    (1, 73, "jusjurandum, quod juravit ad Abraham patrem nostrum, daturum se nobis"),
    (1, 74, "ut sine timore, de manu inimicorum nostrorum liberati, serviamus illi"),
    (1, 75, "in sanctitate et justitia coram ipso, omnibus diebus nostris."),
    (1, 76, "Et tu puer, propheta Altissimi vocaberis: præibis enim ante faciem Domini parare vias ejus,"),
    (1, 77, "ad dandam scientiam salutis plebi ejus in remissionem peccatorum eorum"),
    ...
    (2, 9, "Et ecce angelus Domini stetit juxta illos, et claritas Dei circumfulsit illos, et timuerunt timore magno."),
    ...
    (2, 16, "Et venerunt festinantes: et invenerunt Mariam, et Joseph, et infantem positum in præsepio."),
    ...
    (2, 32, "lumen ad revelationem gentium, et gloriam plebis tuæ Israël.]"),
    (2, 33, "Et erat pater ejus et mater mirantes super his quæ dicebantur de illo."),
    (
        2,
        34,
    ...
    (2, 41, "Et ibant parentes ejus per omnes annos in Jerusalem, in die solemni Paschæ."),
    (2, 42, "Et cum factus esset annorum duodecim, ascendentibus illis Jerosolymam secundum consuetudinem diei festi,"),
    (2, 43, "consummatisque diebus, cum redirent, remansit puer Jesus in Jerusalem, et non cognoverunt parentes ejus."),
    (
        2,
        44,
        "Existimantes autem illum esse in comitatu, venerunt iter diei, et requirebant eum inter cognatos et notos.",
    ),
    (2, 45, "Et non invenientes, regressi sunt in Jerusalem, requirentes eum."),
    (
        2,
        46,
        "Et factum est, post triduum invenerunt illum in templo sedentem in medio doctorum, audientem illos, et interrogantem eos.",
    ),
    (2, 47, "Stupebant autem omnes qui eum audiebant, super prudentia et responsis ejus."),
    (
        2,
        48,
    ...
    (2, 52, "Et Jesus proficiebat sapientia, et ætate, et gratia apud Deum et homines."),
    (
        3,
        1,
    ...
    (3, 3, "Et venit in omnem regionem Jordanis, prædicans baptismum pœnitentiæ in remissionem peccatorum,"),
    (
        3,
        4,
    ...
    (3, 21, "Factum est autem cum baptizaretur omnis populus, et Jesu baptizato, et orante, apertum est cælum:"),
    (
        3,
        22,
    ...
    (3, 26, "qui fuit Mahath, qui fuit Mathathiæ, qui fuit Semei, qui fuit Joseph, qui fuit Juda,"),
    (3, 27, "qui fuit Joanna, qui fuit Resa, qui fuit Zorobabel, qui fuit Salatheil, qui fuit Neri,"),
    ...
    (3, 33, "qui fuit Aminadab, qui fuit Aram, qui fuit Esron, qui fuit Phares, qui fuit Judæ,"),
    (3, 34, "qui fuit Jacob, qui fuit Isaac, qui fuit Abrahæ, qui fuit Thare, qui fuit Nachor,"),
    (3, 35, "qui fuit Sarug, qui fuit Ragau, qui fuit Phaleg, qui fuit Heber, qui fuit Sale,"),
    (3, 36, "qui fuit Cainan, qui fuit Arphaxad, qui fuit Sem, qui fuit Noë, qui fuit Lamech,"),
    ...
    (4, 1, "Jesus autem plenus Spiritu Sancto regressus est a Jordane: et agebatur a Spiritu in desertum"),
    (
        4,
        2,
    ...
    (4, 4, "Et respondit ad illum Jesus: Scriptum est: Quia non in solo pane vivit homo, sed in omni verbo Dei."),
    ...
    (4, 8, "Et respondens Jesus, dixit illi: Scriptum est: Dominum Deum tuum adorabis, et illi soli servies."),
    (
        4,
        9,
    ...
    (4, 12, "Et respondens Jesus, ait illi: Dictum est: Non tentabis Dominum Deum tuum."),
    (4, 13, "Et consummata omni tentatione, diabolus recessit ab illo, usque ad tempus."),
    (4, 14, "Et regressus est Jesus in virtute Spiritus in Galilæam, et fama exiit per universam regionem de illo."),
    ...
    (4, 27, "Et multi leprosi erant in Israël sub Eliseo propheta: et nemo eorum mundatus est nisi Naaman Syrus."),
    ...
    (4, 32, "Et stupebant in doctrina ejus, quia in potestate erat sermo ipsius."),
    (4, 33, "Et in synagoga erat homo habens dæmonium immundum, et exclamavit voce magna,"),
    (4, 34, "dicens: Sine, quid nobis et tibi, Jesu Nazarene? venisti perdere nos? scio te quis sis, Sanctus Dei."),
    (
        4,
        35,
    ...
    (5, 8, "Quod cum videret Simon Petrus, procidit ad genua Jesu, dicens: Exi a me, quia homo peccator sum, Domine."),
    ...
    (5, 31, "Et respondens Jesus, dixit ad illos: Non egent qui sani sunt medico, sed qui male habent."),
    (5, 32, "Non veni vocare justos, sed peccatores ad pœnitentiam."),
    (
        5,
        33,
    ...
    (5, 34, "Quibus ipse ait: Numquid potestis filios sponsi, dum cum illis est sponsus, facere jejunare?"),
    (5, 35, "Venient autem dies, cum ablatus fuerit ab illis sponsus: tunc jejunabunt in illis diebus."),
    (
        5,
        36,
    ...
    (6, 15, "Matthæum, et Thomam, Jacobum Alphæi, et Simonem, qui vocatur Zelotes,"),
    ...
    (7, 3, "Et cum audisset de Jesu, misit ad eum seniores Judæorum, rogans eum ut veniret et salvaret servum ejus."),
    (7, 4, "At illi cum venissent ad Jesum, rogabant eum sollicite, dicentes ei: Quia dignus est ut hoc illi præstes:"),
    ...
    (7, 17, "Et exiit hic sermo in universam Judæam de eo, et in omnem circa regionem."),
    ...
    (7, 33, "Venit enim Joannes Baptista, neque manducans panem, neque bibens vinum, et dicitis: Dæmonium habet."),
    (
        7,
        34,
    ...
    (7, 43, "Respondens Simon dixit: Æstimo quia is cui plus donavit. At ille dixit ei: Recte judicasti."),
    (
        7,
        44,
    ...
    (8, 9, "Interrogabant autem eum discipuli ejus, quæ esset hæc parabola."),
    (
        8,
        10,
    ...
    (8, 19, "Venerunt autem ad illum mater et fratres ejus, et non poterant adire eum præ turba."),
    ...
    (8, 38, "Et rogabat illum vir, a quo dæmonia exierant, ut cum eo esset. Dimisit autem eum Jesus, dicens:"),
    (
        8,
        39,
        "Redi in domum tuam, et narra quanta tibi fecit Deus. Et abiit per universam civitatem, prædicans quanta illi fecisset Jesus.",
    ),
    (8, 40, "Factum est autem cum rediisset Jesus, excepit illum turba: erunt enim omnes exspectantes eum."),
    (
        8,
        41,
    ...
    (8, 44, "accessit retro, et tetigit fimbriam vestimenti ejus: et confestim stetit fluxus sanguinis ejus."),
    (
        8,
        45,
    ...
    (8, 46, "Et dicit Jesus: Tetigit me aliquis: nam ego novi virtutem de me exiisse."),
    (
        8,
        47,
    ...
    (8, 50, "Jesus autem, audito hoc verbo, respondit patri puellæ: Noli timere, crede tantum, et salva erit."),
    (
        8,
        51,
    ...
    (8, 54, "Ipse autem tenens manum ejus clamavit, dicens: Puella, surge."),
    (8, 55, "Et reversus est spiritus ejus, et surrexit continuo. Et jussit illi dari manducare."),
    (8, 56, "Et stupuerunt parentes ejus, quibus præcepit ne alicui dicerent quod factum erat."),
    (
        9,
        1,
    ...
    (11, 15, "Quidam autem ex eis dixerunt: In Beelzebub principe dæmoniorum ejicit dæmonia."),
    ...
    (11, 19, "Si autem ego in Beelzebub ejicio dæmonia: filii vestri in quo ejiciunt? ideo ipsi judices vestri erunt."),
    (11, 20, "Porro si in digito Dei ejicio dæmonia: profecto pervenit in vos regnum Dei."),
    ...
    (11, 45, "Respondens autem quidam ex legisperitis, ait illi: Magister, hæc dicens etiam contumeliam nobis facis."),
    (
        11,
        46,
    ...
    (11, 54, "insidiantes ei, et quærentes aliquid capere de ore ejus, ut accusarent eum."),
    (
        12,
        1,
    ...
    (12, 13, "Ait autem ei quidam de turba: Magister, dic fratri meo ut dividat mecum hæreditatem."),
    ...
    (12, 20, "Dixit autem illi Deus: Stulte, hac nocte animam tuam repetunt a te: quæ autem parasti, cujus erunt?"),
    ...
    (12, 31, "Verumtamen quærite primum regnum Dei, et justitiam ejus: et hæc omnia adjicientur vobis."),
    ...
    (14, 3, "Et respondens Jesus dixit ad legisperitos et pharisæos, dicens: Si licet sabbato curare?"),
    ...
    (14, 17, "Et misit servum suum hora cœnæ dicere invitatis ut venirent, quia jam parata sunt omnia."),
    (
        14,
        18,
    ...
    (14, 23, "Et ait dominus servo: Exi in vias, et sæpes: et compelle intrare, ut impleatur domus mea."),
    ...
    (14, 33, "Sic ergo omnis ex vobis, qui non renuntiat omnibus quæ possidet, non potest meus esse discipulus."),
    ...
    (15, 19, "jam non sum dignus vocari filius tuus: fac me sicut unum de mercenariis tuis."),
    (
        15,
        20,
    ...
    (15, 21, "Dixitque ei filius: Pater, peccavi in cælum, et coram te: jam non sum dignus vocari filius tuus."),
    (
        15,
        22,
    ...
    (16, 16, "Lex et prophetæ usque ad Joannem: ex eo regnum Dei evangelizatur, et omnis in illud vim facit."),
    ...
    (17, 11, "Et factum est, dum iret in Jerusalem, transibat per mediam Samariam et Galilæam."),
    (17, 12, "Et cum ingrederetur quoddam castellum, occurrerunt ei decem viri leprosi, qui steterunt a longe:"),
    (17, 13, "et levaverunt vocem, dicentes: Jesu præceptor, miserere nostri."),
    ...
    (17, 16, "et cecidit in faciem ante pedes ejus, gratias agens: et hic erat Samaritanus."),
    (17, 17, "Respondens autem Jesus, dixit: Nonne decem mundati sunt? et novem ubi sunt?"),
    ...
    (17, 26, "Et sicut factum est in diebus Noë, ita erit et in diebus Filii hominis:"),
    (
        17,
        27,
    ...
    (18, 12, "jejuno bis in sabbato, decimas do omnium quæ possideo."),
    (
        18,
        13,
    ...
    (18, 21, "Qui ait: Hæc omnia custodivi a juventute mea."),
    (
        18,
        22,
    ...
    (18, 35, "Factum est autem, cum appropinquaret Jericho, cæcus quidam sedebat secus viam, mendicans."),
    ...
    (19, 1, "Et ingressus perambulabat Jericho."),
    (19, 2, "Et ecce vir nomine Zachæus: et hic princeps erat publicanorum, et ipse dives:"),
    (19, 3, "et quærebat videre Jesum, quis esset: et non poterat præ turba, quia statura pusillus erat."),
    ...
    (19, 9, "Ait Jesus ad eum: Quia hodie salus domui huic facta est: eo quod et ipse filius sit Abrahæ."),
    ...
    (19, 28, "Et his dictis, præcedebat ascendens Jerosolymam."),
    (
        19,
        29,
    ...
    (19, 31, "Et si quis vos interrogaverit: Quare solvitis? sic dicetis ei: Quia Dominus operam ejus desiderat."),
    (19, 32, "Abierunt autem qui missi erant: et invenerunt, sicut dixit illis, stantem pullum."),
    (19, 33, "Solventibus autem illis pullum, dixerunt domini ejus ad illos: Quid solvitis pullum?"),
    (19, 34, "At illi dixerunt: Quia Dominus eum necessarium habet."),
    (19, 35, "Et duxerunt illum ad Jesum. Et jacentes vestimenta sua supra pullum, imposuerunt Jesum."),
    ...
    (19, 45, "Et ingressus in templum, cœpit ejicere vendentes in illo, et ementes,"),
    (
        19,
        46,
    ...
    (21, 30, "cum producunt jam ex se fructum, scitis quoniam prope est æstas."),
    ...
    (22, 2, "et quærebant principes sacerdotum, et scribæ, quomodo Jesum interficerent: timebant vero plebem."),
    (22, 3, "Intravit autem Satanas in Judam, qui cognominabatur Iscariotes, unum de duodecim:"),
    ...
    (22, 8, "Et misit Petrum et Joannem, dicens: Euntes parate nobis pascha, ut manducemus."),
    ...
    (22, 24, "Facta est autem et contentio inter eos, quis eorum videretur esse major."),
    ...
    (22, 41, "Et ipse avulsus est ab eis quantum jactus est lapidis: et positis genibus orabat,"),
    ...
    (22, 44, "Et factus est sudor ejus sicut guttæ sanguinis decurrentis in terram."),
    ...
    (22, 48, "Jesus autem dixit illi: Juda, osculo Filium hominis tradis?"),
    (
        22,
        49,
        "Videntes autem hi qui circa ipsum erant, quod futurum erat, dixerunt ei: Domine, si percutimus in gladio?",
    ),
    (22, 50, "Et percussit unus ex illis servum principis sacerdotum, et amputavit auriculam ejus dexteram."),
    (22, 51, "Respondens autem Jesus, ait: Sinite usque huc. Et cum tetigisset auriculam ejus, sanavit eum."),
    (
        22,
        52,
    ...
    (22, 71, "At illi dixerunt: Quid adhuc desideramus testimonium? ipsi enim audivimus de ore ejus."),
    ...
    (23, 3, "Pilatus autem interrogavit eum, dicens: Tu es rex Judæorum? At ille respondens ait: Tu dicis."),
    ...
    (23, 37, "et dicentes: Si tu es rex Judæorum, salvum te fac."),
    (
        23,
        38,
    ...
    (23, 46, "Et clamans voce magna Jesus ait: Pater, in manus tuas commendo spiritum meum. Et hæc dicens, expiravit."),
    ...
    (23, 49, "Stabant autem omnes noti ejus a longe, et mulieres, quæ secutæ eum erant a Galilæa, hæc videntes."),
