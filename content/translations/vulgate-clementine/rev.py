"""Translation: vulgate-clementine · Book: rev
...
VERSES = [
    ...
    (1, 2, "qui testimonium perhibuit verbo Dei, et testimonium Jesu Christi, quæcumque vidit."),
    (
        1,
        3,
    ...
    (2, 16, "Similiter pœnitentiam age: si quominus veniam tibi cito, et pugnabo cum illis in gladio oris mei."),
    (
        2,
        17,
    ...
    (7, 4, "Et audivi numerum signatorum, centum quadraginta quatuor millia signati, ex omni tribu filiorum Israël."),
    (
        7,
        5,
    ...
    (9, 16, "Et numerus equestris exercitus vicies millies dena millia. Et audivi numerum eorum."),
    (
        9,
        17,
    ...
    (10, 5, "Et angelus, quem vidi stantem super mare et super terram, levavit manum suam ad cælum:"),
    (
        10,
        6,
    ...
    (11, 4, "Hi sunt duæ olivæ et duo candelabra in conspectu Domini terræ stantes."),
    (
        11,
        5,
    ...
    (11, 14, "Væ secundum abiit: et ecce væ tertium veniet cito."),
    (
        11,
        15,
    ...
    (12, 13, "Et postquam vidit draco quod projectus esset in terram, persecutus est mulierem, quæ peperit masculum:"),
    (
        12,
        14,
    ...
    (16, 5, "Et audivi angelum aquarum dicentem: Justus es, Domine, qui es, et qui eras sanctus, qui hæc judicasti:"),
    ...
    (17, 2, "cum qua fornicati sunt reges terræ, et inebriati sunt qui inhabitant terram de vino prostitutionis ejus."),
    (
        17,
        3,
    ...
    (17, 5, "Et in fronte ejus nomen scriptum: Mysterium: Babylon magna, mater fornicationum, et abominationum terræ."),
    (
        17,
        6,
    ...
    (18, 5, "Quoniam pervenerunt peccata ejus usque ad cælum, et recordatus est Dominus iniquitatum ejus."),
    (
        18,
        6,
    ...
    (18, 18, "et clamaverunt videntes locum incendii ejus, dicentes: Quæ similis civitati huic magnæ?"),
    (
        18,
        19,
    ...
    (19, 3, "Et iterum dixerunt: Alleluja. Et fumus ejus ascendit in sæcula sæculorum."),
    (
        19,
        4,
    ...
    (19, 7, "Gaudeamus, et exsultemus: et demus gloriam ei: quia venerunt nuptiæ Agni, et uxor ejus præparavit se."),
    (
        19,
        8,
    ...
    (19, 13, "Et vestitus erat veste aspersa sanguine: et vocatur nomen ejus: Verbum Dei."),
    ...
    (20, 9, "Et ascenderunt super latitudinem terræ, et circuierunt castra sanctorum, et civitatem dilectam."),
    (
        20,
        10,
    ...
    (21, 1, "Et vidi cælum novum et terram novam. Primum enim cælum, et prima terra abiit, et mare jam non est."),
    (
        21,
        2,
    ...
    (21, 17, "Et mensus est murum ejus centum quadraginta quatuor cubitorum, mensura hominis, quæ est angeli."),
    ...
    (21, 24, "Et ambulabunt gentes in lumine ejus: et reges terræ afferent gloriam suam et honorem in illam."),
    (21, 25, "Et portæ ejus non claudentur per diem: nox enim non erit illic."),
    ...
    (22, 7, "Et ecce venio velociter. Beatus, qui custodit verba prophetiæ libri hujus."),
    (
        22,
        8,
    ...
    (22, 10, "Et dicit mihi: Ne signaveris verba prophetiæ libri hujus: tempus enim prope est."),
    (
        22,
        11,
