"""Translation: vulgate-clementine · Book: phi
...
VERSES = [
    ...
    (1, 6, "Confidens hoc ipsum, quia qui cœpit in vobis opus bonum, perficiet usque in diem Christi Jesu:"),
    (
        1,
        7,
    ...
    (1, 9, "Et hoc oro, ut caritas vestra magis ac magis abundet in scientia, et in omni sensu:"),
    (1, 10, "ut probetis potiora, ut sitis sinceri, et sine offensa in diem Christi,"),
    (1, 11, "repleti fructu justitiæ per Jesum Christum, in gloriam et laudem Dei."),
    (1, 12, "Scire autem vos volo fratres, quia quæ circa me sunt, magis ad profectum venerunt Evangelii:"),
    (1, 13, "ita ut vincula mea manifesta fierent in Christo in omni prætorio, et in ceteris omnibus,"),
    (
        1,
        14,
    ...
    (2, 4, "non quæ sua sunt singuli considerantes, sed ea quæ aliorum."),
    (2, 5, "Hoc enim sentite in vobis, quod et in Christo Jesu:"),
    (2, 6, "qui cum in forma Dei esset, non rapinam arbitratus est esse se æqualem Deo:"),
    (
        2,
        7,
    ...
    (2, 10, "ut in nomine Jesu omne genu flectatur cælestium, terrestrium et infernorum,"),
    ...
    (2, 14, "Omnia autem facite sine murmurationibus et hæsitationibus:"),
    (
        2,
        15,
    ...
    (2, 17, "Sed et si immolor supra sacrificium, et obsequium fidei vestræ, gaudeo, et congratulor omnibus vobis."),
    ...
    (2, 23, "Hunc igitur spero me mittere ad vos, mox ut videro quæ circa me sunt."),
    ...
    (3, 7, "Sed quæ mihi fuerunt lucra, hæc arbitratus sum propter Christum detrimenta."),
    (
        3,
        8,
    ...
    (3, 11, "si quo modo occurram ad resurrectionem, quæ est ex mortuis:"),
    (
        3,
        12,
    ...
    (3, 14, "ad destinatum persequor, ad bravium supernæ vocationis Dei in Christo Jesu."),
    ...
    (3, 18, "Multi enim ambulant, quos sæpe dicebam vobis (nunc autem et flens dico) inimicos crucis Christi:"),
    (3, 19, "quorum finis interitus: quorum Deus venter est: et gloria in confusione ipsorum, qui terrena sapiunt."),
    (3, 20, "Nostra autem conversatio in cælis est: unde etiam Salvatorem exspectamus Dominum nostrum Jesum Christum,"),
    (
        3,
        21,
    ...
    (4, 7, "Et pax Dei, quæ exuperat omnem sensum, custodiat corda vestra, et intelligentias vestras in Christo Jesu."),
    (
        4,
        8,
    ...
    (4, 9, "Quæ et didicistis, et accepistis, et audistis, et vidistis in me, hæc agite: et Deus pacis erit vobiscum."),
    (
        4,
        10,
    ...
    (4, 14, "Verumtamen bene fecistis, communicantes tribulationi meæ."),
    (
        4,
        15,
    ...
    (4, 17, "Non quia quæro datum, sed requiro fructum abundantem in ratione vestra."),
    (
        4,
        18,
    ...
    (4, 19, "Deus autem meus impleat omne desiderium vestrum secundum divitias suas in gloria in Christo Jesu."),
    (4, 20, "Deo autem et Patri nostro gloria in sæcula sæculorum. Amen."),
