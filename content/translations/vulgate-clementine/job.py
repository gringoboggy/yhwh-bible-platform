"""Translation: vulgate-clementine · Book: job
...
VERSES = [
    ...
    (1, 13, "Cum autem quadam die filii et filiæ ejus comederent et biberent vinum in domo fratris sui primogeniti,"),
    (1, 14, "nuntius venit ad Job, qui diceret: Boves arabant, et asinæ pascebantur juxta eos:"),
    (
        1,
        15,
    ...
    (2, 5, "alioquin mitte manum tuam, et tange os ejus et carnem, et tunc videbis quod in faciem benedicat tibi."),
    ...
    (16, 5, "roborarem vos ore meo, et moverem labia mea, quasi parcens vobis."),
    (16, 6, "Sed quid agam? Si locutus fuero, non quiescet dolor meus, et si tacuero, non recedet a me."),
    (16, 7, "Nunc autem oppressit me dolor meus, et in nihilum redacti sunt omnes artus mei."),
    (
        16,
        8,
    ...
    (16, 10, "Aperuerunt super me ora sua, et exprobrantes percusserunt maxillam meam: satiati sunt pœnis meis."),
    ...
    (16, 14, "Concidit me vulnere super vulnus: irruit in me quasi gigas."),
    (16, 15, "Saccum consui super cutem meam, et operui cinere carnem meam."),
    (16, 16, "Facies mea intumuit a fletu, et palpebræ meæ caligaverunt."),
    (16, 17, "Hæc passus sum absque iniquitate manus meæ, cum haberem mundas ad Deum preces."),
    (16, 18, "Terra, ne operias sanguinem meum, neque inveniat in te locum latendi clamor meus:"),
    (16, 19, "ecce enim in cælo testis meus, et conscius meus in excelsis."),
    (16, 20, "Verbosi amici mei: ad Deum stillat oculus meus:"),
    (16, 21, "atque utinam sic judicaretur vir cum Deo, quomodo judicatur filius hominis cum collega suo."),
    ...
    (25, 3, "Numquid est numerus militum ejus? et super quem non surget lumen illius?"),
    (25, 4, "Numquid justificari potest homo comparatus Deo? aut apparere mundus natus de muliere?"),
    (25, 5, "Ecce luna etiam non splendet, et stellæ non sunt mundæ in conspectu ejus:"),
    ...
    (40, 6, "Respondens autem Dominus Job de turbine, dixit:"),
    (40, 7, "[Accinge sicut vir lumbos tuos: interrogabo te, et indica mihi."),
    (40, 8, "Numquid irritum facies judicium meum, et condemnabis me, ut tu justificeris?"),
    ...
    (40, 11, "Disperge superbos in furore tuo, et respiciens omnem arrogantem humilia."),
    ...
    (40, 15, "Ecce behemoth quem feci tecum, fœnum quasi bos comedet."),
    (40, 16, "Fortitudo ejus in lumbis ejus, et virtus illius in umbilico ventris ejus."),
    (40, 17, "Stringit caudam suam quasi cedrum; nervi testiculorum ejus perplexi sunt."),
    (40, 18, "Ossa ejus velut fistulæ æris; cartilago illius quasi laminæ ferreæ."),
    (40, 19, "Ipse est principium viarum Dei: qui fecit eum applicabit gladium ejus."),
    (40, 20, "Huic montes herbas ferunt: omnes bestiæ agri ludent ibi."),
    (40, 21, "Sub umbra dormit in secreto calami, et in locis humentibus."),
    (40, 22, "Protegunt umbræ umbram ejus: circumdabunt eum salices torrentis."),
    (40, 23, "Ecce absorbebit fluvium, et non mirabitur, et habet fiduciam quod influat Jordanis in os ejus."),
    (40, 24, "In oculis ejus quasi hamo capiet eum, et in sudibus perforabit nares ejus."),
    (41, 1, "An extrahere poteris Leviathan hamo, et fune ligabis linguam ejus?"),
    (41, 2, "Numquid pones circulum in naribus ejus, aut armilla perforabis maxillam ejus?"),
    ...
    (41, 5, "Numquid illudes ei quasi avi, aut ligabis eum ancillis tuis?"),
    (41, 6, "Concident eum amici? divident illum negotiatores?"),
    (41, 7, "Numquid implebis sagenas pelle ejus, et gurgustium piscium capite illius?"),
    (41, 8, "Pone super eum manum tuam: memento belli, nec ultra addas loqui."),
    (41, 9, "Ecce spes ejus frustrabitur eum, et videntibus cunctis præcipitabitur.]"),
    (41, 10, "[Non quasi crudelis suscitabo eum: quis enim resistere potest vultui meo?"),
    (41, 11, "Quis ante dedit mihi, ut reddam ei? omnia quæ sub cælo sunt, mea sunt."),
    (41, 12, "Non parcam ei, et verbis potentibus, et ad deprecandum compositis."),
    (41, 13, "Quis revelabit faciem indumenti ejus? et in medium oris ejus quis intrabit?"),
    (41, 14, "Portas vultus ejus quis aperiet? per gyrum dentium ejus formido."),
    (41, 15, "Corpus illius quasi scuta fusilia, compactum squamis se prementibus."),
    (41, 16, "Una uni conjungitur, et ne spiraculum quidem incedit per eas."),
    (41, 17, "Una alteri adhærebit, et tenentes se nequaquam separabuntur."),
    (41, 18, "Sternutatio ejus splendor ignis, et oculi ejus ut palpebræ diluculi."),
    (41, 19, "De ore ejus lampades procedunt, sicut tædæ ignis accensæ."),
    (41, 20, "De naribus ejus procedit fumus, sicut ollæ succensæ atque ferventis."),
    (41, 21, "Halitus ejus prunas ardere facit, et flamma de ore ejus egreditur."),
    (41, 22, "In collo ejus morabitur fortitudo, et faciem ejus præcedit egestas."),
    (41, 23, "Membra carnium ejus cohærentia sibi: mittet contra eum fulmina, et ad locum alium non ferentur."),
    (41, 24, "Cor ejus indurabitur tamquam lapis, et stringetur quasi malleatoris incus."),
    (41, 25, "Cum sublatus fuerit, timebunt angeli, et territi purgabuntur."),
    (41, 26, "Cum apprehenderit eum gladius, subsistere non poterit, neque hasta, neque thorax:"),
    (41, 27, "reputabit enim quasi paleas ferrum, et quasi lignum putridum æs."),
    (41, 28, "Non fugabit eum vir sagittarius: in stipulam versi sunt ei lapides fundæ."),
    (41, 29, "Quasi stipulam æstimabit malleum, et deridebit vibrantem hastam."),
    (41, 30, "Sub ipso erunt radii solis, et sternet sibi aurum quasi lutum."),
    (41, 31, "Fervescere faciet quasi ollam profundum mare, et ponet quasi cum unguenta bulliunt."),
    (41, 32, "Post eum lucebit semita: æstimabit abyssum quasi senescentem."),
    (41, 33, "Non est super terram potestas quæ comparetur ei, qui factus est ut nullum timeret."),
    (41, 34, "Omne sublime videt: ipse est rex super universos filios superbiæ.]"),
