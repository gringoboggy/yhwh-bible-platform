"""Translation: vulgate-clementine · Book: 1th
...
BOOK = "1th"
VERSES = [
    (1, 1, "Paulus, et Silvanus, et Timotheus ecclesiæ Thessalonicensium in Deo Patre, et Domino Jesu Christo."),
    (
        1,
        2,
    ...
    (1, 10, "et exspectare Filium ejus de cælis (quem suscitavit a mortuis) Jesum, qui eripuit nos ab ira ventura."),
    ...
    (4, 2, "Scitis enim quæ præcepta dederim vobis per Dominum Jesum."),
