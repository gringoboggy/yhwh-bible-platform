"""Translation: vulgate-clementine · Book: col
...
BOOK = "col"
VERSES = [
    (1, 1, "Paulus Apostolus Jesu Christi per voluntatem Dei, et Timotheus frater:"),
    ...
    (1, 5, "propter spem, quæ reposita est vobis in cælis: quam audistis in verbo veritatis Evangelii:"),
    (
        1,
        6,
    ...
    (1, 13, "qui eripuit nos de potestate tenebrarum, et transtulit in regnum filii dilectionis suæ,"),
    (1, 14, "in quo habemus redemptionem per sanguinem ejus, remissionem peccatorum:"),
    (1, 15, "qui est imago Dei invisibilis, primogenitus omnis creaturæ:"),
    (
        1,
        16,
    ...
    (1, 26, "mysterium, quod absconditum fuit a sæculis, et generationibus, nunc autem manifestatum est sanctis ejus,"),
    (
        1,
        27,
    ...
    (2, 3, "in quo sunt omnes thesauri sapientiæ et scientiæ absconditi."),
    ...
    (2, 6, "Sicut ergo accepistis Jesum Christum Dominum, in ipso ambulate,"),
    (
        2,
        7,
    ...
    (2, 16, "Nemo ergo vos judicet in cibo, aut in potu, aut in parte diei festi, aut neomeniæ, aut sabbatorum:"),
    (2, 17, "quæ sunt umbra futurorum: corpus autem Christi."),
    (
        2,
        18,
    ...
    (3, 1, "Igitur, si consurrexistis cum Christo: quæ sursum sunt quærite, ubi Christus est in dextera Dei sedens:"),
    ...
    (4, 1, "Domini, quod justum est et æquum, servis præstate: scientes quod et vos Dominum habetis in cælo."),
