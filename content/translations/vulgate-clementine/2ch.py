"""Translation: vulgate-clementine · Book: 2ch
...
VERSES = [
    ...
    (1, 13, "Venit ergo Salomon ab excelso Gabaon in Jerusalem coram tabernaculo fœderis, et regnavit super Israël."),
    (
        1,
        14,
    ...
    (5, 3, "Venerunt itaque ad regem omnes viri Israël in die solemni mensis septimi."),
    (5, 4, "Cumque venissent cuncti seniorum Israël, portaverunt Levitæ arcam,"),
    (
        5,
        5,
    ...
    (6, 2, "ego autem ædificavi domum nomini ejus, ut habitaret ibi in perpetuum."),
    (
        6,
        3,
        "Et convertit rex faciem suam, et benedixit universæ multitudini Israël (nam omnis turba stabat intenta), et ait:",
    ),
    (6, 4, "Benedictus Dominus Deus Israël, qui quod locutus est David patri meo, opere complevit, dicens:"),
    (
        6,
        5,
    ...
    (6, 7, "Cumque fuisset voluntatis David patris mei ut ædificaret domum nomini Domini Dei Israël,"),
    (
        6,
        8,
    ...
    (6, 11, "Et posui in ea arcam in qua est pactum Domini quod pepigit cum filiis Israël."),
    (6, 12, "Stetit ergo coram altari Domini ex adverso universæ multitudinis Israël, et extendit manus suas."),
    (
        6,
        13,
    ...
    (6, 17, "Et nunc Domine Deus Israël, firmetur sermo tuus quem locutus es servo tuo David."),
    (
        6,
        18,
    ...
    (7, 15, "Oculi quoque mei erunt aperti, et aures meæ erectæ ad orationem ejus, qui in loco isto oraverit."),
    (
        7,
        16,
    ...
    (8, 2, "civitates quas dederat Hiram Salomoni, ædificavit, et habitare ibi fecit filios Israël."),
    (8, 3, "Abiit quoque in Emath Suba, et obtinuit eam."),
    (8, 4, "Et ædificavit Palmyram in deserto, et alias civitates munitissimas ædificavit in Emath."),
    (
        8,
        5,
    ...
    (9, 30, "Regnavit autem Salomon in Jerusalem super omnem Israël quadraginta annis."),
    (
        9,
        31,
        "Dormivitque cum patribus suis, et sepelierunt eum in civitate David: regnavitque Roboam filius ejus pro eo.",
    ),
    (10, 1, "Profectus est autem Roboam in Sichem: illuc enim cunctus Israël convenerat ut constituerent eum regem."),
    (
        10,
        2,
        "Quod cum audisset Jeroboam filius Nabat, qui erat in Ægypto (fugerat quippe illuc ante Salomonem), statim reversus est.",
    ),
    (10, 3, "Vocaveruntque eum, et venit cum universo Israël: et locuti sunt ad Roboam, dicentes:"),
    (
        10,
        4,
    ...
    (10, 12, "Venit ergo Jeroboam et universus populus ad Roboam die tertio, sicut præceperat eis."),
    ...
    (10, 17, "Super filios autem Israël qui habitabant in civitatibus Juda, regnavit Roboam."),
    (
        10,
        18,
    ...
    (10, 19, "Recessitque Israël a domo David, usque ad diem hanc."),
    (
        11,
        1,
    ...
    (11, 3, "Loquere ad Roboam filium Salomonis regem Juda, et ad universum Israël, qui est in Juda et Benjamin:"),
    (
        11,
        4,
    ...
    (11, 5, "Habitavit autem Roboam in Jerusalem, et ædificavit civitates muratas in Juda."),
    (11, 6, "Exstruxitque Bethlehem, et Etam, et Thecue,"),
    (11, 7, "Bethsur quoque, et Socho, et Odollam,"),
    (11, 8, "necnon et Geth, et Maresa, et Ziph,"),
    (11, 9, "sed et Aduram, et Lachis, et Azeca,"),
    (11, 10, "Saraa quoque, et Ajalon, et Hebron, quæ erant in Juda et Benjamin, civitates munitissimas."),
    ...
    (11, 13, "Sacerdotes autem et Levitæ qui erant in universo Israël, venerunt ad eum de cunctis sedibus suis,"),
    (
        11,
        14,
    ...
    (11, 18, "Duxit autem Roboam uxorem Mahalath filiam Jerimoth filii David: Abihail quoque filiam Eliab filii Isai,"),
    (11, 19, "quæ peperit ei filios Jehus, et Somoriam, et Zoom."),
    ...
    (12, 1, "Cumque roboratum fuisset regnum Roboam et confortatum, dereliquit legem Domini, et omnis Israël cum eo."),
    (12, 2, "Anno autem quinto regni Roboam, ascendit Sesac rex Ægypti in Jerusalem (quia peccaverant Domino)"),
    (
        12,
        3,
    ...
    (12, 6, "Consternatique principes Israël et rex, dixerunt: Justus est Dominus."),
    (
        12,
        7,
    ...
    (13, 1, "Anno octavodecimo regis Jeroboam, regnavit Abia super Judam."),
    (
        13,
        2,
    ...
    (13, 4, "Stetit ergo Abia super montem Semeron, qui erat in Ephraim, et ait: Audi, Jeroboam, et omnis Israël."),
    (
        13,
        5,
    ...
    (13, 6, "Et surrexit Jeroboam filius Nabat, servus Salomonis filii David, et rebellavit contra dominum suum."),
    (
        13,
        7,
    ...
    (13, 16, "Fugeruntque filii Israël Judam, et tradidit eos Deus in manu eorum."),
    (
        13,
        17,
    ...
    (13, 20, "nec valuit ultra resistere Jeroboam in diebus Abia: quem percussit Dominus, et mortuus est."),
    (
        13,
        21,
    ...
    (14, 4, "et præcepit Judæ ut quæreret Dominum Deum patrum suorum, et faceret legem, et universa mandata:"),
    (14, 5, "et abstulit de cunctis urbibus Juda aras et fana, et regnavit in pace."),
    (
        14,
        6,
    ...
    (14, 10, "Porro Asa perrexit obviam ei, et instruxit aciem ad bellum in valle Sephata, quæ est juxta Maresa:"),
    (
        14,
        11,
    ...
    (14, 12, "Exterruit itaque Dominus Æthiopes coram Asa et Juda: fugeruntque Æthiopes."),
    (
        14,
        13,
    ...
    (16, 11, "Opera autem Asa prima et novissima scripta sunt in libro regum Juda et Israël."),
    (
        16,
        12,
    ...
    (17, 1, "Regnavit autem Josaphat filius ejus pro eo, et invaluit contra Israël."),
    (
        17,
        2,
    ...
    (17, 4, "sed in Deo patris sui: et perrexit in præceptis illius, et non juxta peccata Israël."),
    (
        17,
        5,
    ...
    (18, 4, "Dixitque Josaphat ad regem Israël: Consule, obsecro, impræsentiarum sermonem Domini."),
    (
        18,
        5,
    ...
    (18, 8, "Vocavit ergo rex Israël unum de eunuchis, et dixit ei: Voca cito Michæam filium Jemla."),
    (
        18,
        9,
    ...
    (18, 28, "Igitur ascenderunt rex Israël et Josaphat rex Juda in Ramoth Galaad."),
    (
        18,
        29,
    ...
    (18, 32, "Cum enim vidissent duces equitatus quod non esset rex Israël, reliquerunt eum."),
    (
        18,
        33,
    ...
    (19, 5, "Constituitque judices terræ in cunctis civitatibus Juda munitis per singula loca,"),
    (
        19,
        6,
    ...
    (20, 5, "Cumque stetisset Josaphat in medio cœtu Juda et Jerusalem, in domo Domini ante atrium novum,"),
    (
        20,
        6,
    ...
    (20, 19, "Porro Levitæ de filiis Caath et de filiis Core laudabant Dominum Deum Israël voce magna in excelsum."),
    (
        20,
        20,
    ...
    (20, 30, "Quievitque regnum Josaphat, et præbuit ei Deus pacem per circuitum."),
    (
        20,
        31,
    ...
    (20, 35, "Post hæc iniit amicitias Josaphat rex Juda cum Ochozia rege Israël, cujus opera fuerunt impiissima."),
    ...
    (21, 5, "Triginta duorum annorum erat Joram cum regnare cœpisset, et octo annis regnavit in Jerusalem."),
    (
        21,
        6,
    ...
    (21, 8, "In diebus illis rebellavit Edom, ne esset subditus Judæ, et constituit sibi regem."),
    (
        21,
        9,
    ...
    (21, 16, "Suscitavit ergo Dominus contra Joram spiritum Philisthinorum, et Arabum qui confines sunt Æthiopibus:"),
    (
        21,
        17,
    ...
    (23, 16, "Pepigit autem Jojada fœdus inter se, universumque populum, et regem, ut esset populus Domini."),
    (
        23,
        17,
    ...
    (24, 2, "Fecitque quod bonum est coram Domino cunctis diebus Jojadæ sacerdotis."),
    (24, 3, "Accepit autem ei Jojada uxores duas, e quibus genuit filios et filias."),
    (24, 4, "Post quæ placuit Joas ut instauraret domum Domini."),
    (
        24,
        5,
    ...
    (24, 8, "Præcepit ergo rex, et fecerunt arcam: posueruntque eam juxta portam domus Domini forinsecus."),
    (
        24,
        9,
    ...
    (24, 16, "sepelieruntque eum in civitate David cum regibus, eo quod fecisset bonum cum Israël, et cum domo ejus."),
    (
        24,
        17,
    ...
    (25, 6, "mercede quoque conduxit de Israël centum millia robustorum, centum talentis argenti."),
    (
        25,
        7,
    ...
    (25, 22, "corruitque Juda coram Israël, et fugit in tabernacula sua."),
    (
        25,
        23,
    ...
    (25, 26, "Reliqua autem sermonum Amasiæ priorum et novissimorum scripta sunt in libro regum Juda et Israël."),
    (
        25,
        27,
    ...
    (26, 2, "Ipse ædificavit Ailath, et restituit eam ditioni Juda, postquam dormivit rex cum patribus suis."),
    (
        26,
        3,
    ...
    (26, 4, "Fecitque quod erat rectum in oculis Domini, juxta omnia quæ fecerat Amasias pater ejus."),
    (
        26,
        5,
    ...
    (27, 4, "Urbes quoque ædificavit in montibus Juda, et in saltibus castella et turres."),
    (
        27,
        5,
    ...
    (27, 8, "Viginti quinque annorum erat cum regnare cœpisset, et sedecim annis regnavit in Jerusalem."),
    (
        27,
        9,
    ...
    (28, 2, "sed ambulavit in viis regum Israël, insuper et statuas fudit Baalim."),
    (
        28,
        3,
    ...
    (28, 17, "Veneruntque Idumæi, et percusserunt multos ex Juda, et ceperunt prædam magnam."),
    (
        28,
        18,
    ...
    (29, 2, "Fecitque quod erat placitum in conspectu Domini, juxta omnia quæ fecerat David pater ejus."),
    ...
    (29, 10, "Nunc ergo placet mihi ut ineamus fœdus cum Domino Deo Israël, et avertet a nobis furorem iræ suæ."),
    (
        29,
        11,
    ...
    (29, 13, "At vero de filiis Elisaphan, Samri, et Jahiel. De filiis quoque Asaph, Zacharias, et Mathanias:"),
    (29, 14, "necnon de filiis Heman, Jahiel, et Semei: sed et de filiis Idithun, Semeias, et Oziel."),
    (
        29,
        15,
    ...
    (31, 7, "Mense tertio cœperunt acervorum jacere fundamenta, et mense septimo compleverunt eos."),
    (
        31,
        8,
    ...
    (32, 10, "Hæc dicit Sennacherib rex Assyriorum: In quo habentes fiduciam sedetis obsessi in Jerusalem?"),
    (
        32,
        11,
    ...
    (32, 19, "Locutusque est contra Deum Jerusalem, sicut adversum deos populorum terræ, opera manuum hominum."),
    (
        32,
        20,
    ...
    (32, 28, "Apothecas quoque frumenti, vini, et olei, et præsepia omnium jumentorum, caulasque pecorum,"),
    (
        32,
        29,
    ...
    (33, 2, "Fecit autem malum coram Domino, juxta abominationes gentium quas subvertit Dominus coram filiis Israël:"),
    (
        33,
        3,
    ...
    (33, 21, "Viginti duorum annorum erat Amon cum regnare cœpisset, et duobus annis regnavit in Jerusalem."),
    (
        33,
        22,
    ...
    (34, 1, "Octo annorum erat Josias cum regnare cœpisset, et triginta et uno anno regnavit in Jerusalem."),
    (
        34,
        2,
    ...
    (34, 5, "Ossa præterea sacerdotum combussit in altaribus idolorum, mundavitque Judam et Jerusalem."),
    ...
    (34, 13, "Super eos vero qui ad diversos usus onera portabant, erant scribæ, et magistri de Levitis, janitores."),
    (
        34,
        14,
    ...
    (34, 23, "At illa respondit eis: Hæc dicit Dominus Deus Israël: Dicite viro qui misit vos ad me:"),
    (
        34,
        24,
    ...
    (35, 19, "Octavodecimo anno regni Josiæ hoc Phase celebratum est."),
    (
        35,
        20,
    ...
    (35, 26, "Reliqua autem sermonum Josiæ, et misericordiarum ejus, quæ lege præcepta sunt Domini,"),
    (35, 27, "opera quoque illius prima et novissima, scripta sunt in libro regum Juda et Israël."),
    (36, 1, "Tulit ergo populus terræ Joachaz filium Josiæ, et constituit regem pro patre suo in Jerusalem."),
    (36, 2, "Viginti trium annorum erat Joachaz cum regnare cœpisset, et tribus mensibus regnavit in Jerusalem."),
    (
        36,
        3,
    ...
    (36, 11, "Viginti et unius anni erat Sedecias cum regnare cœpisset, et undecim annis regnavit in Jerusalem:"),
    (
        36,
        12,
