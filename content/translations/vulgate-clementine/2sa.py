"""Translation: vulgate-clementine · Book: 2sa
...
VERSES = [
    ...
    (1, 3, "Dixitque ad eum David: Unde venis? Qui ait ad eum: De castris Israël fugi."),
    (
        1,
        4,
    ...
    (1, 17, "Planxit autem David planctum hujuscemodi super Saul, et super Jonathan filium ejus"),
    (
        1,
        18,
    ...
    (1, 19, "Inclyti Israël super montes tuos interfecti sunt: quomodo ceciderunt fortes?"),
    (
        1,
        20,
    ...
    (1, 25, "[Quomodo ceciderunt fortes in prælio? Jonathas in excelsis tuis occisus est?"),
    (
        1,
        26,
    ...
    (2, 2, "Ascendit ergo David, et duæ uxores ejus, Achinoam Jezraëlites, et Abigail uxor Nabal Carmeli:"),
    ...
    (2, 17, "Et ortum est bellum durum satis in die illa: fugatusque est Abner et viri Israël a pueris David."),
    (
        2,
        18,
    ...
    (2, 20, "Respexit itaque Abner post tergum suum, et ait: Tune es Asaël? Qui respondit: Ego sum."),
    (
        2,
        21,
    ...
    (3, 2, "Natique sunt filii David in Hebron: fuitque primogenitus ejus Amnon, de Achinoam Jezraëlitide."),
    (
        3,
        3,
    ...
    (3, 9, "Hæc faciat Deus Abner, et hæc addat ei, nisi quomodo juravit Dominus David, sic faciam cum eo,"),
    (
        3,
        10,
    ...
    (3, 38, "Dixit quoque rex ad servos suos: Num ignoratis quoniam princeps et maximus cecidit hodie in Israël?"),
    (
        3,
        39,
    ...
    (5, 1, "Et venerunt universæ tribus Israël ad David in Hebron, dicentes: Ecce nos os tuum et caro tua sumus."),
    (
        5,
        2,
    ...
    (5, 14, "et hæc nomina eorum, qui nati sunt ei in Jerusalem: Samua, et Sobab, et Nathan, et Salomon,"),
    (5, 15, "et Jebahar, et Elisua, et Nepheg,"),
    (5, 16, "et Japhia, et Elisama, et Elioda, et Eliphaleth."),
    (
        5,
        17,
    ...
    (5, 21, "Et reliquerunt ibi sculptilia sua, quæ tulit David et viri ejus."),
    ...
    (6, 1, "Congregavit autem rursum David omnes electos ex Israël, triginta millia."),
    (
        6,
        2,
    ...
    (6, 15, "Et David et omnis domus Israël ducebant arcam testamenti Domini in jubilo, et in clangore buccinæ."),
    (
        6,
        16,
    ...
    (7, 13, "Ipse ædificabit domum nomini meo, et stabiliam thronum regni ejus usque in sempiternum."),
    (
        7,
        14,
    ...
    (7, 17, "Secundum omnia verba hæc, et juxta universam visionem istam, sic locutus est Nathan ad David."),
    (
        7,
        18,
    ...
    (8, 7, "Et tulit David arma aurea quæ habebant servi Adarezer, et detulit ea in Jerusalem."),
    ...
    (8, 15, "Et regnavit David super omnem Israël: faciebat quoque David judicium et justitiam omni populo suo."),
    (8, 16, "Joab autem filius Sarviæ erat super exercitum: porro Josaphat filius Ahilud erat a commentariis:"),
    (8, 17, "et Sadoc filius Achitob, et Achimelech filius Abiathar, erant sacerdotes: et Saraias, scriba:"),
    (8, 18, "Banaias autem filius Jojadæ super Cerethi et Phelethi: filii autem David sacerdotes erant."),
    (
        9,
        1,
    ...
    (10, 1, "Factum est autem post hæc ut moreretur rex filiorum Ammon, et regnavit Hanon filius ejus pro eo."),
    (
        10,
        2,
    ...
    (10, 15, "Videntes igitur Syri quoniam corruissent coram Israël, congregati sunt pariter."),
    (
        10,
        16,
    ...
    (11, 5, "et reversa est domum suam concepto fœtu. Mittensque nuntiavit David, et ait: Concepi."),
    (11, 6, "Misit autem David ad Joab, dicens: Mitte ad me Uriam Hethæum. Misitque Joab Uriam ad David."),
    (
        11,
        7,
    ...
    (11, 14, "Factum est ergo mane, et scripsit David epistolam ad Joab: misitque per manum Uriæ,"),
    (
        11,
        15,
    ...
    (11, 18, "Misit itaque Joab, et nuntiavit David omnia verba prælii:"),
    (11, 19, "præcepitque nuntio, dicens: Cum compleveris universos sermones belli ad regem,"),
    (
        11,
        20,
    ...
    (11, 22, "Abiit ergo nuntius, et venit, et narravit David omnia quæ ei præceperat Joab."),
    (
        11,
        23,
    ...
    (13, 3, "Erat autem Amnon amicus nomine Jonadab, filius Semmaa fratris David, vir prudens valde."),
    (
        13,
        4,
    ...
    (13, 14, "Noluit autem acquiescere precibus ejus, sed prævalens viribus oppressit eam, et cubavit cum ea."),
    (
        13,
        15,
    ...
    (13, 17, "sed vocato puero qui ministrabat ei, dixit: Ejice hanc a me foras, et claude ostium post eam."),
    (
        13,
        18,
    ...
    (13, 35, "Dixit autem Jonadab ad regem: Ecce filii regis adsunt: juxta verbum servi tui, sic factum est."),
    (
        13,
        36,
    ...
    (13, 39, "Cessavitque rex David persequi Absalom, eo quod consolatus esset super Amnon interitu."),
    (14, 1, "Intelligens autem Joab filius Sarviæ quod cor regis versum esset ad Absalom,"),
    (
        14,
        2,
    ...
    (15, 4, "Quis me constituat judicem super terram, ut ad me veniant omnes qui habent negotium, et juste judicem?"),
    (
        15,
        5,
    ...
    (15, 13, "Venit igitur nuntius ad David, dicens: Toto corde universus Israël sequitur Absalom."),
    (
        15,
        14,
    ...
    (15, 17, "Egressusque rex et omnis Israël pedibus suis, stetit procul a domo:"),
    (
        15,
        18,
    ...
    (15, 29, "Reportaverunt ergo Sadoc et Abiathar arcam Dei in Jerusalem, et manserunt ibi."),
    (
        15,
        30,
    ...
    (15, 37, "Veniente ergo Chusai amico David in civitatem, Absalom quoque ingressus est Jerusalem."),
    (
        16,
        1,
    ...
    (17, 4, "Placuitque sermo ejus Absalom, et cunctis majoribus natu Israël."),
    ...
    (17, 24, "David autem venit in castra, et Absalom transivit Jordanem, ipse et omnes viri Israël cum eo."),
    (
        17,
        25,
    ...
    (17, 26, "Et castrametatus est Israël cum Absalom in terra Galaad."),
    (
        17,
        27,
    ...
    (18, 6, "Itaque egressus est populus in campum contra Israël, et factum est prælium in saltu Ephraim."),
    (
        18,
        7,
    ...
    (19, 1, "Nuntiatum est autem Joab quod rex fleret et lugeret filium suum,"),
    (
        19,
        2,
    ...
    (19, 23, "Et ait rex Semei: Non morieris. Juravitque ei."),
    (
        19,
        24,
    ...
    (19, 25, "Cumque Jerusalem occurrisset regi, dixit ei rex: Quare non venisti mecum, Miphiboseth?"),
    (
        19,
        26,
    ...
    (19, 33, "Dixit itaque rex ad Berzellai: Veni mecum, ut requiescas securus mecum in Jerusalem."),
    (19, 34, "Et ait Berzellai ad regem: Quot sunt dies annorum vitæ meæ, ut ascendam cum rege in Jerusalem?"),
    (
        19,
        35,
    ...
    (19, 36, "Paululum procedam famulus tuus ab Jordane tecum: non indigeo hac vicissitudine,"),
    (
        19,
        37,
    ...
    (20, 4, "Dixit autem rex Amasæ: Convoca mihi omnes viros Juda in diem tertium, et tu adesto præsens."),
    ...
    (20, 9, "Dixit itaque Joab ad Amasam: Salve mi frater. Et tenuit manu dextera mentum Amasæ, quasi osculans eum."),
    (
        20,
        10,
    ...
    (20, 20, "Respondensque Joab, ait: Absit, absit hoc a me: non præcipito, neque demolior."),
    (
        20,
        21,
    ...
    (20, 23, "Fuit ergo Joab super omnem exercitum Israël: Banaias autem filius Jojadæ super Cerethæos et Phelethæos:"),
    ...
    (21, 11, "Et nuntiata sunt David quæ fecerat Respha filia Aja, concubina Saul."),
    (
        21,
        12,
    ...
    (21, 13, "et asportavit inde ossa Saul, et ossa Jonathæ filii ejus: et colligentes ossa eorum qui affixi fuerant,"),
    (
        21,
        14,
    ...
    (21, 21, "Et blasphemavit Israël: percussit autem eum Jonathan filius Samaa fratris David."),
    (21, 22, "Hi quatuor nati sunt de Arapha in Geth, et ceciderunt in manu David et servorum ejus."),
    (
        22,
        1,
    ...
    (22, 10, "Inclinavit cælos, et descendit: et caligo sub pedibus ejus."),
    ...
    (22, 13, "Præ fulgore in conspectu ejus, succensi sunt carbones ignis."),
    ...
    (22, 23, "Omnia enim judicia ejus in conspectu meo, et præcepta ejus non amovi a me."),
    ...
    (23, 3, "Dixit Deus Israël mihi, locutus est fortis Israël: Dominator hominum, justus dominator in timore Dei,"),
    ...
    (23, 22, "Hæc fecit Banaias filius Jojadæ."),
    (
        23,
        23,
    ...
    (23, 24, "Asaël frater Joab inter triginta, Elehanan filius patrui ejus de Bethlehem,"),
    ...
    (23, 37, "Selec de Ammoni, Naharai Berothites armiger Joab filii Sarviæ,"),
    ...
    (24, 5, "Cumque pertransissent Jordanem, venerunt in Aroër ad dexteram urbis, quæ est in valle Gad:"),
    (
        24,
        6,
    ...
    (24, 8, "et lustrata universa terra, affuerunt post novem menses et viginti dies in Jerusalem."),
    (
        24,
        9,
    ...
    (24, 19, "Et ascendit David juxta sermonem Gad, quem præceperat ei Dominus."),
