"""Translation: vulgate-clementine · Book: lam
...
VERSES = [
    ...
    (
        2,
        2,
        "Beth Præcipitavit Dominus, nec pepercit omnia speciosa Jacob: destruxit in furore suo munitiones virginis Juda, et dejecit in terram; polluit regnum et principes ejus.",
    ),
    (
        2,
        3,
    ...
    (3, 35, "Lamed Ut declinaret judicium viri in conspectu vultus Altissimi."),
    (3, 36, "Lamed Ut perverteret hominem in judicio suo; Dominus ignoravit."),
    ...
    (3, 58, "Res Judicasti, Domine, causam animæ meæ, redemptor vitæ meæ."),
    ...
    (3, 64, "Thau Redes eis vicem, Domine, juxta opera manuum suarum."),
