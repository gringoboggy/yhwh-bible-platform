"""Translation: vulgate-clementine · Book: ecc
...
VERSES = [
    ...
    (5, 3, "Multas curas sequuntur somnia, et in multis sermonibus invenietur stultitia."),
    (
        5,
        4,
        "Si quid vovisti Deo, ne moreris reddere: displicet enim ei infidelis et stulta promissio, sed quodcumque voveris redde:",
    ),
    (5, 5, "multoque melius est non vovere, quam post votum promissa non reddere."),
    (
        5,
        6,
    ...
    (5, 7, "Ubi multa sunt somnia, plurimæ sunt vanitates, et sermones innumeri; tu vero Deum time.]"),
    (
        5,
        8,
    ...
    (5, 9, "et insuper universæ terræ rex imperat servienti."),
    (5, 10, "Avarus non implebitur pecunia, et qui amat divitias fructum non capiet ex eis; et hoc ergo vanitas."),
    (
        5,
        11,
    ...
    (5, 13, "[Est et alia infirmitas pessima quam vidi sub sole: divitiæ conservatæ in malum domini sui."),
    (5, 14, "Pereunt enim in afflictione pessima: generavit filium qui in summa egestate erit."),
    (5, 15, "Sicut egressus est nudus de utero matris suæ, sic revertetur, et nihil auferet secum de labore suo."),
    (
        5,
        16,
        "Miserabilis prorsus infirmitas: quomodo venit, sic revertetur. Quid ergo prodest ei quod laboravit in ventum?",
    ),
    (5, 17, "cunctis diebus vitæ suæ comedit in tenebris, et in curis multis, et in ærumna atque tristitia.]"),
    (
        5,
        18,
    ...
    (5, 20, "Non enim satis recordabitur dierum vitæ suæ, eo quod Deus occupet deliciis cor ejus.]"),
    ...
    (7, 4, "Cor sapientium ubi tristitia est, et cor stultorum ubi lætitia."),
    ...
    (7, 9, "Ne sis velox ad irascendum, quia ira in sinu stulti requiescit."),
    (
        7,
        10,
    ...
    (7, 16, "Noli esse justus multum, neque plus sapias quam necesse est, ne obstupescas."),
    ...
    (7, 19, "Sapientia confortavit sapientem super decem principes civitatis;"),
    (7, 20, "non est enim homo justus in terra qui faciat bonum et non peccet."),
    (
        7,
        21,
    ...
    (7, 23, "Cuncta tentavi in sapientia. Dixi: Sapiens efficiar: et ipsa longius recessit a me,"),
    ...
    (7, 28, "quam adhuc quærit anima mea, et non inveni. Virum de mille unum reperi; mulierem ex omnibus non inveni."),
    (
        7,
        29,
    ...
    (8, 1, "[Sapientia hominis lucet in vultu ejus, et potentissimus faciem illius commutabit."),
    (8, 2, "Ego os regis observo, et præcepta juramenti Dei."),
    ...
    (8, 7, "quia ignorat præterita, et futura nullo scire potest nuntio."),
    (
        8,
        8,
    ...
    (9, 4, "Nemo est qui semper vivat, et qui hujus rei habeat fiduciam; melior est canis vivus leone mortuo."),
    (
        9,
        5,
    ...
    (12, 14, "et cuncta quæ fiunt adducet Deus in judicium pro omni errato, sive bonum, sive malum illud sit.]"),
]
