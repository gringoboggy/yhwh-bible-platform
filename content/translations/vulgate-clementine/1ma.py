"""Translation: vulgate-clementine · Book: 1ma
...
VERSES = [
    ...
    (
        1,
        4,
        "Et congregavit virtutem, et exercitum fortem nimis: et exaltatum est, et elevatum cor ejus: et obtinuit regiones gentium, et tyrannos: et facti sunt illi in tributum.",
    ),
    ...
    (1, 8, "Et obtinuerunt pueri ejus regnum, unusquisque in loco suo:"),
    (
        1,
        9,
    ...
    (1, 14, "Et ædificaverunt gymnasium in Jerosolymis secundum leges nationum:"),
    (
        1,
        15,
    ...
    (1, 19, "Et comprehendit civitates munitas in terra Ægypti, et accepit spolia terræ Ægypti."),
    (
        1,
        20,
        "Et convertit Antiochus, postquam percussit Ægyptum in centesimo et quadragesimo tertio anno: et ascendit ad Israël, et ascendit Jerosolymam in multitudine gravi.",
    ),
    (
        1,
        21,
    ...
    (1, 24, "Et fecit cædem hominum, et locutus est in superbia magna."),
    (1, 25, "Et factus est planctus magnus in Israël, et in omni loco eorum:"),
    (
        1,
        26,
        "et ingemuerunt principes et seniores; virgines et juvenes infirmati sunt: et speciositas mulierum immutata est.",
    ),
    (1, 27, "Omnis maritus sumpsit lamentum, et quæ sedebant in thoro maritali, lugebant:"),
    (1, 28, "et commota est terra super habitantes in ea, et universa domus Jacob induit confusionem."),
    (
        1,
        29,
    ...
    (
        1,
        30,
        "Et locutus est ad eos verba pacifica in dolo: et crediderunt ei. Et irruit super civitatem repente, et percussit eam plaga magna, et perdidit populum multum ex Israël.",
    ),
    (1, 31, "Et accepit spolia civitatis: et succendit eam igni, et destruxit domos ejus, et muros ejus in circuitu:"),
    ...
    (
        1,
        35,
        "et posuerunt illic gentem peccatricem viros iniquos, et convaluerunt in ea: et posuerunt arma, et escas, et congregaverunt spolia Jerusalem: et reposuerunt illic: et facti sunt in laqueum magnum.",
    ),
    (1, 36, "Et factum est hoc ad insidias sanctificationi, et in diabolum malum in Israël:"),
    ...
    (1, 40, "Secundum gloriam ejus multiplicata est ignominia ejus, et sublimitas ejus conversa est in luctum."),
    (
        1,
        41,
    ...
    (1, 43, "et multi ex Israël consenserunt servituti ejus, et sacrificaverunt idolis, et coinquinaverunt sabbatum."),
    (
        1,
        44,
    ...
    (
        1,
        45,
        "et prohiberent holocausta et sacrificia, et placationes fieri in templo Dei, et prohiberent celebrari sabbatum, et dies solemnes:",
    ),
    (1, 46, "et jussit coinquinari sancta, et sanctum populum Israël."),
    (1, 47, "Et jussit ædificari aras, et templa, et idola, et immolari carnes suillas, et pecora communia,"),
    (
        1,
        48,
    ...
    (1, 50, "et quicumque non fecissent secundum verbum regis Antiochi, morerentur."),
    (
        1,
        51,
        "Secundum omnia verba hæc scripsit omni regno suo: et præposuit principes populo, qui hæc fieri cogerent. Et jusserunt civitatibus Juda sacrificare.",
    ),
    (1, 52, "Et congregati sunt multi de populo ad eos qui dereliquerant legem Domini, et fecerunt mala super terram:"),
    (1, 53, "et effugaverunt populum Israël in abditis, et in absconditis fugitivorum locis."),
    (
        1,
        54,
    ...
    (1, 55, "et ante januas domorum et in plateis incendebant thura, et sacrificabant:"),
    (1, 56, "et libros legis Dei combusserunt igni, scindentes eos:"),
    (
        1,
        57,
    ...
    (1, 58, "In virtute sua faciebant hæc populo Israël, qui inveniebatur in omni mense et mense in civitatibus."),
    (1, 59, "Et quinta et vigesima die mensis sacrificabant super aram, quæ erat contra altare."),
    (1, 60, "Et mulieres, quæ circumcidebant filios suos, trucidabantur secundum jussum regis Antiochi,"),
    (
        1,
        61,
    ...
    (3, 1, "Et surrexit Judas, qui vocabatur Machabæus, filius ejus, pro eo:"),
    (
        3,
        2,
    ...
    (3, 8, "Et perambulavit civitates Juda, et perdidit impios ex eis, et avertit iram ab Israël."),
    (3, 9, "Et nominatus est usque ad novissimum terræ, et congregavit pereuntes.]"),
    (3, 10, "Et congregavit Apollonius gentes, et a Samaria virtutem multam et magnam ad bellandum contra Israël."),
    (
        3,
        11,
        "Et cognovit Judas, et exiit obviam illi: et percussit, et occidit illum: et ceciderunt vulnerati multi, et reliqui fugerunt.",
    ),
    (3, 12, "Et accepit spolia eorum: et gladium Apollonii abstulit Judas, et erat pugnans in eo omnibus diebus."),
    (
        3,
        13,
    ...
    (3, 16, "Et appropinquaverunt usque ad Bethoron: et exivit Judas obviam illi cum paucis."),
    (
        3,
        17,
    ...
    (3, 25, "Et cecidit timor Judæ ac fratrum ejus, et formido super omnes gentes in circuitu eorum:"),
    (3, 26, "et pervenit ad regem nomen ejus, et de præliis Judæ narrabant omnes gentes."),
    (
        3,
        27,
    ...
    (3, 53, "Quomodo poterimus subsistere ante faciem eorum, nisi tu, Deus, adjuves nos?"),
    (3, 54, "Et tubis exclamaverunt voce magna."),
    (3, 55, "Et post hæc constituit Judas duces populi, tribunos, et centuriones, et pentacontarchos, et decuriones."),
    (
        3,
        56,
    ...
    (4, 11, "et scient omnes gentes quia est qui redimat et liberet Israël."),
    (4, 12, "Et elevaverunt alienigenæ oculos suos, et viderunt eos venientes ex adverso."),
    (4, 13, "Et exierunt de castris in prælium, et tuba cecinerunt hi qui erant cum Juda."),
    ...
    (4, 19, "Et adhuc loquente Juda hæc, ecce apparuit pars quædam prospiciens de monte."),
    (
        4,
        20,
    ...
    (4, 25, "Et facta est salus magna in Israël in die illa."),
    ...
    (4, 31, "Conclude exercitum istum in manu populi tui Israël, et confundantur in exercitu suo et equitibus."),
    ...
    (5, 2, "et cogitabant tollere genus Jacob, qui erant inter eos, et cœperunt occidere de populo, et persequi."),
    (
        5,
        3,
    ...
    (5, 8, "et cepit Gazer civitatem et filias ejus, et reversus est in Judæam."),
    (
        5,
        9,
    ...
    (5, 20, "Et partiti sunt Simoni viri tria millia, ut iret in Galilæam: Judæ autem octo millia in Galaaditim."),
    (
        5,
        21,
    ...
    (5, 49, "Et præcepit Judas prædicare in castris, ut applicarent unusquisque in quo erat loco:"),
    (
        5,
        50,
    ...
    (5, 58, "Et præcepit his qui erant in exercitu suo, et abierunt Jamniam."),
    ...
    (5, 62, "Ipsi autem non erant de semine virorum illorum, per quos salus facta est in Israël."),
    (
        5,
        63,
    ...
    (6, 5, "Et venit qui nuntiaret ei in Perside, quia fugata sunt castra quæ erant in terra Juda:"),
    (
        6,
        6,
    ...
    (6, 21, "Et exierunt quidam ex eis qui obsidebantur: et adjunxerunt se illis aliqui impii ex Israël,"),
    (6, 22, "et abierunt ad regem, et dixerunt: Quousque non facis judicium, et vindicas fratres nostros?"),
    (6, 23, "Nos decrevimus servire patri tuo, et ambulare in præceptis ejus, et obsequi edictis ejus:"),
    (
        6,
        24,
    ...
    (6, 27, "et nisi præveneris eos velocius, majora quam hæc facient, et non poteris obtinere eos."),
    (
        6,
        28,
    ...
    (6, 42, "Et appropiavit Judas et exercitus ejus in prælium, et ceciderunt de exercitu regis sexcenti viri."),
    (
        6,
        43,
    ...
    (7, 5, "Et venerunt ad eum viri iniqui et impii ex Israël: et Alcimus dux eorum, qui volebat fieri sacerdos."),
    (
        7,
        6,
    ...
    (7, 12, "Et convenerunt ad Alcimum et Bacchidem congregatio scribarum requirere quæ justa sunt:"),
    (7, 13, "et primi, Assidæi qui erant in filiis Israël: et exquirebant ab eis pacem."),
    ...
    (7, 23, "Et vidit Judas omnia mala quæ fecit Alcimus et qui cum eo erant filiis Israël, multo plus quam gentes:"),
    (
        7,
        24,
    ...
    (7, 29, "Et venit ad Judam, et salutaverunt se invicem pacifice: et hostes parati erant rapere Judam."),
    (
        7,
        30,
    ...
    (7, 39, "Et exiit Nicanor ab Jerusalem, et castra applicuit ad Bethoron: et occurrit illi exercitus Syriæ."),
    (7, 40, "Et Judas applicuit in Adarsa cum tribus millibus viris: et oravit Judas, et dixit:"),
    (
        7,
        41,
    ...
    (7, 44, "Ut autem vidit exercitus ejus quia cecidisset Nicanor, projecerunt arma sua, et fugerunt:"),
    (
        7,
        45,
    ...
    (7, 50, "Et siluit terra Juda dies paucos."),
    (
        8,
        1,
    ...
    (8, 18, "et ut auferrent ab eis jugum Græcorum, quia viderunt quod in servitutem premerent regnum Israël."),
    ...
    (8, 25, "auxilium feret gens Judæorum, prout tempus dictaverit, corde pleno:"),
    (
        8,
        26,
    ...
    (8, 29, "secundum hæc verba constituerunt Romani populo Judæorum."),
    (
        8,
        30,
    ...
    (8, 32, "si ergo iterum adierint nos, adversum te faciemus illis judicium, et pugnabimus tecum mari terraque."),
    (
        9,
        1,
    ...
    (9, 20, "Et fleverunt eum omnis populus Israël planctu magno, et lugebant dies multos,"),
    (9, 21, "et dixerunt: Quomodo cecidit potens, qui salvum faciebat populum Israël !"),
    (
        9,
        22,
    ...
    (9, 27, "Et facta est tribulatio magna in Israël, qualis non fuit ex die qua non est visus propheta in Israël."),
    (9, 28, "Et congregati sunt omnes amici Judæ, et dixerunt Jonathæ:"),
    (
        9,
        29,
    ...
    (9, 31, "Et suscepit Jonathas tempore illo principatum, et surrexit loco Judæ fratris sui."),
    ...
    (9, 51, "Et posuit custodiam in eis, ut inimicitias exercerent in Israël:"),
    ...
    (10, 5, "recordabitur enim omnium malorum, quæ fecimus in eum, et in fratrem ejus, et in gentem ejus."),
    (
        10,
        6,
    ...
    (10, 9, "Et traditi sunt Jonathæ obsides, et reddidit eos parentibus suis:"),
    (10, 10, "et habitavit Jonathas in Jerusalem, et cœpit ædificare et innovare civitatem."),
    (
        10,
        11,
    ...
    (10, 18, "Rex Alexander fratri Jonathæ salutem."),
    ...
    (10, 23, "Quid hoc fecimus, quod præoccupavit nos Alexander apprehendere amicitiam Judæorum ad munimen sui?"),
    (10, 24, "scribam et ego illis verba deprecatoria, et dignitates, et dona, ut sint mecum in adjutorium."),
    (10, 25, "Et scripsit eis in hæc verba: Rex Demetrius genti Judæorum salutem."),
    (
        10,
        26,
    ...
    (10, 31, "et Jerusalem sit sancta, et libera cum finibus suis: et decimæ et tributa ipsius sint."),
    (
        10,
        32,
    ...
    (10, 59, "Et scripsit rex Alexander Jonathæ, ut veniret obviam sibi."),
    (
        10,
        60,
    ...
    (10, 66, "Et reversus est Jonathas in Jerusalem cum pace et lætitia."),
    ...
    (10, 81, "Populus autem stabat, sicut præceperat Jonathas: et laboraverunt equi eorum."),
    (
        10,
        82,
    ...
    (11, 5, "Et narraverunt regi quia hæc fecit Jonathas, ut invidiam facerent ei: et tacuit rex."),
    ...
    (11, 29, "Et consensit rex: et scripsit Jonathæ epistolas de his omnibus, hunc modum continentes:"),
    (11, 30, "Rex Demetrius fratri Jonathæ salutem, et genti Judæorum."),
    ...
    (11, 37, "Nunc ergo curate facere horum exemplum, et detur Jonathæ, et ponatur in monte sancto, in loco celebri."),
    (
        11,
        38,
    ...
    (11, 50, "Da nobis dextras, et cessent Judæi oppugnare nos, et civitatem."),
    (
        11,
        51,
    ...
    (11, 59, "et Simonem fratrem ejus constituit ducem a terminis Tyri usque ad fines Ægypti."),
    (
        11,
        60,
    ...
    (11, 72, "Et reversus est Jonathas ad eos in prælium, et convertit eos in fugam, et pugnaverunt."),
    (
        11,
        73,
    ...
    (12, 31, "Et divertit Jonathas ad Arabas, qui vocantur Zabadæi: et percussit eos, et accepit spolia eorum."),
    ...
    (12, 41, "Et exivit Jonathas obviam illi cum quadraginta millibus virorum electorum in prælium, et venit Bethsan."),
    ...
    (12, 44, "Et dixit Jonathæ: Ut quid vexasti universum populum, cum bellum nobis non sit?"),
    (
        12,
        45,
    ...
    (
        12,
        53,
        "Et quæsierunt omnes gentes quæ erant in circuitu eorum conterere eos: dixerunt enim: Non habent principem et adjuvantem: nunc ergo expugnemus illos, et tollamus de hominibus memoriam eorum.",
    ),
    (
        13,
        1,
    ...
    (13, 4, "horum gratia perierunt fratres mei omnes propter Israël, et relictus sum ego solus."),
    (
        13,
        5,
    ...
    (13, 8, "et responderunt voce magna, dicentes: Tu es dux noster loco Judæ, et Jonathæ fratris tui:"),
    ...
    (13, 25, "Et misit Simon, et accepit ossa Jonathæ fratris sui, et sepelivit ea in Modin civitate patrum ejus."),
    (13, 26, "Et planxerunt eum omnis Israël planctu magno, et luxerunt eum dies multos."),
    (
        13,
        27,
    ...
    (13, 32, "et regnavit loco ejus, et imposuit sibi diadema Asiæ, et fecit plagam magnam in terra."),
    (
        13,
        33,
    ...
    (13, 36, "Rex Demetrius Simoni summo sacerdoti et amico regum, et senioribus, et genti Judæorum, salutem."),
    (
        13,
        37,
    ...
    (13, 41, "Anno centesimo septuagesimo, ablatum est jugum gentium ab Israël."),
    (
        13,
        42,
    ...
    (
        13,
        52,
        "Et constituit ut omnibus annis agerentur dies hi cum lætitia. Et munivit montem templi, qui erat secus arcem, et habitavit ibi ipse, et qui cum eo erant.",
    ),
    (
        13,
        53,
    ...
    (14, 11, "Fecit pacem super terram, et lætatus est Israël lætitia magna."),
    ...
    (14, 16, "Et auditum est Romæ quia defunctus esset Jonathas, et usque in Spartiatas: et contristati sunt valde."),
    (
        14,
        17,
    ...
    (14, 19, "Et lectæ sunt in conspectu ecclesiæ in Jerusalem. Et hoc exemplum epistolarum, quas Spartiatæ miserunt:"),
    (
        14,
        20,
    ...
    (14, 37, "et collocavit in ea viros Judæos ad tutamentum regionis, et civitatis, et exaltavit muros Jerusalem."),
    ...
    (14, 49, "exemplum autem eorum ponere in ærario, ut habeat Simon, et filii ejus."),
    (
        15,
        1,
    ...
    (15, 2, "et erant continentes hunc modum: Rex Antiochus Simoni sacerdoti magno, et genti Judæorum salutem."),
    (
        15,
        3,
    ...
    (15, 24, "Exemplum autem eorum scripserunt Simoni principi sacerdotum, et populo Judæorum."),
    (
        15,
        25,
    ...
    (15, 34, "Nos vero tempus habentes, vindicamus hæreditatem patrum nostrorum."),
    (
        15,
        35,
    ...
    (15, 41, "Et collocavit illic equites et exercitum, ut egressi perambularent viam Judææ, sicut constituit ei rex."),
    (16, 1, "Et ascendit Joannes de Gazaris, et nuntiavit Simoni patri suo quæ fecit Cendebæus in populo ipsorum."),
    (
        16,
        2,
    ...
    (16, 11, "Et Ptolemæus filius Abobi constitutus erat dux in campo Jericho, et habebat argentum et aurum multum:"),
    ...
    (16, 17, "et fecit deceptionem magnam in Israël, et reddidit mala pro bonis."),
    (
        16,
        18,
    ...
    (16, 20, "Et alios misit occupare Jerusalem et montem templi."),
    (
        16,
        21,
