"""Translation: vulgate-clementine · Book: gen
...
VERSES = [
    ...
    (2, 18, "Dixit quoque Dominus Deus: Non est bonum esse hominem solum: faciamus ei adjutorium simile sibi."),
    (
        2,
        19,
    ...
    (2, 25, "Erat autem uterque nudus, Adam scilicet et uxor ejus: et non erubescebant."),
    (
        3,
        1,
    ...
    (3, 21, "Fecit quoque Dominus Deus Adæ et uxori ejus tunicas pelliceas, et induit eos:"),
    (
        3,
        22,
    ...
    (4, 2, "Rursumque peperit fratrem ejus Abel. Fuit autem Abel pastor ovium, et Cain agricola."),
    ...
    (4, 5, "Ad Cain vero, et ad munera illius non respexit: iratusque est Cain vehementer, et concidit vultus ejus."),
    ...
    (4, 13, "Dixitque Cain ad Dominum: Major est iniquitas mea, quam ut veniam merear."),
    (
        4,
        14,
    ...
    (4, 20, "Genuitque Ada Jabel, qui fuit pater habitantium in tentoriis, atque pastorum."),
    (4, 21, "Et nomen fratris ejus Jubal: ipse fuit pater canentium cithara et organo."),
    (
        4,
        22,
    ...
    (6, 8, "Noë vero invenit gratiam coram Domino."),
    (6, 9, "Hæ sunt generationes Noë: Noë vir justus atque perfectus fuit in generationibus suis; cum Deo ambulavit."),
    (6, 10, "Et genuit tres filios, Sem, Cham et Japheth."),
    ...
    (7, 5, "Fecit ergo Noë omnia quæ mandaverat ei Dominus."),
    ...
    (7, 9, "duo et duo ingressa sunt ad Noë in arcam, masculus et femina, sicut præceperat Dominus Noë."),
    ...
    (7, 15, "ingressæ sunt ad Noë in arcam, bina et bina ex omni carne, in qua erat spiritus vitæ."),
    (
        7,
        16,
    ...
    (8, 6, "Cumque transissent quadraginta dies, aperiens Noë fenestram arcæ, quam fecerat, dimisit corvum,"),
    (8, 7, "qui egrediebatur, et non revertebatur, donec siccarentur aquæ super terram."),
    (8, 8, "Emisit quoque columbam post eum, ut videret si jam cessassent aquæ super faciem terræ."),
    (
        8,
        9,
    ...
    (8, 15, "Locutus est autem Deus ad Noë, dicens:"),
    ...
    (8, 18, "Egressus est ergo Noë, et filii ejus: uxor illius, et uxores filiorum ejus cum eo."),
    (
        8,
        19,
    ...
    (19, 37, "Peperitque major filium, et vocavit nomen ejus Moab: ipse est pater Moabitarum usque in præsentem diem."),
    (
        19,
        38,
    ...
    (20, 4, "Abimelech vero non tetigerat eam, et ait: Domine, num gentem ignorantem et justam interficies?"),
    (
        20,
        5,
    ...
    (20, 17, "Orante autem Abraham, sanavit Deus Abimelech et uxorem, ancillasque ejus, et pepererunt:"),
    ...
    (23, 4, "Advena sum et peregrinus apud vos: date mihi jus sepulchri vobiscum, ut sepeliam mortuum meum."),
    ...
    (24, 8, "sin autem mulier noluerit sequi te, non teneberis juramento: filium meum tantum ne reducas illuc."),
    (24, 9, "Posuit ergo servus manum sub femore Abraham domini sui, et juravit illi super sermone hoc."),
    (
        24,
        10,
    ...
    (24, 13, "Ecce ego sto prope fontem aquæ, et filiæ habitatorum hujus civitatis egredientur ad hauriendam aquam."),
    (
        24,
        14,
    ...
    (24, 19, "Cumque ille bibisset, adjecit: Quin et camelis tuis hauriam aquam, donec cuncti bibant."),
    (
        24,
        20,
    ...
    (24, 23, "Dixitque ad eam: Cujus es filia? indica mihi, est in domo patris tui locus ad manendum?"),
    ...
    (24, 28, "Cucurrit itaque puella, et nuntiavit in domum matris suæ omnia quæ audierat."),
    ...
    (24, 59, "Dimiserunt ergo eam, et nutricem illius, servumque Abraham, et comites ejus,"),
    (
        24,
        60,
    ...
    (27, 16, "pelliculasque hædorum circumdedit manibus, et colli nuda protexit:"),
    ...
    (27, 23, "Et non cognovit eum, quia pilosæ manus similitudinem majoris expresserant. Benedicens ergo illi,"),
    ...
    (29, 1, "Profectus ergo Jacob venit in terram orientalem."),
    (
        29,
        2,
    ...
    (29, 6, "Sanusne est? inquit. Valet, inquiunt: et ecce Rachel filia ejus venit cum grege suo."),
    (
        29,
        7,
    ...
    (29, 12, "et indicavit ei quod frater esset patris sui, et filius Rebeccæ: at illa festinans nuntiavit patri suo."),
    (
        29,
        13,
    ...
    (29, 16, "Habebat vero duas filias: nomen majoris Lia, minor vero appellabatur Rachel."),
    (29, 17, "Sed Lia lippis erat oculis: Rachel decora facie, et venusto aspectu."),
    (29, 18, "Quam diligens Jacob, ait: Serviam tibi pro Rachel filia tua minore, septem annis."),
    (29, 19, "Respondit Laban: Melius est ut tibi eam dem quam alteri viro: mane apud me."),
    (29, 20, "Servivit ergo Jacob pro Rachel septem annis: et videbantur illi pauci dies præ amoris magnitudine."),
    (29, 21, "Dixitque ad Laban: Da mihi uxorem meam: quia jam tempus impletum est, ut ingrediar ad illam."),
    ...
    (29, 31, "Videns autem Dominus quod despiceret Liam, aperuit vulvam ejus, sorore sterili permanente."),
    (
        29,
        32,
    ...
    (30, 4, "Deditque illi Balam in conjugium: quæ,"),
    ...
    (31, 11, "Dixitque angelus Dei ad me in somnis: Jacob? Et ego respondi: Adsum."),
    (
        31,
        12,
    ...
    (31, 17, "Surrexit itaque Jacob, et impositis liberis ac conjugibus suis super camelos, abiit."),
    (
        31,
        18,
    ...
    (31, 26, "Et dixit ad Jacob: Quare ita egisti, ut clam me abigeres filias meas quasi captivas gladio?"),
    (
        31,
        27,
    ...
    (31, 31, "Respondit Jacob: Quod inscio te profectus sum, timui ne violenter auferres filias tuas."),
    (
        31,
        32,
    ...
    (31, 36, "Tumensque Jacob, cum jurgio ait: Quam ob culpam meam, et ob quod peccatum meum sic exarsisti post me,"),
    (
        31,
        37,
    ...
    (31, 45, "Tulit itaque Jacob lapidem, et erexit illum in titulum:"),
    (31, 46, "dixitque fratribus suis: Afferte lapides. Qui congregantes fecerunt tumulum, comederuntque super eum:"),
    (31, 47, "quem vocavit Laban Tumulum testis: et Jacob, Acervum testimonii, uterque juxta proprietatem linguæ suæ."),
    (
        31,
        48,
    ...
    (31, 49, "Intueatur et judicet Dominus inter nos quando recesserimus a nobis,"),
    (
        31,
        50,
    ...
    (33, 20, "Et erecto ibi altari, invocavit super illud fortissimum Deum Israël."),
    ...
    (34, 13, "Responderunt filii Jacob Sichem et patri ejus in dolo, sævientes ob stuprum sororis:"),
    (
        34,
        14,
    ...
    (35, 6, "Venit igitur Jacob Luzam, quæ est in terra Chanaan, cognomento Bethel: ipse et omnis populus cum eo."),
    (
        35,
        7,
    ...
    (35, 9, "Apparuit autem iterum Deus Jacob postquam reversus est de Mesopotamia Syriæ, benedixitque ei"),
    (35, 10, "dicens: Non vocaberis ultra Jacob, sed Israël erit nomen tuum. Et appellavit eum Israël,"),
    (
        35,
        11,
    ...
    (35, 23, "Filii Liæ: primogenitus Ruben, et Simeon, et Levi, et Judas, et Issachar, et Zabulon."),
    (35, 24, "Filii Rachel: Joseph et Benjamin."),
    (35, 25, "Filii Balæ ancillæ Rachelis: Dan et Nephthali."),
    (35, 26, "Filii Zelphæ ancillæ Liæ: Gad et Aser: hi sunt filii Jacob, qui nati sunt ei in Mesopotamia Syriæ."),
    (
        35,
        27,
    ...
    (38, 3, "Quæ concepit, et peperit filium, et vocavit nomen ejus Her."),
    ...
    (38, 7, "Fuit quoque Her primogenitus Judæ nequam in conspectu Domini: et ab eo occisus est."),
    (
        38,
        8,
    ...
    (40, 12, "Respondit Joseph: Hæc est interpretatio somnii: tres propagines, tres adhuc dies sunt:"),
    (
        40,
        13,
    ...
    (40, 18, "Respondit Joseph: Hæc est interpretatio somnii: tria canistra, tres adhuc dies sunt:"),
    ...
    (42, 1, "Audiens autem Jacob quod alimenta venderentur in Ægypto, dixit filiis suis: Quare negligitis?"),
    (
        42,
        2,
    ...
    (42, 3, "Descendentes igitur fratres Joseph decem, ut emerent frumenta in Ægypto,"),
    ...
    (42, 12, "Quibus ille respondit: Aliter est: immunita terræ hujus considerare venistis."),
    (
        42,
        13,
    ...
    (43, 6, "Dixit eis Israël: In meam hoc fecistis miseriam, ut indicaretis ei et alium habere vos fratrem."),
    (
        43,
        7,
    ...
    (43, 10, "Si non intercessisset dilatio, jam vice alter venissemus."),
    (
        43,
        11,
    ...
    (43, 20, "locuti sunt: Oramus, domine, ut audias nos. Jam ante descendimus ut emeremus escas:"),
    (
        43,
        21,
    ...
    (45, 25, "Qui ascendentes ex Ægypto, venerunt in terram Chanaan ad patrem suum Jacob."),
    (
        45,
        26,
    ...
    (46, 7, "filii ejus, et nepotes, filiæ, et cuncta simul progenies."),
    (
        46,
        8,
    ...
    (46, 18, "Hi filii Zelphæ, quam dedit Laban Liæ filiæ suæ: et hos genuit Jacob sedecim animas."),
    ...
    (46, 22, "Hi filii Rachel quos genuit Jacob: omnes animæ, quatuordecim."),
    (46, 23, "Filii Dan: Husim."),
    (46, 24, "Filii Nephthali: Jasiel et Guni et Jeser et Sallem."),
    (46, 25, "Hi filii Balæ, quam dedit Laban Racheli filiæ suæ: et hos genuit Jacob: omnes animæ, septem."),
    (
        46,
        26,
    ...
    (46, 30, "Dixitque pater ad Joseph: Jam lætus moriar, quia vidi faciem tuam, et superstitem te relinquo."),
    (
        46,
        31,
    ...
    (47, 5, "Dixit itaque rex ad Joseph: Pater tuus et fratres tui venerunt ad te."),
    (
        47,
        6,
    ...
    (47, 7, "Post hæc introduxit Joseph patrem suum ad regem, et statuit eum coram eo: qui benedicens illi,"),
    ...
    (47, 21, "et cunctos populos ejus a novissimis terminis Ægypti usque ad extremos fines ejus,"),
    (
        47,
        22,
    ...
    (47, 31, "Et ille: Jura ergo, inquit, mihi. Quo jurante, adoravit Israël Deum, conversus ad lectuli caput."),
    (
        48,
        1,
    ...
    (49, 2, "[Congregamini, et audite, filii Jacob, audite Israël patrem vestrum:"),
    ...
    (49, 16, "Dan judicabit populum suum sicut et alia tribus in Israël."),
    ...
    (49, 20, "Aser, pinguis panis ejus, et præbebit delicias regibus."),
    (49, 21, "Nephthali, cervus emissus, et dans eloquia pulchritudinis."),
    (49, 22, "Filius accrescens Joseph, filius accrescens et decorus aspectu: filiæ discurrerunt super murum."),
    ...
    (49, 27, "Benjamin lupus rapax, mane comedat prædam, et vespere dividet spolia.]"),
    (
        49,
        28,
    ...
    (50, 25, "Cumque adjurasset eos atque dixisset: Deus visitabit vos, asportate ossa mea vobiscum de loco isto:"),
    (
        50,
        26,
