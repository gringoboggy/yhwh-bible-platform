"""Translation: vulgate-clementine · Book: 2pe
...
VERSES = [
    ...
    (3, 13, "Novos vero cælos, et novam terram secundum promissa ipsius exspectamus, in quibus justitia habitat."),
    (3, 14, "Propter quod, carissimi, hæc exspectantes, satagite immaculati, et inviolati ei inveniri in pace:"),
    (
        3,
        15,
