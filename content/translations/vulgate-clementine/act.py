"""Translation: vulgate-clementine · Book: act
...
BOOK = "act"
VERSES = [
    (1, 1, "Primum quidem sermonem feci de omnibus, o Theophile, quæ cœpit Jesus facere et docere"),
    ...
    (1, 6, "Igitur qui convenerant, interrogabant eum, dicentes: Domine, si in tempore hoc restitues regnum Israël?"),
    ...
    (2, 16, "sed hoc est quod dictum est per prophetam Joël:"),
    (
        2,
        17,
    ...
    (5, 35, "dixitque ad illos: Viri Israëlitæ, attendite vobis super hominibus istis quid acturi sitis."),
    (
        5,
        36,
    ...
    (7, 59, "Et lapidabant Stephanum invocantem, et dicentem: Domine Jesu, suscipe spiritum meum."),
    (
        7,
        60,
    ...
    (
        8,
        7,
        "Multi enim eorum qui habebant spiritus immundos, clamantes voce magna exibant. Multi autem paralytici et claudi curati sunt. Factum est ergo gaudium magnum in illa civitate.",
    ),
    (
        8,
        9,
    ...
    (9, 12, "(Et vidit virum Ananiam nomine, introëuntem, et imponentem sibi manus ut visum recipiat.)"),
    (
        9,
        13,
    ...
    (13, 16, "Surgens autem Paulus, et manu silentium indicens, ait: Viri Israëlitæ, et qui timetis Deum, audite:"),
    (
        13,
        17,
    ...
    (13, 23, "Hujus Deus ex semine secundum promissionem eduxit Israël salvatorem Jesum,"),
    (13, 24, "prædicante Joanne ante faciem adventus ejus baptismum pœnitentiæ omni populo Israël."),
    (
        13,
        25,
    ...
    (14, 8, "Et quidam vir Lystris infirmus pedibus sedebat, claudus ex utero matris suæ, qui numquam ambulaverat."),
    (14, 9, "Hic audivit Paulum loquentem. Qui intuitus eum, et videns quia fidem haberet ut salvus fieret,"),
    (14, 10, "dixit magna voce: Surge super pedes tuos rectus. Et exilivit, et ambulabat."),
    (
        14,
        11,
    ...
    (14, 12, "Et vocabant Barnabam Jovem, Paulum vero Mercurium: quoniam ipse erat dux verbi."),
    (
        14,
        13,
    ...
    (14, 16, "qui in præteritis generationibus dimisit omnes gentes ingredi vias suas."),
    (
        14,
        17,
    ...
    (14, 18, "Et hæc dicentes, vix sedaverunt turbas ne sibi immolarent."),
    (
        14,
        19,
    ...
    (14, 24, "Transeuntesque Pisidiam, venerunt in Pamphyliam,"),
    (14, 25, "et loquentes verbum Domini in Perge, descenderunt in Attaliam:"),
    (14, 26, "et inde navigaverunt Antiochiam, unde erant traditi gratiæ Dei in opus quod compleverunt."),
    (
        14,
        27,
    ...
    (14, 28, "Morati sunt autem tempus non modicum cum discipulis."),
    (
        15,
        1,
    ...
    (15, 30, "Illi ergo dimissi, descenderunt Antiochiam: et congregata multitudine tradiderunt epistolam."),
    ...
    (20, 21, "testificans Judæis atque gentilibus in Deum pœnitentiam, et fidem in Dominum nostrum Jesum Christum."),
    ...
    (20, 30, "Et ex vobisipsis exsurgent viri loquentes perversa, ut abducant discipulos post se."),
    (
        20,
        31,
