"""Translation: vulgate-clementine · Book: bar
...
VERSES = [
    ...
    (2, 3, "et manducaret homo carnes filii sui et carnes filiæ suæ."),
    (
        2,
        4,
    ...
    (2, 6, "Domino Deo nostro justitia, nobis autem et patribus nostris confusio faciei, sicut est dies hæc:"),
    ...
    (2, 12, "peccavimus, impie egimus, inique gessimus, Domine Deus noster, in omnibus justitiis tuis."),
    ...
    (3, 1, "[Et nunc, Domine omnipotens, Deus Israël, anima in angustiis, et spiritus anxius clamat ad te."),
    ...
    (3, 10, "Quid est, Israël, quod in terra inimicorum es,"),
    ...
    (3, 20, "Juvenes viderunt lumen, et habitaverunt super terram, viam autem disciplinæ ignoraverunt,"),
    ...
    (3, 24, "O Israël, quam magna est domus Dei, et ingens locus possessionis ejus !"),
    ...
    (
        3,
        34,
        "Stellæ autem dederunt lumen in custodiis suis, et lætatæ sunt: vocatæ sunt, et dixerunt: Adsumus, et luxerunt ei cum jucunditate, qui fecit illas.",
    ),
    (3, 35, "Hic est Deus noster, et non æstimabitur alius adversus eum."),
    (3, 36, "Hic adinvenit omnem viam disciplinæ, et tradidit illam Jacob puero suo, et Israël dilecto suo."),
    (3, 37, "Post hæc in terris visus est, et cum hominibus conversatus est.]"),
    (
        4,
        1,
    ...
    (4, 4, "Beati sumus, Israël, quia quæ Deo placent manifesta sunt nobis.]"),
    (4, 5, "[Animæquior esto, populus Dei, memorabilis Israël:"),
    (
        4,
        6,
    ...
    (4, 30, "[Animæquior esto, Jerusalem: exhortatur enim te, qui te nominavit."),
    ...
    (5, 2, "Circumdabit te Deus diploide justitiæ, et imponet mitram capiti honoris æterni."),
    (5, 3, "Deus enim ostendet splendorem suum in te, omni qui sub cælo est."),
    (5, 4, "Nominabitur enim tibi nomen tuum a Deo in sempiternum: pax justitiæ, et honor pietatis."),
    (
        5,
        5,
    ...
    (5, 8, "Obumbraverunt autem et silvæ, et omne lignum suavitatis Israël ex mandato Dei."),
    (
        5,
        9,
