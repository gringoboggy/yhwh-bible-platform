"""Translation: vulgate-clementine · Book: rom
...
VERSES = [
    ...
    (2, 9, "Tribulatio et angustia in omnem animam hominis operantis malum, Judæi primum, et Græci:"),
    (2, 10, "gloria autem, et honor, et pax omni operanti bonum, Judæo primum, et Græco:"),
    ...
    (2, 17, "Si autem tu Judæus cognominaris, et requiescis in lege, et gloriaris in Deo,"),
    ...
    (2, 26, "Si igitur præputium justitias legis custodiat, nonne præputium illius in circumcisionem reputabitur?"),
    (
        2,
        27,
    ...
    (2, 28, "Non enim qui in manifesto, Judæus est: neque quæ in manifesto, in carne, est circumcisio:"),
    (
        2,
        29,
        "sed qui in abscondito, Judæus est: et circumcisio cordis in spiritu, non littera: cujus laus non ex hominibus, sed ex Deo est.",
    ),
    (3, 1, "Quid ergo amplius Judæo est? aut quæ utilitas circumcisionis?"),
    ...
    (3, 6, "secundum hominem dico. Absit. Alioquin quomodo judicabit Deus hunc mundum?"),
    (
        3,
        7,
    ...
    (3, 9, "Quid ergo? præcellimus eos? Nequaquam. Causati enim sumus Judæos et Græcos omnes sub peccato esse,"),
    (3, 10, "sicut scriptum est: [Quia non est justus quisquam:"),
    ...
    (3, 20, "quia ex operibus legis non justificabitur omnis caro coram illo. Per legem enim cognitio peccati."),
    ...
    (4, 3, "Quid enim dicit Scriptura? Credidit Abraham Deo, et reputatam est illi ad justitiam."),
    ...
    (4, 13, "Non enim per legem promissio Abrahæ, aut semini ejus ut hæres esset mundi: sed per justitiam fidei."),
    (4, 14, "Si enim qui ex lege, hæredes sunt: exinanita est fides, abolita est promissio."),
    ...
    (5, 1, "Justificati ergo ex fide, pacem habeamus ad Deum per Dominum nostrum Jesum Christum:"),
    (
        5,
        2,
    ...
    (5, 8, "Commendat autem caritatem suam Deus in nobis: quoniam cum adhuc peccatores essemus, secundum tempus,"),
    (
        5,
        9,
    ...
    (6, 18, "Liberati autem a peccato, servi facti estis justitiæ."),
    (
        6,
        19,
    ...
    (6, 20, "Cum enim servi essetis peccati, liberi fuistis justitiæ."),
    ...
    (6, 23, "Stipendia enim peccati, mors. Gratia autem Dei, vita æterna, in Christo Jesu Domino nostro."),
    ...
    (7, 12, "Itaque lex quidem sancta, et mandatum sanctum, et justum, et bonum."),
    (
        7,
        13,
    ...
    (7, 17, "Nunc autem jam non ego operor illud, sed quod habitat in me peccatum."),
    (
        7,
        18,
    ...
    (7, 20, "Si autem quod nolo, illud facio: jam non ego operor illud, sed quod habitat in me, peccatum."),
    (7, 21, "Invenio igitur legem, volenti mihi facere bonum, quoniam mihi malum adjacet:"),
    ...
    (7, 24, "Infelix ego homo, quis me liberabit de corpore mortis hujus?"),
    (
        7,
        25,
    ...
    (8, 2, "Lex enim spiritus vitæ in Christo Jesu liberavit me a lege peccati et mortis."),
    (
        8,
        3,
    ...
    (8, 4, "ut justificatio legis impleretur in nobis, qui non secundum carnem ambulamus, sed secundum spiritum."),
    (
        8,
        5,
    ...
    (8, 7, "quoniam sapientia carnis inimica est Deo: legi enim Dei non est subjecta, nec enim potest."),
    ...
    (8, 20, "Vanitati enim creatura subjecta est non volens, sed propter eum, qui subjecit eam in spe:"),
    ...
    (8, 33, "Quis accusabit adversus electos Dei? Deus qui justificat,"),
    (
        8,
        34,
    ...
    (9, 6, "Non autem quod exciderit verbum Dei. Non enim omnes qui ex Israël sunt, ii sunt Israëlitæ:"),
    ...
    (9, 12, "non ex operibus, sed ex vocante dictum est ei quia major serviet minori,"),
    (9, 13, "sicut scriptum est: Jacob dilexi, Esau autem odio habui."),
    (9, 14, "Quid ergo dicemus? numquid iniquitas apud Deum? Absit."),
    (9, 15, "Moysi enim dicit: Miserebor cujus misereor: et misericordiam præstabo cujus miserebor."),
    ...
    (9, 18, "Ergo cujus vult miseretur, et quem vult indurat."),
    ...
    (9, 24, "Quos et vocavit nos non solum ex Judæis, sed etiam in gentibus,"),
    (
        9,
        25,
    ...
    (9, 31, "Israël vero sectando legem justitiæ, in legem justitiæ non pervenit."),
    ...
    (10, 3, "Ignorantes enim justitiam Dei, et suam quærentes statuere, justitiæ Dei non sunt subjecti."),
    (10, 4, "Finis enim legis, Christus, ad justitiam omni credenti."),
    (10, 5, "Moyses enim scripsit, quoniam justitiam, quæ ex lege est, qui fecerit homo, vivet in ea."),
    (
        10,
        6,
    ...
    (10, 12, "Non enim est distinctio Judæi et Græci: nam idem Dominus omnium, dives in omnes qui invocant illum."),
    ...
    (10, 21, "Ad Israël autem dicit: Tota die expandi manus meas ad populum non credentem, et contradicentem."),
    (
        11,
        1,
    ...
    (11, 34, "Quis enim cognovit sensum Domini? aut quis consiliarius ejus fuit?"),
    ...
    (13, 12, "Nox præcessit, dies autem appropinquavit. Abjiciamus ergo opera tenebrarum, et induamur arma lucis."),
    (
        13,
        13,
    ...
    (14, 5, "Nam alius judicat diem inter diem: alius autem judicat omnem diem: unusquisque in suo sensu abundet."),
    (
        14,
        6,
    ...
    (14, 17, "Non est enim regnum Dei esca et potus: sed justitia, et pax, et gaudium in Spiritu Sancto:"),
    ...
    (14, 22, "Tu fidem habes? penes temetipsum habe coram Deo. Beatus qui non judicat semetipsum in eo quod probat."),
    (
        14,
        23,
    ...
    (15, 5, "Deus autem patientiæ et solatii det vobis idipsum sapere in alterutrum secundum Jesum Christum:"),
    ...
    (15, 10, "Et iterum dicit: Lætamini gentes cum plebe ejus."),
    (15, 11, "Et iterum: Laudate omnes gentes Dominum: et magnificate eum omnes populi."),
    (15, 12, "Et rursus Isaias ait: Erit radix Jesse, et qui exsurget regere gentes, in eum gentes sperabunt."),
    (
        15,
        13,
    ...
    (15, 17, "Habeo igitur gloriam in Christo Jesu ad Deum."),
    (
        15,
        18,
    ...
    (15, 21, "sed sicut scriptum est: Quibus non est annuntiatum de eo, videbunt: et qui non audierunt, intelligent."),
    ...
    (15, 25, "Nunc igitur proficiscar in Jerusalem ministrare sanctis."),
    (
        15,
        26,
    ...
    (16, 27, "soli sapienti Deo, per Jesum Christum, cui honor et gloria in sæcula sæculorum. Amen."),
]
