"""Translation: vulgate-clementine · Book: 2co
...
VERSES = [
    ...
    (1, 3, "Benedictus Deus et Pater Domini nostri Jesu Christi, Pater misericordiarum, et Deus totius consolationis,"),
    (
        1,
        4,
    ...
    (1, 16, "et per vos transire in Macedoniam, et iterum a Macedonia venire ad vos, et a vobis deduci in Judæam."),
    (
        1,
        17,
    ...
    (2, 6, "Sufficit illi, qui ejusmodi est, objurgatio hæc, quæ fit a pluribus:"),
    (
        2,
        7,
    ...
    (3, 9, "Nam si ministratio damnationis gloria est: multo magis abundat ministerium justitiæ in gloria."),
    ...
    (5, 21, "Eum, qui non noverat peccatum, pro nobis peccatum fecit, ut nos efficeremur justitia Dei in ipso."),
    ...
    (6, 7, "in verbo veritatis, in virtute Dei, per arma justitiæ a dextris et a sinistris,"),
    (
        6,
        8,
    ...
    (8, 16, "Gratias autem Deo, qui dedit eamdem sollicitudinem pro vobis in corde Titi,"),
    (8, 17, "quoniam exhortationem quidem suscepit: sed cum sollicitior esset, sua voluntate profectus est ad vos."),
    (8, 18, "Misimus etiam cum illo fratrem, cujus laus est in Evangelio per omnes ecclesias:"),
    (
        8,
        19,
    ...
    (9, 9, "sicut scriptum est: Dispersit, dedit pauperibus: justitia ejus manet in sæculum sæculi."),
    (
        9,
        10,
    ...
    (11, 22, "Hebræi sunt, et ego: Israëlitæ sunt, et ego: semen Abrahæ sunt, et ego."),
    (
        11,
        23,
    ...
    (11, 24, "A Judæis quinquies, quadragenas, una minus, accepi."),
    ...
    (11, 27, "in labore et ærumna, in vigiliis multis, in fame et siti, in jejuniis multis, in frigore et nuditate,"),
    ...
    (11, 31, "Deus et Pater Domini nostri Jesu Christi, qui est benedictus in sæcula, scit quod non mentior."),
    ...
    (12, 3, "Et scio hujusmodi hominem sive in corpore, sive extra corpus nescio, Deus scit:"),
    (12, 4, "quoniam raptus est in paradisum: et audivit arcana verba, quæ non licet homini loqui."),
    (12, 5, "Pro hujusmodi gloriabor: pro me autem nihil gloriabor nisi in infirmitatibus meis."),
    (
        12,
        6,
