"""Translation: vulgate-clementine · Book: hab
...
VERSES = [
    ...
    (1, 11, "Tunc mutabitur spiritus, et pertransibit, et corruet: hæc est fortitudo ejus dei sui.]"),
    (
        1,
        12,
    ...
    (2, 4, "Ecce qui incredulus est, non erit recta anima ejus in semetipso; justus autem in fide sua vivet."),
    (
        2,
        5,
    ...
    (2, 11, "Quia lapis de pariete clamabit, et lignum, quod inter juncturas ædificiorum est, respondebit."),
    ...
    (2, 15, "Væ qui potum dat amico suo mittens fel suum, et inebrians ut aspiciat nuditatem ejus !"),
    (
        2,
        16,
    ...
    (2, 20, "Dominus autem in templo sancto suo: sileat a facie ejus omnis terra !]"),
    ...
    (3, 9, "Suscitans suscitabis arcum tuum, juramenta tribubus quæ locutus es; fluvios scindes terræ."),
    (
        3,
        10,
