"""Translation: vulgate-clementine · Book: hos
...
VERSES = [
    ...
    (1, 5, "Et in illa die conteram arcum Israël in valle Jezrahel."),
    (
        1,
        6,
    ...
    (2, 22, "Et terra exaudiet triticum, et vinum, et oleum, et hæc exaudient Jezrahel."),
    (
        2,
        23,
    ...
    (3, 2, "Et fodi eam mihi quindecim argenteis, et coro hordei, et dimidio coro hordæi."),
    (3, 3, "Et dixi ad eam: Dies multos exspectabis me; non fornicaberis, et non eris viro; sed et ego exspectabo te."),
    (
        3,
        4,
    ...
    (4, 16, "Quoniam sicut vacca lasciviens declinavit Israël; nunc pascet eos Dominus, quasi agnum in latitudine."),
    ...
    (5, 9, "Ephraim in desolatione erit in die correptionis; in tribubus Israël ostendi fidem."),
    (5, 10, "Facti sunt principes Juda quasi assumentes terminum; super eos effundam quasi aquam iram meam."),
    (5, 11, "Calumniam patiens est Ephraim, fractus judicio, quoniam cœpit abire post sordes."),
    ...
    (
        6,
        1,
        "[In tribulatione sua mane consurgent ad me: Venite, et revertamur ad Dominum, quia ipse cepit, et sanabit nos; percutiet, et curabit nos.",
    ),
    (
        6,
        2,
    ...
    (11, 3, "Et ego quasi nutritius Ephraim: portabam eos in brachiis meis, et nescierunt quod curarem eos."),
    (
        11,
        4,
    ...
    (11, 5, "Non revertetur in terram Ægypti, et Assur ipse rex ejus, quoniam noluerunt converti."),
    (11, 6, "Cœpit gladius in civitatibus ejus, et consumet electos ejus, et comedet capita eorum."),
    (11, 7, "Et populus meus pendebit ad reditum meum; jugum autem imponetur eis simul, quod non auferetur."),
    (
        11,
        8,
    ...
    (13, 1, "[Loquente Ephraim, horror invasit Israël; et deliquit in Baal, et mortuus est."),
    (
        13,
        2,
    ...
    (13, 9, "Perditio tua, Israël: tantummodo in me auxilium tuum."),
    (
        13,
        10,
    ...
    (14, 1, "[Convertere, Israël, ad Dominum Deum tuum, quoniam corruisti in iniquitate tua."),
    (
        14,
        2,
    ...
    (14, 4, "Sanabo contritiones eorum; diligam eos spontanee: quia aversus est furor meus ab eis."),
    (14, 5, "Ero quasi ros; Israël germinabit sicut lilium, et erumpet radix ejus ut Libani."),
    (14, 6, "Ibunt rami ejus, et erit quasi oliva gloria ejus, et odor ejus ut Libani."),
    (
        14,
        7,
