"""Translation: vulgate-clementine · Book: jdg
...
VERSES = [
    ...
    (1, 2, "Dixitque Dominus: Judas ascendet: ecce tradidi terram in manus ejus."),
    (
        1,
        3,
    ...
    (1, 6, "Fugit autem Adonibezec: quem persecuti comprehenderunt, cæsis summitatibus manuum ejus ac pedum."),
    (
        1,
        7,
    ...
    (1, 13, "Cumque cepisset eam Othoniel filius Cenez frater Caleb minor, dedit ei Axam filiam suam conjugem."),
    (
        1,
        14,
    ...
    (1, 18, "Cepitque Judas Gazam cum finibus suis, et Ascalonem, atque Accaron cum terminis suis."),
    (
        1,
        19,
    ...
    (1, 22, "Domus quoque Joseph ascendit in Bethel, fuitque Dominus cum eis."),
    ...
    (1, 28, "Postquam autem confortatus est Israël, fecit eos tributarios, et delere noluit."),
    ...
    (2, 6, "Dimisit ergo Josue populum, et abierunt filii Israël unusquisque in possessionem suam, ut obtinerent eam:"),
    (
        2,
        7,
    ...
    (2, 11, "Feceruntque filii Israël malum in conspectu Domini, et servierunt Baalim."),
    (
        2,
        12,
    ...
    (3, 13, "Et copulavit ei filios Ammon, et Amalec: abiitque et percussit Israël, atque possedit urbem palmarum."),
    (3, 14, "Servieruntque filii Israël Eglon regi Moab decem et octo annis."),
    (
        3,
        15,
    ...
    (3, 21, "Extenditque Aod sinistram manum, et tulit sicam de dextro femore suo, infixitque eam in ventre ejus"),
    (
        3,
        22,
    ...
    (3, 30, "Humiliatusque est Moab in die illo sub manu Israël: et quievit terra octoginta annis."),
    (
        3,
        31,
        "Post hunc fuit Samgar filius Anath, qui percussit de Philisthiim sexcentos viros vomere: et ipse quoque defendit Israël.",
    ),
    (4, 1, "Addideruntque filii Israël facere malum in conspectu Domini post mortem Aod,"),
    (
        4,
        2,
    ...
    (4, 4, "Erat autem Debbora prophetis uxor Lapidoth, quæ judicabat populum in illo tempore."),
    (
        4,
        5,
    ...
    (4, 12, "Nuntiatumque est Sisaræ quod ascendisset Barac filius Abinoëm in montem Thabor:"),
    ...
    (4, 23, "Humiliavit ergo Deus in die illo Jabin regem Chanaan coram filiis Israël:"),
    (4, 24, "qui crescebant quotidie, et forti manu opprimebant Jabin regem Chanaan, donec delerent eum."),
    (5, 1, "Cecineruntque Debbora et Barac filius Abinoëm in illo die, dicentes:"),
    (5, 2, "[Qui sponte obtulistis de Israël animas vestras ad periculum, benedicite Domino."),
    (
        5,
        3,
    ...
    (5, 5, "Montes fluxerunt a facie Domini, et Sinai a facie Domini Dei Israël."),
    (
        5,
        6,
    ...
    (5, 7, "Cessaverunt fortes in Israël, et quieverunt: donec surgeret Debbora, surgeret mater in Israël."),
    (
        5,
        8,
    ...
    (5, 9, "[Cor meum diligit principes Israël: qui propria voluntate obtulistis vos discrimini, benedicite Domino."),
    (5, 10, "Qui ascenditis super nitentes asinos, et sedetis in judicio, et ambulatis in via, loquimini."),
    (
        5,
        11,
    ...
    (5, 24, "[Benedicta inter mulieres Jahel uxor Haber Cinæi, et benedicatur in tabernaculo suo."),
    ...
    (5, 29, "Una sapientior ceteris uxoribus ejus, hæc socrui verba respondit:"),
    (
        5,
        30,
    ...
    (6, 1, "Fecerunt autem filii Israël malum in conspectu Domini: qui tradidit illos in manu Madian septem annis,"),
    (
        6,
        2,
        "et oppressi sunt valde ab eis. Feceruntque sibi antra et speluncas in montibus, et munitissima ad repugnandum loca.",
    ),
    (6, 3, "Cumque sevisset Israël, ascendebat Madian et Amalec, ceterique orientalium nationum:"),
    (
        6,
        4,
    ...
    (6, 6, "Humiliatusque est Israël valde in conspectu Madian."),
    ...
    (6, 30, "Et dixerunt ad Joas: Produc filium tuum huc, ut moriatur: quia destruxit aram Baal, et succidit nemus."),
    (
        6,
        31,
    ...
    (6, 36, "Dixitque Gedeon ad Deum: Si salvum facis per manum meam Israël, sicut locutus es,"),
    (
        6,
        37,
    ...
    (8, 29, "Abiit itaque Jerobaal filius Joas, et habitavit in domo sua:"),
    (8, 30, "habuitque septuaginta filios, qui egressi sunt de femore ejus: eo quod plures haberet uxores."),
    ...
    (8, 35, "nec fecerunt misericordiam cum domo Jerobaal Gedeon, juxta omnia bona quæ fecerat Israëli."),
    (
        9,
        1,
    ...
    (9, 22, "Regnavit itaque Abimelech super Israël tribus annis."),
    ...
    (9, 53, "et ecce una mulier fragmen molæ desuper jaciens, illisit capiti Abimelech, et confregit cerebrum ejus."),
    (
        9,
        54,
    ...
    (9, 55, "Illoque mortuo, omnes qui cum eo erant de Israël, reversi sunt in sedes suas:"),
    (
        9,
        56,
    ...
    (10, 2, "et judicavit Israëlem viginti et tribus annis, mortuusque est, ac sepultus in Samir."),
    (10, 3, "Huic successit Jair Galaadites, qui judicavit Israël per viginti et duos annos,"),
    (
        10,
        4,
    ...
    (10, 5, "Mortuusque est Jair, ac sepultus in loco cui est vocabulum Camon."),
    (
        10,
        6,
    ...
    (11, 4, "In illis diebus pugnabant filii Ammon contra Israël."),
    (
        11,
        5,
    ...
    (11, 15, "Hæc dicit Jephte: Non tulit Israël terram Moab, nec terram filiorum Ammon:"),
    ...
    (11, 28, "Noluitque acquiescere rex filiorum Ammon verbis Jephte, quæ per nuntios mandaverat."),
    (
        11,
        29,
    ...
    (12, 7, "Judicavit itaque Jephte Galaadites Israël sex annis: et mortuus est, ac sepultus in civitate sua Galaad."),
    (12, 8, "Post hunc judicavit Israël Abesan de Bethlehem:"),
    (
        12,
        9,
    ...
    (12, 11, "Cui successit Ahialon Zabulonites: et judicavit Israël decem annis:"),
    (12, 12, "mortuusque est, ac sepultus in Zabulon."),
    (12, 13, "Post hunc judicavit Israël Abdon filius Illel Pharathonites:"),
    (
        12,
        14,
    ...
    (13, 24, "Peperit itaque filium, et vocavit nomen ejus Samson. Crevitque puer, et benedixit ei Dominus."),
    ...
    (14, 7, "Descenditque, et locutus est mulieri quæ placuerat oculis ejus."),
    (
        14,
        8,
    ...
    (15, 4, "Perrexitque et cepit trecentas vulpes, caudasque earum junxit ad caudas, et faces ligavit in medio:"),
    (
        15,
        5,
    ...
    (15, 15, "Inventamque maxillam, id est, mandibulam asini, quæ jacebat, arripiens interfecit in ea mille viros,"),
    ...
    (15, 20, "Judicavitque Israël in diebus Philisthiim viginti annis."),
    ...
    (16, 22, "Jamque capilli ejus renasci cœperunt."),
    (
        16,
        23,
    ...
    (17, 6, "In diebus illis non erat rex in Israël, sed unusquisque quod sibi rectum videbatur, hoc faciebat."),
    (
        17,
        7,
    ...
    (17, 12, "Implevitque Michas manum ejus, et habuit puerum sacerdotem apud se:"),
    ...
    (18, 22, "et jam a domo Michæ essent procul, viri qui habitabant in ædibus Michæ conclamantes secuti sunt,"),
    ...
    (19, 2, "quæ reliquit eum, et reversa est in domum patris sui in Bethlehem, mansitque apud eum quatuor mensibus."),
    (
        19,
        3,
    ...
    (20, 4, "respondit: Veni in Gabaa Benjamin cum uxore mea, illucque diverti:"),
    (
        20,
        5,
    ...
    (20, 7, "Adestis, omnes filii Israël: decernite quid facere debeatis."),
    (
        20,
        8,
    ...
    (20, 11, "Convenitque universus Israël ad civitatem, quasi homo unus eadem mente, unoque consilio."),
    (20, 12, "Et miserunt nuntios ad omnem tribum Benjamin, qui dicerent: Cur tantum nefas in vobis repertum est?"),
    (
        20,
        13,
    ...
    (20, 15, "Inventique sunt viginti quinque millia de Benjamin educentium gladium, præter habitatores Gabaa,"),
    (
        20,
        16,
    ...
    (20, 19, "Statimque filii Israël surgentes mane, castrametati sunt juxta Gabaa:"),
    (20, 20, "et inde procedentes ad pugnam contra Benjamin, urbem oppugnare cœperunt."),
    (20, 21, "Egressique filii Benjamin de Gabaa, occiderunt de filiis Israël die illo viginti duo millia virorum."),
    (
        20,
        22,
    ...
    (20, 24, "Cumque filii Israël altera die contra filios Benjamin ad prælium processissent,"),
    (
        20,
        25,
    ...
    (20, 29, "Posueruntque filii Israël insidias per circuitum urbis Gabaa:"),
    (20, 30, "et tertia vice, sicut semel et bis, contra Benjamin exercitum produxerunt."),
    (
        20,
        31,
    ...
    (21, 3, "Quare, Domine Deus Israël, factum est hoc malum in populo tuo, ut hodie una tribus auferretur ex nobis?"),
    (
        21,
        4,
    ...
    (21, 7, "unde uxores accipient? omnes enim in commune juravimus, non daturos nos his filias nostras."),
    (
        21,
        8,
    ...
    (21, 15, "Universusque Israël valde doluit, et egit pœnitentiam super interfectione unius tribus ex Israël."),
    (
        21,
        16,
        "Dixeruntque majores natu: Quid faciemus reliquis, qui non acceperunt uxores? omnes in Benjamin feminæ conciderunt,",
    ),
    (21, 17, "et magna nobis cura, ingentique studio providendum est, ne una tribus deleatur ex Israël."),
    (
        21,
        18,
    ...
    (21, 20, "Præceperuntque filiis Benjamin, atque dixerunt: Ite, ad latitate in vineis."),
    (
        21,
        21,
