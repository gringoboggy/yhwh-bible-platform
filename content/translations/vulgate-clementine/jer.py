"""Translation: vulgate-clementine · Book: jer
...
BOOK = "jer"
VERSES = [
    (1, 1, "Verba Jeremiæ filii Helciæ, de sacerdotibus qui fuerunt in Anathoth, in terra Benjamin."),
    (
        1,
        2,
    ...
    (2, 4, "Audite verbum Domini, domus Jacob, et omnes cognationes domus Israël."),
    (
        2,
        5,
    ...
    (2, 12, "Obstupescite, cæli, super hoc, et portæ ejus, desolamini vehementer, dicit Dominus."),
    (
        2,
        13,
    ...
    (2, 14, "Numquid servus est Israël, aut vernaculus? quare ergo factus est in prædam?"),
    (
        2,
        15,
    ...
    (3, 4, "Ergo saltem amodo voca me: Pater meus, dux virginitatis meæ tu es:"),
    ...
    (3, 11, "Et dixit Dominus ad me: Justificavit animam suam aversatrix Israël, comparatione prævaricatricis Judæ."),
    (
        3,
        12,
    ...
    (3, 20, "Sed quomodo si contemnat mulier amatorem suum, sic contempsit me domus Israël, dicit Dominus."),
    (
        3,
        21,
    ...
    (3, 23, "Vere mendaces erant colles, et multitudo montium: vere in Domino Deo nostro salus Israël."),
    (
        3,
        24,
    ...
    (5, 11, "Prævaricatione enim prævaricata est in me domus Israël, et domus Juda, ait Dominus."),
    (
        5,
        12,
        "Negaverunt Dominum, et dixerunt: Non est ipse: neque veniet super nos malum: gladium et famem non videbimus.",
    ),
    (5, 13, "Prophetæ fuerunt in ventum locuti, et responsum non fuit in eis: hæc ergo evenient illis."),
    (
        5,
        14,
    ...
    (6, 2, "Speciosæ et delicatæ assimilavi filiam Sion."),
    (
        6,
        3,
    ...
    (6, 14, "Et curabant contritionem filiæ populi mei cum ignominia, dicentes: Pax, pax ! et non erat pax."),
    (
        6,
        15,
    ...
    (6, 24, "Audivimus famam ejus; dissolutæ sunt manus nostræ: tribulatio apprehendit nos, dolores ut parturientem."),
    ...
    (6, 28, "Omnes isti principes declinantes, ambulantes fraudulenter, æs et ferrum: universi corrupti sunt."),
    (
        6,
        29,
    ...
    (7, 33, "Et erit morticinum populi hujus in cibos volucribus cæli et bestiis terræ, et non erit qui abigat."),
    (
        7,
        34,
    ...
    (8, 11, "Et sanabant contritionem filiæ populi mei ad ignominiam, dicentes: Pax, pax ! cum non esset pax."),
    (
        8,
        12,
    ...
    (8, 15, "Exspectavimus pacem, et non erat bonum: tempus medelæ, et ecce formido."),
    (
        8,
        16,
    ...
    (8, 18, "Dolor meus super dolorem, in me cor meum mœrens."),
    (
        8,
        19,
    ...
    (10, 1, "[Audite verbum quod locutus est Dominus super vos, domus Israël."),
    (
        10,
        2,
        "Hæc dicit Dominus: Juxta vias gentium nolite discere, et a signis cæli nolite metuere, quæ timent gentes,",
    ),
    (10, 3, "quia leges populorum vanæ sunt. Quia lignum de saltu præcidit opus manus artificis in ascia:"),
    ...
    (10, 12, "Qui facit terram in fortitudine sua, præparat orbem in sapientia sua, et prudentia sua extendit cælos:"),
    (
        10,
        13,
    ...
    (10, 17, "Congrega de terra confusionem tuam, quæ habitas in obsidione:"),
    (
        10,
        18,
    ...
    (11, 3, "et dices ad eos: Hæc dicit Dominus Deus Israël: Maledictus vir qui non audierit verba pacti hujus"),
    (
        11,
        4,
    ...
    (12, 7, "[Reliqui domum meam; dimisi hæreditatem meam: dedi dilectam animam meam in manu inimicorum ejus."),
    (12, 8, "Facta est mihi hæreditas mea quasi leo in silva: dedit contra me vocem, ideo odivi eam."),
    (
        12,
        9,
    ...
    (13, 5, "Et abii, et abscondi illud in Euphrate, sicut præceperat mihi Dominus."),
    (
        13,
        6,
    ...
    (13, 9, "[Hæc dicit Dominus: Sic putrescere faciam superbiam Juda, et superbiam Jerusalem multam:"),
    (
        13,
        10,
    ...
    (13, 18, "Dic regi et dominatrici: Humiliamini, sedete, quoniam descendit de capite vestro corona gloriæ vestræ."),
    (
        13,
        19,
    ...
    (13, 24, "Et disseminabo eos quasi stipulam quæ vento raptatur in deserto."),
    ...
    (14, 2, "[Luxit Judæa, et portæ ejus corruerunt, et obscuratæ sunt in terra, et clamor Jerusalem ascendit."),
    (
        14,
        3,
    ...
    (20, 17, "qui non me interfecit a vulva, ut fieret mihi mater mea sepulchrum, et vulva ejus conceptus æternus !"),
    ...
    (21, 3, "Et dixit Jeremias ad eos: Sic dicetis Sedeciæ:"),
    (
        21,
        4,
    ...
    (21, 6, "Et percutiam habitatores civitatis hujus: homines et bestiæ pestilentia magna morientur."),
    (
        21,
        7,
    ...
    (22, 1, "Hæc dicit Dominus: Descende in domum regis Juda, et loqueris ibi verbum hoc,"),
    (
        22,
        2,
    ...
    (23, 13, "Et in prophetis Samariæ vidi fatuitatem: prophetabant in Baal, et decipiebant populum meum Israël."),
    (
        23,
        14,
    ...
    (25, 19, "Pharaoni regi Ægypti, et servis ejus, et principibus ejus, et omni populo ejus:"),
    (
        25,
        20,
    ...
    (26, 1, "In principio regni Joakim filii Josiæ regis Juda, factum est verbum istud a Domino, dicens:"),
    (
        26,
        2,
    ...
    (26, 7, "Et audierunt sacerdotes, et prophetæ, et omnis populus, Jeremiam loquentem verba hæc in domo Domini."),
    (
        26,
        8,
    ...
    (26, 22, "Et misit rex Joakim viros in Ægyptum, Elnathan filium Achobor, et viros cum eo, in Ægyptum,"),
    (
        26,
        23,
    ...
    (27, 1, "In principio regni Joakim filii Josiæ regis Juda, factum est verbum istud ad Jeremiam a Domino, dicens:"),
    ...
    (28, 2, "Hæc dicit Dominus exercituum, Deus Israël: Contrivi jugum regis Babylonis."),
    (
        28,
        3,
    ...
    (28, 10, "Et tulit Hananias propheta catenam de collo Jeremiæ prophetæ, et confregit eam."),
    (
        28,
        11,
    ...
    (30, 2, "Hæc dicit Dominus Deus Israël, dicens: Scribe tibi omnia verba quæ locutus sum ad te, in libro."),
    (
        30,
        3,
    ...
    (30, 4, "Et hæc verba quæ locutus est Dominus ad Israël et ad Judam:"),
    ...
    (30, 13, "non est qui judicet judicium tuum ad alligandum: curationum utilitas non est tibi."),
    (
        30,
        14,
    ...
    (31, 1, "[In tempore illo, dicit Dominus, ero Deus universis cognationibus Israël, et ipsi erunt mihi in populum."),
    (
        31,
        2,
    ...
    (31, 24, "et habitabunt in eo Judas et omnes civitates ejus simul, agricolæ et minantes greges."),
    ...
    (31, 31, "Ecce dies venient, dicit Dominus, et feriam domui Israël et domui Juda fœdus novum,"),
    (
        31,
        32,
    ...
    (31, 39, "Et exibit ultra norma mensuræ in conspectu ejus super collem Gareb, et circuibit Goatha,"),
    (
        31,
        40,
    ...
    (33, 2, "[Hæc dicit Dominus, qui facturus est, et formaturus illud, et paraturus: Dominus nomen ejus:"),
    (33, 3, "Clama ad me, et exaudiam te, et annuntiabo tibi grandia et firma quæ nescis."),
    (
        33,
        4,
    ...
    (33, 7, "Et convertam conversionem Juda et conversionem Jerusalem, et ædificabo eos sicut a principio."),
    (
        33,
        8,
    ...
    (33, 17, "Quia hæc dicit Dominus: Non interibit de David vir qui sedeat super thronum domus Israël:"),
    (
        33,
        18,
    ...
    (34, 4, "Attamen audi verbum Domini, Sedecia, rex Juda: Hæc dicit Dominus ad te: Non morieris in gladio,"),
    (
        34,
        5,
    ...
    (34, 6, "Et locutus est Jeremias propheta ad Sedeciam regem Juda universa verba hæc in Jerusalem."),
    (
        34,
        7,
    ...
    (35, 1, "Verbum quod factum est ad Jeremiam a Domino in diebus Joakim filii Josiæ regis Juda, dicens:"),
    (
        35,
        2,
    ...
    (36, 5, "et præcepit Jeremias Baruch, dicens: Ego clausus sum, nec valeo ingredi domum Domini."),
    (
        36,
        6,
    ...
    (37, 6, "Et factum est verbum Domini ad Jeremiam prophetam, dicens:"),
    (
        37,
        7,
    ...
    (37, 11, "Ergo cum recessisset exercitus Chaldæorum ab Jerusalem, propter exercitum Pharaonis,"),
    (
        37,
        12,
    ...
    (37, 16, "Itaque ingressus est Jeremias in domum laci et in ergastulum: et sedit ibi Jeremias diebus multis."),
    (
        37,
        17,
    ...
    (38, 3, "Hæc dicit Dominus: Tradendo tradetur civitas hæc in manu exercitus regis Babylonis, et capiet eam."),
    (
        38,
        4,
    ...
    (38, 24, "Dixit ergo Sedecias ad Jeremiam: Nullus sciat verba hæc, et non morieris."),
    (
        38,
        25,
    ...
    (39, 2, "Undecimo autem anno Sedeciæ, mense quarto, quinta mensis, aperta est civitas:"),
    (
        39,
        3,
    ...
    (39, 8, "Domum quoque regis et domum vulgi succenderunt Chaldæi igni, et murum Jerusalem subverterunt."),
    (
        39,
        9,
    ...
    (39, 11, "Præceperat autem Nabuchodonosor rex Babylonis de Jeremia Nabuzardan magistro militum, dicens:"),
    ...
    (41, 15, "Ismahel autem filius Nathaniæ fugit cum octo viris a facie Johanan, et abiit ad filios Ammon."),
    (
        41,
        16,
    ...
    (43, 7, "et ingressi sunt terram Ægypti, quia non obedierunt voci Domini, et venerunt usque ad Taphnis."),
    ...
    (45, 2, "Hæc dicit Dominus Deus Israël ad te, Baruch:"),
    (
        45,
        3,
    ...
    (46, 1, "Quod factum est verbum Domini ad Jeremiam prophetam contra gentes."),
    (
        46,
        2,
    ...
    (46, 3, "[Præparate scutum et clypeum, et procedite ad bellum."),
    ...
    (46, 17, "Vocate nomen Pharaonis regis Ægypti: tumultum adduxit tempus."),
    (
        46,
        18,
    ...
    (46, 20, "Vitula elegans atque formosa Ægyptus, stimulator ab aquilone veniet ei."),
    (
        46,
        21,
    ...
    (47, 1, "Quod factum est verbum Domini ad Jeremiam prophetam contra Palæstinos, antequam percuteret Pharao Gazam."),
    (
        47,
        2,
    ...
    (47, 5, "Venit calvitium super Gazam; conticuit Ascalon, et reliquiæ vallis earum: usquequo concideris?"),
    ...
    (48, 9, "Date florem Moab, quia florens egredietur: et civitates ejus desertæ erunt, et inhabitabiles."),
    ...
    (48, 13, "Et confundetur Moab a Chamos sicut confusa est domus Israël a Bethel, in qua habebat fiduciam."),
    (48, 14, "Quomodo dicitis: Fortes sumus, et viri robusti ad præliandum?"),
    (
        48,
        15,
    ...
    (48, 19, "In via sta, et prospice, habitatio Aroër: interroga fugientem, et ei qui evasit dic: Quid accidit?"),
    (
        48,
        20,
    ...
    (49, 6, "Et post hæc reverti faciam captivos filiorum Ammon, ait Dominus.]"),
    (
        49,
        7,
    ...
    (49, 17, "Et erit Idumæa deserta: omnis qui transibit per eam stupebit, et sibilabit super omnes plagas ejus."),
    (
        49,
        18,
    ...
    (49, 21, "A voce ruinæ eorum commota est terra; clamor in mari Rubro auditus est vocis ejus."),
    (
        49,
        22,
    ...
    (49, 25, "Quomodo dereliquerunt civitatem laudabilem, urbem lætitiæ?"),
    (
        49,
        26,
    ...
    (49, 35, "[Hæc dicit Dominus exercituum: Ecce ego confringam arcum Ælam, et summam fortitudinem eorum:"),
    (
        49,
        36,
    ...
    (50, 1, "Verbum quod locutus est Dominus de Babylone et de terra Chaldæorum, in manu Jeremiæ prophetæ."),
    (
        50,
        2,
    ...
    (50, 31, "Ecce ego ad te, superbe ! dicit Dominus Deus exercituum: quia venit dies tuus, tempus visitationis tuæ."),
    (
        50,
        32,
    ...
    (50, 35, "Gladius ad Chaldæos, ait Dominus, et ad habitatores Babylonis, et ad principes, et ad sapientes ejus."),
    ...
    (51, 4, "Et cadent interfecti in terra Chaldæorum, et vulnerati in regionibus ejus."),
    (
        51,
        5,
    ...
    (51, 40, "Deducam eos quasi agnos ad victimam, et quasi arietes cum hædis."),
    (
        51,
        41,
    ...
    (51, 61, "Et dixit Jeremias ad Saraiam: Cum veneris in Babylonem, et videris, et legeris omnia verba hæc,"),
    (
        51,
        62,
    ...
    (52, 2, "Et fecit malum in oculis Domini, juxta omnia quæ fecerat Joakim,"),
    (
        52,
        3,
    ...
    (52, 6, "Mense autem quarto, nona mensis, obtinuit fames civitatem, et non erant alimenta populo terræ."),
    (
        52,
        7,
    ...
    (52, 16, "De pauperibus vero terræ reliquit Nabuzardan princeps militiæ vinitores et agricolas."),
    (
        52,
        17,
    ...
    (52, 26, "Tulit autem eos Nabuzardan magister militiæ, et duxit eos ad regem Babylonis in Reblatha:"),
    (
        52,
        27,
        "et percussit eos rex Babylonis, et interfecit eos in Reblatha in terra Emath: et translatus est Juda de terra sua.",
    ),
    (52, 28, "Iste est populus quem transtulit Nabuchodonosor: in anno septimo, Judæos tria millia et viginti tres:"),
    ...
    (52, 33, "Et mutavit vestimenta carceris ejus, et comedebat panem coram eo semper cunctis diebus vitæ suæ."),
    (
        52,
        34,
