"""Translation: vulgate-clementine · Book: nah
...
VERSES = [
    ...
    (2, 8, "Et Ninive quasi piscina aquarum aquæ ejus; ipsi vero fugerunt. State, state ! et non est qui revertatur."),
    ...
    (3, 9, "Æthiopia fortitudo ejus, et Ægyptus, et non est finis; Africa et Libyes fuerunt in auxilio tuo."),
    (
        3,
        10,
