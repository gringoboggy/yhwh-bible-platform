"""Translation: vulgate-clementine · Book: oba
...
VERSES = [
    ...
    (1, 6, "Quomodo scrutati sunt Esau; investigaverunt abscondita ejus?"),
    (
        1,
        7,
    ...
    (1, 21, "Et ascendent salvatores in montem Sion judicare montem Esau, et erit Domino regnum.]"),
]
