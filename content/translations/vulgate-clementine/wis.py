"""Translation: vulgate-clementine · Book: wis
...
VERSES = [
    ...
    (
        5,
        13,
        "sic et nos nati continuo desivimus esse; et virtutis quidem nullum signum valuimus ostendere, in malignitate autem nostra consumpti sumus. Talia dixerunt in inferno hi qui peccaverunt:",
    ),
    (
        5,
        14,
    ...
    (
        6,
        1,
        "[Melior est sapientia quam vires, et vir prudens quam fortis. Audite ergo, reges, et intelligite; discite, judices finium terræ.",
    ),
    ...
    (
        6,
        21,
        "Si ergo delectamini sedibus et sceptris, o reges populi, diligite sapientiam, ut in perpetuum regnetis: diligite lumen sapientiæ, omnes qui præestis populis.]",
    ),
    (
        6,
        22,
    ...
    (
        9,
        18,
        "et sic correctæ sint semitæ eorum qui sunt in terris, et quæ tibi placent didicerint homines? Nam per sapientiam sanati sunt quicumque placuerunt tibi, Domine, a principio.]",
    ),
    ...
    (
        11,
        5,
        "[Per quæ enim pœnas passi sunt inimici illorum a defectione potus sui, et in eis cum abundarent filii Israël lætati sunt: per hæc, cum illis deessent, bene cum illis actum est.",
    ),
    ...
    (13, 12, "reliquiis autem ejus operis ad præparationem escæ abutatur,"),
    (
        13,
        13,
    ...
    (14, 28, "Aut enim dum lætantur insaniunt, aut certe vaticinantur falsa, aut vivunt injuste, aut pejerant cito."),
    (14, 29, "Dum enim confidunt in idolis quæ sine anima sunt, male jurantes noceri se non sperant."),
    (
        14,
        30,
    ...
    (14, 31, "Non enim juratorum virtus, sed peccantium pœna, perambulat semper injustorum prævaricationem.]"),
    ...
    (15, 5, "cujus aspectus insensato dat concupiscentiam, et diligit mortuæ imaginis effigiem sine anima."),
    (
        15,
        6,
    ...
    (16, 23, "hic autem iterum ut nutrirentur justi, etiam suæ virtutis oblitus est."),
    (
        16,
        24,
    ...
    (17, 12, "nihil enim est timor nisi proditio cogitationis auxiliorum."),
    (
        17,
        13,
    ...
    (17, 16, "Deinde si quisquam ex illis decidisset, custodiebatur in carcere sine ferro reclusus."),
    (
        17,
        17,
    ...
    (17, 20, "Omnis enim orbis terrarum limpido illuminabatur lumine, et non impeditis operibus continebatur."),
    (
        17,
        21,
    ...
    (19, 15, "Et non solum hæc, sed et alius quidam respectus illorum erat, quoniam inviti recipiebant extraneos."),
    (19, 16, "Qui autem cum lætitia receperunt hos qui eisdem usi erant justitiis, sævissimis afflixerunt doloribus."),
    (
        19,
        17,
    ...
    (19, 19, "Agrestia enim in aquatica convertebantur, et quæcumque erant natantia, in terram transibant."),
    (19, 20, "Ignis in aqua valebat supra suam virtutem, et aqua extinguentis naturæ obliviscebatur."),
    (
        19,
        22,
