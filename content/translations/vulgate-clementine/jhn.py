"""Translation: vulgate-clementine · Book: jhn
...
VERSES = [
    ...
    (6, 1, "Post hæc abiit Jesus trans mare Galilææ, quod est Tiberiadis:"),
    ...
    (6, 4, "Erat autem proximum Pascha dies festus Judæorum."),
    (
        6,
        5,
    ...
    (6, 23, "aliæ vero supervenerunt naves a Tiberiade juxta locum ubi manducaverunt panem, gratias agente Domino."),
    (
        6,
        24,
    ...
    (6, 38, "quia descendi de cælo, non ut faciam voluntatem meam, sed voluntatem ejus qui misit me."),
    (
        6,
        39,
    ...
    (6, 41, "Murmurabant ergo Judæi de illo, quia dixisset: Ego sum panis vivus, qui de cælo descendi,"),
    (
        6,
        42,
    ...
    (6, 52, "Litigabant ergo Judæi ad invicem, dicentes: Quomodo potest hic nobis carnem suam dare ad manducandum?"),
    (
        6,
        53,
    ...
    (6, 59, "Hæc dixit in synagoga docens, in Capharnaum."),
    (6, 60, "Multi ergo audientes ex discipulis ejus, dixerunt: Durus est hic sermo, et quis potest eum audire?"),
    (
        6,
        61,
    ...
    (6, 66, "Ex hoc multi discipulorum ejus abierunt retro: et jam non cum illo ambulabant."),
    (6, 67, "Dixit ergo Jesus ad duodecim: Numquid et vos vultis abire?"),
    (6, 68, "Respondit ergo ei Simon Petrus: Domine, ad quem ibimus? verba vitæ æternæ habes:"),
    (6, 69, "et nos credidimus, et cognovimus quia tu es Christus Filius Dei."),
    (6, 70, "Respondit eis Jesus: Nonne ego vos duodecim elegi: et ex vobis unus diabolus est?"),
    (6, 71, "Dicebat autem Judam Simonis Iscariotem: hic enim erat traditurus eum, cum esset unus ex duodecim."),
    (
        7,
        1,
    ...
    (
        10,
        41,
        "et multi venerunt ad eum, et dicebant: Quia Joannes quidem signum fecit nullum. Omnia autem quæcumque dixit Joannes de hoc, vera erant. Et multi crediderunt in eum.",
    ),
    ...
    (15, 13, "Majorem hac dilectionem nemo habet, ut animam suam ponat qui pro amicis suis."),
    ...
    (19, 3, "Et veniebant ad eum, et dicebant: Ave, rex Judæorum: et dabant ei alapas."),
    (
        19,
        4,
    ...
    (19, 7, "Responderunt ei Judæi: Nos legem habemus, et secundum legem debet mori, quia Filium Dei se fecit."),
    (19, 8, "Cum ergo audisset Pilatus hunc sermonem, magis timuit."),
    (19, 9, "Et ingressus est prætorium iterum: et dixit ad Jesum: Unde es tu? Jesus autem responsum non dedit ei."),
    (
        19,
        10,
    ...
    (19, 14, "Erat autem parasceve Paschæ, hora quasi sexta, et dicit Judæis: Ecce rex vester."),
    (
        19,
        15,
    ...
    (19, 17, "Et bajulans sibi crucem exivit in eum, qui dicitur Calvariæ locum, hebraice autem Golgotha:"),
    ...
    (19, 25, "Stabant autem juxta crucem Jesu mater ejus, et soror matris ejus, Maria Cleophæ, et Maria Magdalene."),
    (
        19,
        26,
    ...
    (19, 40, "Acceperunt ergo corpus Jesu, et ligaverunt illud linteis cum aromatibus, sicut mos est Judæis sepelire."),
    (
        19,
        41,
        "Erat autem in loco, ubi crucifixus est, hortus: et in horto monumentum novum, in quo nondum quisquam positus erat.",
    ),
    (19, 42, "Ibi ergo propter parasceven Judæorum, quia juxta erat monumentum, posuerunt Jesum."),
    (
        20,
        1,
    ...
    (20, 14, "Hæc cum dixisset, conversa est retrorsum, et vidit Jesum stantem: et non sciebat quia Jesus est."),
    (
        20,
        15,
    ...
    (20, 18, "Venit Maria Magdalene annuntians discipulis: Quia vidi Dominum, et hæc dixit mihi."),
    (
        20,
        19,
    ...
    (21, 1, "Postea manifestavit se iterum Jesus discipulis ad mare Tiberiadis. Manifestavit autem sic:"),
    (
        21,
        2,
    ...
    (21, 4, "Mane autem facto stetit Jesus in littore: non tamen cognoverunt discipuli quia Jesus est."),
    (21, 5, "Dixit ergo eis Jesus: Pueri, numquid pulmentarium habetis? Responderunt ei: Non."),
    (
        21,
        6,
    ...
    (21, 10, "Dicit eis Jesus: Afferte de piscibus, quos prendidistis nunc."),
    (
        21,
        11,
    ...
    (21, 13, "Et venit Jesus, et accipit panem, et dat eis, et piscem similiter."),
    (21, 14, "Hoc jam tertio manifestatus est Jesus discipulis suis cum resurrexisset a mortuis."),
    (
        21,
        15,
    ...
    (21, 21, "Hunc ergo cum vidisset Petrus, dixit Jesu: Domine, hic autem quid?"),
    (21, 22, "Dicit ei Jesus: Sic eum volo manere donec veniam, quid ad te? tu me sequere."),
    (
        21,
        23,
