"""Translation: vulgate-clementine · Book: tit
...
VERSES = [
    ...
    (1, 4, "Tito dilecto filio secundum communem fidem, gratia, et pax a Deo Patre, et Christo Jesu Salvatore nostro."),
    (
        1,
        5,
    ...
    (1, 8, "sed hospitalem, benignum, sobrium, justum, sanctum, continentem,"),
    (
        1,
        9,
    ...
    (1, 14, "non intendentes judaicis fabulis, et mandatis hominum, aversantium se a veritate."),
    (
        1,
        15,
    ...
    (2, 6, "Juvenes similiter hortare ut sobrii sint."),
    ...
    (2, 13, "exspectantes beatam spem, et adventum gloriæ magni Dei, et Salvatoris nostri Jesu Christi:"),
    (
        2,
        14,
    ...
    (3, 7, "ut justificati gratia ipsius, hæredes simus secundum spem vitæ æternæ."),
    (
        3,
        8,
    ...
    (3, 13, "Zenam legisperitum et Apollo sollicite præmitte, ut nihil illis desit."),
