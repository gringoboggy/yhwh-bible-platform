"""Translation: vulgate-clementine · Book: 1ch
...
VERSES = [
    ...
    (3, 12, "et hujus Amasias filius genuit Azariam. Porro Azariæ filius Joatham"),
    (3, 13, "procreavit Achaz patrem Ezechiæ, de quo natus est Manasses."),
    (3, 14, "Sed et Manasses genuit Amon patrem Josiæ."),
    (3, 15, "Filii autem Josiæ fuerunt: primogenitus Johanan, secundus Joakim, tertius Sedecias, quartus Sellum."),
    (3, 16, "De Joakim natus est Jechonias, et Sedecias."),
    (3, 17, "Filii Jechoniæ fuerunt: Asir, Salathiel,"),
    ...
    (3, 22, "Filius Secheniæ, Semeia: cujus filii Hattus, et Jegaal, et Baria, et Naaria, et Saphat, sex numero."),
    (3, 23, "Filius Naariæ, Elioënai, et Ezechias, et Ezricam, tres."),
    (3, 24, "Filii Elioënai, Oduia, et Eliasub, et Pheleia, et Accub, et Johanan, et Dalaia, et Anani, septem."),
    (4, 1, "Filii Juda: Phares, Hesron, et Charmi, et Hur, et Sobal."),
    (4, 2, "Raia vero filius Sobal genuit Jahath, de quo nati sunt Ahumai, et Laad: hæ cognationes Sarathi."),
    ...
    (4, 16, "Filii quoque Jaleleel: Ziph, et Zipha, Thiria, et Asraël."),
    (
        4,
        17,
    ...
    (4, 32, "Villæ quoque eorum: Etam, et Aën, Remmon, et Thochen, et Asan, civitates quinque."),
    (
        4,
        33,
        "Et universi viculi eorum per circuitum civitatum istarum usque ad Baal: hæc est habitatio eorum, et sedium distributio.",
    ),
    (4, 34, "Mosobab quoque et Jemlech, et Josa filius Amasiæ,"),
    (4, 35, "et Joël, et Jehu filius Josabiæ filii Saraiæ filii Asiel,"),
    (4, 36, "et Elioënai, et Jacoba, et Isuhaia, et Asaia, et Adiel, et Ismiel, et Banaia,"),
    ...
    (7, 3, "Filii Ozi: Izrahia, de quo nati sunt Michaël, et Obadia, et Joël, et Jesia, quinque omnes principes."),
    (
        7,
        4,
    ...
    (7, 24, "filia autem ejus fuit Sara, quæ ædificavit Bethoron inferiorem et superiorem, et Ozensara."),
    ...
    (10, 3, "Et aggravatum est prælium contra Saul, inveneruntque eum sagittarii, et vulneraverunt jaculis."),
    (
        10,
        4,
    ...
    (10, 11, "Hoc cum audissent viri Jabes Galaad, omnia scilicet quæ Philisthiim fecerant super Saul,"),
    (
        10,
        12,
    ...
    (11, 1, "Congregatus est igitur omnis Israël ad David in Hebron, dicens: Os tuum sumus, et caro tua."),
    (
        11,
        2,
    ...
    (11, 4, "Abiit quoque David et omnis Israël in Jerusalem: hæc est Jebus, ubi erant Jebusæi habitatores terræ."),
    (
        11,
        5,
    ...
    (11, 8, "Ædificavitque urbem in circuitu a Mello usque ad gyrum; Joab autem reliqua urbis exstruxit."),
    ...
    (11, 12, "Et post eum Eleazar filius patrui ejus Ahohites, qui erat inter tres potentes."),
    (
        11,
        13,
    ...
    (11, 24, "Hæc fecit Banaias filius Jojadæ, qui erat inter tres robustos nominatissimus,"),
    (
        11,
        25,
        "inter triginta primus, verumtamen ad tres usque non pervenerat: posuit autem eum David ad auriculam suam.",
    ),
    (11, 26, "Porro fortissimi viri in exercitu, Asahel frater Joab, et Elchanan filius patrui ejus de Bethlehem,"),
    ...
    (11, 31, "Ethai filius Ribai de Gabaath filiorum Benjamin, Banaia Pharatonites,"),
    (11, 32, "Hurai de torrente Gaas, Abiel Arbathites, Azmoth Bauramites, Eliaba Salabonites."),
    (11, 34, "Filii Assem Gezonites, Jonathan filius Sage Ararites,"),
    (11, 35, "Ahiam filius Sachar Ararites, Eliphal filius Ur,"),
    (11, 36, "Hepher Mecherathites, Ahia Phelonites,"),
    (11, 37, "Hesro Carmelites, Naarai filius Asbai,"),
    (11, 38, "Joël frater Nathan, Mibahar filius Agarai,"),
    (11, 39, "Selec Ammonites, Naharai Berothites armiger Joab filii Sarviæ,"),
    (11, 40, "Ira Jethræus, Gareb Jethræus,"),
    (11, 41, "Urias Hethæus, Zabad filius Oholi,"),
    (11, 42, "Adina filius Siza Rubenites princeps Rubenitarum, et cum eo triginta:"),
    (11, 43, "Hanan filius Maacha, et Josaphat Mathanites,"),
    (11, 44, "Ozia Astarothites, Samma, et Jehiel filii Hotham Arorites,"),
    (11, 45, "Jedihel filius Samri, et Joha frater ejus Thosaites,"),
    (
        11,
        47,
    ...
    (12, 6, "Elcana, et Jesia, et Azareel, et Joëzer, et Jesbaam de Carehim:"),
    (12, 7, "Joëla quoque, et Zabadia filii Jeroham de Gedor."),
    (
        12,
        8,
    ...
    (12, 16, "Venerunt autem et de Benjamin et de Juda ad præsidium in quo morabatur David."),
    (
        12,
        17,
    ...
    (12, 24, "Filii Juda portantes clypeum et hastam, sex millia octingenti expediti ad prælium."),
    ...
    (12, 28, "Sadoc etiam puer egregiæ indolis, et domus patris ejus, principes viginti duo."),
    (
        12,
        29,
    ...
    (15, 7, "De filiis Gersom, Joël princeps: et fratres ejus centum triginta."),
    ...
    (15, 14, "Sanctificati sunt ergo sacerdotes et Levitæ ut portarent arcam Domini Dei Israël."),
    (
        15,
        15,
    ...
    (15, 23, "Et Barachias, et Elcana, janitores arcæ."),
    (
        15,
        24,
    ...
    (17, 12, "Ipse ædificabit mihi domum, et firmabo solium ejus usque in æternum."),
    (
        17,
        13,
    ...
    (17, 15, "Juxta omnia verba hæc, et juxta universam visionem istam, sic locutus est Nathan ad David."),
    (
        17,
        16,
    ...
    (17, 22, "Et posuisti populum tuum Israël tibi in populum usque in æternum, et tu, Domine, factus es Deus ejus."),
    (
        17,
        23,
    ...
    (18, 14, "Regnavit ergo David super universum Israël, et faciebat judicium atque justitiam cuncto populo suo."),
    (18, 15, "Porro Joab filius Sarviæ erat super exercitum, et Josaphat filius Ahilud a commentariis:"),
    ...
    (19, 1, "Accidit autem ut moreretur Naas rex filiorum Ammon, et regnaret filius ejus pro eo."),
    (
        19,
        2,
    ...
    (19, 8, "Quod cum audisset David, misit Joab, et omnem exercitum virorum fortium:"),
    (
        19,
        9,
    ...
    (19, 14, "Perrexit ergo Joab et populus qui cum eo erat, contra Syrum ad prælium: et fugavit eos."),
    (
        19,
        15,
    ...
    (21, 1, "Consurrexit autem Satan contra Israël, et concitavit David ut numeraret Israël."),
    (
        21,
        2,
    ...
    (21, 7, "Displicuit autem Deo quod jussum erat: et percussit Israël."),
    (
        21,
        8,
    ...
    (21, 11, "Cumque venisset Gad ad David, dixit ei: Hæc dicit Doinus: Elige, quod volueris:"),
    (
        21,
        12,
    ...
    (21, 14, "Misit ergo Dominus pestilentiam in Israël: et ceciderunt de Israël septuaginta millia virorum."),
    (
        21,
        15,
    ...
    (21, 28, "Protinus ergo David, videns quod exaudisset eum Dominus in area Ornan Jebusæi, immolavit ibi victimas."),
    (
        21,
        29,
    ...
    (22, 1, "Dixitque David: Hæc est domus Dei, et hoc altare in holocaustum Israëli."),
    (
        22,
        2,
    ...
    (22, 6, "Vocavitque Salomonem filium suum, et præcepit ei ut ædificaret domum Domino Deo Israël."),
    ...
    (22, 12, "Det quoque Dominus prudentiam et sensum ut regere possis Israël, et custodire legem Domini Dei tui."),
    (
        22,
        13,
    ...
    (22, 16, "in auro et argento et ære et ferro, cujus non est numerus. Surge igitur et fac, et erit Dominus tecum."),
    (22, 17, "Præcepit quoque David cunctis principibus Israël ut adjuvarent Salomonem filium suum:"),
    (
        22,
        18,
    ...
    (23, 1, "Igitur David, senex et plenus dierum, regem constituit Salomonem filium suum super Israël."),
    (23, 2, "Et congregavit omnes principes Israël, et sacerdotes atque Levitas."),
    ...
    (23, 5, "Porro quatuor millia janitores, et totidem psaltæ, canentes Domino in organis quæ fecerat ad canendum."),
    ...
    (23, 8, "Filii Leedan: princeps Jahiel, et Zethan, et Joël, tres."),
    ...
    (23, 27, "Juxta præcepta quoque David novissima, supputabitur numerus filiorum Levi a viginti annis et supra."),
    (
        23,
        28,
    ...
    (25, 8, "Miseruntque sortes per vices suas, ex æquo tam major quam minor, doctus pariter et indoctus."),
    (
        25,
        9,
    ...
    (25, 12, "Quinta Nathaniæ, filiis et fratribus ejus duodecim."),
    (25, 13, "Sexta Bocciau, filiis et fratribus ejus duodecim."),
    (25, 14, "Septima Isreela, filiis et fratribus ejus duodecim."),
    (25, 15, "Octava Jesaiæ, filiis et fratribus ejus duodecim."),
    (25, 16, "Nona Mathaniæ, filiis et fratribus ejus duodecim."),
    (25, 17, "Decima Semeiæ, filiis et fratribus ejus duodecim."),
    (25, 18, "Undecima Azareel, filiis et fratribus ejus duodecim."),
    (25, 19, "Duodecima Hasabiæ, filiis et fratribus ejus duodecim."),
    (25, 20, "Tertiadecima Subaël, filiis et fratribus ejus duodecim."),
    (25, 21, "Quartadecima Mathathiæ, filiis et fratribus ejus duodecim."),
    (25, 22, "Quintadecima Jerimoth, filiis et fratribus ejus duodecim."),
    (25, 23, "Sextadecima Hananiæ, filiis et fratribus ejus duodecim."),
    (25, 24, "Septimadecima Jesbacassæ, filiis et fratribus ejus duodecim."),
    ...
    (26, 1, "Divisiones autem janitorum: de Coritis Meselemia, filius Core, de filiis Asaph."),
    (26, 2, "Filii Meselemiæ: Zacharias primogenitus, Jadihel secundus, Zabadias tertius, Jathanaël quartus,"),
    (26, 3, "Ælam quintus, Johanan sextus, Elioënai septimus."),
    (
        26,
        4,
    ...
    (26, 6, "Semei autem filio ejus nati sunt filii, præfecti familiarum suarum: erant enim viri fortissimi."),
    (
        26,
        7,
    ...
    (26, 15, "Obededom vero et filiis ejus ad austrum: in qua parte domus erat seniorum concilium."),
    (26, 16, "Sephim et Hosa ad occidentem, juxta portam, quæ ducit ad viam ascensionis: custodia contra custodiam."),
    (
        26,
        17,
    ...
    (26, 18, "In cellulis quoque janitorum ad occidentem quatuor in via, binique per cellulas."),
    (26, 19, "Hæ sunt divisiones janitorum filiorum Core et Merari."),
    (26, 20, "Porro Achias erat super thesauros domus Dei, et vasa sanctorum."),
    (26, 21, "Filii Ledan, filii Gersonni: de Ledan principes familiarum Ledan, et Gersonni, Jehieli."),
    (26, 22, "Filii Jehieli: Zathan, et Joël fratres ejus super thesauros domus Domini."),
    (26, 23, "Amramitis, et Isaaritis, et Hebronitis, et Ozihelitis."),
    (26, 24, "Subaël autem filius Gersom filii Moysi, præpositus thesauris."),
    (
        26,
        25,
    ...
    (27, 2, "Primæ turmæ in primo mense Jesboam præerat filius Zabdiel, et sub eo viginti quatuor millia;"),
    ...
    (27, 18, "Juda, Eliu frater David: Issachar, Amri filius Michaël."),
    (27, 19, "Zabulonitis, Jesmaias filius Abdiæ: Nephthalitibus, Jerimoth filius Ozriel:"),
    (27, 20, "filiis Ephraim, Osee filius Ozaziu: dimidiæ tribui Manasse, Joël filius Phadaiæ:"),
    (27, 21, "et dimidiæ tribui Manasse in Galaad, Jaddo filius Zachariæ: Benjamin autem, Jasiel filius Abner:"),
    (27, 22, "Dan vero, Ezrihel filius Jeroham: hi principes filiorum Israël."),
    (
        27,
        23,
    ...
    (27, 31, "super oves quoque, Jaziz Agareus: omnes hi, principes substantiæ regis David."),
    (
        27,
        32,
    ...
    (27, 34, "Post Achitophel fuit Jojada filius Banaiæ, et Abiathar. Princeps autem exercitus regis erat Joab."),
    (
        28,
        1,
    ...
    (29, 26, "Igitur David filius Isai regnavit super universum Israël."),
    (
        29,
        27,
