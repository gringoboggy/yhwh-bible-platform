"""Translation: vulgate-clementine · Book: 1ti
...
BOOK = "1ti"
VERSES = [
    (1, 1, "Paulus Apostolus Jesu Christi secundum imperium Dei Salvatoris nostri, et Christi Jesu spei nostræ,"),
    ...
    (3, 4, "suæ domui bene præpositum: filios habentem subditos cum omni castitate."),
    ...
    (5, 15, "Jam enim quædam conversæ sunt retro Satanam."),
    (
        5,
        16,
    ...
    (5, 24, "Quorumdam hominum peccata manifesta sunt, præcedentia ad judicium: quosdam autem et subsequuntur."),
    ...
    (6, 6, "Est autem quæstus magnus pietas cum sufficientia."),
