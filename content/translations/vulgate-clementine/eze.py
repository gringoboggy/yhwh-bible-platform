"""Translation: vulgate-clementine · Book: eze
...
VERSES = [
    ...
    (1, 2, "In quinta mensis, ipse est annus quintus transmigrationis regis Joachin,"),
    (
        1,
        3,
    ...
    (1, 5, "et in medio ejus similitudo quatuor animalium. Et hic aspectus eorum, similitudo hominis in eis."),
    ...
    (1, 8, "Et manus hominis sub pennis eorum, in quatuor partibus: et facies et pennas per quatuor partes habebant."),
    (
        1,
        9,
    ...
    (1, 15, "Cumque aspicerem animalia, apparuit rota una super terram juxta animalia, habens quatuor facies."),
    (
        1,
        16,
    ...
    (1, 17, "Per quatuor partes earum euntes ibant, et non revertebantur cum ambularent."),
    (
        1,
        18,
    ...
    (3, 4, "Et dixit ad me: Fili hominis, vade ad domum Israël, et loqueris verba mea ad eos."),
    (3, 5, "Non enim ad populum profundi sermonis et ignotæ linguæ tu mitteris ad domum Israël:"),
    (
        3,
        6,
    ...
    (3, 17, "Fili hominis, speculatorem dedi te domui Israël, et audies de ore meo verbum, et annuntiabis eis ex me."),
    (
        3,
        18,
    ...
    (4, 1, "Et tu, fili hominis, sume tibi laterem, et pones eum coram te, et describes in eo civitatem Jerusalem."),
    (
        4,
        2,
    ...
    (5, 5, "Hæc dicit Dominus Deus: Ista est Jerusalem: in medio gentium posui eam, et in circuitu ejus terras."),
    (
        5,
        6,
    ...
    (5, 8, "ideo hæc dicit Dominus Deus: Ecce ego ad te, et ipse ego faciam in medio tui judicia in oculis gentium:"),
    ...
    (6, 2, "Fili hominis, pone faciem tuam ad montes Israël, et prophetabis ad eos,"),
    (
        6,
        3,
    ...
    (8, 4, "Et ecce ibi gloria Dei Israël, secundum visionem quam videram in campo."),
    (
        8,
        5,
    ...
    (10, 10, "et aspectus earum similitudo una quatuor, quasi sit rota in medio rotæ."),
    (
        10,
        11,
    ...
    (10, 20, "Ipsum est animal quod vidi subter Deum Israël juxta fluvium Chobar, et intellexi quia cherubim essent."),
    (10, 21, "Quatuor vultus uni, et quatuor alæ uni: et similitudo manus hominis sub alis eorum."),
    (
        10,
        22,
    ...
    (12, 9, "Fili hominis, numquid non dixerunt ad te domus Israël, domus exasperans: Quid tu facis?"),
    (
        12,
        10,
    ...
    (12, 24, "Non enim erit ultra omnis visio cassa, neque divinatio ambigua in medio filiorum Israël:"),
    (
        12,
        25,
    ...
    (13, 4, "Quasi vulpes in desertis prophetæ tui, Israël, erant."),
    (
        13,
        5,
    ...
    (14, 1, "Et venerunt ad me viri seniorum Israël, et sederunt coram me."),
    ...
    (14, 5, "ut capiatur domus Israël in corde suo, quo recesserunt a me in cunctis idolis suis."),
    (
        14,
        6,
    ...
    (14, 10, "Et portabunt iniquitatem suam: juxta iniquitatem interrogantis, sic iniquitas prophetæ erit:"),
    (
        14,
        11,
    ...
    (16, 59, "Quia hæc dicit Dominus Deus: Et faciam tibi sicut despexisti juramentum, ut irritum faceres pactum:"),
    ...
    (17, 2, "Fili hominis, propone ænigma, et narra parabolam ad domum Israël,"),
    (
        17,
        3,
    ...
    (18, 3, "Vivo ego, dicit Dominus Deus, si erit ultra vobis parabola hæc in proverbium in Israël."),
    (
        18,
        4,
    ...
    (20, 10, "Ejeci ergo eos de terra Ægypti, et eduxi eos in desertum."),
    (20, 11, "Et dedi eis præcepta mea, et judicia mea ostendi eis, quæ faciens homo vivet in eis."),
    (
        20,
        12,
    ...
    (20, 19, "Ego Dominus Deus vester: in præceptis meis ambulate: judicia mea custodite, et facite ea,"),
    (
        20,
        20,
    ...
    (20, 25, "Ergo et ego dedi eis præcepta non bona, et judicia in quibus non vivent."),
    (
        20,
        26,
    ...
    (20, 37, "Et subjiciam vos sceptro meo, et inducam vos in vinculis fœderis."),
    (
        20,
        38,
    ...
    (21, 2, "[Fili hominis, pone faciem tuam ad Jerusalem, et stilla ad sanctuaria, et propheta contra humum Israël."),
    (
        21,
        3,
    ...
    (21, 20, "Viam pones ut veniat gladius ad Rabbath filiorum Ammon, et ad Judam in Jerusalem munitissimam."),
    (
        21,
        21,
    ...
    (21, 25, "Tu autem, profane, impie dux Israël, cujus venit dies in tempore iniquitatis præfinita:"),
    (
        21,
        26,
    ...
    (21, 30, "Revertere ad vaginam tuam, in loco in quo creatus es: in terra nativitatis tuæ judicabo te."),
    (
        21,
        31,
    ...
    (22, 5, "Quæ juxta sunt, et quæ procul a te, triumphabunt de te, sordida, nobilis, grandis interitu."),
    (22, 6, "Ecce principes Israël singuli in brachio suo fuerunt in te, ad effundendum sanguinem."),
    (
        22,
        7,
    ...
    (23, 16, "insanivit super eos concupiscentia oculorum suorum, et misit nuntios ad eos in Chaldæam."),
    (
        23,
        17,
    ...
    (23, 31, "In via sororis tuæ ambulasti, et dabo calicem ejus in manu tua."),
    (
        23,
        32,
    ...
    (25, 8, "[Hæc dicit Dominus Deus: Pro eo quod dixerunt Moab et Seir: Ecce sicut omnes gentes, domus Juda:"),
    (
        25,
        9,
    ...
    (26, 6, "Filiæ quoque ejus quæ sunt in agro, gladio interficientur: et scient quia ego Dominus.]"),
    (
        26,
        7,
    ...
    (29, 6, "Et scient omnes habitatores Ægypti quia ego Dominus, pro eo quod fuisti baculus arundineus domui Israël:"),
    (
        29,
        7,
    ...
    (30, 8, "et scient quia ego Dominus, cum dedero ignem in Ægypto, et attriti fuerint omnes auxiliatores ejus."),
    (
        30,
        9,
    ...
    (30, 17, "Juvenes Heliopoleos et Bubasti gladio cadent, et ipsæ captivæ ducentur."),
    (
        30,
        18,
    ...
    (30, 19, "Et judicia faciam in Ægypto: et scient quia ego Dominus.]"),
    (
        30,
        20,
    ...
    (31, 2, "Fili hominis, dic Pharaoni regi Ægypti et populo ejus: [Cui similis factus es in magnitudine tua?"),
    (
        31,
        3,
    ...
    (31, 13, "In ruina ejus habitaverunt omnia volatilia cæli, et in ramis ejus fuerunt universæ bestiæ regionis."),
    (
        31,
        14,
    ...
    (33, 16, "Omnia peccata ejus quæ peccavit, non imputabuntur ei: judicium et justitiam fecit: vita vivet."),
    (33, 17, "Et dixerunt filii populi tui: Non est æqui ponderis via Domini: et ipsorum via injusta est."),
    ...
    (33, 20, "Et dicitis: Non est recta via Domini. Unumquemque juxta vias suas judicabo de vobis, domus Israël."),
    (
        33,
        21,
    ...
    (34, 20, "Propterea hæc dicit Dominus Deus ad vos: Ecce ego ipse judico inter pecus pingue et macilentum:"),
    (
        34,
        21,
    ...
    (34, 30, "Et scient quia ego Dominus Deus eorum cum eis, et ipsi populus meus domus Israël, ait Dominus Deus."),
    (
        34,
        31,
    ...
    (36, 1, "Tu autem, fili hominis, propheta super montes Israël, et dices: [Montes Israël, audite verbum Domini."),
    (
        36,
        2,
    ...
    (36, 21, "Et peperci nomini sancto meo, quod polluerat domus Israël in gentibus ad quas ingressi sunt."),
    (
        36,
        22,
    ...
    (38, 19, "Et in zelo meo, in igne iræ meæ locutus sum, quia in die illa erit commotio magna super terram Israël:"),
    (
        38,
        20,
    ...
    (39, 12, "Et sepelient eos domus Israël, ut mundent terram septem mensibus."),
    (
        39,
        13,
    ...
    (39, 22, "Et scient domus Israël quia ego Dominus Deus eorum, a die illa et deinceps."),
    (
        39,
        23,
    ...
    (40, 8, "Et limen portæ, juxta vestibulum portæ intrinsecus, calamo uno."),
    (
        40,
        9,
    ...
    (40, 41, "quatuor mensæ hinc, et quatuor mensæ inde: per latera portæ octo mensæ erant, super quas immolabant."),
    (
        40,
        42,
    ...
    (43, 4, "Et majestas Domini ingressa est templum per viam portæ quæ respiciebat ad orientem."),
    (43, 5, "Et elevavit me spiritus, et introduxit me in atrium interius: et ecce repleta erat gloria Domini domus."),
    (43, 6, "Et audivi loquentem ad me de domo: et vir qui stabat juxta me"),
    (
        43,
        7,
    ...
    (43, 15, "Ipse autem ariel quatuor cubitorum, et ab ariel usque ad sursum cornua quatuor."),
    (
        43,
        16,
    ...
    (43, 26, "Septem diebus expiabunt altare et mundabunt illud, et implebunt manum ejus."),
    (
        43,
        27,
    ...
    (44, 14, "Et dabo eos janitores domus in omni ministerio ejus, et in universis quæ fient in ea."),
    (
        44,
        15,
    ...
    (44, 29, "Victimam et pro peccato et pro delicto ipsi comedent, et omne votum in Israël ipsorum erit."),
    (
        44,
        30,
    ...
    (45, 16, "Omnis populus terræ tenebitur primitiis his principi in Israël."),
    (
        45,
        17,
    ...
    (45, 21, "In primo mense, quartadecima die mensis, erit vobis Paschæ solemnitas: septem diebus azyma comedentur."),
    ...
    (46, 23, "Et paries per circuitum ambiens quatuor atriola: et culinæ fabricatæ erant subter porticus per gyrum."),
    ...
    (47, 21, "Et dividetis terram istam vobis per tribus Israël:"),
    (
        47,
        22,
    ...
    (48, 9, "Primitiæ quas separabitis Domino, longitudo viginti quinque millibus, et latitudo decem millibus."),
    (
        48,
        10,
    ...
    (48, 12, "Et erunt eis primitiæ de primitiis terræ Sanctum sanctorum, juxta terminum Levitarum."),
    (
        48,
        13,
    ...
    (48, 19, "Servientes autem civitati, operabuntur ex omnibus tribubus Israël."),
    (
        48,
        20,
    ...
    (48, 29, "Hæc est terra quam mittetis in sortem tribubus Israël, et hæ partitiones earum, ait Dominus Deus."),
