"""Translation: vulgate-clementine · Book: lev
...
VERSES = [
    ...
    (1, 4, "ponetque manum super caput hostiæ, et acceptabilis erit, atque in expiationem ejus proficiens."),
    (
        1,
        5,
    ...
    (1, 7, "Et subjicient in altari ignem, strue lignorum ante composita:"),
    (1, 8, "et membra quæ sunt cæsa, desuper ordinantes, caput videlicet, et cuncta quæ adhærent jecori,"),
    (
        1,
        9,
    ...
    (2, 10, "quidquid autem reliquum est, erit Aaron, et filiorum ejus, Sanctum sanctorum de oblationibus Domini."),
    (
        2,
        11,
    ...
    (3, 4, "duos renes cum adipe quo teguntur ilia, et reticulum jecoris cum renunculis."),
    (
        3,
        5,
    ...
    (3, 12, "Si capra fuerit ejus oblatio, et obtulerit eam Domino,"),
    (
        3,
        13,
    ...
    (3, 15, "duos renunculos cum reticulo, quod est super eos juxta ilia, et arvinam jecoris cum renunculis:"),
    ...
    (4, 13, "Quod si omnis turba Israël ignoraverit, et per imperitiam fecerit quod contra mandatum Domini est,"),
    (
        4,
        14,
    ...
    (4, 33, "ponet manum super caput ejus, et immolabit eam in loco ubi solent cædi holocaustorum hostiæ."),
    (
        4,
        34,
    ...
    (8, 36, "Feceruntque Aaron et filii ejus cuncta quæ locutus est Dominus per manum Moysi."),
    (9, 1, "Facto autem octavo die, vocavit Moyses Aaron, et filios ejus, ac majores natu Israël, dixitque ad Aaron:"),
    (
        9,
        2,
    ...
    (9, 5, "Tulerunt ergo cuncta quæ jusserat Moyses ad ostium tabernaculi: ubi cum omnis multitudo astaret,"),
    (9, 6, "ait Moyses: Iste est sermo, quem præcepit Dominus: facite, et apparebit vobis gloria ejus."),
    (
        9,
        7,
    ...
    (10, 11, "doceatisque filios Israël omnia legitima mea quæ locutus est Dominus ad eos per manum Moysi."),
    (
        10,
        12,
    ...
    (13, 22, "et si quidem creverit, adjudicabit eum lepræ;"),
    ...
    (13, 29, "Vir, sive mulier, in cujus capite vel barba germinaverit lepra, videbit eos sacerdos."),
    (
        13,
        30,
    ...
    (13, 38, "Vir, sive mulier, in cujus cute candor apparuerit,"),
    (
        13,
        39,
    ...
    (13, 40, "Vir, de cujus capite capilli fluunt, calvus et mundus est:"),
    ...
    (14, 5, "Et unum ex passeribus immolari jubebit in vase fictili super aquas viventes:"),
    ...
    (14, 35, "ibit cujus est domus, nuntians sacerdoti, et dicet: Quasi plaga lepræ videtur mihi esse in domo mea."),
    (
        14,
        36,
    ...
    (14, 40, "jubebit erui lapides in quibus lepra est, et projici eos extra civitatem in locum immundum:"),
    (
        14,
        41,
    ...
    (14, 49, "et in purificationem ejus sumet duos passeres, lignumque cedrinum, et vermiculum atque hyssopum:"),
    ...
    (14, 53, "Cumque dimiserit passerem avolare in agrum libere, orabit pro domo, et jure mundabitur."),
    ...
    (15, 2, "Loquimini filiis Israël, et dicite eis: Vir, qui patitur fluxum seminis, immundus erit."),
    (
        15,
        3,
    ...
    (
        15,
        19,
        "Mulier, quæ redeunte mense patitur fluxum sanguinis, septem diebus separabitur. Omnis qui tetigerit eam, immundus erit usque ad vesperum:",
    ),
    (15, 20, "et in quo dormierit vel sederit diebus separationis suæ, polluetur."),
    (15, 21, "Qui tetigerit lectum ejus, lavabit vestimenta sua: et ipse lotus aqua, immundus erit usque ad vesperum."),
    (
        15,
        22,
    ...
    (15, 28, "Si steterit sanguis, et fluere cessaverit, numerabit septem dies purificationis suæ:"),
    (
        15,
        29,
    ...
    (15, 33, "et quæ menstruis temporibus separatur, vel quæ jugi fluit sanguine, et hominis qui dormierit cum ea."),
    (
        16,
        1,
    ...
    (16, 3, "nisi hæc ante fecerit: vitulum pro peccato offeret, et arietem in holocaustum."),
    (
        16,
        4,
    ...
    (16, 19, "aspergensque digito septies, expiet, et sanctificet illud ab immunditiis filiorum Israël."),
    ...
    (17, 3, "Homo quilibet de domo Israël, si occiderit bovem aut ovem, sive capram, in castris vel extra castra,"),
    (
        17,
        4,
    ...
    (20, 8, "Custodite præcepta mea, et facite ea: ego Dominus qui sanctifico vos."),
    (
        20,
        9,
    ...
    (20, 16, "Mulier, quæ succubuerit cuilibet jumento, simul interficietur cum eo: sanguis eorum sit super eos."),
    (
        20,
        17,
    ...
    (22, 1, "Locutus quoque est Dominus ad Moysen, dicens:"),
    (
        22,
        2,
    ...
    (22, 15, "Nec contaminabunt sanctificata filiorum Israël, quæ offerunt Domino:"),
    (
        22,
        16,
    ...
    (22, 28, "Sive illa bos, sive ovis, non immolabuntur una die cum fœtibus suis."),
    ...
    (23, 2, "Loquere filiis Israël, et dices ad eos: Hæ sunt feriæ Domini, quas vocabitis sanctas."),
    (
        23,
        3,
    ...
    (23, 4, "Hæ sunt ergo feriæ Domini sanctæ, quas celebrare debetis temporibus suis."),
    ...
    (23, 29, "Omnis anima, quæ afflicta non fuerit die hac, peribit de populis suis:"),
    (23, 30, "et quæ operis quippiam fecerit, delebo eam de populo suo."),
    (
        23,
        31,
    ...
    (23, 38, "exceptis sabbatis Domini, donisque vestris, et quæ offeretis ex voto, vel quæ sponte tribuetis Domino."),
    (
        23,
        39,
    ...
    (23, 42, "et habitabitis in umbraculis septem diebus: omnis, qui de genere est Israël, manebit in tabernaculis,"),
    (
        23,
        43,
    ...
    (23, 44, "Locutusque est Moyses super solemnitatibus Domini ad filios Israël."),
    ...
    (24, 8, "Per singula sabbata mutabuntur coram Domino suscepti a filiis Israël fœdere sempiterno:"),
    (
        24,
        9,
    ...
    (24, 15, "Et ad filios Israël loqueris: Homo, qui maledixerit Deo suo, portabit peccatum suum;"),
    (
        24,
        16,
    ...
    (24, 22, "Æquum judicium sit inter vos, sive peregrinus, sive civis peccaverit: quia ego sum Dominus Deus vester."),
    (
        24,
        23,
    ...
    (25, 1, "Locutusque est Dominus ad Moysen in monte Sinai, dicens:"),
    (
        25,
        2,
    ...
    (25, 4, "septimo autem anno sabbatum erit terræ, requietionis Domini: agrum non seres, et vineam non putabis."),
    (
        25,
        5,
    ...
    (25, 7, "jumentis tuis et pecoribus, omnia quæ nascuntur præbebunt cibum."),
    (
        25,
        8,
    ...
    (25, 12, "ob sanctificationem jubilæi: sed statim oblata comedetis."),
    (25, 13, "Anno jubilæi, redient omnes ad possessiones suas."),
    (
        25,
        14,
    ...
    (25, 23, "Terra quoque non vendetur in perpetuum, quia mea est, et vos advenæ et coloni mei estis:"),
    (25, 24, "unde cuncta regio possessionis vestræ sub redemptionis conditione vendetur."),
    (
        25,
        25,
    ...
    (25, 32, "Ædes Levitarum quæ in urbibus sunt, semper possunt redimi:"),
    (
        25,
        33,
    ...
    (25, 40, "sed quasi mercenarius et colonus erit: usque ad annum jubilæum operabitur apud te,"),
    (25, 41, "et postea egredietur cum liberis suis, et revertetur ad cognationem, ad possessionem patrum suorum."),
    (25, 42, "Mei enim servi sunt, et ego eduxi eos de terra Ægypti: non veneant conditione servorum:"),
    (25, 43, "ne affligas eum per potentiam, sed metuito Deum tuum."),
    (25, 44, "Servus et ancilla sint vobis de nationibus quæ in circuitu vestro sunt:"),
    (
        25,
        45,
    ...
    (25, 51, "Si plures fuerint anni qui remanent usque ad jubilæum, secundum hos reddet et pretium:"),
    ...
    (25, 54, "Quod si per hæc redimi non potuerit, anno jubilæo egredietur cum liberis suis."),
    (25, 55, "Mei enim sunt servi filii Israël, quos eduxi de terra Ægypti."),
    (
        26,
        1,
    ...
    (26, 19, "et conteram superbiam duritiæ vestræ. Daboque vobis cælum desuper sicut ferrum, et terram æneam."),
    (26, 20, "Consumetur incassum labor vester, non proferet terra germen, nec arbores poma præbebunt."),
    (
        26,
        21,
    ...
    (26, 27, "Sin autem nec per hæc audieritis me, sed ambulaveritis contra me:"),
    ...
    (26, 34, "Tunc placebunt terræ sabbata sua cunctis diebus solitudinis suæ: quando fueritis"),
    (
        26,
        35,
    ...
    (26, 42, "Et recordabor fœderis mei, quod pepigi cum Jacob, et Isaac, et Abraham. Terræ quoque memor ero:"),
    (
        26,
        43,
    ...
    (27, 1, "Locutusque est Dominus ad Moysen, dicens:"),
    (
        27,
        2,
    ...
    (27, 13, "Quod si dare voluerit is qui offert, addet supra æstimationem quintam partem."),
    (
        27,
        14,
    ...
    (27, 17, "Si statim ab anno incipientis jubilæi voverit agrum, quanto valere potest, tanto æstimabitur."),
    (
        27,
        18,
    ...
    (27, 25, "Omnis æstimatio siclo sanctuarii ponderabitur. Siclus viginti obolos habet."),
    (
        27,
        26,
    ...
    (27, 29, "et omnis consecratio, quæ offertur ab homine, non redimetur, sed morte morietur."),
    (27, 30, "Omnes decimæ terræ, sive de frugibus, sive de pomis arborum, Domini sunt, et illi sanctificantur."),
    ...
    (27, 34, "Hæc sunt præcepta, quæ mandavit Dominus Moysi ad filios Israël in monte Sinai."),
]
