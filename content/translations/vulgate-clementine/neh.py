"""Translation: vulgate-clementine · Book: neh
...
BOOK = "neh"
VERSES = [
    (1, 1, "Verba Nehemiæ filii Helchiæ. Et factum est in mense Casleu, anno vigesimo, et ego eram in Susis castro."),
    (
        1,
        2,
    ...
    (2, 4, "Et ait mihi rex: Pro qua re postulas? Et oravi Deum cæli,"),
    (
        2,
        5,
    ...
    (2, 11, "Et veni Jerusalem, et eram ibi tribus diebus."),
    (
        2,
        12,
    ...
    (3, 2, "Et juxta eum ædificaverunt viri Jericho: et juxta eum ædificavit Zachur filius Amri."),
    (
        3,
        3,
    ...
    (3, 9, "Et juxta eum ædificavit Raphaia filius Hur, princeps vici Jerusalem."),
    (
        3,
        10,
        "Et juxta eum ædificavit Jedaia filius Haromaph contra domum suam: et juxta eum ædificavit Hattus filius Haseboniæ.",
    ),
    (3, 11, "Mediam partem vici ædificavit Melchias filius Herem, et Hasub filius Phahath Moab, et turrim furnorum."),
    (3, 12, "Et juxta eum ædificavit Sellum filius Alohes, princeps mediæ partis vici Jerusalem, ipse et filiæ ejus."),
    (
        3,
        13,
    ...
    (3, 18, "Post eum ædificaverunt fratres eorum: Bavai filius Enadad, princeps dimidiæ partis Ceilæ:"),
    (
        3,
        19,
    ...
    (3, 22, "Et post eum ædificaverunt sacerdotes, viri de campestribus Jordanis."),
    (
        3,
        23,
    ...
    (3, 26, "Nathinæi autem habitabant in Ophel usque contra portam aquarum ad orientem, et turrim quæ prominebat."),
    (
        3,
        27,
        "Post eum ædificaverunt Thecueni mensuram secundam e regione, a turre magna et eminente usque ad murum templi.",
    ),
    (3, 28, "Sursum autem a porta equorum ædificaverunt sacerdotes, unusquisque contra domum suam."),
    (
        3,
        29,
    ...
    (3, 32, "Et inter cœnaculum anguli in porta gregis, ædificaverunt aurifices et negotiatores."),
    (
        4,
        1,
    ...
    (4, 20, "in loco quocumque audieritis clangorem tubæ, illuc concurrite ad nos: Deus noster pugnabit pro nobis."),
    (
        4,
        21,
    ...
    (5, 1, "Et factus est clamor populi et uxorum ejus magnus adversus fratres suos Judæos."),
    (
        5,
        2,
    ...
    (5, 6, "Et iratus sum nimis cum audissem clamorem eorum secundum verba hæc:"),
    (
        5,
        7,
    ...
    (5, 16, "quin potius in opere muri ædificavi, et agrum non emi, et omnes pueri mei congregati ad opus erant."),
    (
        5,
        17,
    ...
    (6, 4, "Miserunt autem ad me secundum verbum hoc per quatuor vices: et respondi eis juxta sermonem priorem."),
    (
        6,
        5,
    ...
    (6, 15, "Completus est autem murus vigesimo quinto die mensis Elul, quinquaginta duobus diebus."),
    (
        6,
        16,
    ...
    (6, 19, "sed et laudabant eum coram me, et verba mea nuntiabant ei: et Tobias mittebat epistolas ut terreret me."),
    ...
    (7, 43, "filii Josue et Cedmihel filiorum Oduiæ, septuaginta quatuor. Cantores:"),
    (7, 44, "filii Asaph, centum quadraginta octo."),
    (
        7,
        45,
        "Janitores: filii Sellum, filii Ater, filii Telmon, filii Accub, filii Hatita, filii Sobai: centum triginta octo.",
    ),
    (7, 46, "Nathinæi: filii Soha, filii Hasupha, filii Tebbaoth,"),
    (7, 47, "filii Ceros, filii Siaa, filii Phadon, filii Lebana, filii Hagaba, filii Selmai,"),
    ...
    (
        7,
        67,
        "absque servis et ancillis eorum, qui erant septem millia trecenti triginta septem, et inter eos cantores et cantatrices, ducenti quadraginta quinque. Equi eorum, septingenti triginta sex: muli eorum, ducenti quadraginta quinque:",
    ),
    ...
    (8, 8, "Et legerunt in libro legis Dei distincte, et aperte ad intelligendum: et intellexerunt cum legeretur."),
    (
        8,
        9,
    ...
    (9, 9, "Et vidisti afflictionem patrum nostrorum in Ægypto, clamoremque eorum audisti super mare Rubrum."),
    (
        9,
        10,
    ...
    (9, 33, "Et tu justus es in omnibus quæ venerunt super nos: quia veritatem fecisti, nos autem impie egimus."),
    (
        9,
        34,
    ...
    (10, 9, "Porro Levitæ, Josue filius Azaniæ, Bennui de filiis Henadad, Cedmihel,"),
    ...
    (10, 14, "Capita populi, Pharos, Phahathmoab, Ælam, Zethu, Bani,"),
    ...
    (10, 30, "et ut non daremus filias nostras populo terræ, et filias eorum non acciperemus filiis nostris."),
    (
        10,
        31,
    ...
    (10, 32, "Et statuemus super nos præcepta, ut demus tertiam partem sicli per annum ad opus domus Dei nostri,"),
    (
        10,
        33,
    ...
    (11, 2, "Benedixit autem populus omnibus viris qui se sponte obtulerant ut habitarent in Jerusalem."),
    (
        11,
        3,
    ...
    (11, 6, "omnes hi filii Phares, qui habitaverunt in Jerusalem, quadringenti sexaginta octo viri fortes."),
    (
        11,
        7,
    ...
    (11, 8, "et post eum Gebbai, Sellai, nongenti viginti octo,"),
    (11, 9, "et Joël filius Zechri præpositus eorum, et Judas filius Senua super civitatem secundus."),
    (11, 10, "Et de sacerdotibus, Idaia filius Joarib, Jachin,"),
    (
        11,
        11,
    ...
    (11, 14, "et fratres eorum potentes nimis: centum viginti octo, et præpositus eorum Zabdiel filius potentium."),
    (11, 15, "Et de Levitis, Semeia filius Hasub, filius Azaricam, filius Hasabia, filius Boni,"),
    (11, 16, "et Sabathai et Jozabed, super omnia opera quæ erant forinsecus in domo Dei, a principibus Levitarum."),
    (
        11,
        17,
    ...
    (11, 18, "omnes Levitæ in civitate sancta ducenti octoginta quatuor."),
    (11, 19, "Et janitores, Accub, Telmon, et fratres eorum, qui custodiebant ostia: centum septuaginta duo."),
    (
        11,
        20,
        "Et reliqui ex Israël sacerdotes et Levitæ in universis civitatibus Juda, unusquisque in possessione sua.",
    ),
    (11, 21, "Et Nathinæi, qui habitabant in Ophel, et Siaha, et Gaspha de Nathinæis."),
    (
        11,
        22,
    ...
    (11, 23, "Præceptum quippe regis super eos erat, et ordo in cantoribus per dies singulos,"),
    (11, 24, "et Phathahia filius Mesezebel, de filiis Zara filii Juda in manu regis, juxta omne verbum populi,"),
    (
        11,
        25,
    ...
    (11, 26, "et in Jesue, et in Molada, et in Bethphaleth,"),
    (11, 27, "et in Hasersual, et in Bersabee, et in filiabus ejus,"),
    (11, 28, "et in Siceleg, et in Mochona, et in filiabus ejus,"),
    (11, 29, "et in Remmon, et in Saraa, et in Jerimuth,"),
    (
        11,
        30,
    ...
    (11, 31, "Filii autem Benjamin, a Geba, Mechmas, et Hai, et Bethel, et filiabus ejus"),
    (11, 32, "Anathoth, Nob, Anania,"),
    (11, 33, "Asor, Rama, Gethaim,"),
    (11, 34, "Hadid, Seboim, et Neballat, Lod,"),
    (11, 35, "et Ono valle artificum."),
    (11, 36, "Et de Levitis portiones Judæ et Benjamin."),
    (
        12,
        1,
    ...
    (12, 8, "Porro Levitæ, Jesua, Bennui, Cedmihel, Sarebia, Juda, Mathanias, super hymnos ipsi et fratres eorum:"),
    ...
    (12, 12, "In diebus autem Joacim erant sacerdotes et principes familiarum: Saraiæ, Maraia: Jeremiæ, Hanania:"),
    (12, 13, "Esdræ, Mosollam: Amariæ, Johanan:"),
    (12, 14, "Milicho, Jonathan: Sebeniæ, Joseph:"),
    (12, 15, "Haram, Edna: Maraioth, Helci:"),
    (12, 16, "Adaiæ, Zacharia: Genthon, Mosollam:"),
    (12, 17, "Abiæ, Zechri: Miamin et Moadiæ, Phelti:"),
    (12, 18, "Belgæ, Sammua: Semaiæ, Jonathan:"),
    (12, 19, "Jojarib, Mathanai: Jodaiæ, Azzi:"),
    (12, 20, "Sellai, Celai: Amoc, Heber:"),
    (12, 21, "Helciæ, Hasebia: Idaiæ, Nathanaël."),
    (
        12,
        22,
    ...
    (12, 30, "Et mundati sunt sacerdotes et Levitæ, et mundaverunt populum, et portas, et murum."),
    (
        12,
        31,
    ...
    (12, 34, "et Azarias, Esdras, et Mosollam, Judas, et Benjamin, et Semeia, et Jeremias."),
    (
        12,
        35,
    ...
    (12, 41, "Et sacerdotes, Eliachim, Maasia, Miamin, Michea, Elioënai, Zacharia, Hanania in tubis,"),
    (
        12,
        42,
    ...
    (13, 3, "Factum est autem, cum audissent legem, separaverunt omnem alienigenam ab Israël."),
    (
        13,
        4,
    ...
    (13, 8, "Et malum mihi visum est valde. Et projeci vasa domus Tobiæ foras de gazophylacio:"),
    (13, 9, "præcepique et emundaverunt gazophylacia: et retuli ibi vasa domus Dei, sacrificium, et thus."),
    (
        13,
        10,
    ...
    (13, 23, "Sed et in diebus illis vidi Judæos ducentes uxores Azotidas, Ammonitidas, et Moabitidas."),
    (
        13,
        24,
