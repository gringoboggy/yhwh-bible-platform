"""Translation: vulgate-clementine · Book: mic
...
VERSES = [
    ...
    (1, 9, "quia desperata est plaga ejus, quia venit usque ad Judam; tetigit portam populi mei usque ad Jerusalem."),
    (1, 10, "In Geth nolite annuntiare; lacrimis ne ploretis; in domo pulveris pulvere vos conspergite."),
    (
        1,
        11,
    ...
    (1, 14, "Propterea dabit emissarios super hæreditatem Geth, domus mendacii in deceptionem regibus Israël."),
    (1, 15, "Adhuc hæredem adducam tibi quæ habitas in Maresa; usque ad Odollam veniet gloria Israël."),
    (
        1,
        16,
    ...
    (5, 13, "et perire faciam sculptilia tua et statuas tuas de medio tui, et non adorabis ultra opera manuum tuarum:"),
    (5, 14, "et evellam lucos tuos de medio tui, et conteram civitates tuas."),
    (5, 15, "Et faciam, in furore et in indignatione, ultionem in omnibus gentibus quæ non audierunt.]"),
    ...
    (7, 20, "Dabis veritatem Jacob, misericordiam Abraham, quæ jurasti patribus nostris a diebus antiquis.]"),
]
