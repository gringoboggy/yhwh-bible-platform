"""Translation: vulgate-clementine · Book: num
...
VERSES = [
    ...
    (4, 31, "Hæc sunt onera eorum: portabunt tabulas tabernaculi et vectes ejus, columnas ac bases earum,"),
    (
        4,
        32,
    ...
    (5, 4, "Feceruntque ita filii Israël, et ejecerunt eos extra castra, sicut locutus erat Dominus Moysi."),
    ...
    (5, 9, "Omnes quoque primitiæ, quas offerunt filii Israël, ad sacerdotem pertinent:"),
    ...
    (5, 12, "Loquere ad filios Israël, et dices ad eos: Vir cujus uxor erraverit, maritumque contemnens"),
    (
        5,
        13,
    ...
    (6, 23, "Loquere Aaron et filiis ejus: Sic benedicetis filiis Israël, et dicetis eis:"),
    ...
    (6, 27, "Invocabuntque nomen meum super filios Israël, et ego benedicam eis."),
    (
        7,
        1,
    ...
    (8, 6, "Tolle Levitas de medio filiorum Israël, et purificabis eos"),
    (
        8,
        7,
    ...
    (8, 9, "et applicabis Levitas coram tabernaculo fœderis, convocata omni multitudine filiorum Israël."),
    (8, 10, "Cumque Levitæ fuerint coram Domino, ponent filii Israël manus suas super eos."),
    (8, 11, "Et offeret Aaron Levitas, munus in conspectu Domini a filiis Israël, ut serviant in ministerio ejus."),
    (
        8,
        12,
    ...
    (8, 13, "Statuesque Levitas in conspectu Aaron et filiorum ejus, et consecrabis oblatos Domino,"),
    (8, 14, "ac separabis de medio filiorum Israël, ut sint mei."),
    (
        8,
        15,
    ...
    (8, 16, "Pro primogenitis quæ aperiunt omnem vulvam in Israël, accepi eos."),
    (
        8,
        17,
    ...
    (8, 18, "et tuli Levitas pro cunctis primogenitis filiorum Israël,"),
    (
        8,
        19,
    ...
    (9, 2, "Faciant filii Israël Phase in tempore suo,"),
    (9, 3, "quartadecima die mensis hujus ad vesperam, juxta omnes cæremonias et justificationes ejus."),
    (9, 4, "Præcepitque Moyses filiis Israël ut facerent Phase."),
    (
        9,
        5,
    ...
    (10, 4, "Si semel clangueris, venient ad te principes, et capita multitudinis Israël."),
    (
        10,
        5,
    ...
    (10, 12, "profectique sunt filii Israël per turmas suas de deserto Sinai, et recubuit nubes in solitudine Pharan."),
    ...
    (10, 15, "In tribu filiorum Issachar fuit princeps Nathanaël filius Suar."),
    ...
    (10, 28, "Hæc sunt castra, et profectiones filiorum Israël per turmas suas quando egrediebantur."),
    (
        10,
        29,
    ...
    (10, 36, "Cum autem deponeretur, aiebat: Revertere, Domine, ad multitudinem exercitus Israël."),
    (
        11,
        1,
    ...
    (11, 30, "Reversusque est Moyses, et majores natu Israël in castra."),
    (
        11,
        31,
    ...
    (12, 1, "Locutaque est Maria et Aaron contra Moysen propter uxorem ejus Æthiopissam,"),
    (
        12,
        2,
    ...
    (12, 16, "Profectusque est populus de Haseroth, fixis tentoriis in deserto Pharan."),
    (13, 1, "Ibique locutus est Dominus ad Moysen, dicens:"),
    (
        13,
        2,
    ...
    (13, 4, "De tribu Ruben, Sammua filium Zechur."),
    (13, 5, "De tribu Simeon, Saphat filium Huri."),
    (13, 6, "De tribu Juda, Caleb filium Jephone."),
    (13, 7, "De tribu Issachar, Igal filium Joseph."),
    (13, 8, "De tribu Ephraim, Osee filium Nun."),
    (13, 9, "De tribu Benjamin, Phalti filium Raphu."),
    (13, 10, "De tribu Zabulon, Geddiel filium Sodi."),
    (13, 11, "De tribu Joseph, sceptri Manasse, Gaddi filium Susi."),
    (13, 12, "De tribu Dan, Ammiel filium Gemalli."),
    (13, 13, "De tribu Aser, Sthur filium Michaël."),
    (13, 14, "De tribu Nephthali, Nahabi filium Vapsi."),
    (13, 15, "De tribu Gad, Guel filium Machi."),
    (13, 16, "Hæc sunt nomina virorum, quos misit Moyses ad considerandam terram: vocavitque Osee filium Nun, Josue."),
    (
        13,
        17,
    ...
    (13, 19, "ipsa terra, bona an mala: urbes quales, muratæ an absque muris:"),
    (
        13,
        20,
    ...
    (13, 21, "Cumque ascendissent, exploraverunt terram a deserto Sin, usque Rohob intrantibus Emath."),
    (
        13,
        22,
    ...
    (13, 24, "qui appellatus est Nehelescol, id est Torrens botri, eo quod botrum portassent inde filii Israël."),
    (13, 25, "Reversique exploratores terræ post quadraginta dies, omni regione circuita,"),
    (
        13,
        26,
    ...
    (13, 28, "sed cultores fortissimos habet, et urbes grandes atque muratas. Stirpem Enac vidimus ibi."),
    (
        13,
        29,
    ...
    (13, 33, "Ibi vidimus monstra quædam filiorum Enac de genere giganteo: quibus comparati, quasi locustæ videbamur."),
    (14, 1, "Igitur vociferans omnis turba flevit nocte illa,"),
    (14, 2, "et murmurati sunt contra Moysen et Aaron cuncti filii Israël, dicentes:"),
    (
        14,
        3,
    ...
    (14, 5, "Quo audito, Moyses et Aaron ceciderunt proni in terram coram omni multitudine filiorum Israël."),
    (
        14,
        6,
        "At vero Josue filius Nun et Caleb filius Jephone, qui et ipsi lustraverant terram, sciderunt vestimenta sua,",
    ),
    (14, 7, "et ad omnem multitudinem filiorum Israël locuti sunt: Terra, quam circuivimus, valde bona est."),
    ...
    (14, 27, "Usquequo multitudo hæc pessima murmurat contra me? querelas filiorum Israël audivi."),
    ...
    (14, 39, "Locutusque est Moyses universa verba hæc ad omnes filios Israël, et luxit populus nimis."),
    (
        14,
        40,
    ...
    (15, 11, "Sic facies per singulos boves et arietis et agnos et hædos."),
    (15, 13, "Tam indigenæ quam peregrini eodem ritu offerent sacrificia."),
    (15, 16, "Unum præceptum erit atque judicium tam vobis quam advenis terræ."),
    (15, 17, "Locutus est Dominus ad Moysen, dicens:"),
    (15, 18, "Loquere filiis Israël, et dices ad eos: Cum veneritis in terram, quam dabo vobis,"),
    ...
    (16, 25, "Surrexitque Moyses, et abiit ad Dathan et Abiron: et sequentibus eum senioribus Israël,"),
    (
        16,
        26,
    ...
    (
        16,
        42,
        "Cumque oriretur seditio, et tumultus incresceret, Moyses et Aaron fugerunt ad tabernaculum fœderis. Quod, postquam ingressi sunt, operuit nubes, et apparuit gloria Domini.",
    ),
    ...
    (17, 12, "Dixerunt autem filii Israël ad Moysen: Ecce consumpti sumus, omnes perivimus."),
    ...
    (18, 5, "Excubate in custodia sanctuarii, et in ministerio altaris: ne oriatur indignatio super filios Israël."),
    (
        18,
        6,
    ...
    (18, 14, "Omne quod ex voto reddiderint filii Israël, tuum erit."),
    (
        18,
        15,
    ...
    (18, 22, "ut non accedant ultra filii Israël ad tabernaculum, nec committant peccatum mortiferum,"),
    (
        18,
        23,
    ...
    (19, 5, "comburetque eam cunctis videntibus, tam pelle et carnibus ejus quam sanguine et fimo flammæ traditis."),
    ...
    (21, 2, "At Israël voto se Domino obligans, ait: Si tradideris populum istum in manu mea, delebo urbes ejus."),
    (
        21,
        3,
    ...
    (21, 10, "Profectique filii Israël castrametati sunt in Oboth."),
    (21, 11, "Unde egressi fixere tentoria in Jeabarim, in solitudine quæ respicit Moab contra orientalem plagam."),
    ...
    (21, 17, "Tunc cecinit Israël carmen istud: [Ascendat puteus.] Concinebant:"),
    (
        21,
        18,
    ...
    (21, 21, "Misit autem Israël nuntios ad Sehon regem Amorrhæorum, dicens:"),
    (
        21,
        22,
    ...
    (21, 31, "Habitavit itaque Israël in terra Amorrhæi."),
    ...
    (22, 1, "Profectique castrametati sunt in campestribus Moab, ubi trans Jordanem Jericho sita est."),
    (22, 2, "Videns autem Balac filius Sephor omnia quæ fecerat Israël Amorrhæo,"),
    (22, 3, "et quod pertimuissent eum Moabitæ, et impetum ejus ferre non possent,"),
    (
        22,
        4,
    ...
    (22, 28, "Aperuitque Dominus os asinæ, et locuta est: Quid feci tibi? cur percutis me ecce jam tertio?"),
    ...
    (22, 39, "Perrexerunt ergo simul, et venerunt in urbem, quæ in extremis regni ejus finibus erat."),
    ...
    (24, 2, "et elevans oculos, vidit Israël in tentoriis commorantem per tribus suas: et irruente in se spiritu Dei,"),
    ...
    (24, 5, "Quam pulchra tabernacula tua, Jacob, et tentoria tua, Israël !"),
    (
        24,
        6,
    ...
    (24, 18, "Et erit Idumæa possessio ejus: hæreditas Seir cedet inimicis suis: Israël vero fortiter aget."),
    ...
    (25, 1, "Morabatur autem eo tempore Israël in Settim, et fornicatus est populus cum filiabus Moab,"),
    (25, 2, "quæ vocaverunt eos ad sacrificia sua. At ille comederunt et adoraverunt deos earum."),
    (25, 3, "Initiatusque est Israël Beelphegor: et iratus Dominus,"),
    (
        25,
        4,
        "ait ad Moysen: Tolle cunctos principes populi, et suspende eos contra solem in patibulis, ut avertatur furor meus ab Israël.",
    ),
    (25, 5, "Dixitque Moyses ad judices Israël: Occidat unusquisque proximos suos, qui initiati sunt Beelphegor."),
    (
        25,
        6,
    ...
    (27, 5, "Retulitque Moyses causam earum ad judicium Domini."),
    (27, 6, "Qui dixit ad eum:"),
    (
        27,
        7,
    ...
    (
        27,
        8,
        "Ad filios autem Israël loqueris hæc: Homo cum mortuus fuerit absque filio, ad filiam ejus transibit hæreditas.",
    ),
    (27, 9, "Si filiam non habuerit, habebit successores fratres suos."),
    (27, 10, "Quod si et fratres non fuerint, dabitis hæreditatem fratribus patris ejus."),
    (
        27,
        11,
    ...
    (27, 23, "Et impositis capiti ejus manibus, cuncta replicavit quæ mandaverat Dominus."),
    ...
    (29, 40, "Narravitque Moyses filiis Israël omnia quæ ei Dominus imperarat."),
    (30, 1, "Et locutus est ad principes tribuum filiorum Israël: Iste est sermo quem præcepit Dominus:"),
    (
        30,
        2,
    ...
    (30, 4, "quidquid pollicita est, et juravit, opere complebit."),
    (
        30,
        5,
    ...
    (30, 7, "quo die audierit vir, et non contradixerit, voti rea erit, reddetque quodcumque promiserat."),
    (
        30,
        8,
    ...
    (30, 9, "Vidua et repudiata quidquid voverint, reddent."),
    (30, 10, "Uxor in domo viri cum se voto constrinxerit et juramento,"),
    ...
    (30, 15, "Sin autem contradixerit postquam rescivit, portabit ipse iniquitatem ejus."),
    (
        30,
        16,
    ...
    (32, 7, "cur subvertitis mentes filiorum Israël, ne transire audeant in locum, quem eis daturus est Dominus?"),
    ...
    (32, 12, "præter Caleb filium Jephone Cenezæum, et Josue filium Nun: isti impleverunt voluntatem meam."),
    (
        32,
        13,
    ...
    (32, 18, "Non revertemur in domos nostras, usque dum possideant filii Israël hæreditatem suam:"),
    (32, 19, "nec quidquam quæremus trans Jordanem, quia jam habemus nostram possessionem in orientali ejus plaga."),
    ...
    (32, 34, "Igitur exstruxerunt filii Gad, Dibon, et Ataroth, et Aroër,"),
    ...
    (35, 1, "Hæc quoque locutus est Dominus ad Moysen in campes tribus Moab supra Jordanem, contra Jericho:"),
    ...
    (36, 5, "Respondit Moyses filiis Israël, et Domino præcipiente ait: Recte tribus filiorum Joseph locuta est."),
    (
        36,
        6,
    ...
    (36, 8, "et cunctæ feminæ de eadem tribu maritos accipient: ut hæreditas permaneat in familiis,"),
    (36, 9, "nec sibi misceantur tribus, sed ita maneant"),
    (36, 10, "ut a Domino separatæ sunt. Feceruntque filiæ Salphaad ut fuerat imperatum:"),
