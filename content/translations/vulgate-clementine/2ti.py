"""Translation: vulgate-clementine · Book: 2ti
...
BOOK = "2ti"
VERSES = [
    (1, 1, "Paulus Apostolus Jesu Christi per voluntatem Dei, secundum promissionem vitæ, quæ est in Christo Jesu,"),
    ...
    (1, 13, "Formam habe sanorum verborum, quæ a me audisti in fide, et in dilectione in Christo Jesu."),
    ...
    (2, 8, "Memor esto Dominum Jesum Christum resurrexisse a mortuis ex semine David, secundum Evangelium meum,"),
    ...
    (3, 12, "Et omnes, qui pie volunt vivere in Christo Jesu, persecutionem patientur."),
    (3, 13, "Mali autem homines et seductores proficient in pejus, errantes, et in errorem mittentes."),
    ...
    (4, 6, "Ego enim jam delibor, et tempus resolutionis meæ instat."),
    ...
    (4, 14, "Alexander ærarius multa mala mihi ostendit: reddet illi Dominus secundum opera ejus:"),
