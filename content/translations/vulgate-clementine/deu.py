"""Translation: vulgate-clementine · Book: deu
...
VERSES = [
    ...
    (1, 5, "trans Jordanem in terra Moab. Cœpitque Moyses explanare legem, et dicere:"),
    ...
    (1, 16, "Præcepique eis, dicens: Audite illos, et quod justum est judicate: sive civis sit ille, sive peregrinus."),
    (
        1,
        17,
    ...
    (1, 18, "Præcepique omnia quæ facere deberetis."),
    (
        1,
        19,
    ...
    (1, 20, "dixi vobis: Venistis ad montem Amorrhæi, quem Dominus Deus noster daturus est nobis:"),
    (
        1,
        21,
    ...
    (1, 30, "Dominus Deus, qui ductor est vester, pro vobis ipse pugnabit, sicut fecit in Ægypto cunctis videntibus."),
    (
        1,
        31,
    ...
    (2, 3, "Sufficit vobis circuire montem istum: ite contra aquilonem:"),
    (
        2,
        4,
    ...
    (2, 10, "Emim primi fuerunt habitatores ejus, populus magnus, et validus, et tam excelsus ut de Enacim stirpe,"),
    (2, 11, "quasi gigantes crederentur, et essent similes filiorum Enacim. Denique Moabitæ appellant eos Emim."),
    (
        2,
        12,
    ...
    (2, 15, "cujus manus fuit adversum eos, ut interirent de castrorum medio."),
    ...
    (2, 20, "Terra gigantum reputata est: et in ipsa olim habitaverunt gigantes, quos Ammonitæ vocant Zomzommim,"),
    (
        2,
        21,
    ...
    (2, 26, "Misi ergo nuntios de solitudine Cademoth ad Sehon regem Hesebon verbis pacificis, dicens:"),
    (
        2,
        27,
    ...
    (2, 31, "Dixitque Dominus ad me: Ecce cœpi tibi tradere Sehon, et terram ejus: incipe possidere eam."),
    (2, 32, "Egressusque est Sehon obviam nobis cum omni populo suo ad prælium in Jasa."),
    (2, 33, "Et tradidit eum Dominus Deus noster nobis: percussimusque eum cum filiis suis et omni populo suo."),
    (
        2,
        34,
    ...
    (2, 35, "absque jumentis, quæ in partem venere prædantium: et spoliis urbium, quas cepimus"),
    (
        2,
        36,
    ...
    (3, 7, "jumenta autem et spolia urbium diripuimus."),
    (
        3,
        8,
    ...
    (3, 9, "quem Sidonii Sarion vocant, et Amorrhæi Sanir:"),
    (
        3,
        10,
    ...
    (3, 25, "Transibo igitur, et videbo terram hanc optimam trans Jordanem, et montem istum egregium, et Libanum."),
    (
        3,
        26,
    ...
    (4, 4, "Vos autem qui adhæretis Domino Deo vestro, vivitis universi usque in præsentem diem."),
    (
        4,
        5,
    ...
    (4, 16, "ne forte decepti faciatis vobis sculptam similitudinem, aut imaginem masculi vel feminæ:"),
    (4, 17, "similitudinem omnium jumentorum, quæ sunt super terram, vel avium sub cælo volantium,"),
    (4, 18, "atque reptilium, quæ moventur in terra, sive piscium qui sub terra morantur in aquis:"),
    (
        4,
        19,
    ...
    (4, 24, "quia Dominus Deus tuus ignis consumens est, Deus æmulator."),
    (
        4,
        25,
    ...
    (4, 35, "ut scires quoniam Dominus ipse est Deus, et non est alius præter eum."),
    (
        4,
        36,
    ...
    (4, 44, "Ista est lex, quam proposuit Moyses coram filiis Israël:"),
    (
        4,
        45,
    ...
    (4, 48, "ab Aroër, quæ sita est super ripam torrentis Arnon, usque ad montem Sion, qui est et Hermon,"),
    (
        4,
        49,
    ...
    (5, 2, "Dominus Deus noster pepigit nobiscum fœdus in Horeb."),
    (5, 3, "Non cum patribus nostris iniit pactum, sed nobiscum qui in præsentiarum sumus, et vivimus."),
    ...
    (5, 6, "Ego Dominus Deus tuus, qui eduxi te de terra Ægypti, de domo servitutis."),
    ...
    (5, 10, "et faciens misericordiam in multa millia diligentibus me, et custodientibus præcepta mea."),
    (
        5,
        11,
        "Non usurpabis nomen Domini Dei tui frustra: quia non erit impunitus qui super re vana nomen ejus assumpserit.",
    ),
    (5, 12, "Observa diem sabbati, ut sanctifices eum, sicut præcepit tibi Dominus Deus tuus."),
    ...
    (6, 4, "Audi, Israël: Dominus Deus noster, Dominus unus est."),
    (6, 5, "Diliges Dominum Deum tuum ex toto corde tuo, et ex tota anima tua, et ex tota fortitudine tua."),
    (6, 6, "Eruntque verba hæc, quæ ego præcipio tibi hodie, in corde tuo:"),
    (
        6,
        7,
    ...
    (6, 9, "scribesque ea in limine, et ostiis domus tuæ."),
    (
        6,
        10,
    ...
    (6, 14, "Non ibitis post deos alienos cunctarum gentium, quæ in circuitu vestro sunt:"),
    (
        6,
        15,
    ...
    (6, 17, "Custodi præcepta Domini Dei tui, ac testimonia et cæremonias, quas præcepit tibi:"),
    (
        6,
        18,
    ...
    (6, 21, "dices ei: Servi eramus Pharaonis in Ægypto, et eduxit nos Dominus de Ægypto in manu forti:"),
    (
        6,
        22,
    ...
    (7, 11, "Custodi ergo præcepta et cæremonias atque judicia, quæ ego mando tibi hodie ut facias."),
    (
        7,
        12,
    ...
    (7, 17, "Si dixeris in corde tuo: Plures sunt gentes istæ quam ego: quomodo potero delere eas?"),
    (7, 18, "noli metuere, sed recordare quæ fecerit Dominus Deus tuus Pharaoni, et cunctis Ægyptiis,"),
    (
        7,
        19,
    ...
    (8, 5, "ut recogites in corde tuo, quia sicut erudit filium suum homo, sic Dominus Deus tuus erudivit te,"),
    (8, 6, "ut custodias mandata Domini Dei tui, et ambules in viis ejus, et timeas eum."),
    (
        8,
        7,
    ...
    (8, 12, "ne postquam comederis et satiatus fueris, domos pulchras ædificaveris, et habitaveris in eis,"),
    (8, 13, "habuerisque armenta boum, et ovium greges, argenti et auri, cunctarumque rerum copiam,"),
    (
        8,
        14,
    ...
    (8, 17, "ne diceres in corde tuo: Fortitudo mea, et robur manus meæ, hæc mihi omnia præstiterunt:"),
    (
        8,
        18,
    ...
    (9, 13, "Rursumque ait Dominus ad me: Cerno quod populus iste duræ cervicis sit:"),
    (
        9,
        14,
        "dimitte me ut conteram eum, et deleam nomen ejus de sub cælo, et constituam te super gentem, quæ hac major et fortior sit.",
    ),
    (9, 15, "Cumque de monte ardente descenderem, et duas tabulas fœderis utraque tenerem manu,"),
    (
        9,
        16,
    ...
    (9, 22, "In incendio quoque, et in tentatione, et in Sepulchris concupiscentiæ provocastis Dominum:"),
    (
        9,
        23,
    ...
    (9, 24, "sed semper fuistis rebelles a die qua nosse vos cœpi."),
    (
        9,
        25,
    ...
    (10, 2, "et scribam in tabulis verba quæ fuerunt in his qui ante confregisti: ponesque eas in arca."),
    (
        10,
        3,
    ...
    (10, 13, "custodiasque mandata Domini, et cæremonias ejus, quas ego hodie præcipio tibi, ut bene sit tibi?"),
    (10, 14, "En Domini Dei tui cælum est, et cælum cæli, terra, et omnia quæ in ea sunt:"),
    (
        10,
        15,
    ...
    (10, 16, "Circumcidite igitur præputium cordis vestri, et cervicem vestram ne induretis amplius:"),
    (
        10,
        17,
    ...
    (10, 18, "Facit judicium pupillo et viduæ; amat peregrinum, et dat ei victum atque vestitum."),
    (10, 19, "Et vos ergo amate peregrinos, quia et ipsi fuistis advenæ in terra Ægypti."),
    (10, 20, "Dominum Deum tuum timebis, et ei soli servies: ipsi adhærebis, jurabisque in nomine illius."),
    ...
    (11, 3, "signa et opera quæ fecit in medio Ægypti Pharaoni regi, et universæ terræ ejus,"),
    (
        11,
        4,
    ...
    (11, 5, "vobisque quæ fecerit in solitudine donec veniretis ad hunc locum:"),
    (
        11,
        6,
    ...
    (11, 7, "Oculi vestri viderunt opera Domini magna quæ fecit,"),
    (
        11,
        8,
    ...
    (11, 11, "sed montuosa est et campestris, de cælo expectans pluvias,"),
    ...
    (11, 14, "dabit pluviam terræ vestræ temporaneam et serotinam, ut colligatis frumentum, et vinum, et oleum,"),
    (11, 15, "fœnumque ex agris ad pascenda jumenta, et ut ipsi comedatis ac saturemini."),
    (
        11,
        16,
    ...
    (11, 20, "Scribes ea super postes et januas domus tuæ,"),
    (
        11,
        21,
    ...
    (11, 27, "benedictionem, si obedieritis mandatis Domini Dei vestri, quæ ego hodie præcipio vobis:"),
    (
        11,
        28,
    ...
    (11, 32, "Videte ergo ut impleatis cæremonias atque judicia, quæ ego hodie ponam in conspectu vestro."),
    (
        12,
        1,
    ...
    (12, 8, "Non facietis ibi quæ nos hic facimus hodie, singuli quod sibi rectum videtur:"),
    (
        12,
        9,
    ...
    (12, 26, "Quæ autem sanctificaveris, et voveris Domino, tolles, et venies ad locum, quem elegerit Dominus:"),
    (
        12,
        27,
    ...
    (13, 7, "cunctarum in circuitu gentium, quæ juxta vel procul sunt, ab initio usque ad finem terræ,"),
    (13, 8, "non acquiescas ei, nec audias, neque parcat ei oculus tuus ut miserearis et occultes eum,"),
    (13, 9, "sed statim interficies: sit primum manus tua super eum, et postea omnis populus mittat manum."),
    (
        13,
        10,
        "Lapidibus obrutus necabitur: quia voluit te abstrahere a Domino Deo tuo, qui eduxit te de terra Ægypti, de domo servitutis:",
    ),
    (13, 11, "ut omnis Israël audiens timeat, et nequaquam ultra faciat quippiam hujus rei simile."),
    ...
    (14, 3, "Ne comedatis quæ immunda sunt."),
    ...
    (14, 9, "Hæc comedetis ex omnibus quæ morantur in aquis: quæ habent pinnulas et squamas, comedite:"),
    (14, 10, "quæ absque pinnulis et squamis sunt, ne comedatis, quia immunda sunt."),
    (14, 11, "Omnes aves mundas comedite."),
    (14, 12, "Immundas ne comedatis: aquilam scilicet, et gryphem, et haliæetum,"),
    (14, 13, "ixion et vulturem ac milvum juxta genus suum:"),
    (14, 14, "et omne corvini generis,"),
    (14, 15, "et struthionem, ac noctuam, et larum, atque accipitrem juxta genus suum:"),
    (14, 16, "herodium ac cygnum, et ibin,"),
    (14, 17, "ac mergulum, porphyrionem, et nycticoracem,"),
    (14, 18, "onocrotalum, et charadrium, singula in genere suo: upupam quoque et vespertilionem."),
    (14, 19, "Et omne quod reptat et pennulas habet, immundum erit, et non comedetur."),
    ...
    (14, 22, "Decimam partem separabis de cunctis fructibus tuis qui nascuntur in terra per annos singulos,"),
    (
        14,
        23,
    ...
    (15, 3, "A peregrino et advena exiges: civem et propinquum repetendi non habebis potestatem."),
    (
        15,
        4,
    ...
    (15, 8, "sed aperies eam pauperi, et dabis mutuum, quo eum indigere perspexeris."),
    (
        15,
        9,
    ...
    (16, 8, "Sex diebus comedes azyma: et in die septima, quia collecta est Domini Dei tui, non facies opus."),
    (16, 9, "Septem hebdomadas numerabis tibi ab ea die qua falcem in segetem miseris."),
    (
        16,
        10,
    ...
    (16, 12, "Et recordaberis quoniam servus fueris in Ægypto: custodiesque ac facies quæ præcepta sunt."),
    (
        16,
        13,
    ...
    (16, 17, "sed offeret unusquisque secundum quod habuerit juxta benedictionem Domini Dei sui, quam dederit ei."),
    (
        16,
        18,
    ...
    (16, 20, "Juste quod justum est persequeris: ut vivas, et possideas terram, quam Dominus Deus tuus dederit tibi."),
    (16, 21, "Non plantabis lucum, et omnem arborem juxta altare Domini Dei tui."),
    ...
    (17, 10, "Et facies quodcumque dixerint qui præsunt loco quem elegerit Dominus, et docuerint te"),
    (17, 11, "juxta legem ejus, sequerisque sententiam eorum, nec declinabis ad dexteram neque ad sinistram."),
    (
        17,
        12,
    ...
    (17, 17, "Non habebit uxores plurimas, quæ alliciant animum ejus, neque argenti et auri immensa pondera."),
    (
        17,
        18,
    ...
    (18, 11, "nec incantator, nec qui pythones consulat, nec divinos, aut quærat a mortuis veritatem."),
    (18, 12, "Omnia enim hæc abominatur Dominus, et propter istiusmodi scelera delebit eos in introitu tuo."),
    ...
    (18, 19, "Qui autem verba ejus, quæ loquetur in nomine meo, audire noluerit, ego ultor existam."),
    (
        18,
        20,
    ...
    (19, 2, "tres civitates separabis tibi in medio terræ, quam Dominus Deus tuus dabit tibi in possessionem,"),
    (
        19,
        3,
    ...
    (19, 7, "Idcirco præcipio tibi, ut tres civitates æqualis inter se spatii dividas."),
    (
        19,
        8,
    ...
    (19, 13, "Non miseraberis ejus, et auferes innoxium sanguinem de Israël, ut bene sit tibi."),
    (
        19,
        14,
    ...
    (19, 16, "Si steterit testis mendax contra hominem, accusans eum prævaricationis,"),
    (
        19,
        17,
    ...
    (20, 2, "Appropinquante autem jam prælio, stabit sacerdos ante aciem, et sic loquetur ad populum:"),
    (
        20,
        3,
    ...
    (20, 10, "Siquando accesseris ad expugnandam civitatem, offeres ei primum pacem."),
    (
        20,
        11,
        "Si receperit, et aperuerit tibi portas, cunctus populus, qui in ea est, salvabitur, et serviet tibi sub tributo.",
    ),
    (20, 12, "Sin autem fœdus inire noluerit, et cœperit contra te bellum, oppugnabis eam."),
    (
        20,
        13,
    ...
    (20, 16, "De his autem civitatibus, quæ dabuntur tibi, nullum omnino permittes vivere:"),
    (
        20,
        17,
    ...
    (21, 7, "et dicent: Manus nostræ non effuderunt sanguinem hunc, nec oculi viderunt:"),
    (
        21,
        8,
    ...
    (21, 9, "tu autem alienus eris ab innocentis cruore, qui fusus est, cum feceris quod præcepit Dominus."),
    (
        21,
        10,
    ...
    (21, 12, "introduces eam in domum tuam: quæ radet cæsariem, et circumcidet ungues,"),
    (
        21,
        13,
    ...
    (21, 19, "apprehendent eum, et ducent ad seniores civitatis illius, et ad portam judicii,"),
    (
        21,
        20,
    ...
    (21, 22, "Quando peccaverit homo quod morte plectendum est, et adjudicatus morti appensus fuerit in patibulo:"),
    (
        21,
        23,
    ...
    (22, 1, "Non videbis bovem fratris tui, aut ovem errantem, et præteribis: sed reduces fratri tuo,"),
    (
        22,
        2,
    ...
    (23, 1, "Non intravit eunuchus, attritis vel amputatis testiculis et abscisso veretro, ecclesiam Domini."),
    (23, 2, "Non ingredietur mamzer, hoc est, de scorto natus, in ecclesiam Domini, usque ad decimam generationem."),
    (23, 3, "Ammonites et Moabites etiam post decimam generationem non intrabunt ecclesiam Domini in æternum:"),
    (
        23,
        4,
    ...
    (23, 6, "Non facies cum eis pacem, nec quæras eis bona cunctis diebus vitæ tuæ in sempiternum."),
    (23, 7, "Non abominaberis Idumæum, quia frater tuus est: nec Ægyptium, quia advena fuisti in terra ejus."),
    (23, 8, "Qui nati fuerint ex eis, tertia generatione intrabunt in ecclesiam Domini."),
    ...
    (23, 12, "Habebis locum extra castra, ad quem egrediaris ad requisita naturæ,"),
    ...
    (23, 16, "Habitabit tecum in loco, qui ei placuerit, et in una urbium tuarum requiescet: ne contristes eum."),
    (23, 17, "Non erit meretrix de filiabus Israël, nec scortator de filiis Israël."),
    (
        23,
        18,
    ...
    (23, 19, "Non fœnerabis fratri tuo ad usuram pecuniam, nec fruges, nec quamlibet aliam rem:"),
    (
        23,
        20,
    ...
    (24, 6, "Non accipies loco pignoris inferiorem, et superiorem molam: quia animam suam opposuit tibi."),
    (
        24,
        7,
    ...
    (24, 9, "Mementote quæ fecerit Dominus Deus vester Mariæ in via cum egrederemini de Ægypto."),
    (24, 10, "Cum repetes a proximo tuo rem aliquam, quam debet tibi, non ingredieris domum ejus ut pignus auferas:"),
    ...
    (24, 16, "Non occidentur patres pro filiis, nec filii pro patribus, sed unusquisque pro peccato suo morietur."),
    (24, 17, "Non pervertes judicium advenæ et pupilli, nec auferes pignoris loco viduæ vestimentum."),
    (
        24,
        18,
    ...
    (25, 6, "et primogenitum ex ea filium nomine illius appellabit, ut non deleatur nomen ejus ex Israël."),
    (
        25,
        7,
    ...
    (25, 10, "Et vocabitur nomen illius in Israël, Domus discalceati."),
    (
        25,
        11,
    ...
    (25, 13, "Non habebis in sacculo diversa pondera, majus et minus:"),
    (25, 14, "nec erit in domo tua modius major, et minor."),
    (
        25,
        15,
    ...
    (25, 16, "Abominatur enim Dominus tuus eum qui facit hæc, et aversatur omnem injustitiam."),
    (25, 17, "Memento quæ fecerit tibi Amalec in via quando egrediebaris ex Ægypto:"),
    (
        25,
        18,
    ...
    (26, 6, "Afflixeruntque nos Ægyptii, et persecuti sunt, imponentes onera gravissima:"),
    (
        26,
        7,
    ...
    (26, 8, "et eduxit nos de Ægypto in manu forti, et brachio extento, in ingenti pavore, in signis atque portentis:"),
    ...
    (27, 5, "et ædificabis ibi altare Domino Deo tuo de lapidibus, quos ferrum non tetigit,"),
    (27, 6, "et de saxis informibus et impolitis: et offeres super eo holocausta Domino Deo tuo,"),
    (27, 7, "et immolabis hostias pacificas, comedesque ibi, et epulaberis coram Domino Deo tuo."),
    (27, 8, "Et scribes super lapides omnia verba legis hujus plane et lucide."),
    (
        27,
        9,
    ...
    (27, 10, "audies vocem ejus, et facies mandata atque justitias, quas ego præcipio tibi."),
    (27, 11, "Præcepitque Moyses populo in die illo, dicens:"),
    (
        27,
        12,
    ...
    (27, 14, "Et pronuntiabunt Levitæ, dicentque ad omnes viros Israël excelsa voce:"),
    (
        27,
        15,
    ...
    (27, 18, "Maledictus qui errare facit cæcum in itinere: et dicet omnis populus: Amen."),
    (27, 19, "Maledictus qui pervertit judicium advenæ, pupilli et viduæ: et dicet omnis populus: Amen."),
    (
        27,
        20,
        "Maledictus qui dormit cum uxore patris sui, et revelat operimentum lectuli ejus: et dicet omnis populus: Amen.",
    ),
    (27, 21, "Maledictus qui dormit cum omni jumento: et dicet omnis populus: Amen."),
    (27, 22, "Maledictus qui dormit cum sorore sua, filia patris sui, vel matris suæ: et dicet omnis populus: Amen."),
    ...
    (28, 2, "Venientque super te universæ benedictiones istæ, et apprehendent te: si tamen præcepta ejus audieris."),
    ...
    (28, 5, "Benedicta horrea tua, et benedictæ reliquiæ tuæ."),
    (28, 6, "Benedictus eris tu ingrediens et egrediens."),
    (
        28,
        7,
    ...
    (28, 17, "Maledictum horreum tuum, et maledictæ reliquiæ tuæ."),
    (28, 18, "Maledictus fructus ventris tui, et fructus terræ tuæ, armenta boum tuorum, et greges ovium tuarum."),
    ...
    (28, 21, "Adjungat tibi Dominus pestilentiam, donec consumat te de terra ad quam ingredieris possidendam."),
    (
        28,
        22,
        "Percutiat te Dominus egestate, febri et frigore, ardore et æstu, et aëre corrupto ac rubigine, et persequatur donec pereas.",
    ),
    (28, 23, "Sit cælum, quod supra te est, æneum: et terra, quam calcas, ferrea."),
    (28, 24, "Det Dominus imbrem terræ tuæ pulverem, et de cælo descendat super te cinis, donec conteraris."),
    (
        28,
        25,
    ...
    (28, 26, "sitque cadaver tuum in escam cunctis volatilibus cæli, et bestiis terræ, et non sit qui abigat."),
    (
        28,
        27,
    ...
    (28, 28, "Percutiat te Dominus amentia et cæcitate ac furore mentis,"),
    (
        28,
        29,
    ...
    (28, 34, "et stupens ad terrorem eorum quæ videbunt oculi tui."),
    (
        28,
        35,
    ...
    (28, 38, "Sementem multam jacies in terram, et modicum congregabis: quia locustæ devorabunt omnia."),
    (
        28,
        39,
        "Vineam plantabis, et fodies: et vinum non bibes, nec colliges ex ea quippiam: quoniam vastabitur vermibus.",
    ),
    (28, 40, "Olivas habebis in omnibus terminis tuis, et non ungeris oleo: quia defluent, et peribunt."),
    (28, 41, "Filios generabis et filias, et non frueris eis: quoniam ducentur in captivitatem."),
    (28, 42, "Omnes arbores tuas et fruges terræ tuæ rubigo consumet."),
    (
        28,
        43,
        "Advena, qui tecum versatur in terra, ascendet super te, eritque sublimior: tu autem descendes, et eris inferior.",
    ),
    (28, 44, "Ipse fœnerabit tibi, et tu non fœnerabis ei. Ipse erit in caput, et tu eris in caudam."),
    (
        28,
        45,
    ...
    (28, 47, "eo quod non servieris Domino Deo tuo in gaudio, cordisque lætitia, propter rerum omnium abundantiam."),
    (
        28,
        48,
    ...
    (28, 50, "gentem procacissimam, quæ non deferat seni, nec misereatur parvuli,"),
    (
        28,
        51,
    ...
    (28, 54, "Homo delicatus in te, et luxuriosus valde, invidebit fratri suo, et uxori, quæ cubat in sinu suo,"),
    (
        28,
        55,
    ...
    (28, 60, "et convertet in te omnes afflictiones Ægypti, quas timuisti, et adhærebunt tibi."),
    (
        28,
        61,
    ...
    (28, 66, "et erit vita tua quasi pendens ante te. Timebis nocte et die, et non credes vitæ tuæ."),
    (
        28,
        67,
    ...
    (29, 8, "et tulimus terram eorum, ac tradidimus possidendam Ruben et Gad, et dimidiæ tribui Manasse."),
    (29, 9, "Custodite ergo verba pacti hujus, et implete ea: ut intelligatis universa quæ facitis."),
    (
        29,
        10,
    ...
    (29, 12, "ut transeas in fœdere Domini Dei tui, et in jurejurando quod hodie Dominus Deus tuus percutit tecum:"),
    (
        29,
        13,
    ...
    (29, 14, "Nec vobis solis ego hoc fœdus ferio, et hæc juramenta confirmo,"),
    (29, 15, "sed cunctis præsentibus et absentibus."),
    (
        29,
        16,
    ...
    (29, 24, "Et dicent omnes gentes: Quare sic fecit Dominus terræ huic? quæ est hæc ira furoris ejus immensa?"),
    (
        29,
        25,
    ...
    (30, 4, "Si ad cardines cæli fueris dissipatus, inde te retrahet Dominus Deus tuus,"),
    (
        30,
        5,
    ...
    (30, 11, "Mandatum hoc, quod ego præcipio tibi hodie, non supra te est, neque procul positum,"),
    (
        30,
        12,
    ...
    (30, 14, "sed juxta te est sermo valde, in ore tuo, et in corde tuo, ut facias illum."),
    ...
    (31, 1, "Abiit itaque Moyses, et locutus est omnia verba hæc ad universum Israël,"),
    (
        31,
        2,
    ...
    (31, 4, "Facietque Dominus eis sicut fecit Sehon et Og regibus Amorrhæorum, et terræ eorum, delebitque eos."),
    (31, 5, "Cum ergo et hos tradiderit vobis, similiter facietis eis, sicut præcepi vobis."),
    (
        31,
        6,
    ...
    (31, 10, "Præcepitque eis, dicens: Post septem annos, anno remissionis, in solemnitate tabernaculorum,"),
    (
        31,
        11,
    ...
    (31, 15, "apparuitque Dominus ibi in columna nubis, quæ stetit in introitu tabernaculi."),
    (
        31,
        16,
    ...
    (31, 22, "Scripsit ergo Moyses canticum, et docuit filios Israël."),
    (
        31,
        23,
    ...
    (31, 25, "præcepit Levitis, qui portabant arcam fœderis Domini, dicens:"),
    (
        31,
        26,
    ...
    (32, 1, "[Audite, cæli, quæ loquor: audiat terra verba oris mei."),
    (
        32,
        2,
    ...
    (32, 9, "Pars autem Domini, populus ejus: Jacob funiculus hæreditatis ejus."),
    (
        32,
        10,
    ...
    (32, 19, "[Vidit Dominus, et ad iracundiam concitatus est: quia provocaverunt eum filii sui et filiæ."),
    (
        32,
        20,
    ...
    (32, 32, "De vinea Sodomorum, vinea eorum, et de suburbanis Gomorrhæ: uva eorum, uva fellis, et botri amarissimi."),
    (32, 33, "Fel draconum vinum eorum, et venenum aspidum insanabile."),
    (32, 34, "Nonne hæc condita sunt apud me, et signata in thesauris meis?"),
    (
        32,
        35,
    ...
    (32, 40, "Levabo ad cælum manum meam, et dicam: Vivo ego in æternum."),
    (
        32,
        41,
    ...
    (32, 45, "Complevitque omnes sermones istos, loquens ad universum Israël,"),
    (
        32,
        46,
    ...
    (32, 52, "E contra videbis terram, et non ingredieris in eam, quam ego dabo filiis Israël."),
    (33, 1, "Hæc est benedictio, qua benedixit Moyses, homo Dei, filiis Israël ante mortem suam."),
    (
        33,
        2,
    ...
    (33, 4, "Legem præcepit nobis Moyses, hæreditatem multitudinis Jacob."),
    (33, 5, "Erit apud rectissimum rex, congregatis principibus populi cum tribubus Israël."),
    ...
    (33, 13, "Joseph quoque ait: [De benedictione Domini terra ejus, de pomis cæli, et rore, atque abysso subjacente."),
    (33, 14, "De pomis fructuum solis ac lunæ,"),
    (33, 15, "de vertice antiquorum montium, de pomis collium æternorum:"),
    (
        33,
        16,
    ...
    (33, 18, "Et Zabulon ait: [Lætare, Zabulon, in exitu tuo, et Issachar in tabernaculis tuis."),
    (
        33,
        19,
    ...
    (33, 24, "Aser quoque ait: [Benedictus in filiis Aser, sit placens fratribus suis, et tingat in oleo pedem suum:"),
    (33, 25, "ferrum et æs calceamentum ejus. Sicut dies juventutis tuæ, ita et senectus tua."),
    (
        33,
        26,
    ...
    (34, 2, "et universum Nephthali, terramque Ephraim et Manasse, et omnem terram Juda usque ad mare novissimum,"),
    (34, 3, "et australem partem, et latitudinem campi Jericho civitatis palmarum usque Segor."),
    (
        34,
        4,
    ...
    (34, 5, "Mortuusque est ibi Moyses servus Domini, in terra Moab, jubente Domino:"),
    (
        34,
        6,
    ...
    (34, 10, "Et non surrexit ultra propheta in Israël sicut Moyses, quem nosset Dominus facie ad faciem,"),
    (
        34,
        11,
    ...
    (34, 12, "et cunctam manum robustam, magnaque mirabilia, quæ fecit Moyses coram universo Israël."),
]
