"""Translation: vulgate-clementine · Book: 2ma
...
VERSES = [
    ...
    (1, 3, "et det vobis cor omnibus ut colatis eum, et faciatis ejus voluntatem, corde magno et animo volenti."),
    ...
    (1, 26, "accipe sacrificium pro universo populo tuo Israël, et custodi partem tuam, et sanctifica."),
    (
        1,
        27,
    ...
    (1, 31, "Cum autem consumptum esset sacrificium, ex residua aqua Nehemias jussit lapides majores perfundi."),
    ...
    (
        2,
        18,
        "sicut promisit in lege, speramus quod cito nostri miserebitur, et congregavit de sub cælo in locum sanctum. Eripuit enim nos de magnis periculis, et locum purgavit.",
    ),
    (2, 19, "De Juda vero Machabæo, et fratribus ejus, et de templi magni purificatione, et de aræ dedicatione,"),
    (2, 20, "sed et de præliis quæ pertinent ad Antiochum Nobilem et filium ejus Eupatorem,"),
    (
        2,
        21,
    ...
    (2, 23, "Itemque ab Jasone Cyrenæo quinque libris comprehensa tentavimus nos uno volumine breviare."),
    (
        2,
        24,
    ...
    (2, 31, "brevitatem vero dictionis sectari, et executiones rerum vitare, brevianti concedendum est."),
    (
        2,
        32,
    ...
    (3, 21, "erat enim misera commistæ multitudinis, et magni sacerdotis in agone constituti exspectatio."),
    (
        3,
        22,
    ...
    (4, 43, "De his ergo cœpit judicium adversus Menelaum agitari."),
    ...
    (4, 48, "Cito ergo injustam pœnam dederunt, qui pro civitate, et populo, et sacris vasis causam prosecuti sunt."),
    ...
    (6, 17, "Sed hæc nobis ad commonitionem legentium dicta sint paucis. Jam enim veniendum est ad narrationem."),
    (
        6,
        18,
    ...
    (7, 3, "Iratus itaque rex, jussit sartagines et ollas æneas succendi: quibus statim succensis,"),
    (
        7,
        4,
    ...
    (8, 12, "Judas autem ubi comperit, indicavit his qui secum erant Judæis Nicanoris adventum."),
    (8, 13, "Ex quibus quidam formidantes, et non credentes Dei justitiæ, in fugam vertebantur:"),
    (
        8,
        14,
    ...
    (8, 32, "et Philarchen, qui cum Timotheo erat, interfecerunt, virum scelestum, qui in multis Judæos afflixerat."),
    (
        8,
        33,
    ...
    (8, 34, "Facinorosissimus autem Nicanor, qui mille negotiantes ad Judæorum venditionem adduxerat,"),
    (
        8,
        35,
    ...
    (9, 17, "super hæc, et Judæum se futurum, et omnem locum terræ perambulaturum, et prædicaturum Dei potestatem."),
    (
        9,
        18,
    ...
    (9, 19, "Optimis civibus Judæis plurimam salutem, et bene valere, et esse felices, rex et principes Antiochus."),
    ...
    (10, 2, "aras autem quas alienigenæ per plateas exstruxerant, itemque delubra demolitus est:"),
    (
        10,
        3,
    ...
    (10, 8, "Et decreverunt communi præcepto et decreto universæ genti Judæorum omnibus annis agere dies istos."),
    ...
    (10, 14, "Gorgias autem cum esset dux locorum, assumptis advenis, frequenter Judæos debellabat."),
    (
        10,
        15,
    ...
    (12, 1, "His factis pactionibus, Lysias pergebat ad regem, Judæi autem agriculturæ operam dabant."),
    (
        12,
        2,
    ...
    (12, 7, "Et cum hæc ita egisset, discessit quasi iterum reversurus, et universos Joppitas eradicaturus."),
    (12, 8, "Sed cum cognovisset et eos qui erant Jamniæ, velle pari modo facere habitantibus secum Judæis,"),
    (
        12,
        9,
    ...
    (12, 29, "Inde ad civitatem Scytharum abierunt, quæ ab Jerosolymis sexcentis stadiis aberat."),
    (
        12,
        30,
    ...
    (12, 34, "Quibus congressis, contigit paucos ruere Judæorum."),
    (
        12,
        35,
    ...
    (13, 6, "Inde in cinerem dejici jussit sacrilegum, omnibus eum propellentibus ad interitum."),
    ...
    (13, 9, "Sed rex mente effrenatus veniebat, nequiorem se patre suo Judæis ostensurus."),
    (
        13,
        10,
    ...
    (13, 17, "Hoc autem factum est die illucescente, adjuvante eum Domini protectione."),
    (13, 18, "Sed rex, accepto gustu audaciæ Judæorum, arte difficultatem locorum tentabat:"),
    (
        13,
        19,
        "et Bethsuræ, quæ erat Judæorum præsidium munitum, castra admovebat: sed fugabatur, impingebat, minorabatur.",
    ),
    (13, 20, "His autem qui intus erant, Judas necessaria mittebat."),
    (
        13,
        21,
    ...
    (14, 12, "Qui statim Nicanorem præpositum elephantorum ducem misit in Judæam:"),
    (
        14,
        13,
    ...
    (14, 17, "Simon vero frater Judæ commiserat cum Nicanore: sed conterritus est repentino adventu adversariorum."),
    (
        14,
        18,
    ...
    (14, 32, "Quibus cum juramento dicentibus nescire se ubi esset qui quærebatur, extendens manum ad templum,"),
    (
        14,
        33,
    ...
    (14, 40, "Putabat enim, si illum decepisset, se cladem Judæis maximam illaturum."),
    (
        14,
        41,
    ...
    (
        15,
        36,
        "Itaque omnes communi consilio decreverunt nullo modo diem istum absque celebritate præterire: habere autem celebritatem tertiadecima die mensis Adar, quod dicitur voce syriaca, pridie Mardochæi diei.",
    ),
    (
        15,
        37,
