"""Translation: vulgate-clementine · Book: pro
...
VERSES = [
    ...
    (7, 17, "aspersi cubile meum myrrha, et aloë, et cinnamomo."),
    ...
    (23, 10, "Ne attingas parvulorum terminos, et agrum pupillorum ne introëas:"),
