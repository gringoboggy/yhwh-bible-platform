"""Translation: vulgate-clementine · Book: zep
...
VERSES = [
    ...
    (1, 5, "et eos qui adorant super tecta militiam cæli, et adorant et jurant in Domino, et jurant in Melchom;"),
    ...
    (3, 3, "Principes ejus in medio ejus quasi leones rugientes; judices ejus lupi vespere, non relinquebant in mane."),
    (3, 4, "Prophetæ ejus vesani, viri infideles; sacerdotes ejus polluerunt sanctum, injuste egerunt contra legem."),
    (
        3,
        5,
    ...
    (3, 14, "Lauda, filia Sion; jubila, Israël: lætare, et exsulta in omni corde, filia Jerusalem."),
    (
        3,
        15,
        "Abstulit Dominus judicium tuum; avertit inimicos tuos. Rex Israël Dominus in medio tui: non timebis malum ultra.",
    ),
    (3, 16, "In die illa dicetur Jerusalem: Noli timere; Sion: Non dissolvantur manus tuæ."),
    (
        3,
        17,
