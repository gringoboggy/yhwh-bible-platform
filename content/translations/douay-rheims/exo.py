"""Translation: douay-rheims · Book: exo
...
VERSES = [
    ...
    (26, 16, "Let every one of them be ten cubits in length, and in breadth on cubit and a half."),
    (
        26,
        17,
    ...
    (
        38,
        27,
        "There were moreover a hundred talents of silver, whereof were cast the sockets of the sanctuary, and of the entry where the veil hangeth. A hundred sockets were made of a hundred talents, one talent being reckoned for every socket.",
    ),
    (
        38,
        28,
    ...
    (39, 22, "They made also the tunick of the ephod all of violet,"),
    (39, 23, "And a hole for the head in the upper part at the middle, and a woven border round about the hole:"),
    (39, 24, "And beneath at the feet pomegranates of violet, purple, scarlet, and fine twisted linen:"),
    (
        39,
        25,
    ...
    (39, 27, "They made also fine linen tunicks with woven work for Aaron and his sons:"),
    (39, 28, "And mitres with their little crowns of fine linen: And linen breeches of fine linen:"),
    (
        39,
        29,
    ...
    (39, 31, "And they fastened it to the mitre with a violet fillet, as the Lord had commanded Moses."),
    (
        39,
        32,
    ...
    (39, 34, "The cover of rams’ skins dyed red, and the other cover of violet skins,"),
    (39, 35, "The veil, the ark, the bars, the propitiatory,"),
    (39, 36, "The table, with the vessels thereof, and the loaves of proposition:"),
    (39, 37, "The candlestick, the lamps, and the furniture of them with the oil:"),
    (
        39,
        38,
        "The altar of gold, and the ointment, and the incense of spices: And the hanging in the entry of the tabernacle:",
    ),
    (
        39,
        39,
    ...
    (40, 16, "And Moses did all that the Lord had commanded."),
    (40, 17, "So in the first month of the second year, the first day of the month, the tabernacle was set up."),
    (40, 18, "And Moses reared it up, and placed the boards and the sockets and the bars, and set up the pillars,"),
    (40, 19, "And spread the roof over the tabernacle, putting over it a cover, as the Lord had commanded."),
    (40, 20, "And he put the testimony in the ark, thrusting bars underneath, and the oracle above."),
    (
        40,
        21,
        "And when he had brought the ark into the tabernacle, he drew the veil before it to fulfill the commandment of the Lord.",
    ),
    (40, 22, "And he set the table in the tabernacle of the testimony at the north side without the veil,"),
    (40, 23, "Setting there in order the loaves of proposition, as the Lord had commanded Moses."),
    (
        40,
        24,
        "He set the candlestick also in the tabernacle of the testimony over against the table on the south side,",
    ),
    (40, 25, "Placing the lamps in order, according to the precept of the Lord."),
    (40, 26, "He set also the altar of gold under the roof of the testimony over against the veil,"),
    (40, 27, "And burnt upon it the incense of spices, as the Lord had commanded Moses."),
    (40, 28, "And he put also the hanging in the entry of the tabernacle of the testimony,"),
    (
        40,
        29,
    ...
    (40, 30, "And he set the laver between the tabernacle of the testimony and the altar, filling it with water."),
    (40, 31, "And Moses and Aaron, and his sons washed their hands and feet,"),
    (
        40,
        32,
    ...
    (40, 34, "The cloud covered the tabernacle of the testimony, and the glory of the Lord filled it."),
    (
        40,
        35,
    ...
    (40, 37, "If it hung over, they remained in the same place."),
    (
        40,
        38,
