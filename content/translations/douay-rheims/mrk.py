"""Translation: douay-rheims · Book: mrk
...
VERSES = [
    ...
    (9, 3, "And his garments became shining and exceeding white as snow, so as no fuller upon earth can make white."),
    ...
    (9, 6, "For he knew not what he said: for they were struck with fear."),
    (
        9,
        7,
    ...
    (9, 8, "And immediately looking about, they saw no man any more, but Jesus only with them."),
    (
        9,
        9,
    ...
    (9, 11, "And they asked him, saying: Why then do the Pharisees and scribes say that Elias must come first?"),
    (
        9,
        12,
    ...
    (9, 14, "And coming to his disciples, he saw a great multitude about them, and the scribes disputing with them."),
    (
        9,
        15,
        "And presently all the people seeing Jesus, were astonished and struck with fear; and running to him, they saluted him.",
    ),
    (9, 16, "And he asked them: What do you question about among you?"),
    (9, 17, "And one of the multitude, answering, said: Master, I have brought my son to thee, having a dumb spirit."),
    (
        9,
        18,
    ...
    (9, 23, "And Jesus saith to him: If thou canst believe, all things are possible to him that believeth."),
    ...
    (9, 28, "And when he was come into the house, his disciples secretly asked him: Why could not we cast him out?"),
    (9, 29, "And he said to them: This kind can go out by nothing, but by prayer and fasting."),
    (9, 30, "And departing from thence, they passed through Galilee, and he would not that any man should know it."),
    (
        9,
        31,
    ...
    (9, 32, "But they understood not the word, and they were afraid to ask him."),
    (
        9,
        33,
    ...
    (9, 36, "And taking a child, he set him in the midst of them. Whom when he had embraced, he saith to them:"),
    (
        9,
        37,
    ...
    (9, 40, "For he that is not against you, is for you."),
    (
        9,
        41,
    ...
    (9, 44, "Where there worm dieth not, and the fire is not extinguished."),
    (
        9,
        45,
    ...
    (9, 48, "Where the worm dieth not, and the fire is not extinguished."),
    (9, 49, "For every one shall be salted with fire: and every victim shall be salted with salt."),
    (
        9,
        50,
