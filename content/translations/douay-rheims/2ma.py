"""Translation: douay-rheims · Book: 2ma
...
VERSES = [
    ...
    (
        1,
        8,
        "They burnt the gate, and shed innocent blood: then we prayed to the Lord, and were heard, and we offered sacrifices, and fine flour, and lighted the lamps, and set forth the leaves.",
    ),
    (1, 9, "And now celebrate ye the days of Scenopegia in the month of Casleu."),
    (
        1,
        10,
        "In the year Bone hundred and eighty-eight, the people that is at Jerusalem, and in Judea, and the senate, and Judas, to Aristobolus, the preceptor of king Ptolemee, who is of the stock of the anointed priests, and to the Jews that are in Egypt, health and welfare.",
    ),
    (
        1,
        11,
    ...
    (
        1,
        16,
        "When Antiochus was came in: and opening a secret entrance of the temple, they cast stones and slew the leader, and them that were with him, and hewed them in pieces, and cutting off their heads they threw them forth.",
    ),
    ...
    (
        1,
        19,
        "For when our fathers were led in Persia, the priests that then were worshippers of God took privately the fire from the altar, and hid it in a valley where there was a deep pit without water, and there they kept it safe, so that the place was unknown to all men.",
    ),
    (
        1,
        20,
    ...
    (
        1,
        24,
        "And the prayer of Nehemias was after this manner: O Lord God, Creator of all things, dreadful and strong, just and merciful, who alone art the goad king,",
    ),
    (
        1,
        25,
    ...
    (2, 6, "Then some of them that followed him, came up to mark the place: but they could not And it."),
    (
        2,
        7,
    ...
    (2, 20, "As also the wars against Antioch the Illustrious, and his son Eupator:"),
    (
        2,
        21,
    ...
    (
        5,
        12,
        "And commanded the soldiers to kill, and not to spare any that came in their way, and to go up into the houses slay.",
    ),
    (
        5,
        13,
        "Thus there was a slaughter of young and old, a destruction of women children, and killing of virgins and infants.",
    ),
    (
        5,
        14,
        "And there were slain in the space o three whole days fourscore thousand, forty thousand were made prisoners, and as many sold.",
    ),
    (
        5,
        15,
    ...
    (
        5,
        18,
        "Otherwise had they not been involved in many sins, as Heliodorus, who was sent by king Seleucus to rob treasury, so this man also, as soon as had come, had been forthwith scourged, and put back from his presumption.",
    ),
    ...
    (11, 10, "So they went on courageously, having a helper from Peaven, and the who shewed mercy to them."),
    (
        11,
        11,
    ...
    (12, 1, "When these covenants were made, Lyslas went to the king, and the Jews gave themselves to husbandry."),
    (
        12,
        2,
    ...
    (13, 24, "He embraced Machabeus, and made him governor and prince from Ptolemais unto the Cerrenians."),
    (
        13,
        25,
