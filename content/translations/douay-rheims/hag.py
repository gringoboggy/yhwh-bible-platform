"""Translation: douay-rheims · Book: hag
...
VERSES = [
    ...
    (2, 1, "And in the seventh month, the word of the Lord came by the hand of Aggeus the prophet, saying:"),
    (
        2,
        2,
    ...
    (2, 11, "Thus saith the Lord of hosts: Ask the priests the law, saying:"),
    (
        2,
        12,
    ...
    (2, 21, "Speak to Zorobabel the governor of Juda, saying: I will move both heaven and earth."),
    (
        2,
        22,
