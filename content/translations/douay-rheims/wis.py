"""Translation: douay-rheims · Book: wis
...
VERSES = [
    ...
    (2, 24, "But by the envy of the devil, death came into the world: And they follow him that are of his side."),
    ...
    (
        5,
        13,
        "So we also being born, forthwith ceased to be: and have been able to shew no mark of virtue: but are consumed in our wickedness. Such things as these the sinners said in hell:",
    ),
    (
        5,
        14,
    ...
    (5, 17, "And his zeal will take armour, and he will arm the creature for the revenge of his enemies."),
    (5, 18, "He will put on justice as a breastplate, and will take true judgment instead of a helmet."),
    (5, 19, "He will take equity for an invincible shield:"),
    (
        5,
        20,
    ...
    (
        6,
        1,
        "Wisdom is better than strength, and a wise man is better than a strong man. Hear therefore, ye kings, and understand: learn, ye that are judges of the ends of the earth.",
    ),
    ...
    (
        6,
        21,
        "If then your delight be in thrones, and sceptres, O ye kings of the people, love wisdom, that you may reign for ever. Love the light of wisdom, all ye that bear rule over peoples.",
    ),
    (
        6,
        22,
    ...
    (17, 12, "For fear is nothing else but a yielding up of the succours from thought."),
    (
        17,
        13,
    ...
    (17, 16, "Moreover if any of them had fallen down, he was kept shut up in prison without irons."),
    (
        17,
        17,
    ...
    (17, 20, "For the whole world was enlightened with a clear light, and none were hindered in their labours."),
    (
        17,
        21,
    ...
    (19, 16, "But these grievously afflicted them whom they had received with joy, and who lived under the same laws."),
    (
        19,
        17,
    ...
    (19, 20, "The fire had power in water above its own virtue, and the water forgot its quenching nature."),
    (
        19,
        22,
