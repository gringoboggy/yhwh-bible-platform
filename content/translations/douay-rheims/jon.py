"""Translation: douay-rheims · Book: jon
...
VERSES = [
    ...
    (2, 4, "And I said: I am cast away out of the sight of thy eyes: but yet I shall see thy holy temple again."),
    (
        2,
        5,
    ...
    (2, 8, "They that are vain observe vanities, forsake their own mercy."),
    (
        2,
        9,
