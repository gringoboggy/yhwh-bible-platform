"""Translation: douay-rheims · Book: psa
...
VERSES = [
    ...
    (13, 3, "Consider, and hear me, O Lord my God. Enlighten my eyes that I never sleep in death:"),
    (
        13,
        4,
    ...
    (15, 1, "A psalm of David. Lord, who shall dwell in thy tabernacle? or who shall rest in thy holy hill?"),
    ...
    (16, 1, "The inscription of a title to David himself. Preserve me, O Lord, for I have put trust in thee."),
    ...
    (16, 10, "Because thou wilt not leave my soul in hell; nor wilt then give thy holy one to see corruption."),
    (
        16,
        11,
    ...
    (18, 22, "For till his judgments are in my sight: and his justices I have not put away from me."),
    ...
    (18, 26, "And with the elect thou wilt be elect: and with the perverse thou wilt be perverted."),
    ...
    (18, 40, "And thou hast made my enemies turn their back upon me, and hast destroyed them that hated me."),
    ...
    (18, 46, "The Lord liveth, and blessed be my God, and let the God of my salvation be exalted:"),
    (18, 47, "O God, who avengest me, and subduest the people under me, my deliverer from my enemies."),
    ...
    (20, 1, "May the Lord hear thee in the day of tribulation: may the name of the God of Jacob protect thee."),
    (20, 2, "May he send thee help from the sanctuary: and defend thee out of Sion."),
    (20, 3, "May he be mindful of all thy sacrifices: and may thy whole burnt offering be made fat."),
    (20, 4, "May he give thee according to thy own heart; and confirm all thy counsels."),
    (20, 5, "We will rejoice in thy salvation; and in the name of our God we shall be exalted."),
    (
        20,
        6,
    ...
    (21, 2, "Thou hast given him his heart’s desire: and hast not withholden from him the will of his lips."),
    (
        21,
        3,
    ...
    (23, 1, "A psalm for David. The Lord ruleth me: and I shall want nothing."),
    ...
    (24, 2, "For he hath founded it upon the seas; and hath prepared it upon the rivers."),
    (24, 3, "Who shall ascend into the mountain of the Lord: or who shall stand in his holy place?"),
    (
        24,
        4,
    ...
    (24, 6, "This is the generation of them that seek him, of them that seek the face of the God of Jacob."),
    (
        24,
        7,
    ...
    (26, 2, "Prove me, O Lord, and try me; burn my reins and my heart."),
    (26, 3, "For thy mercy is before my eyes; and I am well pleased with thy truth."),
    (26, 4, "I have not sat with the council of vanity: neither will I go in with the doers of unjust things."),
    (26, 5, "I have hated the assembly of the malignant; and with the wicked I will not sit."),
    (26, 6, "I will wash my hands among the innocent; and will compass thy altar, O Lord:"),
    (26, 7, "That I may hear the voice of thy praise: and tell of all thy wondrous works."),
    (26, 8, "I have loved, O Lord, the beauty of thy house; and the place where thy glory dwelleth."),
    (26, 9, "Take not away my soul, O God, with the wicked: nor my life with bloody men:"),
    (26, 10, "In whose hands are iniquities: their right hand is filled with gifts."),
    (26, 11, "But as for me, I have walked in my innocence: redeem me, and have mercy on me."),
    (26, 12, "My foot hath stood in the direct way: in the churches I will bless thee, O Lord."),
    (
        27,
        1,
    ...
    (27, 7, "Hear, O Lord, my voice, with which I have cried to thee: have mercy on me and hear me."),
    (27, 8, "My heart hath said to thee: My face hath sought thee: thy face, O Lord, will I still seek."),
    (
        27,
        9,
    ...
    (27, 10, "For my father and my mother have left me: but the Lord hath taken me up."),
    (27, 11, "Set me, O Lord, a law in thy way, and guide me in the right path, because of my enemies."),
    (
        27,
        12,
    ...
    (27, 13, "I believe to see the good things of the Lord in the land of the living."),
    ...
    (28, 6, "Blessed be the Lord, for he hath heard the voice of my supplication."),
    (
        28,
        7,
    ...
    (28, 8, "The Lord is the strength of his people, and the protector of the salvation of his anointed."),
    (28, 9, "Save, O Lord, thy people, and bless thy inheritance: and rule them and exalt them for ever."),
    (
        29,
        1,
    ...
    (29, 10, "The Lord maketh the flood to dwell: and the Lord shall sit king for ever."),
    ...
    (33, 1, "A psalm for David. Rejoice in the Lord, O ye just: praise becometh the upright."),
    ...
    (33, 22, "Let thy mercy, O Lord, be upon us, as we have hoped in thee."),
    ...
    (34, 12, "Who is the man that desireth life: who loveth to see good days?"),
    ...
    (34, 20, "The Lord keepeth all their bones, not one of them shall be broken."),
    ...
    (35, 1, "For David himself. Judge thou, O Lord, them that wrong me: overthrow them that fight against me."),
    ...
    (35, 17, "Lord, when wilt thou look upon me? rescue thou soul from their malice: my only one from the lions."),
    ...
    (35, 28, "Any my tongue shall meditate thy justice, thy praise all the day long."),
    ...
    (37, 1, "A psalm for David himself. Be not emulous of evildoers; nor envy them that work iniquity."),
    ...
    (37, 9, "For the evildoers shall be cut off: but they that wait upon the Lord shall inherit the land."),
    (
        37,
        10,
    ...
    (37, 18, "The Lord knoweth the days of undefiled; and their inheritance shall be for ever."),
    ...
    (37, 33, "But the Lord will not leave in his hands; nor condemn him when he shall be judged."),
    (
        37,
        34,
    ...
    (40, 15, "Let them immediately bear their confusion, that say to me: Tis well, tis well."),
    (
        40,
        16,
    ...
    (41, 9, "For even the man of peace, in whom I trusted, who ate my bread, hath greatly supplanted me."),
    (41, 10, "But thou, O Lord, have mercy on me, and raise me up again: and I will requite them."),
    ...
    (41, 13, "Blessed by the Lord the God of Israel from eternity to eternity. So be it. So be it."),
    ...
    (42, 3, "My tears have been any bread day and night, whilst it is said to me daily: Where is thy God?"),
    (
        42,
        4,
    ...
    (43, 4, "And I will go in to the altar of God: to God who giveth joy to my youth."),
    (
        43,
        5,
    ...
    (44, 4, "Thou art thyself my king and my God, who commandest the saving of Jacob."),
    (
        44,
        5,
    ...
    (44, 7, "But thou hast saved us from them that afflict us: and hast put them to shame that hate us."),
    (44, 8, "In God shall we glory all the day long: and in thy name we will give praise for ever."),
    (44, 9, "But now thou hast cast us off, and put us to shame: and thou, O God, wilt not go out with our armies."),
    (44, 10, "Thou hast made us turn our back to our enemies: and they that hated us plundered for themselves."),
    (44, 11, "Thou hast given us up like sheep to be eaten: thou hast scattered us among the nations."),
    (44, 12, "Thou hast sold thy people for no price: and there was no reckoning in the exchange of them."),
    (44, 13, "Thou hast made us a reproach to our neighbours, a scoff and derision to them that are round about us."),
    (44, 14, "Thou hast made us a byword among the Gentiles: a shaking of the head among the people."),
    (44, 15, "All the day long my shame is before me: and the confusion of my face hath covered me,"),
    (44, 16, "At the voice of him that reproacheth and detracteth me: at the face of the enemy and persecutor."),
    (
        44,
        17,
        "All these things have come upon us, yet we have not forgotten thee: and we have not done wickedly in they covenant.",
    ),
    (44, 18, "And our heart hath not turned back: neither hast thou turned aside our steps from thy way."),
    (44, 19, "For thou hast humbled us in the place of affliction: and the shadow of death hath covered us."),
    (44, 20, "If we have forgotten the name of our God, and if we have spread forth our hands to a strange god:"),
    (
        44,
        21,
    ...
    (44, 23, "Arise, why sleepest thou, O Lord? arise, and cast us not off to the end."),
    (44, 24, "Why turnest thou face away? and forgettest our want and our trouble?"),
    (44, 25, "For our soul is humbled down to the dust: our belly cleaveth to the earth."),
    ...
    (51, 2, "Wash me yet more from my iniquity, and cleanse me from my sin."),
    ...
    (53, 1, "They are corrupted, and become abominable in iniquities: there is none that doth good."),
    (
        53,
        2,
    ...
    (59, 2, "Deliver me from them that work iniquity, and save me from bloody men."),
    ...
    (60, 3, "Thou hast shewn thy people hard things; thou hast made us drink wine of sorrow."),
    (
        60,
        4,
    ...
    (66, 1, "Unto the end, a canticle of a psalm of the resurrection. Shout with joy to God, all the earth,"),
    ...
    (67, 2, "That we may know thy way upon earth: thy salvation in all nations."),
    (67, 3, "Let people confess to thee, O God: let all people give praise to thee."),
    (
        67,
        4,
        "Let the nations be glad and rejoice: for thou judgest the people with justice, and directest the nations upon earth.",
    ),
    (67, 5, "Let the people, O God, confess to thee: let all the people give praise to thee:"),
    (67, 6, "The earth hath yielded her fruit. May God, our God bless us,"),
    (67, 7, "May God bless us: and all the ends of the earth fear him."),
    ...
    (75, 2, "When I shall take a time, I will judge justices."),
    (75, 3, "The earth is melted, and all that dwell therein: I have established the pillars thereof."),
    (75, 4, "I said to the wicked: Do not act wickedly: and to the sinners: Lift not up the horn."),
    (75, 5, "Lift not up your horn on high: speak not iniquity against God."),
    (75, 6, "For neither from the east, nor from the west, nor from the desert hills:"),
    (75, 7, "For God is the judge. One he putteth down, and another he lifteth up:"),
    (
        75,
        8,
    ...
    (75, 9, "But I will declare for ever: I will sing to the God of Jacob."),
    (75, 10, "And I will break all the horns of sinners: but the horns of the just shall be exalted."),
    ...
    (78, 32, "In all these things they sinned still: and they believed not for his wondrous works."),
    ...
    (78, 45, "He sent amongst them divers sores of flies, which devoured them: and frogs which destroyed them."),
    ...
    (78, 53, "And he brought them out in hope, and they feared not: band the sea overwhelmed their enemies."),
    (
        78,
        54,
    ...
    (78, 72, "And he fed them in the innocence of his heart: and conducted them by the skillfulness of his hands."),
    (
        79,
        1,
    ...
    (79, 3, "They have poured out their blood as water, round about Jerusalem and there was none to bury them."),
    (79, 4, "We are become a reproach to our neighbours: a scorn and derision to them that are round about us."),
    (79, 5, "How long, O Lord, wilt thou be angry for ever: shall thy zeal be kindled like a fire?"),
    (
        79,
        6,
        "Pour out thy wrath upon the nations that have not known thee: and upon the kingdoms that have not called upon thy name.",
    ),
    (79, 7, "Because they have devoured Jacob; and have laid waste his place."),
    (
        79,
        8,
    ...
    (85, 3, "Thou hast mitigated all thy anger: thou best turned away from the wrath of thy indignation."),
    ...
    (87, 1, "For the sons of Core, a psalm of a canticle. The foundations thereof are in the holy mountains:"),
    ...
    (88, 1, "O Lord, the God of my salvation: I have cried in the day, and in the night before thee."),
    ...
    (95, 8, "Today if you shall hear his voice, harden not your hearts:"),
    (
        95,
        9,
    ...
    (98, 6, "With long trumpets, and sound of comet. Make a joyful noise before the Lord our king:"),
    (98, 7, "Let the sea be moved and the fulness thereof: the world and they that dwell therein."),
    ...
    (101, 1, "A psalm for David himself. Mercy and judgment I will sing to thee, O Lord: I will sing,"),
    (
        101,
        2,
    ...
    (105, 1, "Alleluia. Give glory to the Lord, and call upon his name: declare his deeds among the Gentiles."),
    ...
    (105, 27, "He gave them power to shew his signs, and his wonders in the land of Cham."),
    ...
    (107, 1, "Give glory to the Lord, for he is good: for his mercy endureth for ever."),
    (
        107,
        2,
        "Let them say so that have been redeemed by the Lord, whom he hath redeemed from the hand of the enemy: and gathered out of the countries.",
    ),
    (107, 3, "From the rising and the setting of the sun, from the north and from the sea."),
    (
        107,
        4,
    ...
    (107, 12, "And their heart was humbled with labours: they were weakened, and their was none to help them."),
    ...
    (107, 16, "Because he hath broken gates of brass, and burst the iron bars."),
    ...
    (107, 33, "He hath turned rivers into a wilderness: and the sources of water into dry ground:"),
    (107, 34, "A fruitful land into barrenness, for the wickedness of them that dwell therein."),
    (107, 35, "He hath turned a wilderness into pools of water, and a dry land into water springs."),
    (107, 36, "And hath placed there the hungry; and they made a city for their habitation."),
    (107, 37, "And they sowed fields, and planted vineyards: and they yielded fruit of birth."),
    (
        107,
        38,
    ...
    (107, 42, "The just shall see, and shall rejoice, and all iniquity shall stop their mouth."),
    ...
    (108, 3, "I will praise thee, O Lord, among the people: and I will sing unto thee among the populations."),
    ...
    (109, 11, "May the userer search all his substance: and let strangers plunder his labours."),
    ...
    (
        109,
        16,
        "Because he remembered not to show mercy, But persecuted the poor man and the beggar; and the broken in heart, to put him to death.",
    ),
    (
        109,
        17,
    ...
    (109, 21, "But thou, O Lord, do with for thy names sake: because thy mercy is sweet. Do thou deliver me."),
    ...
    (112, 1, "Blessed is the man that feareth the Lord: he shall delight exceedingly in his commandments."),
    (112, 2, "His seed shall be mighty upon earth: the generation of the righteous shall be blessed."),
    (112, 3, "Glory and wealth shall be in his house: and his justice remaineth for ever and ever."),
    (112, 4, "To the righteous a light is risen up in darkness: he is merciful, and compassionate and just."),
    (112, 5, "Acceptable is the man that showeth mercy and lendeth: he shall order his words with judgment:"),
    (112, 6, "Because he shall not be moved for ever."),
    (
        112,
        7,
        "The just shall be in everlasting remembrance: he shall not hear the evil hearing. His heart is ready to hope in the Lord:",
    ),
    (112, 8, "His heart is strengthened, he shall not be moved until he look over his enemies."),
    (
        112,
        9,
    ...
    (113, 1, "Praise the Lord, ye children: praise ye the name of the Lord."),
    (113, 2, "Blessed be the name of the Lord, from henceforth now and for ever."),
    (113, 3, "From the rising of the sun unto the going down of the same, the name of the Lord is worthy of praise."),
    (113, 4, "The Lord is high above all nations; and his glory above the heavens."),
    (113, 5, "Who is as the Lord our God, who dwelleth on high:"),
    (113, 6, "And looketh down on the low things in heaven and in earth?"),
    (113, 7, "Raising up the needy from the earth, and lifting up the poor out of the dunghill:"),
    (113, 8, "That he may place him with princes, with the princes of his people."),
    (113, 9, "Who maketh a barren woman to dwell in a house, the joyful mother of children."),
    (114, 1, "When Israel went out of Egypt, the house of Jacob from a barbarous people:"),
    (114, 2, "Judea made his sanctuary, Israel his dominion."),
    (114, 3, "The sea saw and fled: Jordan was turned back."),
    (114, 4, "The mountains skipped like rams, and the hills like the lambs of the flock."),
    (114, 5, "What ailed thee, O thou sea, that thou didst flee: and thou, O Jordan, that thou wast turned back?"),
    (114, 6, "Ye mountains, that ye skipped like rams, and ye hills, like lambs of the flock?"),
    (114, 7, "At the presence of the Lord the earth was moved, at the presence of the God of Jacob:"),
    (114, 8, "Who turned the rock into pools of water, and the stony hill into fountains of waters."),
    (115, 1, "Not to us, O Lord, not to us; but to thy name give glory."),
    (115, 2, "For thy mercy, and for thy truth’s sake: lest the gentiles should say: Where is their God?"),
    (115, 3, "But our God is in heaven: he hath done all things whatsoever he would."),
    (115, 4, "The idols of the gentiles are silver and gold, the works of the hands of men."),
    (115, 5, "They have mouths and speak not: they have eyes and see not."),
    (115, 6, "They have ears and hear not: they have noses and smell not."),
    (
        115,
        7,
        "They have hands and feel not: they have feet and walk not: neither shall they cry out through their throat.",
    ),
    (115, 8, "Let them that make them become like unto them: and all such as trust in them."),
    (115, 9, "The house of Israel hath hoped in the Lord: he is their helper and their protector."),
    (115, 10, "The house of Aaron hath hoped in the Lord: he is their helper and their protector."),
    (115, 11, "They that fear the Lord hath hoped in the Lord: he is their helper and their protector."),
    (
        115,
        12,
    ...
    (115, 13, "He hath blessed all that fear the Lord, both little and great."),
    (115, 14, "May the Lord add blessings upon you: upon you, and upon your children."),
    (115, 15, "Blessed be you of the Lord, who made heaven and earth."),
    (115, 16, "The heaven of heaven is the Lord’s: but the earth he has given to the children of men."),
    (115, 17, "The dead shall not praise thee, O Lord: nor any of them that go down to hell."),
    (115, 18, "But we that live bless the Lord: from this time now and for ever."),
    ...
    (117, 2, "For his mercy is confirmed upon us: and the truth of the Lord remaineth for ever."),
    ...
    (122, 2, "Our feet were standing in thy courts, O Jerusalem."),
    (122, 3, "Jerusalem, which is built as a city, which is compact together."),
    (
        122,
        4,
        "For thither did the tribes go up, the tribes of the Lord: the testimony of Israel, to praise the name of the Lord.",
    ),
    (122, 5, "Because their seats have sat in judgment, seats upon the house of David."),
    (122, 6, "Pray ye for the things that are for the peace of Jerusalem: and abundance for them that love thee."),
    (122, 7, "Let peace be in thy strength: and abundance in thy towers."),
    (122, 8, "For the sake of my brethren, and of my neighbours, I spoke peace of thee."),
    (122, 9, "Because of the house of the Lord our God, I have sought good things for thee."),
    ...
    (130, 1, "Out of the depths I have cried to thee, O Lord:"),
    ...
    (132, 1, "O Lord, remember David, and all his meekness."),
    ...
    (132, 18, "His enemies I will clothe with confusion: but upon him will my sanctification flourish."),
    (133, 1, "Behold how good and how pleasant it is for brethren to dwell in unity."),
    (
        133,
        2,
    ...
    (134, 2, "In the nights lift up your hands to the holy places, and bless ye the Lord."),
    (134, 3, "May the Lord out of Sion bless thee, he that made heaven and earth."),
    (135, 1, "Praise ye the name of the Lord: O you his servants, praise the Lord:"),
    ...
    (135, 6, "Whatsoever the Lord hath pleased he hath done, in heaven, in earth, in the sea, and in all the deeps."),
    (
        135,
        7,
    ...
    (136, 1, "Praise the Lord, for he is good: for his mercy endureth for ever."),
    ...
    (136, 8, "The sun to rule over the day: for his mercy endureth for ever."),
    ...
    (136, 11, "Who brought Israel from among them: for his mercy endureth for ever."),
    (136, 12, "With a mighty hand and a stretched out arm: for his mercy endureth for ever."),
    ...
    (137, 1, "Upon the rivers of Babylon, there we sat and wept: when we remembered Sion:"),
    (137, 2, "On the willows in the midst thereof we hung up our instruments."),
    (
        137,
        3,
        "For there they that led us into captivity required of us the words of songs. And they that carried us away, said: Sing ye to us a hymn of the songs of Sion.",
    ),
    (137, 4, "How shall we sing the song of the Lord in a strange land?"),
    (137, 5, "If I forget thee, O Jerusalem, let my right hand be forgotten."),
    (
        137,
        6,
    ...
    (138, 3, "In what day soever I shall call upon thee, hear me: thou shall multiply strength in my soul."),
    ...
    (138, 8, "The Lord will repay for me: thy mercy, O Lord, endureth for ever: O despise not the work of thy hands."),
    (139, 1, "Lord, thou hast proved me, and known me:"),
    (139, 2, "Thou hast know my sitting down, and my rising up."),
    ...
    (139, 8, "If I ascend into heaven, thou art there: if I descend into hell, thou art present."),
    ...
    (139, 21, "Have I not hated them, O Lord, that hated thee: and pine away because of thy enemies?"),
