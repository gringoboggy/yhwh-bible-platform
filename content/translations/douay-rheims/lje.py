"""Translation: douay-rheims · Book: lje
...
VERSES = [
    ...
    (1, 7, "For my angel is with you: And I myself will demand an account of your souls."),
    (
        1,
        8,
    ...
    (1, 9, "And as if it were for a maiden that loveth to go gay: so do they take gold and make them up."),
    (
        1,
        10,
    ...
    (1, 12, "And these gods cannot defend themselves from the rust, and the moth."),
    (
        1,
        13,
    ...
    (1, 17, "When they are placed in the house, their eyes are full of dust by the feet of them that go in."),
    (
        1,
        18,
    ...
    (1, 21, "Their faces are black with the smoke that is made in the house."),
    (
        1,
        22,
        "Owls, and swallows, and other birds fly upon their bodies, and upon their heads, and cats in like manner.",
    ),
    (1, 23, "Whereby you may know that they are no gods. Therefore fear them not."),
    (
        1,
        24,
    ...
    (1, 25, "Men buy them at a high price, whereas there is no breath in them."),
    (
        1,
        26,
    ...
    (1, 32, "And they roar and cry before their gods, as men do at the feast when one is dead."),
    (1, 33, "The priests take away their garments, and clothe their wives and their children."),
    (
        1,
        34,
    ...
    (1, 36, "They cannot deliver a man from death nor save the weak from the mighty."),
    (1, 37, "They cannot restore the blind man to his sight: nor deliver a man from distress."),
    (1, 38, "They shall not pity the widow, nor do good to the fatherless."),
    (
        1,
        39,
    ...
    (1, 40, "How then is it to be supposed, or to be said, that they are gods?"),
    (
        1,
        41,
    ...
    (
        1,
        43,
        "The women also with cords about them, sit in the ways, burning olive stones. And when any one of them, drawn away by some passenger, lieth with him, she upbraideth her neighbour, that she was not thought as worthy as herself, nor her cord broken.",
    ),
    (
        1,
        44,
    ...
    (1, 53, "They cannot set up a king over the land, nor give rain to men."),
    (
        1,
        54,
    ...
    (1, 56, "And they cannot withstand a king and war. How then can it be supposed, or admitted that they are gods?"),
    (
        1,
        57,
    ...
    (1, 60, "The sun, and the moon, and the stars being bright, and sent forth for profitable uses, are obedient."),
    (
        1,
        61,
    ...
    (1, 62, "And the clouds when God commandeth them to go over the whole world, do that which is commanded them."),
    (
        1,
        63,
    ...
    (1, 65, "Knowing therefore that they are not gods, fear them not."),
    (1, 66, "For neither can they curse kings, nor bless them."),
    (
        1,
        67,
        "Neither do they shew signs in the heaven to the nations, nor shine as the sun, nor give light as the moon.",
    ),
    (1, 68, "Beasts are better than they, which can fly under a covert, and help themselves."),
    (1, 69, "Therefore there is no manner of appearance that they are gods: so fear them not."),
    (
        1,
        70,
    ...
    (1, 73, "Better therefore is the just man that hath no idols: for he shall be far from reproach."),
]
