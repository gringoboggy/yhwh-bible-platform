"""Translation: douay-rheims · Book: mic
...
VERSES = [
    ...
    (5, 14, "And I will pluck up thy groves out of the midst of thee: and will crush thy cities."),
    (5, 15, "And I will execute vengeance in wrath and in indignation among all the nations that have not given ear."),
    (
        6,
        1,
