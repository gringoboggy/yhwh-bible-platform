"""Translation: douay-rheims · Book: isa
...
VERSES = [
    ...
    (
        9,
        1,
        "And they shall look to the earth, and behold trouble and darkness, weakness and distress, and a mist following them, and they cannot fly away from their distress. At the first time the land of Zabulon, and the land of Nephtali was lightly touched: and at the last the way of the sea beyond the Jordan of the Galilee of the Gentiles was heavily loaded.",
    ),
    (
        9,
        2,
    ...
    (32, 1, "Behold a king shall reign in justice, and princes shell rule in judgment."),
    (
        32,
        2,
    ...
    (38, 22, "And Ezechias bed said: What shall be the sign that I shall go up to the house of the Lord?"),
    (
        39,
        1,
    ...
    (39, 5, "And Isaias said to Ezechias: Rear the word of the Lord of hosts."),
    (
        39,
        6,
    ...
    (
        45,
        25,
        "Therefore shall he say: In the Lord are my justices and empire: they shall come to him, and all that resist him shall be confounded. In the Lord shall all the seed of Israel be justified and praised.",
    ),
    (
        46,
        1,
