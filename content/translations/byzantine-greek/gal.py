"""Translation: byzantine-greek · Book: gal
...
VERSES = [
    ...
    (1, 3, "χάρις ὑμῖν καὶ εἰρήνη ἀπὸ θεοῦ πατρός, καὶ κυρίου ἡμῶν Ἰησοῦ χριστοῦ,"),
    (
        1,
        4,
    ...
    (1, 11, "Γνωρίζω δὲ ὑμῖν, ἀδελφοί, τὸ εὐαγγέλιον τὸ εὐαγγελισθὲν ὑπ’ ἐμοῦ, ὅτι οὐκ ἔστιν κατὰ ἄνθρωπον."),
    ...
    (1, 18, "Ἔπειτα μετὰ ἔτη τρία ἀνῆλθον εἰς Ἱεροσόλυμα ἱστορῆσαι Πέτρον, καὶ ἐπέμεινα πρὸς αὐτὸν ἡμέρας δεκαπέντε."),
    ...
    (1, 23, "μόνον δὲ ἀκούοντες ἦσαν ὅτι Ὁ διώκων ἡμᾶς ποτέ, νῦν εὐαγγελίζεται τὴν πίστιν ἥν ποτε ἐπόρθει."),
    (1, 24, "Καὶ ἐδόξαζον ἐν ἐμοὶ τὸν θεόν."),
    (2, 1, "Ἔπειτα διὰ δεκατεσσάρων ἐτῶν πάλιν ἀνέβην εἰς Ἱεροσόλυμα μετὰ Βαρνάβα, συμπαραλαβὼν καὶ Τίτον·"),
    (
        2,
        2,
    ...
    (2, 11, "Ὅτε δὲ ἦλθεν Πέτρος εἰς Ἀντιόχειαν, κατὰ πρόσωπον αὐτῷ ἀντέστην, ὅτι κατεγνωσμένος ἦν."),
    (
        2,
        12,
    ...
    (2, 18, "Εἰ γὰρ ἃ κατέλυσα, ταῦτα πάλιν οἰκοδομῶ, παραβάτην ἐμαυτὸν συνίστημι."),
    ...
    (3, 7, "Γινώσκετε ἄρα ὅτι οἱ ἐκ πίστεως, οὗτοί εἰσιν υἱοὶ Ἀβραάμ."),
    (
        3,
        8,
    ...
    (3, 12, "ὁ δὲ νόμος οὐκ ἔστιν ἐκ πίστεως, ἀλλ’ Ὁ ποιήσας αὐτὰ ἄνθρωπος ζήσεται ἐν αὐτοῖς."),
    (
        3,
        13,
    ...
    (3, 18, "Εἰ γὰρ ἐκ νόμου ἡ κληρονομία, οὐκέτι ἐξ ἐπαγγελίας· τῷ δὲ Ἀβραὰμ δι’ ἐπαγγελίας κεχάρισται ὁ θεός."),
    (
        3,
        19,
        "Τί οὖν ὁ νόμος; Τῶν παραβάσεων χάριν προσετέθη, ἄχρι οὗ ἔλθῃ τὸ σπέρμα ᾧ ἐπήγγελται, διαταγεὶς δι’ ἀγγέλων ἐν χειρὶ μεσίτου.",
    ),
    (3, 20, "Ὁ δὲ μεσίτης ἑνὸς οὐκ ἔστιν, ὁ δὲ θεὸς εἷς ἐστίν."),
    (
        3,
        21,
    ...
    (4, 7, "Ὥστε οὐκέτι εἶ δοῦλος, ἀλλ’ υἱός· εἰ δὲ υἱός, καὶ κληρονόμος θεοῦ διὰ χριστοῦ."),
    (4, 8, "Ἀλλὰ τότε μέν, οὐκ εἰδότες θεόν, ἐδουλεύσατε τοῖς μὴ φύσει οὖσιν θεοῖς·"),
    (
        4,
        9,
    ...
    (4, 10, "Ἡμέρας παρατηρεῖσθε, καὶ μῆνας, καὶ καιρούς, καὶ ἐνιαυτούς."),
    (4, 11, "Φοβοῦμαι ὑμᾶς, μήπως εἰκῇ κεκοπίακα εἰς ὑμᾶς."),
    ...
    (4, 18, "Καλὸν δὲ τὸ ζηλοῦσθαι ἐν καλῷ πάντοτε, καὶ μὴ μόνον ἐν τῷ παρεῖναί με πρὸς ὑμᾶς."),
    (4, 19, "Τεκνία μου, οὓς πάλιν ὠδίνω, ἄχρι οὗ μορφωθῇ χριστὸς ἐν ὑμῖν,"),
    ...
    (4, 22, "Γέγραπται γάρ, ὅτι Ἀβραὰμ δύο υἱοὺς ἔσχεν· ἕνα ἐκ τῆς παιδίσκης, καὶ ἕνα ἐκ τῆς ἐλευθέρας."),
    (4, 23, "Ἀλλ’ ὁ μὲν ἐκ τῆς παιδίσκης κατὰ σάρκα γεγέννηται, ὁ δὲ ἐκ τῆς ἐλευθέρας διὰ τῆς ἐπαγγελίας."),
    (
        4,
        24,
    ...
    (4, 26, "Ἡ δὲ ἄνω Ἱερουσαλὴμ ἐλευθέρα ἐστίν, ἥτις ἐστὶν μήτηρ πάντων ἡμῶν·"),
    (
        4,
        27,
    ...
    (4, 28, "Ἡμεῖς δέ, ἀδελφοί, κατὰ Ἰσαάκ, ἐπαγγελίας τέκνα ἐσμέν."),
    ...
    (4, 31, "Ἄρα, ἀδελφοί, οὐκ ἐσμὲν παιδίσκης τέκνα, ἀλλὰ τῆς ἐλευθέρας."),
    (5, 1, "Τῇ ἐλευθερίᾳ οὖν ᾗ χριστὸς ἡμᾶς ἠλευθέρωσεν, στήκετε, καὶ μὴ πάλιν ζυγῷ δουλείας ἐνέχεσθε."),
    ...
    (5, 4, "Κατηργήθητε ἀπὸ τοῦ χριστοῦ, οἵτινες ἐν νόμῳ δικαιοῦσθε· τῆς χάριτος ἐξεπέσατε."),
    (5, 5, "Ἡμεῖς γὰρ πνεύματι ἐκ πίστεως ἐλπίδα δικαιοσύνης ἀπεκδεχόμεθα."),
    (5, 6, "Ἐν γὰρ χριστῷ Ἰησοῦ οὔτε περιτομή τι ἰσχύει, οὔτε ἀκροβυστία, ἀλλὰ πίστις δι’ ἀγάπης ἐνεργουμένη."),
    (5, 7, "Ἐτρέχετε καλῶς· τίς ὑμᾶς ἐνέκοψεν τῇ ἀληθείᾳ μὴ πείθεσθαι;"),
    ...
    (5, 14, "Ὁ γὰρ πᾶς νόμος ἐν ἑνὶ λόγῳ πληροῦται, ἐν τῷ, Ἀγαπήσεις τὸν πλησίον σου ὡς ἑαυτόν."),
    (5, 15, "Εἰ δὲ ἀλλήλους δάκνετε καὶ κατεσθίετε, βλέπετε μὴ ὑπὸ ἀλλήλων ἀναλωθῆτε."),
    ...
    (5, 19, "Φανερὰ δέ ἐστιν τὰ ἔργα τῆς σαρκός, ἅτινά ἐστιν μοιχεία, πορνεία, ἀκαθαρσία, ἀσέλγεια,"),
    (5, 20, "εἰδωλολατρεία, φαρμακεία, ἔχθραι, ἔρεις, ζῆλοι, θυμοί, ἐριθεῖαι, διχοστασίαι, αἱρέσεις,"),
    (
        5,
        21,
    ...
    (5, 23, "πρᾳότης, ἐγκράτεια· κατὰ τῶν τοιούτων οὐκ ἔστιν νόμος."),
    (5, 24, "Οἱ δὲ τοῦ χριστοῦ, τὴν σάρκα ἐσταύρωσαν σὺν τοῖς παθήμασιν καὶ ταῖς ἐπιθυμίαις."),
    ...
    (6, 9, "Τὸ δὲ καλὸν ποιοῦντες μὴ ἐκκακῶμεν· καιρῷ γὰρ ἰδίῳ θερίσομεν, μὴ ἐκλυόμενοι."),
    ...
    (6, 15, "Ἐν γὰρ χριστῷ Ἰησοῦ οὔτε περιτομή τι ἰσχύει, οὔτε ἀκροβυστία, ἀλλὰ καινὴ κτίσις."),
    (6, 16, "Καὶ ὅσοι τῷ κανόνι τούτῳ στοιχήσουσιν, εἰρήνη ἐπ’ αὐτούς, καὶ ἔλεος, καὶ ἐπὶ τὸν Ἰσραὴλ τοῦ θεοῦ."),
    (6, 17, "Τοῦ λοιποῦ, κόπους μοι μηδεὶς παρεχέτω· ἐγὼ γὰρ τὰ στίγματα τοῦ κυρίου Ἰησοῦ ἐν τῷ σώματί μου βαστάζω."),
