"""Translation: byzantine-greek · Book: 2co
...
VERSES = [
    ...
    (1, 7, "εἰδότες ὅτι ὥσπερ κοινωνοί ἐστε τῶν παθημάτων, οὕτως καὶ τῆς παρακλήσεως."),
    (
        1,
        8,
    ...
    (1, 10, "ὃς ἐκ τηλικούτου θανάτου ἐρρύσατο ἡμᾶς καὶ ῥύεται, εἰς ὃν ἠλπίκαμεν ὅτι καὶ ἔτι ῥύσεται,"),
    (
        1,
        11,
    ...
    (1, 15, "Καὶ ταύτῃ τῇ πεποιθήσει ἐβουλόμην ἐλθεῖν πρὸς ὑμᾶς τὸ πρότερον, ἵνα δευτέραν χάριν ἔχητε·"),
    (
        1,
        16,
    ...
    (1, 18, "Πιστὸς δὲ ὁ θεός, ὅτι ὁ λόγος ἡμῶν ὁ πρὸς ὑμᾶς οὐκ ἐγένετο Ναὶ καὶ οὔ."),
    (
        1,
        19,
    ...
    (1, 20, "Ὅσαι γὰρ ἐπαγγελίαι θεοῦ, ἐν αὐτῷ τὸ Ναί, καὶ ἐν αὐτῷ τὸ Ἀμήν, τῷ θεῷ πρὸς δόξαν δι’ ἡμῶν."),
    (1, 21, "Ὁ δὲ βεβαιῶν ἡμᾶς σὺν ὑμῖν εἰς χριστόν, καὶ χρίσας ἡμᾶς, θεός·"),
    ...
    (2, 1, "Ἔκρινα δὲ ἐμαυτῷ τοῦτο, τὸ μὴ πάλιν ἐν λύπῃ πρὸς ὑμᾶς ἐλθεῖν."),
    ...
    (3, 10, "Καὶ γὰρ οὐ δεδόξασται τὸ δεδοξασμένον ἐν τούτῳ τῷ μέρει, ἕνεκεν τῆς ὑπερβαλλούσης δόξης."),
    ...
    (3, 15, "Ἀλλ’ ἕως σήμερον, ἡνίκα ἀναγινώσκεται Μωϋσῆς, κάλυμμα ἐπὶ τὴν καρδίαν αὐτῶν κεῖται."),
    ...
    (4, 5, "Οὐ γὰρ ἑαυτοὺς κηρύσσομεν, ἀλλὰ χριστὸν Ἰησοῦν κύριον· ἑαυτοὺς δὲ δούλους ὑμῶν διὰ Ἰησοῦν."),
    (
        4,
        6,
    ...
    (4, 12, "Ὥστε ὁ μὲν θάνατος ἐν ἡμῖν ἐνεργεῖται, ἡ δὲ ζωὴ ἐν ὑμῖν."),
    (
        4,
        13,
        "Ἔχοντες δὲ τὸ αὐτὸ πνεῦμα τῆς πίστεως, κατὰ τὸ γεγραμμένον, Ἐπίστευσα, διὸ ἐλάλησα, καὶ ἡμεῖς πιστεύομεν, διὸ καὶ λαλοῦμεν·",
    ),
    (4, 14, "εἰδότες ὅτι ὁ ἐγείρας τὸν κύριον Ἰησοῦν καὶ ἡμᾶς διὰ Ἰησοῦ ἐγερεῖ, καὶ παραστήσει σὺν ὑμῖν."),
    (
        4,
        15,
    ...
    (5, 8, "θαρροῦμεν δέ, καὶ εὐδοκοῦμεν μᾶλλον ἐκδημῆσαι ἐκ τοῦ σώματος, καὶ ἐνδημῆσαι πρὸς τὸν κύριον."),
    ...
    (5, 17, "Ὥστε εἴ τις ἐν χριστῷ, καινὴ κτίσις· τὰ ἀρχαῖα παρῆλθεν, ἰδού, γέγονεν καινὰ τὰ πάντα."),
    (
        5,
        18,
    ...
    (5, 21, "Τὸν γὰρ μὴ γνόντα ἁμαρτίαν, ὑπὲρ ἡμῶν ἁμαρτίαν ἐποίησεν, ἵνα ἡμεῖς γενώμεθα δικαιοσύνη θεοῦ ἐν αὐτῷ."),
    ...
    (6, 15, "Τίς δὲ συμφώνησις χριστῷ πρὸς Βελίαρ; Ἢ τίς μερὶς πιστῷ μετὰ ἀπίστου;"),
    (
        6,
        16,
    ...
    (7, 3, "Οὐ πρὸς κατάκρισιν λέγω· προείρηκα γάρ, ὅτι ἐν ταῖς καρδίαις ἡμῶν ἐστὲ εἰς τὸ συναποθανεῖν καὶ συζῇν."),
    (
        7,
        4,
    ...
    (7, 6, "Ἀλλ’ ὁ παρακαλῶν τοὺς ταπεινοὺς παρεκάλεσεν ἡμᾶς, ὁ θεός, ἐν τῇ παρουσίᾳ Τίτου·"),
    (
        7,
        7,
    ...
    (8, 5, "καὶ οὐ καθὼς ἠλπίσαμεν, ἀλλ’ ἑαυτοὺς ἔδωκαν πρῶτον τῷ κυρίῳ, καὶ ἡμῖν διὰ θελήματος θεοῦ"),
    ...
    (8, 12, "Εἰ γὰρ ἡ προθυμία πρόκειται, καθὸ ἐὰν ἔχῃ τις, εὐπρόσδεκτος, οὐ καθὸ οὐκ ἔχει."),
    (
        8,
        13,
        "Οὐ γὰρ ἵνα ἄλλοις ἄνεσις, ὑμῖν δὲ θλίψις· ἀλλ’ ἐξ ἰσότητος, ἐν τῷ νῦν καιρῷ τὸ ὑμῶν περίσσευμα εἰς τὸ ἐκείνων ὑστέρημα,",
    ),
    (8, 14, "ἵνα καὶ τὸ ἐκείνων περίσσευμα γένηται εἰς τὸ ὑμῶν ὑστέρημα· ὅπως γένηται ἰσότης,"),
    (8, 15, "καθὼς γέγραπται, Ὁ τὸ πολύ, οὐκ ἐπλεόνασεν· καὶ ὁ τὸ ὀλίγον, οὐκ ἠλαττόνησεν."),
    ...
    (8, 18, "Συνεπέμψαμεν δὲ μετ’ αὐτοῦ τὸν ἀδελφόν, οὗ ὁ ἔπαινος ἐν τῷ εὐαγγελίῳ διὰ πασῶν τῶν ἐκκλησιῶν·"),
    (
        8,
        19,
    ...
    (8, 21, "προνοούμενοι καλὰ οὐ μόνον ἐνώπιον κυρίου ἀλλὰ καὶ ἐνώπιον ἀνθρώπων."),
    (
        8,
        22,
    ...
    (9, 7, "Ἕκαστος καθὼς προαιρεῖται τῇ καρδίᾳ· μὴ ἐκ λύπης ἢ ἐξ ἀνάγκης· ἱλαρὸν γὰρ δότην ἀγαπᾷ ὁ θεός."),
    (
        9,
        8,
    ...
    (9, 11, "ἐν παντὶ πλουτιζόμενοι εἰς πᾶσαν ἁπλότητα, ἥτις κατεργάζεται δι’ ἡμῶν εὐχαριστίαν τῷ θεῷ."),
    (
        9,
        12,
    ...
    (9, 15, "Χάρις δὲ τῷ θεῷ ἐπὶ τῇ ἀνεκδιηγήτῳ αὐτοῦ δωρεᾷ."),
    (
        10,
        1,
    ...
    (10, 4, "τὰ γὰρ ὅπλα τῆς στρατείας ἡμῶν οὐ σαρκικά, ἀλλὰ δυνατὰ τῷ θεῷ πρὸς καθαίρεσιν ὀχυρωμάτων-"),
    (
        10,
        5,
    ...
    (10, 18, "Οὐ γὰρ ὁ ἑαυτὸν συνιστῶν, ἐκεῖνός ἐστιν δόκιμος, ἀλλ’ ὃν ὁ κύριος συνίστησιν."),
    (11, 1, "Ὄφελον ἀνείχεσθέ μου μικρὸν τῇ ἀφροσύνῃ· ἀλλὰ καὶ ἀνέχεσθέ μου."),
    ...
    (11, 6, "Εἰ δὲ καὶ ἰδιώτης τῷ λόγῳ, ἀλλ’ οὐ τῇ γνώσει· ἀλλ’ ἐν παντὶ φανερωθέντες ἐν πᾶσιν εἰς ὑμᾶς."),
    (
        11,
        7,
    ...
    (11, 10, "Ἔστιν ἀλήθεια χριστοῦ ἐν ἐμοί, ὅτι ἡ καύχησις αὕτη οὐ φραγήσεται εἰς ἐμὲ ἐν τοῖς κλίμασιν τῆς Ἀχαΐας."),
    ...
    (11, 14, "Καὶ οὐ θαυμαστόν· αὐτὸς γὰρ ὁ Σατανᾶς μετασχηματίζεται εἰς ἄγγελον φωτός."),
    (
        11,
        15,
    ...
    (11, 17, "Ὃ λαλῶ, οὐ λαλῶ κατὰ κύριον, ἀλλ’ ὡς ἐν ἀφροσύνῃ, ἐν ταύτῃ τῇ ὑποστάσει τῆς καυχήσεως."),
    (11, 18, "Ἐπεὶ πολλοὶ καυχῶνται κατὰ τὴν σάρκα, κἀγὼ καυχήσομαι."),
    ...
    (11, 21, "Κατὰ ἀτιμίαν λέγω, ὡς ὅτι ἡμεῖς ἠσθενήσαμεν· ἐν ᾧ δ’ ἄν τις τολμᾷ- ἐν ἀφροσύνῃ λέγω- τολμῶ κἀγώ."),
    ...
    (11, 24, "ὑπὸ Ἰουδαίων πεντάκις τεσσαράκοντα παρὰ μίαν ἔλαβον."),
    ...
    (11, 28, "Χωρὶς τῶν παρεκτός, ἡ ἐπισύστασίς μου ἡ καθ’ ἡμέραν, ἡ μέριμνα πασῶν τῶν ἐκκλησιῶν."),
    ...
    (11, 31, "Ὁ θεὸς καὶ πατὴρ τοῦ κυρίου Ἰησοῦ χριστοῦ οἶδεν, ὁ ὢν εὐλογητὸς εἰς τοὺς αἰῶνας, ὅτι οὐ ψεύδομαι."),
    (11, 32, "Ἐν Δαμασκῷ ὁ ἐθνάρχης Ἀρέτα τοῦ βασιλέως ἐφρούρει τὴν Δαμασκηνῶν πόλιν, πιάσαι με θέλων·"),
    ...
    (12, 3, "Καὶ οἶδα τὸν τοιοῦτον ἄνθρωπον- εἴτε ἐν σώματι, εἴτε ἐκτὸς τοῦ σώματος, οὐκ οἶδα· ὁ θεὸς οἶδεν-"),
    (12, 4, "ὅτι ἡρπάγη εἰς τὸν παράδεισον, καὶ ἤκουσεν ἄρρητα ῥήματα, ἃ οὐκ ἐξὸν ἀνθρώπῳ λαλῆσαι."),
    (12, 5, "Ὑπὲρ τοῦ τοιούτου καυχήσομαι· ὑπὲρ δὲ ἐμαυτοῦ οὐ καυχήσομαι, εἰ μὴ ἐν ταῖς ἀσθενείαις μου·"),
    (
        12,
        6,
    ...
    (12, 12, "Τὰ μὲν σημεῖα τοῦ ἀποστόλου κατειργάσθη ἐν ὑμῖν ἐν πάσῃ ὑπομονῇ, ἐν σημείοις καὶ τέρασιν καὶ δυνάμεσιν."),
    (
        12,
        13,
    ...
    (12, 16, "Ἔστω δέ, ἐγὼ οὐ κατεβάρησα ὑμᾶς· ἀλλ’ ὑπάρχων πανοῦργος, δόλῳ ὑμᾶς ἔλαβον."),
    ...
    (13, 8, "Οὐ γὰρ δυνάμεθά τι κατὰ τῆς ἀληθείας, ἀλλ’ ὑπὲρ τῆς ἀληθείας."),
    (13, 9, "Χαίρομεν γὰρ ὅταν ἡμεῖς ἀσθενῶμεν, ὑμεῖς δὲ δυνατοὶ ἦτε· τοῦτο δὲ καὶ εὐχόμεθα, τὴν ὑμῶν κατάρτισιν."),
    (
        13,
        10,
    ...
    (13, 12, "Ἀσπάσασθε ἀλλήλους ἐν ἁγίῳ φιλήματι."),
    (13, 13, "Ἀσπάζονται ὑμᾶς οἱ ἅγιοι πάντες."),
    (
        13,
        14,
