"""Translation: byzantine-greek · Book: 2jn
...
VERSES = [
    ...
    (1, 8, "Βλέπετε ἑαυτούς, ἵνα μὴ ἀπολέσωμεν ἃ εἰργασάμεθα, ἀλλὰ μισθὸν πλήρη ἀπολάβωμεν."),
    (
        1,
        9,
    ...
    (1, 11, "ὁ γὰρ λέγων αὐτῷ χαίρειν κοινωνεῖ τοῖς ἔργοις αὐτοῦ τοῖς πονηροῖς."),
    (
        1,
        12,
    ...
    (1, 13, "Ἀσπάζεταί σε τὰ τέκνα τῆς ἀδελφῆς σου τῆς ἐκλεκτῆς. Ἀμήν."),
]
