"""Translation: byzantine-greek · Book: col
...
BOOK = "col"
VERSES = [
    (1, 1, "Παῦλος ἀπόστολος Ἰησοῦ χριστοῦ διὰ θελήματος θεοῦ, καὶ Τιμόθεος ὁ ἀδελφός,"),
    (
        1,
        2,
    ...
    (1, 3, "Εὐχαριστοῦμεν τῷ θεῷ καὶ πατρὶ τοῦ κυρίου ἡμῶν Ἰησοῦ χριστοῦ, πάντοτε περὶ ὑμῶν προσευχόμενοι,"),
    (1, 4, "ἀκούσαντες τὴν πίστιν ὑμῶν ἐν χριστῷ Ἰησοῦ, καὶ τὴν ἀγάπην τὴν εἰς πάντας τοὺς ἁγίους,"),
    (
        1,
        5,
    ...
    (1, 7, "καθὼς καὶ ἐμάθετε ἀπὸ Ἐπαφρᾶ τοῦ ἀγαπητοῦ συνδούλου ἡμῶν, ὅς ἐστιν πιστὸς ὑπὲρ ὑμῶν διάκονος τοῦ χριστοῦ,"),
    ...
    (1, 12, "εὐχαριστοῦντες τῷ πατρὶ τῷ ἱκανώσαντι ἡμᾶς εἰς τὴν μερίδα τοῦ κλήρου τῶν ἁγίων ἐν τῷ φωτί,"),
    (
        1,
        13,
    ...
    (1, 26, "τὸ μυστήριον τὸ ἀποκεκρυμμένον ἀπὸ τῶν αἰώνων καὶ ἀπὸ τῶν γενεῶν· νυνὶ δὲ ἐφανερώθη τοῖς ἁγίοις αὐτοῦ,"),
    (
        1,
        27,
    ...
    (2, 3, "ἐν ᾧ εἰσὶν πάντες οἱ θησαυροὶ τῆς σοφίας καὶ τῆς γνώσεως ἀπόκρυφοι."),
    (2, 4, "Τοῦτο δὲ λέγω, ἵνα μή τις ὑμᾶς παραλογίζηται ἐν πιθανολογίᾳ."),
    (
        2,
        5,
    ...
    (2, 10, "καί ἐστε ἐν αὐτῷ πεπληρωμένοι, ὅς ἐστιν ἡ κεφαλὴ πάσης ἀρχῆς καὶ ἐξουσίας·"),
    (
        2,
        11,
    ...
    (3, 7, "ἐν οἷς καὶ ὑμεῖς περιεπατήσατέ ποτε, ὅτε ἐζῆτε ἐν αὐτοῖς."),
    ...
    (3, 14, "ἐπὶ πᾶσιν δὲ τούτοις τὴν ἀγάπην, ἥτις ἐστὶν σύνδεσμος τῆς τελειότητος."),
    (
        3,
        15,
    ...
    (3, 20, "Τὰ τέκνα, ὑπακούετε τοῖς γονεῦσιν κατὰ πάντα· τοῦτο γάρ ἐστιν εὐάρεστον ἐν κυρίῳ."),
    ...
    (3, 23, "καὶ πᾶν ὅ τι ἐὰν ποιῆτε, ἐκ ψυχῆς ἐργάζεσθε, ὡς τῷ κυρίῳ καὶ οὐκ ἀνθρώποις·"),
    (3, 24, "εἰδότες ὅτι ἀπὸ κυρίου λήψεσθε τὴν ἀνταπόδοσιν τῆς κληρονομίας· τῷ γὰρ κυρίῳ χριστῷ δουλεύετε."),
    ...
    (4, 4, "ἵνα φανερώσω αὐτό, ὡς δεῖ με λαλῆσαι."),
    ...
    (4, 7, "Τὰ κατ’ ἐμὲ πάντα γνωρίσει ὑμῖν Τυχικός, ὁ ἀγαπητὸς ἀδελφὸς καὶ πιστὸς διάκονος καὶ σύνδουλος ἐν κυρίῳ·"),
    (4, 8, "ὃν ἔπεμψα πρὸς ὑμᾶς εἰς αὐτὸ τοῦτο, ἵνα γνῷ τὰ περὶ ὑμῶν καὶ παρακαλέσῃ τὰς καρδίας ὑμῶν·"),
    (4, 9, "σὺν Ὀνησίμῳ τῷ πιστῷ καὶ ἀγαπητῷ ἀδελφῷ, ὅς ἐστιν ἐξ ὑμῶν. Πάντα ὑμῖν γνωριοῦσιν τὰ ὧδε."),
    (
        4,
        10,
    ...
    (4, 13, "Μαρτυρῶ γὰρ αὐτῷ ὅτι ἔχει ζῆλον πολὺν ὑπὲρ ὑμῶν καὶ τῶν ἐν Λαοδικείᾳ καὶ τῶν ἐν Ἱεραπόλει."),
    (4, 14, "Ἀσπάζεται ὑμᾶς Λουκᾶς ὁ ἰατρὸς ὁ ἀγαπητός, καὶ Δημᾶς."),
    (4, 15, "Ἀσπάσασθε τοὺς ἐν Λαοδικείᾳ ἀδελφούς, καὶ Νυμφᾶν, καὶ τὴν κατ’ οἶκον αὐτοῦ ἐκκλησίαν."),
    (
        4,
        16,
    ...
    (4, 18, "Ὁ ἀσπασμὸς τῇ ἐμῇ χειρὶ Παύλου. Μνημονεύετέ μου τῶν δεσμῶν. Ἡ χάρις μεθ’ ὑμῶν. Ἀμήν."),
]
