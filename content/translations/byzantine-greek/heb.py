"""Translation: byzantine-greek · Book: heb
...
VERSES = [
    ...
    (1, 2, "ὃν ἔθηκεν κληρονόμον πάντων, δι’ οὗ καὶ τοὺς αἰῶνας ἐποίησεν,"),
    (
        1,
        3,
    ...
    (1, 12, "καὶ ὡσεὶ περιβόλαιον ἑλίξεις αὐτούς, καὶ ἀλλαγήσονται· σὺ δὲ ὁ αὐτὸς εἶ, καὶ τὰ ἔτη σου οὐκ ἐκλείψουσιν."),
    (
        1,
        13,
    ...
    (2, 13, "Καὶ πάλιν, Ἐγὼ ἔσομαι πεποιθὼς ἐπ’ αὐτῷ. Καὶ πάλιν, Ἰδοὺ ἐγὼ καὶ τὰ παιδία ἅ μοι ἔδωκεν ὁ θεός."),
    (
        2,
        14,
    ...
    (2, 15, "καὶ ἀπαλλάξῃ τούτους, ὅσοι φόβῳ θανάτου διὰ παντὸς τοῦ ζῇν ἔνοχοι ἦσαν δουλείας."),
    ...
    (3, 2, "πιστὸν ὄντα τῷ ποιήσαντι αὐτόν, ὡς καὶ Μωϋσῆς ἐν ὅλῳ τῷ οἴκῳ αὐτοῦ."),
    (
        3,
        3,
    ...
    (3, 9, "οὗ ἐπείρασάν με οἱ πατέρες ὑμῶν, ἐδοκίμασάν με, καὶ εἶδον τὰ ἔργα μου τεσσαράκοντα ἔτη."),
    (3, 10, "Διὸ προσώχθισα τῇ γενεᾷ ἐκείνῃ, καὶ εἶπον, Ἀεὶ πλανῶνται τῇ καρδίᾳ· αὐτοὶ δὲ οὐκ ἔγνωσαν τὰς ὁδούς μου·"),
    ...
    (3, 16, "Τινὲς γὰρ ἀκούσαντες παρεπίκραναν, ἀλλ’ οὐ πάντες οἱ ἐξελθόντες ἐξ Αἰγύπτου διὰ Μωϋσέως."),
    ...
    (5, 3, "καὶ διὰ ταύτην ὀφείλει, καθὼς περὶ τοῦ λαοῦ, οὕτως καὶ περὶ ἑαυτοῦ, προσφέρειν ὑπὲρ ἁμαρτιῶν."),
    (5, 4, "Καὶ οὐχ ἑαυτῷ τις λαμβάνει τὴν τιμήν, ἀλλὰ καλούμενος ὑπὸ τοῦ θεοῦ, καθάπερ καὶ Ἀαρών."),
    (
        5,
        5,
    ...
    (5, 8, "καίπερ ὢν υἱός, ἔμαθεν ἀφ’ ὧν ἔπαθεν τὴν ὑπακοήν,"),
    (5, 9, "καὶ τελειωθεὶς ἐγένετο τοῖς ὑπακούουσιν αὐτῷ πᾶσιν αἴτιος σωτηρίας αἰωνίου·"),
    ...
    (6, 3, "Καὶ τοῦτο ποιήσωμεν, ἐάνπερ ἐπιτρέπῃ ὁ θεός."),
    (
        6,
        4,
    ...
    (6, 13, "Τῷ γὰρ Ἀβραὰμ ἐπαγγειλάμενος ὁ θεός, ἐπεὶ κατ’ οὐδενὸς εἶχεν μείζονος ὀμόσαι, ὤμοσεν καθ’ ἑαυτοῦ,"),
    (6, 14, "λέγων, Ἦ μὴν εὐλογῶν εὐλογήσω σε, καὶ πληθύνων πληθυνῶ σε."),
    (6, 15, "Καὶ οὕτως μακροθυμήσας ἐπέτυχεν τῆς ἐπαγγελίας."),
    (6, 16, "Ἄνθρωποι μὲν γὰρ κατὰ τοῦ μείζονος ὀμνύουσιν, καὶ πάσης αὐτοῖς ἀντιλογίας πέρας εἰς βεβαίωσιν ὁ ὅρκος."),
    (
        6,
        17,
    ...
    (6, 20, "ὅπου πρόδρομος ὑπὲρ ἡμῶν εἰσῆλθεν Ἰησοῦς, κατὰ τὴν τάξιν Μελχισεδὲκ ἀρχιερεὺς γενόμενος εἰς τὸν αἰῶνα."),
    (
        7,
        1,
    ...
    (7, 4, "Θεωρεῖτε δὲ πηλίκος οὗτος, ᾧ καὶ δεκάτην Ἀβραὰμ ἔδωκεν ἐκ τῶν ἀκροθινίων ὁ πατριάρχης."),
    (
        7,
        5,
    ...
    (7, 6, "ὁ δὲ μὴ γενεαλογούμενος ἐξ αὐτῶν δεδεκάτωκεν τὸν Ἀβραάμ, καὶ τὸν ἔχοντα τὰς ἐπαγγελίας εὐλόγηκεν."),
    (7, 7, "Χωρὶς δὲ πάσης ἀντιλογίας, τὸ ἔλαττον ὑπὸ τοῦ κρείττονος εὐλογεῖται."),
    (7, 8, "Καὶ ὧδε μὲν δεκάτας ἀποθνῄσκοντες ἄνθρωποι λαμβάνουσιν· ἐκεῖ δέ, μαρτυρούμενος ὅτι ζῇ."),
    (7, 9, "Καί, ὡς ἔπος εἰπεῖν, διὰ Ἀβραὰμ καὶ Λευῒ ὁ δεκάτας λαμβάνων δεδεκάτωται·"),
    (7, 10, "ἔτι γὰρ ἐν τῇ ὀσφύϊ τοῦ πατρὸς ἦν, ὅτε συνήντησεν αὐτῷ ὁ Μελχισεδέκ."),
    (
        7,
        11,
    ...
    (7, 13, "Ἐφ’ ὃν γὰρ λέγεται ταῦτα, φυλῆς ἑτέρας μετέσχηκεν, ἀφ’ ἧς οὐδεὶς προσέσχηκεν τῷ θυσιαστηρίῳ."),
    (7, 14, "Πρόδηλον γὰρ ὅτι ἐξ Ἰούδα ἀνατέταλκεν ὁ κύριος ἡμῶν, εἰς ἣν φυλὴν οὐδὲν περὶ ἱερωσύνης Μωϋσῆς ἐλάλησεν."),
    (7, 15, "Καὶ περισσότερον ἔτι κατάδηλόν ἐστιν, εἰ κατὰ τὴν ὁμοιότητα Μελχισεδὲκ ἀνίσταται ἱερεὺς ἕτερος,"),
    (7, 16, "ὃς οὐ κατὰ νόμον ἐντολῆς σαρκικῆς γέγονεν, ἀλλὰ κατὰ δύναμιν ζωῆς ἀκαταλύτου·"),
    ...
    (7, 22, "κατὰ τοσοῦτον κρείττονος διαθήκης γέγονεν ἔγγυος Ἰησοῦς."),
    (7, 23, "Καὶ οἱ μὲν πλείονές εἰσιν γεγονότες ἱερεῖς, διὰ τὸ θανάτῳ κωλύεσθαι παραμένειν·"),
    (7, 24, "ὁ δέ, διὰ τὸ μένειν αὐτὸν εἰς τὸν αἰῶνα, ἀπαράβατον ἔχει τὴν ἱερωσύνην."),
    (
        7,
        25,
    ...
    (8, 2, "τῶν ἁγίων λειτουργός, καὶ τῆς σκηνῆς τῆς ἀληθινῆς, ἣν ἔπηξεν ὁ κύριος, καὶ οὐκ ἄνθρωπος·"),
    (
        8,
        3,
        "πᾶς γὰρ ἀρχιερεὺς εἰς τὸ προσφέρειν δῶρά τε καὶ θυσίας καθίσταται· ὅθεν ἀναγκαῖον ἔχειν τι καὶ τοῦτον ὃ προσενέγκῃ.",
    ),
    (8, 4, "Εἰ μὲν γὰρ ἦν ἐπὶ γῆς, οὐδ’ ἂν ἦν ἱερεύς, ὄντων τῶν ἱερέων τῶν προσφερόντων κατὰ τὸν νόμον τὰ δῶρα,"),
    (
        8,
        5,
    ...
    (8, 12, "Ὅτι ἵλεως ἔσομαι ταῖς ἀδικίαις αὐτῶν, καὶ τῶν ἁμαρτιῶν αὐτῶν καὶ τῶν ἀνομιῶν αὐτῶν οὐ μὴ μνησθῶ ἔτι."),
    (8, 13, "Ἐν τῷ λέγειν, Καινήν, πεπαλαίωκεν τὴν πρώτην. Τὸ δὲ παλαιούμενον καὶ γηράσκον, ἐγγὺς ἀφανισμοῦ."),
    (9, 1, "Εἶχεν μὲν οὖν καὶ ἡ πρώτη δικαιώματα λατρείας, τό τε ἅγιον κοσμικόν."),
    (
        9,
        2,
    ...
    (9, 5, "ὑπεράνω δὲ αὐτῆς Χερουβὶμ δόξης κατασκιάζοντα τὸ ἱλαστήριον· περὶ ὧν οὐκ ἔστιν νῦν λέγειν κατὰ μέρος."),
    (
        9,
        6,
    ...
    (9, 18, "Ὅθεν οὐδ’ ἡ πρώτη χωρὶς αἵματος ἐγκεκαίνισται."),
    (
        9,
        19,
    ...
    (10, 7, "τότε εἶπον, Ἰδού, ἥκω- ἐν κεφαλίδι βιβλίου γέγραπται περὶ ἐμοῦ- τοῦ ποιῆσαι, ὁ θεός, τὸ θέλημά σου."),
    (
        10,
        8,
    ...
    (10, 9, "τότε εἴρηκεν, Ἰδού, ἥκω τοῦ ποιῆσαι, ὁ θεός, τὸ θέλημά σου. Ἀναιρεῖ τὸ πρῶτον, ἵνα τὸ δεύτερον στήσῃ."),
    (10, 10, "Ἐν ᾧ θελήματι ἡγιασμένοι ἐσμέν, οἱ διὰ τῆς προσφορᾶς τοῦ σώματος Ἰησοῦ χριστοῦ ἐφάπαξ."),
    (
        10,
        11,
    ...
    (10, 12, "αὐτὸς δὲ μίαν ὑπὲρ ἁμαρτιῶν προσενέγκας θυσίαν εἰς τὸ διηνεκές, ἐκάθισεν ἐν δεξιᾷ τοῦ θεοῦ,"),
    ...
    (10, 15, "Μαρτυρεῖ δὲ ἡμῖν καὶ τὸ πνεῦμα τὸ ἅγιον· μετὰ γὰρ τὸ προειρηκέναι,"),
    (
        10,
        16,
    ...
    (10, 17, "καὶ τῶν ἁμαρτιῶν αὐτῶν καὶ τῶν ἀνομιῶν αὐτῶν οὐ μὴ μνησθῶ ἔτι."),
    ...
    (10, 35, "Μὴ ἀποβάλητε οὖν τὴν παρρησίαν ὑμῶν, ἥτις ἔχει μισθαποδοσίαν μεγάλην."),
    (10, 36, "Ὑπομονῆς γὰρ ἔχετε χρείαν, ἵνα τὸ θέλημα τοῦ θεοῦ ποιήσαντες κομίσησθε τὴν ἐπαγγελίαν."),
    (10, 37, "Ἔτι γὰρ μικρὸν ὅσον ὅσον, Ὁ ἐρχόμενος ἥξει, καὶ οὐ χρονιεῖ."),
    (10, 38, "Ὁ δὲ δίκαιος ἐκ πίστεως ζήσεται· καὶ ἐὰν ὑποστείληται, οὐκ εὐδοκεῖ ἡ ψυχή μου ἐν αὐτῷ."),
    ...
    (11, 20, "Πίστει περὶ μελλόντων εὐλόγησεν Ἰσαὰκ τὸν Ἰακὼβ καὶ τὸν Ἠσαῦ."),
    (
        11,
        21,
    ...
    (11, 30, "Πίστει τὰ τείχη Ἰεριχὼ ἔπεσεν, κυκλωθέντα ἐπὶ ἑπτὰ ἡμέρας."),
    ...
    (11, 38, "ὧν οὐκ ἦν ἄξιος ὁ κόσμος- ἐν ἐρημίαις πλανώμενοι καὶ ὄρεσιν καὶ σπηλαίοις καὶ ταῖς ὀπαῖς τῆς γῆς."),
    ...
    (12, 4, "Οὔπω μέχρι αἵματος ἀντικατέστητε πρὸς τὴν ἁμαρτίαν ἀνταγωνιζόμενοι·"),
    (
        12,
        5,
    ...
    (12, 7, "Εἰς παιδείαν ὑπομένετε, ὡς υἱοῖς ὑμῖν προσφέρεται ὁ θεός· τίς γάρ ἐστιν υἱὸς ὃν οὐ παιδεύει πατήρ;"),
    (12, 8, "Εἰ δὲ χωρίς ἐστε παιδείας, ἧς μέτοχοι γεγόνασιν πάντες, ἄρα νόθοι ἐστὲ καὶ οὐχ υἱοί."),
    (
        12,
        9,
    ...
    (12, 13, "καὶ τροχιὰς ὀρθὰς ποιήσατε τοῖς ποσὶν ὑμῶν, ἵνα μὴ τὸ χωλὸν ἐκτραπῇ, ἰαθῇ δὲ μᾶλλον."),
    ...
    (12, 16, "μή τις πόρνος, ἢ βέβηλος, ὡς Ἠσαῦ, ὃς ἀντὶ βρώσεως μιᾶς ἀπέδοτο τὰ πρωτοτόκια αὐτοῦ."),
    (
        12,
        17,
    ...
    (12, 18, "Οὐ γὰρ προσεληλύθατε ψηλαφωμένῳ ὄρει, καὶ κεκαυμένῳ πυρί, καὶ γνόφῳ, καὶ σκότῳ, καὶ θυέλλῃ,"),
    ...
    (12, 22, "Ἀλλὰ προσεληλύθατε Σιὼν ὄρει, καὶ πόλει θεοῦ ζῶντος, Ἱερουσαλὴμ ἐπουρανίῳ, καὶ μυριάσιν ἀγγέλων,"),
    (
        12,
        23,
        "πανηγύρει καὶ ἐκκλησίᾳ πρωτοτόκων ἐν οὐρανοῖς ἀπογεγραμμένων, καὶ κριτῇ θεῷ πάντων, καὶ πνεύμασιν δικαίων τετελειωμένων,",
    ),
    (12, 24, "καὶ διαθήκης νέας μεσίτῃ Ἰησοῦ, καὶ αἵματι ῥαντισμοῦ κρεῖττον λαλοῦντι παρὰ τὸν Ἄβελ."),
    (
        12,
        25,
    ...
    (12, 27, "Τὸ δέ, Ἔτι ἅπαξ, δηλοῖ τῶν σαλευομένων τὴν μετάθεσιν, ὡς πεποιημένων, ἵνα μείνῃ τὰ μὴ σαλευόμενα."),
    (
        12,
        28,
    ...
    (13, 4, "Τίμιος ὁ γάμος ἐν πᾶσιν, καὶ ἡ κοίτη ἀμίαντος· πόρνους δὲ καὶ μοιχοὺς κρινεῖ ὁ θεός."),
    (
        13,
        5,
    ...
    (13, 8, "Ἰησοῦς χριστὸς χθὲς καὶ σήμερον ὁ αὐτός, καὶ εἰς τοὺς αἰῶνας."),
    (
        13,
        9,
