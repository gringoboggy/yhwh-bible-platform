"""Translation: byzantine-greek · Book: rev
...
VERSES = [
    ...
    (1, 19, "Γράψον οὖν ἃ εἶδες, καὶ ἅ εἰσιν, καὶ ἃ μέλλει γίνεσθαι μετὰ ταῦτα·"),
    (
        1,
        20,
    ...
    (2, 3, "καὶ ὑπομονὴν ἔχεις καὶ ἐβάστασας διὰ τὸ ὄνομά μου καὶ οὐκ ἐκοπίασας."),
    ...
    (2, 16, "Μετανόησον οὖν· εἰ δὲ μή, ἔρχομαί σοι ταχύ, καὶ πολεμήσω μετ’ αὐτῶν ἐν τῇ ῥομφαίᾳ τοῦ στόματός μου."),
    (
        2,
        17,
    ...
    (3, 16, "Οὕτως ὅτι χλιαρὸς εἶ, καὶ οὐ ζεστὸς οὔτε ψυχρός, μέλλω σε ἐμέσαι ἐκ τοῦ στόματός μου."),
    (
        3,
        17,
    ...
    (3, 19, "Ἐγὼ ὅσους ἐὰν φιλῶ, ἐλέγχω καὶ παιδεύω· ζήλωσον οὖν καὶ μετανόησον."),
    (
        3,
        20,
    ...
    (4, 2, "Καὶ εὐθέως ἐγενόμην ἐν πνεύματι· καὶ ἰδού, θρόνος ἔκειτο ἐν τῷ οὐρανῷ, καὶ ἐπὶ τὸν θρόνον καθήμενος,"),
    ...
    (5, 10, "καὶ ἐποίησας αὐτοὺς τῷ θεῷ ἡμῶν βασιλεῖς καὶ ἱερεῖς, καὶ βασιλεύσουσιν ἐπὶ τῆς γῆς."),
    (
        5,
        11,
    ...
    (5, 14, "Καὶ τὰ τέσσαρα ζῷα λέγοντα τὸ Ἀμήν. Καὶ οἱ πρεσβύτεροι ἔπεσον, καὶ προσεκύνησαν."),
    (
        6,
        1,
    ...
    (6, 3, "Καὶ ὅτε ἤνοιξεν τὴν δευτέραν σφραγῖδα, ἤκουσα τοῦ δευτέρου ζῴου λέγοντος, Ἔρχου."),
    (
        6,
        4,
    ...
    (6, 7, "Καὶ ὅτε ἤνοιξεν τὴν σφραγῖδα τὴν τετάρτην, ἤκουσα τοῦ τετάρτου ζῴου λέγοντος, Ἔρχου καὶ ἴδε."),
    (
        6,
        8,
    ...
    (7, 6, "ἐκ φυλῆς Ἀσήρ, δώδεκα χιλιάδες· ἐκ φυλῆς Νεφθαλείμ, δώδεκα χιλιάδες· ἐκ φυλῆς Μανασσῆ, δώδεκα χιλιάδες·"),
    (7, 7, "ἐκ φυλῆς Συμεών, δώδεκα χιλιάδες· ἐκ φυλῆς Λευΐ, δώδεκα χιλιάδες· ἐκ φυλῆς Ἰσαχάρ, δώδεκα χιλιάδες·"),
    (
        7,
        8,
    ...
    (8, 6, "Καὶ οἱ ἑπτὰ ἄγγελοι οἱ ἔχοντες τὰς ἑπτὰ σάλπιγγας ἡτοίμασαν ἑαυτοὺς ἵνα σαλπίσωσιν."),
    (
        8,
        7,
    ...
    (8, 9, "καὶ ἀπέθανεν τὸ τρίτον τῶν κτισμάτων ἐν τῇ θαλάσσῃ, τὰ ἔχοντα ψυχάς, καὶ τὸ τρίτον τῶν πλοίων διεφθάρη."),
    (
        8,
        10,
    ...
    (9, 16, "Καὶ ὁ ἀριθμὸς τῶν στρατευμάτων τοῦ ἵππου μυριάδες μυριάδων· ἤκουσα τὸν ἀριθμὸν αὐτῶν."),
    (
        9,
        17,
    ...
    (12, 13, "Καὶ ὅτε εἶδεν ὁ δράκων ὅτι ἐβλήθη εἰς τὴν γῆν, ἐδίωξεν τὴν γυναῖκα ἥτις ἔτεκεν τὸν ἄρρενα."),
    (
        12,
        14,
    ...
    (13, 13, "Καὶ ποιεῖ σημεῖα μεγάλα, καὶ πῦρ ἵνα ἐκ τοῦ οὐρανοῦ καταβαίνῃ ἐπὶ τὴν γῆν ἐνώπιον τῶν ἀνθρώπων."),
    (
        13,
        14,
    ...
    (14, 5, "Καὶ οὐχ εὑρέθη ἐν τῷ στόματι αὐτῶν ψεῦδος· ἄμωμοι γάρ εἰσιν."),
    (
        14,
        6,
    ...
    (16, 4, "Καὶ ὁ τρίτος ἐξέχεεν τὴν φιάλην αὐτοῦ εἰς τοὺς ποταμοὺς καὶ εἰς τὰς πηγὰς τῶν ὑδάτων· καὶ ἐγένετο αἷμα."),
    (16, 5, "Καὶ ἤκουσα τοῦ ἀγγέλου τῶν ὑδάτων λέγοντος, Δίκαιος εἶ, ὁ ὢν καὶ ὁ ἦν, ὁ ὅσιος, ὅτι ταῦτα ἔκρινας·"),
    (16, 6, "ὅτι αἷμα ἁγίων καὶ προφητῶν ἐξέχεαν, καὶ αἷμα αὐτοῖς ἔδωκας πιεῖν· ἄξιοί εἰσιν."),
    (
        16,
        7,
    ...
    (17, 9, "Ὧδε ὁ νοῦς ὁ ἔχων σοφίαν. Αἱ ἑπτὰ κεφαλαὶ ἑπτὰ ὄρη εἰσίν, ὅπου ἡ γυνὴ κάθηται ἐπ’ αὐτῶν."),
    (
        17,
        10,
    ...
    (17, 13, "Οὗτοι μίαν ἔχουσιν γνώμην, καὶ τὴν δύναμιν καὶ τὴν ἐξουσίαν αὐτῶν τῷ θηρίῳ διδόασιν."),
    (
        17,
        14,
    ...
    (17, 15, "Καὶ λέγει μοι, Τὰ ὕδατα, ἃ εἶδες, οὗ ἡ πόρνη κάθηται, λαοὶ καὶ ὄχλοι εἰσίν, καὶ ἔθνη καὶ γλῶσσαι."),
    (
        17,
        16,
    ...
    (17, 18, "Καὶ ἡ γυνή, ἣν εἶδες, ἐστὶν ἡ πόλις ἡ μεγάλη, ἡ ἔχουσα βασιλείαν ἐπὶ τῶν βασιλέων τῆς γῆς."),
    (
        18,
        1,
    ...
    (18, 11, "Καὶ οἱ ἔμποροι τῆς γῆς κλαύσουσιν καὶ πενθήσουσιν ἐπ’ αὐτῇ, ὅτι τὸν γόμον αὐτῶν οὐδεὶς ἀγοράζει οὐκέτι·"),
    (
        18,
        12,
    ...
    (18, 24, "Καὶ ἐν αὐτῇ αἵματα προφητῶν καὶ ἁγίων εὑρέθη, καὶ πάντων τῶν ἐσφαγμένων ἐπὶ τῆς γῆς."),
    (
        19,
        1,
    ...
    (19, 3, "Καὶ δεύτερον εἴρηκεν, Ἁλληλούϊα· καὶ ὁ καπνὸς αὐτῆς ἀναβαίνει εἰς τοὺς αἰῶνας τῶν αἰώνων."),
    (
        19,
        4,
    ...
    (20, 5, "Καὶ οἱ λοιποὶ τῶν νεκρῶν οὐκ ἔζησαν ἄχρι τελεσθῇ τὰ χίλια ἔτη. Αὕτη ἡ ἀνάστασις ἡ πρώτη."),
    (
        20,
        6,
    ...
    (20, 15, "Καὶ εἴ τις οὐχ εὑρέθη ἐν τῷ βιβλίῳ τῆς ζωῆς γεγραμμένος, ἐβλήθη εἰς τὴν λίμνην τοῦ πυρός."),
    (
        21,
        1,
    ...
    (21, 7, "Ὁ νικῶν κληρονομήσει ταῦτα, καὶ ἔσομαι αὐτῷ θεός, καὶ αὐτὸς ἔσται μοι υἱός."),
    (
        21,
        8,
    ...
    (21, 17, "Καὶ ἐμέτρησεν τὸ τεῖχος αὐτῆς ἑκατὸν τεσσαράκοντα τεσσάρων πηχῶν, μέτρον ἀνθρώπου, ὅ ἐστιν ἀγγέλου."),
    (21, 18, "Καὶ ἦν ἡ ἐνδόμησις τοῦ τείχους αὐτῆς ἴασπις· καὶ ἡ πόλις χρυσίον καθαρόν, ὅμοιον ὑέλῳ καθαρῷ."),
    (
        21,
        19,
    ...
    (21, 22, "Καὶ ναὸν οὐκ εἶδον ἐν αὐτῇ· ὁ γὰρ κύριος ὁ θεὸς ὁ παντοκράτωρ ναὸς αὐτῆς ἐστίν, καὶ τὸ ἀρνίον."),
    (
        21,
        23,
    ...
    (22, 7, "Καὶ ἰδού, ἔρχομαι ταχύ. Μακάριος ὁ τηρῶν τοὺς λόγους τῆς προφητείας τοῦ βιβλίου τούτου."),
    (
        22,
        8,
    ...
    (22, 12, "Ἰδού, ἔρχομαι ταχύ, καὶ ὁ μισθός μου μετ’ ἐμοῦ, ἀποδοῦναι ἑκάστῳ ὡς τὸ ἔργον ἔσται αὐτοῦ."),
    ...
    (22, 20, "Λέγει ὁ μαρτυρῶν ταῦτα, Ναί, ἔρχομαι ταχύ. Ἀμήν. Ναί, ἔρχου, κύριε Ἰησοῦ."),
    (22, 21, "Ἡ χάρις τοῦ κυρίου Ἰησοῦ χριστοῦ μετὰ πάντων τῶν ἁγίων. Ἀμήν."),
]
