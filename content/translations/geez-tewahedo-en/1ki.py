...
The Ge'ez follows the LXX / "3 Kingdoms" recension, which diverges from the
Masoretic/KJV — notably in clause order, the dating placements, the
administrative-officer lists (ch.4), and various readings. These are preserved
as-is, NOT corrected toward the KJV. [Square brackets] mark genuine lexical or
textual uncertainty; some verses in the source carry illegibility markers
(⟦illegible⟧, rendered "[illegible]") or appear to have collation seams /
displaced clauses (notably 1:29-30, 2:3, 2:18-19, 3:19-21), which are rendered
as the Ge'ez stands. The divine name እግዚእብሔር is rendered "Yahweh" (project
convention).
...
VERSES = [
    ...
    (1, 41, "And while he was still speaking, behold —"),
    (
        1,
        42,
    ...
    (1, 45, "And Solomon has taken his seat upon the throne of the kingdom."),
    (
        1,
        46,
    ...
    (2, 6, "And David slept with his fathers, and was buried in the city of David."),
    (
        2,
        7,
    ...
    (4, 1, "and he reigned over all Israel."),
    (
        4,
        2,
    ...
    (4, 10, "the son of Hesed, in Arubboth, and Socoh, and all the land of Hepher;"),
    (
        4,
        11,
    ...
    (4, 14, "and Ahinadab son of Iddo, [in] Mahanaim;"),
    (
        4,
        15,
        "and Ahimaaz, in Naphtali — he too took Basemath the daughter of Solomon to be his wife;",
    ),
    (4, 16, "Baana son of Hushai, in Asher and in Bealoth;"),
    (4, 17, "and Jehoshaphat son of Paruah, in Issachar;"),
    (4, 18, "and Shimei son of Ela, in Benjamin;"),
    (
        4,
        19,
    ...
    (4, 32, "And Solomon spoke three [thousand] proverbs, and his songs were four [thousand]."),
    (
        4,
        33,
    ...
    (6, 4, "And he made for that house windows, slanted [latticed / recessed]."),
    (
        6,
        5,
    ...
    (6, 9, "And he built his house and finished it, and roofed [ceiled] it with cedar wood."),
    (
        6,
        10,
    ...
    (6, 14, "And Solomon built and finished the temple."),
    (
        6,
        15,
    ...
    (6, 17, "And the temple was 40 cubits, [the part] before the inner-sanctuary [dabir]."),
    (6, 18, "And cedar wood he wrought within the wall of the house, and there was no stone that was seen."),
    (
        6,
        19,
    ...
    (6, 24, "And he overlaid the cherubim with gold."),
    (
        6,
        25,
    ...
    (6, 26, "And the floor of his house he overlaid [spread over] with gold, within it and without."),
    (
        6,
        27,
