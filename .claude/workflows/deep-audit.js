...
const ROUND = args?.round ?? 8              // round 8 = post-K-R15 edition-isolation / cross-bleed sweep (split win+mac; product-code dims only — see LANE_DIMS); bump in-file, args don't reliably propagate
