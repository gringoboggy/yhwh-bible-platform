...
const ROUND = args?.round ?? 8              // round 8 = remediation audit; round 9 = platform research + regression (bump to 9 ONLY after round-8 fix gate — plans/2026-06-17-round9-parallel-audit-and-platform-research.md); args don't reliably propagate
const NOW = args?.now ?? '2026-06-15'             // Date.now() is unavailable in scripts; stamp via args
...
const LANE_DIMS = {
  // round 9: win=11 (7 replay + 2 platform), mac=22 (18 replay + 2 platform) — see plans/2026-06-17-round9-parallel-audit-and-platform-research.md
