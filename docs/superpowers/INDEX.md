...
|------|------|-------|------|--------|
| 2026-06-03 | Plan | Website — free-download portal (yhwhyaway.com) | `plans/2026-06-03-website-plan.md` | in progress — direction CHOSEN (manuscript-reverent illuminated-codex); Phase-1 clickable prototype BUILT (`website/index.html`+`style.css`, 11 editions, served + reviewed); plain HTML/CSS + a `build_site.py` generator, deploy free on GitLab Pages → yhwhyaway.com; NEXT = export named EPUBs (blocker) · self-host fonts + 2 missing covers · generator · wire downloads · deploy |
