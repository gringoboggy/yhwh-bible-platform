...
| 05 | `05-scholarly-academic-navy.epub` | User loading next; reports **much slower first open** than 01 |
...
### 2. Too busy — inline badges / “Kobo-like”
...
### 3. Table of contents — cramped numbers, uneven pages
...
### 4. Bottom-left “page” numbering strange
...
### 5. Reference tables — Kindle auto-expand (works)
