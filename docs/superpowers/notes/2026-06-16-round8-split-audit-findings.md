...
- [x] **MEDIUM** Test coverage gaps (inject_book write path, coord-guard driver loops) — **Mac turn 114** (`test_inject_write_path.py` + `test_mint11_phase3.py` `_emit_extent_ok` coord-guard class sweep) + build-my-bible HTTP **@ 9b877205**
