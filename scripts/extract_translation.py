...
TRANSLATIONS: dict[str, dict] = {
    ...
    "vulgate-clementine": {
        ...
        "notes": (
            ...
            "column for catholic-study and eastern-orthodox editions "
            "in popup_languages_default. The Stuttgart Vulgate "
    ...
    "arabic-vandyke": {
        ...
        "notes": (
            ...
            "Closes the Arabic popup-language column for editions "
            "declaring `arabic` in popup_languages_default — the "
            "last gap after τ.5-A + "
