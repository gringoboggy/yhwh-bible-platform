...
EDITIONS_SPEC = RecordSpec(
    fields=[
        ...
        FieldSpec("popup_languages_per_chapter", required=False, type=list, item_type=str),
        FieldSpec("popup_languages_per_verse", required=False, type=list, item_type=str),
        # ρ.3 hierarchical symbol tri-state (C2-4) — per-coordinate on/off maps.
        FieldSpec("note_families_on_per_book", required=False, type=list, item_type=str),
        FieldSpec("note_families_off_per_book", required=False, type=list, item_type=str),
        FieldSpec("note_families_on_per_chapter", required=False, type=list, item_type=str),
        FieldSpec("note_families_off_per_chapter", required=False, type=list, item_type=str),
        FieldSpec("disabled_note_ids", required=False, type=list, item_type=str),
        FieldSpec("enabled_note_ids", required=False, type=list, item_type=str),
