...
substituted from `_design.HEADER_NAV_LINKS("/apihelp")` and
...
__all__ = ["APIHELP_HTML", "HEADER_NAV_LINKS", "BUYER_ARC_POLISH_CSS"]

APIHELP_HTML = r"""<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="utf-8">
<title>YHWH Ya' Way · API Reference</title>
...
APIHELP_HTML = apply_design_system(APIHELP_HTML, "/apihelp")
