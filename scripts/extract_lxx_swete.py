...
stats:
  ...
  verses: {verse_total}
notes: |
  39 standard OT books of Swete's Septuagint, remapped from LXX numbering to
  canonical KJV coordinates via scripts/core/versification.lxx_swete_to_kjv
  (Psalms renumbering, Jeremiah's OAN reorder, Theodotion Daniel's Additions,
  Proverbs 24/29 reorder, the 1 Kings 20<->21 swap; the Esther Additions and the
  Exodus 36-39 tabernacle account are omitted as non-canonical / unalignable).
